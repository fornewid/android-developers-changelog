---
title: Leaderboards in Unity games  |  Android game development  |  Android Developers
...
# Leaderboards in Unity games Stay organized with collections Save and categorize content based on your preferences.
...
[leaderboards guide](/games/pgs/leaderboards#create_a_leaderboard) for
...
To post a score and include a metadata tag, use a [PlayGamesPlatform](/games/services/unity/v2/api/class/google-play-games/play-games-platform)
instance directly:
...
[PlayGamesPlatform](/games/services/unity/v2/api/class/google-play-games/play-games-platform) object first:
...
This method uses [PlayGamesPlatform](/games/services/unity/v2/api/class/google-play-games/play-games-platform) directly, which provides additional
...
The [LeaderboardScoreData](/games/services/unity/v2/api/class/google-play-games/basic-api/leaderboard-score-data)
