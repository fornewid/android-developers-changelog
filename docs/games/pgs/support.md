---
title: Google Play Games Services support  |  Android game development  |  Android Developers
url: https://developer.android.com/games/pgs/support
source: html-scrape
---
...
# Google Play Games Services support Stay organized with collections Save and categorize content based on your preferences.
...
* [Capture](/studio/debug/bug-report) a
  bug report and share the Google Drive link. If the bug report contains sensitive
  information, then make it private and only give access to requests from @google.com accounts.
* Add screenshots to help explain your problem if applicable
* To learn how to use the Android logging system see
  [Reading
