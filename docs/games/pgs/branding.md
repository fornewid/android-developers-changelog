---
title: Play Games Services branding guidelines  |  Android game development  |  Android Developers
...
# Play Games Services branding guidelines Stay organized with collections Save and categorize content based on your preferences.
...
* **Minimum features**
  + Meet all required tasks in the
    [Google Play games services quality checklist](/games/pgs/quality).
* **Required iconography**
  + Provide a way to invoke Google Play Games default UI with user interface
    entry points for Achievements or Leaderboards. Developers
...
* **Game feature terminology**
  + When describing any game feature in-game, you may use the "Google Play",
    ...
    services. For reference usage, see the examples on this page.
* **What not to do**
...
![example screenshot](/static/images/games/pgs/branding/branding-example3.png)