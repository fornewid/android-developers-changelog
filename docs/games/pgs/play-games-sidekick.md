...
Play Games Sidekick is an overlay that helps you stay in your game
...
2. To add Play Games Sidekick to your app bundle, select **Add Play
...
For any feedback on Sidekick, use the [feedback
