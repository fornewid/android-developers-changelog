...
and [`com.google.android.gms.games.playergameevent`](https://developers.google.com/android/reference/com/google/android/gms/games/playergameevent/package-summary)
packages.
...
- Follow the instructions for installing and setting up your app to use
  ...
  [Set Up Google Play services SDK](https://developer.android.com/android/guides/setup) guide.

- Define the Game Stats that you want your game to unlock or display, by
...
[`GameStatsClient`](https://developers.google.com/android/reference/com/google/android/gms/games/GameStatsClient)
object. You can do this by calling the
[`Games.getGameStatsClient()`](https://developers.google.com/android/reference/com/google/android/gms/games/GameStatsClient)
