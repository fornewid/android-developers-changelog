---
title: Get started with Google Play Games Services  |  Android game development  |  Android Developers
...
# Get started with Google Play Games Services Stay organized with collections Save and categorize content based on your preferences.
...
2. [Set up your game project](#setup-project) and integrate the authentication
   service.
...
[platform authentication](/games/pgs/signin) before adding other
