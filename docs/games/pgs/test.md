---
title: Enable accounts for testing  |  Android game development  |  Android Developers
...
# Enable accounts for testing Stay organized with collections Save and categorize content based on your preferences.
...
**Warning:** Remember to add **yourself** as a tester so that the
Play Games SDK works for your user account, too.
...
3. In the dialog that appears, enter the email addresses of the Google Accounts
   ...
   per line).
4. Click **Add** to save the users as testers. The owners of the tester
