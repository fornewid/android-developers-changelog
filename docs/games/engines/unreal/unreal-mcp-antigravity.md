---
title: Use Antigravity with Unreal MCP  |  Android game development  |  Android Developers
...
# Use Antigravity with Unreal MCP Stay organized with collections Save and categorize content based on your preferences.
...
1. Open the Unreal Editor, go to **Edit > Plugins**, and enable the
   **Unreal MCP** and **All Toolsets** plugins. Depending on your
   ...
   ![Unreal Editor Plugins window showing the Unreal MCP plugin enabled.](/static/images/games/engines/unreal/unreal-mpc-antigravity-plugins1.png)


   **Figure 1.** Enabling Unreal MCP plugin.


   ![Unreal Editor Plugins window showing the All Toolsets plugin enabled.](/static/images/games/engines/unreal/unreal-mpc-antigravity-plugins2.png)
...
2. Go to **Edit > Editor Preferences**, locate the
   ...
   **Auto Start Server**.
   ...
   ![Unreal Editor Preferences window showing the Auto Start Server option enabled.](/static/images/games/engines/unreal/unreal-mpc-antigravity-preferences.png)
...
5. In the Antigravity IDE, open the **Agent** window, click
   ...
   **MCP Servers > Manage MCP Servers > View raw config**.
   ...
   ![Antigravity IDE Agent window with the three-dot options menu expanded, showing 'MCP Servers' as one of the menu items.](/static/images/games/engines/unreal/unreal-mpc-antigravity-mcp1.png)


   **Figure 4.** Navigating to MCP Servers.


   ![Antigravity IDE menu showing the path to Manage MCP Servers.](/static/images/games/engines/unreal/unreal-mpc-antigravity-mcp2.png)


   **Figure 5.** Selecting Manage MCP Servers.


   ![Antigravity IDE Manage MCP Servers window showing the View raw config button.](/static/images/games/engines/unreal/unreal-mpc-antigravity-mcp3.png)
...
6. Add this configuration to `mcp_config.json`, replacing `[YOUR_PORT]` with
   ...
   ![Antigravity IDE text editor showing the JSON configuration for the Unreal MCP server.](/static/images/games/engines/unreal/unreal-mpc-antigravity-mcp4.png)
...
1. In the Antigravity IDE, open the **Agent** window and enter a prompt to add
   ...
   ![Antigravity IDE Agent window with a user prompt to add a 3D sphere.](/static/images/games/engines/unreal/unreal-mpc-antigravity-example1.png)


   **Figure 8.** Prompting the AI agent to add a sphere.
2. In the Unreal Editor, confirm that the sphere is in the scene.

   ![Unreal Editor showing a 3D sphere successfully added to the scene.](/static/images/games/engines/unreal/unreal-mpc-antigravity-example2.png)
