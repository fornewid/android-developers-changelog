---
title: Unity Adaptive Performance and Android provider  |  Android Developers
...
# Unity Adaptive Performance and Android provider Stay organized with collections Save and categorize content based on your preferences.
...
![Adaptive Performance and Android Provider.](/static/images/games/engines/unity/unity-adpf-android-provider.png)
...
![Adaptive Performance graphic scalers.](/static/images/games/engines/unity/unity-adpf-scaler.png)
...
* **Establish a baseline:** Before using ADPF, thoroughly profile your game's
  ...
  ![ADPF Unity Adaptive Performance best practices.](/static/images/games/engines/unity/unity-adpf-best-practices-1.png)


  **Figure 3.** Establish a baseline.
* **Harness Unity Adaptive Performance scalers:** Experiment with Unity Adaptive
  Performance scalers to gain performance benefits without much effort.
  ![ADPF Unity Adaptive Performance best practices.](/static/images/games/engines/unity/unity-adpf-best-practices-2.png)


  **Figure 4.** Harness Unity Adaptive Performance scalers.
* **Prioritize in-game graphic settings:** Optimize your in-game graphic quality
  ...
  ![ADPF Unity Adaptive Performance best practices.](/static/images/games/engines/unity/unity-adpf-best-practices-3.png)


  **Figure 5.** Prioritize in-game graphic settings.
