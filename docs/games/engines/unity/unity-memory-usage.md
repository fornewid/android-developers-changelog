...
in Google Play Console is '[**anonymous RSS + swap**](https://developer.android.com/google/play/vitals/memory-usage)'. This
...
You can refer to the [`AndroidAndroidProcessStats.cs`](https://github.com/android/games-samples/blob/main/unity/memory-utilities/AndroidProcessStats.cs) and
[`GameMemoryMonitor.cs`](https://github.com/android/games-samples/blob/main/unity/memory-utilities/GameMemoryMonitor.cs) scripts for examples on how to monitor the state and
memory footprints of your game's processes at runtime.
...
To use these tools, add both scripts to your Assets folder, and attach the
`GameMemoryMonitor` script to a GameObject in your scene.
...
![Perfetto UI showing anonymous RSS, swap, and their sum query.](https://developer.android.com/static/games/engines/unity/images/unity-memory-usage-perfetto.png) **Figure 2.** The Perfetto UI showing anonymous RSS, swap, and their sum query.
