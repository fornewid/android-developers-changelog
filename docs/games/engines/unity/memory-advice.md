---
title: Get started with the Memory Advice API for Unity games  |  Android Developers
...
# Get started with the Memory Advice API for Unity games Stay organized with collections Save and categorize content based on your preferences.
...
interval of your choosing. Use the [MemoryAdvice\_getMemoryState](/reference/games/memory-advice/group/memory-advice#memoryadvice_getmemorystate)
