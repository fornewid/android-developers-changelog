---
title: Build your game in Unity  |  Android game development  |  Android Developers
...
# Build your game in Unity Stay organized with collections Save and categorize content based on your preferences.
...
2. To start Unity Hub, click **Installs** tab and then click **Install Unity
   ...
   ![Add an editor in the Unity Hub](/static/images/games/unity-hub-add-editor.png)
3. When you install the Unity Editor, make sure to include the [**Android Build
   ...
   * Expand the **Android Build Support** module. If you are using Unity 2019
   ...
   ![Add the Android Build Support NDK option in the Unity
       Hub](/static/images/games/unity-hub-add-ndk.png)
4. In the **Projects** tab, click **New project**.

   ![Start a new project](/static/images/games/unity-start-new-project.png)
