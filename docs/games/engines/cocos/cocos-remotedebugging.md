---
title: Remote debugging on Android  |  Android game development  |  Android Developers
...
# Remote debugging on Android Stay organized with collections Save and categorize content based on your preferences.
...
2. Select the Android platform and check **Debug mode** in the **Build** panel
   ...
   debug](/static/images/games/engines/cocos/android-debug.png)
3. Open the Chrome devtools for remote debugging by visiting the following
   ...
   devtool](/static/images/games/engines/cocos/android-dbg-devtool.png)
