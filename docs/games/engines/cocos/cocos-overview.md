---
title: About Cocos Creator  |  Android game development  |  Android Developers
...
# About Cocos Creator Stay organized with collections Save and categorize content based on your preferences.
...
![Cocos creator UI](/static/images/games/engines/cocos/cyberpunk.jpg)
...
2. Launch the **Cocos Dashboard**. Go to the **Editor** tab and click
   **Download** to add a version of the Cocos Creator. We highly recommend that
   you use the latest version if possible. ![cocos creator dashboard
   editor](/static/images/games/engines/cocos/dashboard-editor.png)
3. Go to the **Project** tab and click **New** to create a new Cocos Creator
   project. ![cocos creator dashboard
   project](/static/images/games/engines/cocos/dashboard-project.png)
4. Choose an editor version, input your project name, select a location to
   store, and then click **Create**. ![cocos creator dashboard project
   create](/static/images/games/engines/cocos/dashboard-project-create.png)
...
6. [Export your game to
   ...
   using the **Project > Build** panel. ![cocos creator build
   panel](/static/images/games/engines/cocos/build-panel.png)
