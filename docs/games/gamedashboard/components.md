---
title: Components  |  Android game development  |  Android Developers
...
![Game Dashboard Settings - Steps!](/static/images/games/game-dashboard/settings.png "Game Dashboard in Settings - Steps")
...
![Entrypoint Icon!](/static/images/games/game-dashboard/entrypoint-icon.png "Entrypoint
Icon")
...
![Game Dashboard Overlay!](/static/images/games/game-dashboard/overlay.png "Game
Dashboard Overlay")
...
* The *Optimization Tile* sets the specific [Game
  Mode](/games/optimize/adpf/gamemode/about-API-and-interventions) of the running game to
  [`STANDARD`](/reference/android/app/GameManager#GAME_MODE_STANDARD),
  ...
  + To enable the Optimization Tile, implement [Game Mode API](/games/optimize/adpf/gamemode/about-API-and-interventions) in
    your game.
* The *Achievements Tile* keeps track of the
  ...
  + To enable the Achievements Tile, implement Achievements following the
    instructions in [Achievements in Android Games](https://developers.google.com/games/services/android/achievements).
