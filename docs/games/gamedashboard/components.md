...
If the**Game Dashboard** entry is not showing up in**Settings** , make sure that your Google Play Services has been updated. To update your Google Play Services, follow the instructions listed in[Keep your device \& apps working with Google Play Services](https://support.google.com/googleplay/answer/9037938).

## Entrypoint Icon

The*Entrypoint Icon* opens the[Game Dashboard Overlay](https://developer.android.com/games/gamedashboard/components#game-dashboard-overlay). It is revealed from the top right corner of the screen when the user swipes to reveal the system UI bar inside of a fullscreen immersive game. Tapping the Entrypoint Icon opens the Game Dashboard Overlay.
