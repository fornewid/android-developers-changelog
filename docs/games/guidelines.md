...
- Submit **at least 5** repetitive stats to power the Game Stats feature
  stored against the player's gamer profile. All repetitive stats need to
...
Each stat must follow the requirements described in [Game Stats](https://developer.android.com/games/pgs/gamestats).
...
- Titles on [Native PC Early Access Program
  (EAP)](https://developer.android.com/games/playgames/native-pc), given our SDK does not support this feature yet. (Note: This only applies to the Native PC version of your title).
