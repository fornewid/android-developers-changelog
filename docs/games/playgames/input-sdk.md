---
title: Input SDK  |  Android game development  |  Android Developers
...
# Input SDK Stay organized with collections Save and categorize content based on your preferences.
...
applies to all other games that need more than the left-mouse button.
...
![A screenshot showing the Input SDK rendered over a sample game](/static/images/games/playgames/input-sdk-overlay.png)
...
**Note:** For information about the other Google Play Games on PC requirements, see
[Get started with Google Play Games on PC](/games/playgames/start).
