---
title: Google Play Install Referrer  |  Play for Native PC  |  Android Developers
...
* `referrer`: A string representing the referral source. This string can be
  queried once your application is installed and running.
...
[`GetInstallReferrerAsync`](/games/playgames/native-pc/unity/api_reference#playpcsdkmanaged-installreferrer). The response contains the
