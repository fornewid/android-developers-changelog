---
title: https://developer.android.com/games/playgames/native-pc/unity/recall
...
[`RequestRecallAccessAsync`](https://developer.android.com/games/playgames/native-pc/unity/api_reference#playpcsdkmanaged-recall).
...
- Query for existing linked in-game accounts using [`recall.retrieveTokens`](https://developer.android.com/games/services/web/api/rest/v1/recall/retrieveTokens)
