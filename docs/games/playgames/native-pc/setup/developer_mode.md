---
title: Use the PC SDK while developing  |  Play for Native PC  |  Android Developers
...
# Use the PC SDK while developing Stay organized with collections Save and categorize content based on your preferences.
...
* Obtain an early-access partner (EAP) GUID. This a secret key that allows your
  development team to use the SDK from within your game engine editor
  without needing to package or digitally sign your game executable or launch it
  from Google Play Games.

**Note:** Work with your Google Partner to get an early-access partner GUID for your
development team. If you don't have an early-access partner, complete the
[express interest form](https://docs.google.com/forms/d/e/1FAIpQLScn35BX-X63ggG84S76okR37nwq6qRA1PNPk4fsBpDbD7J21Q/viewform?_ga=2.233777694.1640262997.1747860154-345235146.1745606832). 

## **Step 1**: Enable developer mode in the manifest

**Warning:** Make sure to remove the `<IsDeveloperMode>` tag
