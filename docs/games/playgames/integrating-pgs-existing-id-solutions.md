---
title: Integrate Play Games Services with existing identity solution  |  Android game development  |  Android Developers
...
# Integrate Play Games Services with existing identity solution Stay organized with collections Save and categorize content based on your preferences.
...
complete the
[cloud save requirements](/games/playgames/continuity-requirements) for
Google Play Games on PC. Use the [continuity requirements](/games/playgames/continuity-requirements) and
[expected behaviors](/games/playgames/continuity-expected-behaviors) pages to verify that your
...
requirement](/games/playgames/continuity-requirements).

![Play Game Services Multi Idenitifier Workflow](/static/images/games/playgames/pgs-multi-identifier-workflow.png)
...
2. Exchange the authentication token and get a verified Play Games Services ID from the Play Games Server.
   This ensures that the id is trusted and not someone pretending to be another
   player by using a compromised device.
3. Attempt to resolve a game account based on the conditions of the device and any
   linked identifiers.

Two main new scenarios need to be introduced into your game:

* Storing Play Games Services IDs on your backend and assigning them to
  existing account IDs in some way, such as the following:
  + For new players, the progress should be automatically linked to
    Play Games Services at some point. (e.g. at game launch, after the
    tutorial or some number of levels, etc.).
  + For existing players, the current progress should be automatically linked to
    Play Games Services after the player updates to a version of your game
    with Play Games Services V2 integrated.
  + The Play Games Services ID can be linked with one or more accounts,
    and Play Games Services can be de-linked from those accounts, but it
    should be linked to at least one valid account.
* Automatically restoring game progress on a signed out/new device based on the
...
[account binding](#account_binding).

![Strong Binding Flow](/static/images/games/playgames/pgs-strong-binding-flow.png)
...
accounts](#recall_recent_accounts) example below:

![Recall Flow](/static/images/games/playgames/pgs-recall-flow.png)
![Recall Flowchart](/static/images/games/playgames/pgs-recall-flowchart.png)
...
![Play Game Services Account Resolution Workflow](/static/images/games/playgames/pgs-account-resolution-workflow.png)
...
![Strong Binding Switch Accounts Flow](/static/images/games/playgames/pgs-strong-binding-switch-accounts-flow.png)
...
![Strong Binding Existing Account Flow](/static/images/games/playgames/pgs-strong-binding-existing-account-flow.png)
...
![Recall Flow 2](/static/images/games/playgames/pgs-recall-flow-2.png)
...
![Recall Non-Android Flow](/static/images/games/playgames/pgs-recall-non-android-flow.png)
...
![Recall Non-Android Flow 2](/static/images/games/playgames/pgs-recall-non-android-flow-2.png)
...
**Save it anyways**
![Recall Multiple Profiles Save Anyways Flow](/static/images/games/playgames/pgs-recall-multiple-profiles-save-anyway-flow.png)
We disregard duplicate pointers to a given account in the "Save it anyways" model.

**Override it**
![Recall Multiple Profiles Override Flow](/static/images/games/playgames/pgs-recall-multiple-profiles-override-flow.png)
