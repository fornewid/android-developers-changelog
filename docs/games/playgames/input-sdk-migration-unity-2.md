---
title: Upgrade Input SDK for Unity to version 1.1  |  Android game development  |  Android Developers
...
# Upgrade Input SDK for Unity to version 1.1 Stay organized with collections Save and categorize content based on your preferences.




This guide explains how to upgrade your game from the 1.0 to the 1.1 Input SDK for Unity. [Click here](/games/playgames/input-sdk-migration-2)
...
* [Update](#update-input-map) your `InputMap` to set the remapping feature *enabled*.
...
* An `InputAction` that utilizes multiples keys must be composed of a modifier
  ...
  B, Ctrl + Alt, and Shift + A + Tab is invalid.
...
![Diagram showing the flow of the Input SDK when remapping keys.](/static/images/games/playgames/input-flow.png)
...
[upgrade guide from 0.0.4 to 1.0.0-beta](/games/playgames/input-sdk-migration-unity).
...
[Adding the SDK](/games/playgames/input-sdk-start#adding-the-sdk).
...
**Note:** Consider the [best practices](/games/playgames/input-sdk-start#input-sdk-best-practices)
for keyboard and mouse controls in Android games when you design an
`InputAction` and be careful to avoid implementing [unsupported configurations](#remapping-exceptions).
...
[Tracking key IDs](/games/playgames/input-sdk-start#tracking-key-ids).
...
[Assigning different controls for different scenes](/games/playgames/input-sdk-start#input-contexts)
using `InputContexts` or updating the UI of your game by
[Getting notified on remapping events](/games/playgames/input-sdk-start#remapping-listener) using
`InputRemappingListeners`.

When updating your key-bindings take a look at the
[Best practices for designing your key bindings](/games/playgames/input-sdk-start#input-sdk-best-practices)
and consider the [restrictions](/games/playgames/input-sdk-start#remapping-restrictions) and
[limitations](/games/playgames/input-sdk-start#remapping-limitations) of the remapping feature.
