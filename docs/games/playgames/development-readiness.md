---
title: Validate your Google Play Games on PC game readiness  |  Android Developers
...
# Validate your Google Play Games on PC game readiness Stay organized with collections Save and categorize content based on your preferences.
...
2. Open the Game Readiness Checker using the "Validate Game Readiness" icon in
   the system tray context menu (right-click the Google Play Games on PC system
   tray icon).
3. In the Game Readiness Checker, select the package name of the game from the
   testing.
4. Click **Run tests**.
...
text "Test passed" and or red text "Test failed".](/static/images/games/playgames/self-audit-tool.png "Screenshot of the Game Readiness Checker")
...
* **What it tests:** this test looks for features that are not supported on
  Google Play Games on PC but are present in the game's `AndroidManifest.xml`
  file.
* **How to address test failures:** [remove or make optional](/games/playgames/pc-compatibility#unsupported-android-features)
...
* **How to address test failures:** [ensure that your game and its supporting
  libraries](/games/playgames/pc-compatibility#x86-requirement) are built for
  x86-64.

### x86 ABI test

* **What it tests:** this makes sure that the game supports an x86-64 ABI, which
  is recommended for Google Play Games on PC.
* **How to address test failures:** [ensure that your game and its supporting
  libraries](/games/playgames/pc-compatibility#x86-requirement) are built for
  x86-64.
...
* **How to address test failures:** make sure your game supports [the minimum
  OpenGL ES or Vulkan versions](/games/playgames/graphics#opengles-version) for
  Google Play Games on PC and update your `AndroidManifest.xml` accordingly.

### Play Games Services v2 SDK integration test

* **What it tests:** if the Play Games Services SDK v2 SDK can be found in
  the `AndroidManifest.xml`.
* **How to address test failures:** [read about the continuity requirements](/games/playgames/identity#game-identity) and make sure you've integrated the
...
* **How to address test failures** [read about the continuity requirements](/games/playgames/identity#game-identity) and ensure that you're signing in the
  player at launch.
...
* **What it tests:** if the game has integrated with the input mapping service
  using the Input SDK.
* **How to address test failures:** [read about the Input SDK](/games/playgames/input-sdk) and make sure you're annotating action bindings in
  your game.
...
* **How to address test failures:** Ensure that your game meets [the frame rate
  requirements](/games/playgames/graphics#increase-max-frame-rate) for
  Google Play Games on PC and keeps the frame rate stable.

### Permissions test

* **What it tests:** whether the game requests permissions that are not
  supported on Google Play Games on PC.
* **How to address test failures:** [Read about features not present on
  Google Play Games on PC](/games/playgames/pc-compatibility#unsupported-android-features) and make sure
...
* **How to address test failures**: [Read about how to detect ANRs and the most
  common kind](/topic/performance/vitals/anr), and address any issues that may
  have occurred when running the Game Readiness Checker.

### App crash test

* **What it tests:** if the game crashed.
* **How to address test failures:** [Diagnose and repair](/topic/performance/vitals/crash) any crashes that may have occurred when
