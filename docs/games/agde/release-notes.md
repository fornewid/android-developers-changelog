---
title: Release notes  |  Android game development  |  Android Developers
...
our [feedback form](https://forms.gle/H1AbLgHipEc5ekdm7).
...
| --- | --- | --- |
| Stable | AndroidGameDevelopmentExtension-2026-v26.1.102.vsix    9D7FBBD7EE254F58364AEE68B1D4ECF113911B7F7A065F2FFDDE7D13D3CDBBB5 | 719 MiB |
| AndroidGameDevelopmentExtensionSamples-v26.1.102.zip    7EEA49CED8373160930760590804410B8CF533903B46CD19FBBEF7918B365AD8 | 1 MiB |
| Canary | AndroidGameDevelopmentExtension-2026-v26.1.102.vsix    9D7FBBD7EE254F58364AEE68B1D4ECF113911B7F7A065F2FFDDE7D13D3CDBBB5 | 719 MiB |
| AndroidGameDevelopmentExtensionSamples-v26.1.102.zip    7EEA49CED8373160930760590804410B8CF533903B46CD19FBBEF7918B365AD8 | 1 MiB |
...
| Release | Package SHA256 checksum | Size |
| --- | --- | --- |
| Stable | AndroidGameDevelopmentExtension-2022-v26.1.102.vsix    E4E2455C902C2D3989B38713695563C99810AC336E7CB9A600D9646F876DEE95 | 719 MiB |
| AndroidGameDevelopmentExtensionSamples-v26.1.102.zip    7EEA49CED8373160930760590804410B8CF533903B46CD19FBBEF7918B365AD8 | 1 MiB |
| Canary | AndroidGameDevelopmentExtension-2022-v26.1.102.vsix    E4E2455C902C2D3989B38713695563C99810AC336E7CB9A600D9646F876DEE95 | 719 MiB |
| AndroidGameDevelopmentExtensionSamples-v26.1.102.zip    7EEA49CED8373160930760590804410B8CF533903B46CD19FBBEF7918B365AD8 | 1 MiB |
...
| important | New environment variables to control the JDK used in AGDE Game Tools (AGDE\_JAVA\_HOME) and the JDK passed from AGDE to Gradle (AGDE\_GRADLE\_JAVA\_HOME), both default to JAVA\_HOME |
...
| fixed | An issue where an ILLEGAL\_ACCESS\_EXCEPTION was thrown by the the embedded JDK. |
...
| fixed | The extension now always uses the bundled version of JVM instead of relying on JAVA\_HOME to be set properly |
| feature | Updated profilers to now include support for [native memory profiling](/studio/profile/memory-profiler#native-memory-profiler) |
...
| important | **Required** We now require JDK 11+ to be set in JAVA\_HOME |
...
| feature | Added support for launching [standalone Android Studio Profilers](/games/preview/extension#profile-app) from Visual Studio to profile your game. |
...
**Note:** Manually uninstall your existing versions of the extension from
Visual Studio before updating to this version.

|  |  |
| --- | --- |
| feature | Added a formal installer, changed from .vsix to .exe. |
| feature | Added a license key to the product. If you forgot or misplaced your license key that we shared with you, please [contact us](/games/preview/extension#support). |
