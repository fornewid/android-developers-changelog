---
title: TurnBasedMatches: resetForAllPlayers  |  API reference  |  Android Developers
...
# TurnBasedMatches: resetForAllPlayers Stay organized with collections Save and categorize content based on your preferences.
