---
title: Applications: listHidden  |  API reference  |  Android Developers
...
# Applications: listHidden Stay organized with collections Save and categorize content based on your preferences.
...
| `items[].player.lastPlayedWith` | `nested object` | Details about the last time this player played a multiplayer game with the currently authenticated player. Populated for PLAYED\_WITH player collection members. |  |
