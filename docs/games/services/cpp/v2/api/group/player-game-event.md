...
| `https://developer.android.com/games/services/cpp/v2/api/group/player-game-event#group__player__game__event_1ga670d7829aff8f763c7e323001249eeff(https://developer.android.com/games/services/cpp/v2/api/group/player-game-event#group__player__game__event_1gae36a74b9855223a6b27b8a0667337145 *event, const char *key, int64_t seconds, int32_t nanos)` | `void` Adds a duration property to the event. |
...
Details Parameters `event_name` The name of the event. **Returns** A new PgsPlayerGameEvent handle, or NULL on failure. This handle must be released with [PgsPlayerGameEvent_destroy()](https://developer.android.com/games/services/cpp/v2/api/group/player-game-event#group__player__game__event_1ga34b829fbca5be8e23f6da6bc9e766dc9).
...
Details Parameters `event` The event handle to destroy.
...
Details Parameters `event` The event handle. `key` The property key. `value` The property value.
...
Details Parameters `event` The event handle. `key` The property key. `seconds` The number of seconds in the duration. `nanos` The number of nanoseconds in the duration (0 to 999,999,999).
