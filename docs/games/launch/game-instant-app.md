...
By doing this check, you can determine whether your app needs to run within a[limited execution environment](https://developer.android.com/games/launch/game-instant-app#execution-environment)or can take advantage of platform features.
