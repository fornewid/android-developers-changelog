---
title: Materials and Shaders  |  Android Developers
...
# Materials and Shaders Stay organized with collections Save and categorize content based on your preferences.
...
![Setting mobile preview rendering in the Unreal editor](/static/images/games/artbp/material/material_figure01.jpg)


**Figure 1.** Setting mobile preview rendering in the Unreal editor.
...
* Use texture packing to combine single-channel textures. For more information
  on this technique, see the [Textures](/games/optimize/textures) guide.
* Replace data for parameters such as roughness or metallic with a numeric
  constant instead of being read from a texture.
* Use unlit shaders or a simple lighting model, to be able to omit textures
  needed to support lighting calculations in more complicated lighting models.
...
![A comparison of a model rendered with and without lighting](/static/images/games/artbp/material/material_figure02.png)


**Figure 2.** An example of a model being rendered with real time lighting (left) and without real time lighting (right).
...
![An example of the overdraw visualization tool in the Unity editor](/static/images/games/artbp/material/material_figure03.jpg)


**Figure 3.** An example of the overdraw visualization tool in the Unity editor.


![An example of the overdraw visualization tool in the Unreal editor](/static/images/games/artbp/material/material_figure04.jpg)


**Figure 4.** An example of the overdraw visualization tool in the Unreal editor.
...
![A comparison between alpha blending and alpha testing](/static/images/games/artbp/material/material_figure05.jpg)


**Figure 5.** An example image (left) rendered using alpha blending (center) and alpha testing (right).
...
![The Shader Complexity viewmode in the Unreal editor](/static/images/games/artbp/material/material_figure06.jpg)


**Figure 6.** The **Shader Complexity** viewmode in the Unreal editor.

You can also use Unreal’s **Material Stats** feature to profile the cost of
materials as you author them.

![The Material Stats display in the Unreal editor](/static/images/games/artbp/material/material_figure07.jpg)


**Figure 7.** The **Material Stats** display in the Unreal editor.
