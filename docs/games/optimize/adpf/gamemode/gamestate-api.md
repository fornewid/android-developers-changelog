...
Check out the modes you can notify the system in the documentation[Summary](https://developer.android.com/reference/android/app/GameState#summary). It is possible that the list will grow when different resource consumption patterns is discovered in the future.