---
title: Best practices for ADPF  |  Android game development  |  Android Developers
...
# Best practices for ADPF Stay organized with collections Save and categorize content based on your preferences.
...
](/static/games/optimize/adpf/videos/adpf_wrong_quality.mp4)


Rendering problem with ADPF in [Unity MegaCity Metro](https://github.com/Unity-Technologies/megacity-metro/tree/demo/vulkan).
...
* **[Define device tiers](/games/distribute/guide-launch-game)**: Test on representative high-end, mid-range,
