...
[Android 15](https://developer.android.com/about/versions/15) sets a default 60Hz refresh rate for games to optimize
power consumption. To unlock higher frame rates like 120 FPS, you must now
explicitly request them using the [Frame Rate API](https://developer.android.com/media/optimize/performance/frame-rate) or the Swappy
library.
...
The [`setFrameRate()`](https://developer.android.com/reference/android/view/Surface#setFrameRate(float,%20int)) API allows the game devs to use a specific display
...
Use methods [`Display.getSupportedModes()`](https://developer.android.com/reference/android/view/Display#getSupportedModes()) to determine if the device
...
Invoke [`setFrameRate()`](https://developer.android.com/reference/android/view/Surface#setFrameRate(float,%20int)) when your rendering loop starts, during game window
...
[The frame pacing library](https://developer.android.com/media/optimize/performance/frame-rate), or Swappy, is an open-source library designed to
...
[`setFrameRate()`](https://developer.android.com/reference/android/view/Surface#setFrameRate(float,%20int)). Furthermore, Swappy provides additional features that can
...
[heat generation](https://developer.android.com/games/optimize/adpf/thermal) and rapid battery drain, potentially resulting in a
...
between visual fidelity and [power efficiency](https://developer.android.com/games/optimize/power).
