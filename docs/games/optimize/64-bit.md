...
7. If you already see both libraries being packaged, you can skip ahead to
   [testing your app on 64-bit hardware](https://developer.android.com/games/optimize/64-bit#test-64-bit-hardware).
...
> device to the latest stable, public build](https://developer.android.com/games/optimize/64-bit#public) before flashing the 64-bit-only image for the other version of the Android platform.

##### Get a 64-bit-only image

Similar to factory system images, you can flash a 64-bit-only image to your
device [using the Android Flash Tool](https://developer.android.com/games/optimize/64-bit#flashtool) or by [flashing your
device manually](https://developer.android.com/games/optimize/64-bit#flash), as described in the following sections.
...
You can choose to [return to the latest public build](https://developer.android.com/games/optimize/64-bit#public) at any
time.
