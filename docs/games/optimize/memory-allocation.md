...
[low-memory killer (LMK)](https://developer.android.com/topic/performance/memory-management#low-memory_killer)
...
[cold start](https://developer.android.com/topic/performance/vitals/launch-time#cold). Apps that reduce their
...
[`TRIM_MEMORY_UI_HIDDEN`](https://developer.android.com/reference/android/content/ComponentCallbacks2#TRIM_MEMORY_UI_HIDDEN).
...
[System tracing](https://developer.android.com/topic/performance/tracing) reports this situation as a thread
...
[PSS memory](https://developer.android.com/topic/performance/memory-management#calculating_memory_footprint)
was allocated and the categories for which it was used.

Print the [meminfo](https://developer.android.com/studio/command-line/dumpsys#meminfo) statistics in one of
the following ways:
...
[RSS memory](https://developer.android.com/topic/performance/memory-management#calculating_memory_footprint)
