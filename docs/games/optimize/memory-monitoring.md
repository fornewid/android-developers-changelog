...
[Android Vitals - Memory usage (anonymous RSS + swap)](https://developer.android.com/topic/performance/issues/memory-usage) documentation.
...
The memory usage are [broken down by process states in Android Vitals](https://developer.android.com/google/play/vitals/memory-usage#identify-high).
...
[cold start](https://developer.android.com/topic/performance/issues/launch-time#cold) on resume. Reducing background memory usage helps prevent these
