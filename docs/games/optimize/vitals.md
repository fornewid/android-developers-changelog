---
title: Android vitals  |  Android Developers
...
[User-perceived ANR rate](/games/optimize/vitals/anr#android-vitals)  
[User-perceived crash rate](/games/optimize/vitals/crash#android-vitals)  
[Excessive battery usage](/games/optimize/vitals/excessive-battery-usage)  
[Excessive partial wake locks](/topic/performance/vitals/excessive-wakelock)

##### All other vitals:

[Excessive wakeups](/games/optimize/vitals/wakeup)  
 [Stuck partial wake locks](/games/optimize/vitals/wakelock)  
[Excessive background Wi-Fi scans](/games/optimize/vitals/bg-wifi)  
 [Excessive background network
usage](/games/optimize/vitals/bg-network-usage)  
 [App startup time](/games/optimize/vitals/launch-time)  
 [Slow rendering](/games/optimize/vitals/render)

[Slow Sessions](/games/optimize/vitals/slow-session)  
 [Low memory killers (LMKs)](/games/optimize/vitals/lmk)  
[Permission denials](/games/optimize/vitals/permissions)
