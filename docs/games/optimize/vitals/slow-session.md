...
Use [Android Frame Pacing (Swappy)](https://developer.android.com/games/optimize/vitals/slow-session#what_is_swappy),
[Vulkan](https://developer.android.com/games/optimize/vitals/slow-session#what_is_vulkan), and [ADPF](https://developer.android.com/games/optimize/vitals/slow-session#what_is_adpf) to
