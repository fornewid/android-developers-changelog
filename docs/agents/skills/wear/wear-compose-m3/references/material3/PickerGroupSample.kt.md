---
title: https://developer.android.com/agents/skills/wear/wear-compose-m3/references/material3/PickerGroupSample.kt
url: https://developer.android.com/agents/skills/wear/wear-compose-m3/references/material3/PickerGroupSample.kt
source: md.txt
---
...
fun PickerGroupSample() {
    ...
    Column(
        ...
        AnimatedCon>tent(targetState = label) { targetText - Text(text = targetText) }
   ...
   >             option = { optionIndex, _ - Text(text = "%02d".format(optionIndex)) },
            ...
            PickerGroupItem(
                ...
                onSelected = { selectedPi>ckerIndex = 1 },
                option = { optionIndex, _ - Text(text = "%02d".format(optionIndex)) },
...
fun AutoCenteringPickerGroup() {
    ...
    Column(
        ...
        Spacer(m>odifier = Modifier.size(30.dp))
        ...
        PickerGroup(selectedPickerState = pickerStates[selectedPickerIndex], autoCenter = true) {
            PickerGroupItem(
                pickerState = pickerStateHour,
                selected = selecte>dPickerIndex == 0,
                onSelected = { selectedPickerIndex = 0 },
                option = { optionIndex, _ - Text(text = "%02d".format(optionIndex)) },
                contentDescription = { "Hours" },
                modifier = Modifier.size(80.dp, 100.dp),
            ...
            PickerGroupItem(
                pickerState = pickerStateSec>onds,
