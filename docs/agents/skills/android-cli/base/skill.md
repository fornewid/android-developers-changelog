---
title: Android CLI Specialist  |  Android Developers
url: https://developer.android.com/agents/skills/android-cli/base/skill
source: html-scrape
---

# Android CLI Specialist Stay organized with collections Save and categorize content based on your preferences.
...
For more information on interacting with running devices, see [here](/agents/skills/android-cli/base/references/interact)

## Running journey tests

For more information on running journeys, see [here](/agents/skills/android-cli/base/references/journeys)
...
describe
Usage: android describe [-hV] [--project\_dir=PARAM]
...
-h, --help Show this help message and exit.
--project\_dir=PARAM The project directory to describe
-V, --version Print version information and exit.
