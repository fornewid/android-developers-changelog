...
keywords\_public: R8, proguard, keep rules, app size, optimization

## Core workflow

* [ ] Step 1: Create a file called R8\_Configuration\_Analysis.md, or reuse if
...
* Don't generate parts of the report if there is no keep rule to report in
  that section.
