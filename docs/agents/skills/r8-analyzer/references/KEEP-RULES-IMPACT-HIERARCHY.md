---
title: The following Keep Rules are listed based on the impact level  |  Android Developers
url: https://developer.android.com/agents/skills/r8-analyzer/references/KEEP-RULES-IMPACT-HIERARCHY
source: html-scrape
---

# The following Keep Rules are listed based on the impact level Stay organized with collections Save and categorize content based on your preferences.
