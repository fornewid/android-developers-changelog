---
title: BuildConfig  |  Android Developers
url: https://developer.android.com/agents/skills/build/agp/agp-9-upgrade/references/buildconfig
source: html-scrape
---

# BuildConfig Stay organized with collections Save and categorize content based on your preferences.
...
Use the **addCustomBuildConfigFields** recipe from the [gradle-recipes](/agents/skills/build/agp/agp-9-upgrade/references/recipes)
repository.
