---
title: https://developer.android.com/agents/skills/jetpack-compose/theming/styles/skill
url: https://developer.android.com/agents/skills/jetpack-compose/theming/styles/skill
source: md.txt
---
...
- Basic Style Usage: To set backgrounds, sizes, and alignments on a component, follow the [Compose Styles Fundamentals
  Guide](https://developer.android.com/develop/ui/compose/styles/fundamentals).
- State and Transitions: To configure property changes for state shifts (like pressed or hovered), follow the [Animations and State-Based Styling
  Guide](https://developer.android.com/develop/ui/compose/styles/state-animations).
- Architecture Trade offs: To decide when to use a Style versus a standard Modifier, follow the [Styles versus Modifiers
  Comparison](https://developer.android.com/develop/ui/compose/styles/styles-vs-modifiers).
- Theme Level Integration: To connect style definitions with custom themes, follow [Theming with Styles](https://developer.android.com/develop/ui/compose/styles/theming) and [Custom Themes in Compose](https://developer.android.com/develop/ui/compose/designsystems/custom).
