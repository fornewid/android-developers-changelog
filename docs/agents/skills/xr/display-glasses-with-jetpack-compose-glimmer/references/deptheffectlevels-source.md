---
title: https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/deptheffectlevels-source
url: https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/deptheffectlevels-source
source: md.txt
---

When simulating depth on AI glasses using shadows, refer to the following source code in `DepthEffectLevels.kt`:
