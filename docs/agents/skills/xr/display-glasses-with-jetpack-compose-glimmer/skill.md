---
title: https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/skill
...
- **Hardware Permissions:** To request hardware permissions like the microphone and camera, see the [Request hardware permissions for
  intelligent eyewear](https://developer.android.com/develop/xr/jetpack-xr-sdk/request-hardware-permissions).
- **Hardware Access:** To use the glasses camera, sensors, or access the phone's hardware, see the [Use a projected context to access hardware on
  intelligent eyewear](https://developer.android.com/develop/xr/jetpack-xr-sdk/access-hardware-projected-context).
...
- **Color Contrast:** Ensure at least a 70% tone difference between foreground and background using the HCT color space. For calculation metrics, use [references/material-hct-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/material-hct-source).
...
- To add input, focus, tap, swipe to your Glasses UI, follow [Focus in Jetpack
  ...
  - For a detailed breakdown of hardware inputs, see [Hardware Controls for
    display glasses](https://developer.android.com/design/ui/ai-glasses/guides/interaction/inputs#with-display)
...
[references/glimmertheme-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/glimmertheme-source) for reference.
...
[references/deptheffect-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/deptheffect-source) and
[references/deptheffectlevels-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/deptheffectlevels-source) for reference.
...
- **API Source Code:** Use [references/card-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/card-source).
- **Implementation Samples:** Use [references/card-samples-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/card-samples-source). (Basic and Interactive Card usage)
...
- **API Source Code:** Use [references/button-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/button-source).
...
- **API Source Code:** Use [references/titlechip-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/titlechip-source).
- **Implementation Samples:** Use [references/titlechip-samples-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/titlechip-samples-source). (Title Chips above group content)
...
- **API Source Code (IconButton):** Use [references/iconbutton-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/iconbutton-source).
- **API Source Code (IconSizes):** Use [references/iconsizes-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/iconsizes-source).
...
- **API Source Code (List):** Use [references/list-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/list-source).
...
- **API Source Code (GlimmerLazyListState):** Use [references/liststate-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/liststate-source).
...
- **API Source Code (Stack):** Use [references/stack-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/stack-source).
- **API Source Code (StackState):** Use [references/stackstate-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/stackstate-source).
- **API Source Code (StackItemScope):** Use [references/stackitemscope-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/stackitemscope-source).
...
[references/surface-source.md](https://developer.android.com/agents/skills/xr/display-glasses-with-jetpack-compose-glimmer/references/surface-source) for reference.
