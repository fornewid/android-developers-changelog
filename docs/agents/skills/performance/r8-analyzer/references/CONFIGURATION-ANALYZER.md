---
title: Configuration Analyzer data generation  |  Android Developers
url: https://developer.android.com/agents/skills/performance/r8-analyzer/references/CONFIGURATION-ANALYZER
source: html-scrape
---

# Configuration Analyzer data generation Stay organized with collections Save and categorize content based on your preferences.
...
the proto files in "{project\_root}/tmp/r8analysis" folder
