---
title: Add exercise routes  |  Android health & fitness  |  Android Developers
...
# Add exercise routes Stay organized with collections Save and categorize content based on your preferences.
...
3. Reading:
   ...
   2. From a third-party app, through a dialog that allows the user to grant a
      one-time read of a route.
...
To determine whether a user's device supports planned exercise on Health
...
Note: For this permission type,
`READ_EXERCISE_ROUTES` is plural, while
`WRITE_EXERCISE_ROUTE` is singular.
...
* Read health and fitness data, including route data:
  `HealthPermission.getReadPermission(ExerciseSessionRecord::class)`
* Write health and fitness data, including route data:
  `HealthPermission.getWritePermission(ExerciseSessionRecord::class)`
* Write exercise route data: `HealthPermission.PERMISSION_WRITE_EXERCISE_ROUTE`

**Note:** If the user doesn't grant all of the permissions that your app requests,
your app should still run, and it should perform as many tasks as it can with
the permissions that the user granted.
...
**Note:** Even if your app has been granted "Always allow" access to exercise route
data, background access to routes created by other apps is restricted.
...
* The exercise **route**, which contains information such as
...
* [`EXERCISE_DURATION_TOTAL`](/reference/kotlin/androidx/health/connect/client/records/ExerciseSessionRecord#EXERCISE_DURATION_TOTAL())
...
To learn more about background reads, see [Background read example](/health-and-fitness/guides/health-connect/develop/read-data#background-read-example).
