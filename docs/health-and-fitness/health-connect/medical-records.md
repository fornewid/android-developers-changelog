---
title: Medical Records  |  Android health & fitness  |  Android Developers
...
# Medical Records Stay organized with collections Save and categorize content based on your preferences.
...
* A user-facing browser experience for medical data stored in Health Connect
  as new medical data types, along with fine-grained permissions for allowing
  downstream reads.
* An API for applications reading medical data based on user-granted
  permissions.

![An overview of how Medical Records work with Health Connect.](/static/health-and-fitness/guides/medical-records/images/overview.png)
...
* The Play Policy for Medical Records access is still being developed, and
  apps may need to meet additional requirements before they can be released on
  the Play Store.
* Some features, such as changelogs-based APIs, have not been developed for
  Medical Records APIs yet.
...
![Permissions screen for medical records](/static/health-and-fitness/guides/medical-records/images/permissions.png)


**Figure 2**: Medical Records permissions screen
...
![Data browsing screen for medical records](/static/health-and-fitness/guides/medical-records/images/browsing.png)


**Figure 3**: Medical Records data browsing screen

[Next

Data format

arrow\_forward](/health-and-fitness/health-connect/medical-records/data-format)