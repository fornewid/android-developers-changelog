---
title: Get started with Health Connect  |  Android health & fitness  |  Android Developers
...
# Get started with Health Connect Stay organized with collections Save and categorize content based on your preferences.
...
[Migrate from Android 13 to 14](/health-and-fitness/guides/health-connect/migrate/migrate-from-android-13-to-14).
...
* **On Android 14 and higher:** Go to
  **Settings > Security and Privacy > Privacy Controls > Health Connect**,
  or search for **Health Connect** in Settings.
* **On Android 13 and lower:** Go to **Settings > Apps > Health Connect**,
  or add Health Connect to your **Quick Settings** menu.
...
Refer to the [Health Connect releases](/jetpack/androidx/releases/health-connect) for the latest version.

**Note:** The Health Connect SDK supports Android 8 (API level 26) or higher, while
the Health Connect app is only compatible with Android 9 (API level 28) or
higher. This means that third-party apps can support users with Android 8, but
only users with Android 9 or higher can use Health Connect.
...
[`getFeatureStatus()`](/health-and-fitness/guides/health-connect/develop/feature-availability#perform-check). This returns integer constants
...
**Note:** If a feature isn't available, ask the user to update Health Connect.
...
[List of data types](/guide/health-and-fitness/health-connect/plan/data-types#alpha10).
...
**Note:** The activity must display the same privacy policy you provide for your
app in the [Google Play Console](https://support.google.com/googleplay/android-developer/answer/9859455).

### Get a Health Connect client

[`HealthConnectClient`](/reference/kotlin/androidx/health/connect/client/HealthConnectClient) is an entry point to the Health Connect API.
...
using [`getSdkStatus`](/reference/kotlin/androidx/health/connect/client/HealthConnectClient#getSdkStatus(android.content.Context,kotlin.String)). If it is, obtain a
...
[data types](/guide/health-and-fitness/health-connect/plan/data-types#alpha10) available in Health Connect.
...
Then write your record using [`insertRecords`](/reference/kotlin/androidx/health/connect/client/HealthConnectClient#insertRecords(kotlin.collections.List)).
...
You can read your data individually using [`readRecords`](/reference/kotlin/androidx/health/connect/client/HealthConnectClient#readRecords(androidx.health.connect.client.request.ReadRecordsRequest)).

**Note:**
For cumulative types like `StepsRecord`, use `aggregate()` instead of
`readRecords()` to avoid double counting from multiple sources and improve accuracy. See
[Read aggregated
data](/reference/kotlin/androidx/health/connect/client/aggregate/package-summary) for more information.
...
[`aggregate`](/reference/kotlin/androidx/health/connect/client/aggregate/package-summary).
...
**Important:** Health Connect can read data for up to 30 days prior to the
time permission was granted. If you would like your app to read records
beyond 30 days, use the `PERMISSION_READ_HEALTH_DATA_HISTORY` permission.
See [Read restrictions](/health-and-fitness/guides/health-connect/develop/read-data#read-restriction) for more information.
...
* **Health Connect SDK (available on Jetpack):** Include this [SDK](/jetpack/androidx/releases/health-connect) in your
  application to use the Health Connect API.
* **API reference:** Take a look at the [Jetpack reference](/reference/kotlin/androidx/health/connect/client/records/package-summary) for the
  Health Connect API.
* **Declare use of data types:** In the Play Console,
  [declare access to the Health Connect data types](/health-and-fitness/guides/health-connect/publish/declare-access) that your
  app reads from and writes to.
* **Optional GitHub code sample and codelab:** See the GitHub code sample
  [repository](https://github.com/android/health-samples/tree/main/health-connect/HealthConnectSample) and the [codelab](/codelabs/health-connect) exercise to help you get
  started.

**Note:** If you are applying for another request in case your app requires new data
types, you need to include both new and existing data types, and exclude any
data types you no longer need. If you only need to remove access to certain data
types, include all of your existing data types but exclude the data types you no
longer need.
...
* [Write data](/guide/health-and-fitness/health-connect/develop/write-data)
* [Read raw data](/guide/health-and-fitness/health-connect/develop/read-data)
* [Read aggregated data](/guide/health-and-fitness/health-connect/develop/aggregate-data)