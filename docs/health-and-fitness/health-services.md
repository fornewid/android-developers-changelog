---
title: Health Services on Wear OS  |  Android health & fitness  |  Android Developers
...
![Health Services architecture diagram](/static/wear/images/with_health_services.png)


**Figure 1**: Health Services architecture
...
For more information, see [Exercise goals](/reference/kotlin/androidx/health/services/client/data/ExerciseGoal) and
[Passive goals](/reference/kotlin/androidx/health/services/client/data/PassiveGoal).
...
See [Use synthetic data with Health Services](/training/wearables/health-services/synthetic-data) for more
information.
