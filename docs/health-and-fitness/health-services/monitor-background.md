---
title: Monitor data in the background  |  Android health & fitness  |  Android Developers
...
# Monitor data in the background Stay organized with collections Save and categorize content based on your preferences.
...
[`getStartInstant()`](/reference/kotlin/androidx/health/services/client/data/IntervalDataPoint#getstartinstant)
or
[`getEndInstant()`](/reference/kotlin/androidx/health/services/client/data/IntervalDataPoint#getendinstant).
...
that listens for the [`ACTION_BOOT_COMPLETED`](/reference/android/content/Intent#ACTION_BOOT_COMPLETED)
system broadcast.
...
workers have a [10-minute execution limit](/reference/kotlin/androidx/work/WorkManager).
...
2. Call `setShouldUserActivityInfoBeRequested(true)` in the
