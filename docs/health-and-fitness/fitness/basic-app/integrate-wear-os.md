---
title: Integrate a Wear OS module  |  Android health & fitness  |  Android Developers
...
![Wear OS module wizard in Android Studio](/static/health-and-fitness/fitness/basic-app/images/basic_fitness_app_img_8.png)


**Figure 1**: Create a Wear OS module
...
![An image showing the Wear OS app run button](/static/health-and-fitness/fitness/basic-app/images/basic_fitness_app_img_5.png)


**Figure 2**: Run button for the new Wear OS module

This lets you run the Wear OS module on a wearable device. You have two options:

* Run on an [emulator](/training/wearables/get-started/creating#run-emulator).
* Run on a [real device](/training/wearables/get-started/creating#run-watch).
...
* **[Health Services](/health-and-fitness/guides/health-services):** makes accessing sensors and data on the watch
  very convenient and more power-efficient.
* **[Hilt](/training/dependency-injection/hilt-android):** Allows for effective dependency injection and management.
