---
title: Local network permission  |  Privacy  |  Android Developers
...
# Local network permission Stay organized with collections Save and categorize content based on your preferences.
...
* **Media Streaming:** For applications that support Google Cast they can use
  ...
  [`ACCESS_LOCAL_NETWORK`](/reference/kotlin/android/Manifest.permission#access_local_network) permission.
* **General Connectivity:** The [`NsdManager`](/reference/android/net/nsd/NsdManager) includes a system-run service
...
* **Declare the permission in the manifest:** Explicitly declare [`ACCESS_LOCAL_NETWORK`](/reference/kotlin/android/Manifest.permission#access_local_network) in the `AndroidManifest.xml`.
...
* **Pre-granted scenario:** The [`ACCESS_LOCAL_NETWORK`](/reference/kotlin/android/Manifest.permission#access_local_network) permission is part
...
(which now includes [`ACCESS_LOCAL_NETWORK`](/reference/kotlin/android/Manifest.permission#access_local_network)) prevented the app from asking
...
API, effectively resetting the denial count for the [`ACCESS_LOCAL_NETWORK`](/reference/kotlin/android/Manifest.permission#access_local_network)
...
* **Casting:** For media casting functionalities, the most appropriate and
  ...
  behalf, eliminating the need for the app to request [`ACCESS_LOCAL_NETWORK`](/reference/kotlin/android/Manifest.permission#access_local_network)
  permission.
...
reset counter strategy. If the [`ACCESS_LOCAL_NETWORK`](/reference/kotlin/android/Manifest.permission#access_local_network) permission is revoked
...
permission in the [`NEARBY_DEVICES`](/reference/android/Manifest.permission_group#NEARBY_DEVICES) permission group.
