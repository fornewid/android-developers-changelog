...
your app's `https://developer.android.com/reference/android/content/ContentProvider`
objects. This
...
`https://developer.android.com/reference/android/Manifest.permission#WRITE_CONTACTS` permissions:
...
When using
`https://developer.android.com/reference/android/content/Context#getSharedPreferences(java.lang.String, int)` to
create or access your app's `https://developer.android.com/reference/android/content/SharedPreferences` objects,
use `https://developer.android.com/reference/android/content/Context#MODE_PRIVATE`. That way, only your app can
