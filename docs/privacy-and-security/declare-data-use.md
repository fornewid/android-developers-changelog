---
title: Declare your app's data use  |  Privacy  |  Android Developers
...
# Declare your app's data use Stay organized with collections Save and categorize content based on your preferences.
...
* Workflows that request the user to [authenticate using
  biometrics](/training/sign-in/biometric-auth).
* Forms and alerts that prompt the user to enter user data, confirm a
  submission, or make a choice.
* Code that controls the behavior of a [`WebView`](/guide/webapps/webview)
  element in your app.
* Support for the [autofill
  framework](/guide/topics/text/autofill-optimize#hints).
* Use of the [data access auditing](/guide/topics/data/audit-access) APIs.
...
dialog](/training/permissions/requesting). Learn more about how [data safety
information is more visible](/about/versions/14/changes/data-safety) in
Android 14.
...
* Declares at least one of the following permissions:
  + [`BIND_AUTOFILL_SERVICE`](/reference/android/Manifest.permission#BIND_AUTOFILL_SERVICE)
  + [`GET_ACCOUNTS`](/reference/android/Manifest.permission#GET_ACCOUNTS)
* Uses the [`AccountManager`](/reference/android/accounts/AccountManager) API.
...
section](#personal-info), there may be more specific indicators that your app,
...
* Declares at least one of the following permissions:
  ...
  + [`READ_PHONE_NUMBERS`](/reference/android/Manifest.permission#READ_PHONE_NUMBERS)
  ...
  + [`READ_SMS`](/reference/android/Manifest.permission#READ_SMS)
* [Requests user
  consent](/guide/topics/permissions/default-handlers#request-user-consent) to
  become the device's default dialer app or default SMS app.
* [Has carrier
  privileges](/reference/android/telephony/TelephonyManager#hasCarrierPrivileges()).
...
* Uses Google Play's [Billing Library](/google/play/billing).
* Uses the [Google Pay](https://developers.google.com/pay/api/android/overview)
  APIs.
* Declares the
  [`BIND_AUTOFILL_SERVICE`](/reference/android/Manifest.permission#BIND_AUTOFILL_SERVICE)
...
* Uses at least one of the following APIs:
  + [Health Connect](/health-and-fitness/guides/health-connect)
...
* Declares at least one of the following permissions:
  + [`READ_SMS`](/reference/android/Manifest.permission#READ_SMS)
  + [`RECEIVE_MMS`](/reference/android/Manifest.permission#RECEIVE_MMS)
  + [`RECEIVE_SMS`](/reference/android/Manifest.permission#RECEIVE_SMS)
  + [`RECEIVE_WAP_PUSH`](/reference/android/Manifest.permission#RECEIVE_WAP_PUSH)
  + [`SEND_SMS`](/reference/android/Manifest.permission#SEND_SMS)
...
* Uses the system [photo picker](/training/data-storage/shared/photopicker).
* Declares at least one of the following permissions:
  + [`READ_EXTERNAL_STORAGE`](/reference/android/Manifest.permission#READ_EXTERNAL_STORAGE)
  + [`READ_MEDIA_IMAGES`](/reference/android/Manifest.permission#READ_MEDIA_IMAGES)
  + [`READ_MEDIA_VIDEO`](/reference/android/Manifest.permission#READ_MEDIA_VIDEO)
  + [`READ_MEDIA_AUDIO`](/reference/android/Manifest.permission#READ_MEDIA_AUDIO)
...
* Provides a workflow for [handling media
  files](/training/data-storage/use-cases#handle-media-files).
* Record [HDR video content](/training/camera2/hdr-video-capture).
...
* Provides a workflow for [data and file storage](/training/data-storage).
* Provides a workflow for [data backup](/guide/topics/data/backup).

**Note:** Google Play restricts the use of the [`MANAGE_EXTERNAL_STORAGE`](/reference/android/Manifest.permission#MANAGE_EXTERNAL_STORAGE) permission
unless your app satisfies a particular set of requirements. Learn more about the
policy regarding [use of all files access (MANAGE\_EXTERNAL\_STORAGE)
...
* [`READ_CALENDAR`](/reference/android/Manifest.permission#READ_CALENDAR)
* [`WRITE_CALENDAR`](/reference/android/Manifest.permission#WRITE_CALENDAR)
...
* Declares at least one of the following permissions:
  + [`ACCEPT_HANDOVER`](/reference/android/Manifest.permission#ACCEPT_HANDOVER)
  + [`ADD_VOICEMAIL`](/reference/android/Manifest.permission#ADD_VOICEMAIL)
  + [`ANSWER_PHONE_CALLS`](/reference/android/Manifest.permission#ANSWER_PHONE_CALLS)
  + [`CALL_PHONE`](/reference/android/Manifest.permission#CALL_PHONE)
  ...
  + [`RECEIVE_WAP_PUSH`](/reference/android/Manifest.permission#RECEIVE_WAP_PUSH)
  + [`SEND_SMS`](/reference/android/Manifest.permission#SEND_SMS)
  + [`WRITE_CONTACTS`](/reference/android/Manifest.permission#WRITE_CONTACTS)
...
* Binds to a system service, such as
  ...
  or [`TextService`](/reference/android/service/textservice/package-summary).
* Declares the
  [`QUERY_ALL_PACKAGES`](/reference/android/Manifest.permission#QUERY_ALL_PACKAGES)
  permission and calls [`getInstalledApplications()`](/reference/android/content/pm/PackageManager#getInstalledApplications(int))
  or similar methods.
* Creates a search interface.
* Supports the [Google Shortcuts Integration
  Library](/guide/topics/ui/shortcuts/creating-shortcuts#gsi-library).
* Uses the [`Instrumentation`](/reference/android/app/Instrumentation) API.
...
* [Use
  of the broad package (App) visibility (QUERY\_ALL\_PACKAGES)
...
* [Creates a search interface](/guide/topics/search/search-dialog).
...
* Declares the
  [`BATTERY_STATS`](/reference/android/Manifest.permission#BATTERY_STATS)
  permission.
* Uses APIs such as the following:
  + [`ActivityManager`](/reference/android/app/ActivityManager)
  + [`ApplicationErrorReport`](/reference/android/app/ApplicationErrorReport)
  + [`ApplicationExitInfo`](/reference/android/app/ApplicationExitInfo)
  + [`ASurfaceControl](/ndk/reference/group/native-activity#asurfacecontrol)
  + [`BatteryManager`](/reference/android/os/BatteryManager)
  + [`Benchmark`](/studio/profile/benchmarking-overview)
  + [`Choreographer`](/ndk/reference/group/choreographer)
  + [`Debug`](/reference/android/os/Debug)
  + [`HealthStats`](/reference/android/os/health/HealthStats)
  + [`Macrobenchmark`](/studio/profile/macrobenchmark-intro)
  + [`PowerManager`](/reference/android/os/PowerManager)
  + [`StrictMode`](/reference/android/os/StrictMode)
...
number](/reference/android/telephony/TelephonyManager#getImei(int)), [MAC
address](/reference/android/net/wifi/WifiInfo#getMacAddress()), [Widevine Device
...
* Declares at least one of the following permissions:
  + [`AD_ID`](https://developers.google.com/android/reference/com/google/android/gms/ads/identifier/AdvertisingIdClient.Info#public-string-getid)
...
| January 4, 2022 | Updated the "Sexual orientation and gender identity" data type. This [data type now refers to only sexual orientation](#sexual-orientation). Gender identity is now an example of other personal information. |
