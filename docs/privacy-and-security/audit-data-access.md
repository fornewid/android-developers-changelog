---
title: Audit access to data  |  Privacy  |  Android Developers
...
# Audit access to data Stay organized with collections Save and categorize content based on your preferences.
...
of [`AppOpsManager.OnOpNotedCallback`](/reference/android/app/AppOpsManager.OnOpNotedCallback), which can perform
...
**Note:** If your app accesses data in multiple components, such as in a foreground
service and in a background task, create a custom subclass of
[`Application`](/reference/kotlin/android/app/Application) and define
`AppOpsManager.OnOpNotedCallback` in the `onCreate()` method of your subclass.
...
* [`onAsyncNoted()`](/reference/android/app/AppOpsManager.OnOpNotedCallback#onAsyncNoted(android.app.AsyncNotedAppOp))
...
* [`onSelfNoted()`](/reference/android/app/AppOpsManager.OnOpNotedCallback#onSelfNoted(android.app.SyncNotedAppOp))
  is called in the very rare case when an app passes its own UID into
  [`noteOp()`](/reference/android/app/AppOpsManager#noteOp(java.lang.String,%20int,%20java.lang.String,%20java.lang.String,%20java.lang.String)).
...
in the objects passed to the calls to [`onNoted()`](/reference/android/app/AppOpsManager.OnOpNotedCallback#onNoted(android.app.SyncNotedAppOp)).
...
[`createAttributionContext()`](/reference/android/content/Context#createAttributionContext(java.lang.String)),
...
**Note:** If the return value for the attribution tag is `null`, this means that
the current [`Context`](/reference/android/content/Context) object is
associated with the main part of your app.
