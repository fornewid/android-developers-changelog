---
title: Unsafe Download Manager  |  Security  |  Android Developers
...
# Unsafe Download Manager Stay organized with collections Save and categorize content based on your preferences.
...
* **Download Provider SQL Injection** – Through a SQL injection vulnerability, a
  ...
  [`android.permission.INTERNET`](http://go/android-dev/reference/android/Manifest.permission#INTERNET), could also access all database
...
* **Download Provider Request Headers Information Disclosure** – A malicious
  application with the [`android.permission.INTERNET`](http://go/android-dev/reference/android/Manifest.permission#INTERNET) permission
...
android.permission.WRITE\_EXTERNAL\_STORAGE permissions allow broad access to
