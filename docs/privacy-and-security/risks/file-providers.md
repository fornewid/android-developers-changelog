---
title: Improperly Exposed Directories to FileProvider  |  Security  |  Android Developers
...
# Improperly Exposed Directories to FileProvider Stay organized with collections Save and categorize content based on your preferences.
