---
title: createPackageContext  |  Security  |  Android Developers
...
# createPackageContext Stay organized with collections Save and categorize content based on your preferences.
...
* Calls [`createPackageContext`](/reference/android/content/Context#createPackageContext(java.lang.String,%20int)) with
  [`CONTEXT_IGNORE_SECURITY`](/reference/android/content/Context#CONTEXT_IGNORE_SECURITY) and [`CONTEXT_INCLUDE_CODE`](/reference/android/content/Context#CONTEXT_INCLUDE_CODE).
* Calls [`getClassLoader()`](/reference/android/content/Context#getClassLoader()) on the retrieved context.

Malicious App:

* Is able to claim the package name that the vulnerable app passes to
