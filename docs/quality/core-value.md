...
Play also uses user metrics to evaluate the quality of your app. We consider many[user engagement metrics](https://developer.android.com/quality/core-value/user-metrics)including uninstalls and active users.