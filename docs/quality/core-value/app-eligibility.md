---
title: Inline Install API eligibility criteria for apps  |  App quality  |  Android Developers
...
# Inline Install API eligibility criteria for apps Stay organized with collections Save and categorize content based on your preferences.
