...
val output = response.texthttps://github.com/android/snippets/blob/48adb119f98d1fef9d761ab2415e317ce0bb6a9a/misc/src/main/java/com/example/snippets/ai/GeminiOverview.kt#L27-L32
```
