---
title: Implement a PDF viewer  |  Android media  |  Android Developers
...
![A PDF document rendered within an Android application using PdfViewerFragment.](/static/media/images/grow/pdf_title_page.png)
