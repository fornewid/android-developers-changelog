---
title: MediaRouteProvider overview  |  Android media  |  Android Developers
...
# MediaRouteProvider overview Stay organized with collections Save and categorize content based on your preferences.
...
[`MediaRouteProvider`](/reference/androidx/mediarouter/media/MediaRouteProvider),
[`MediaRouteProviderDescriptor`](/reference/androidx/mediarouter/media/MediaRouteProviderDescriptor), and
[`RouteController`](/reference/androidx/mediarouter/media/MediaRouteProvider.RouteController).
...
[MediaRouter](/guide/topics/media/mediarouter) interface to the
...
project, see [Support Library Setup](/tools/support-library/setup).
...
* `CATEGORY_REMOTE_PLAYBACK` — Play video or audio on a separate device which handles media
  ...
  [Chromecast](https://www.google.com/url?q=http://www.google.com/chromecast) devices.
