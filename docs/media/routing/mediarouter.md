---
title: MediaRouter overview  |  Android media  |  Android Developers
...
# MediaRouter overview Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/images/mediarouter/mediarouter-framework.png)
...
![](/static/images/mediarouter/mediarouter-actionbar.png)
...
![](/static/images/mediarouter/mediarouter-selector-ui.png)
...
package `androidx.appcompat.app`. You must add the
[androidx.appcompat:appcompat](/jetpack/androidx/releases/appcompat)
and [androidx.mediarouter:mediarouter](/jetpack/androidx/releases/mediarouter)
support libraries to your app development project. For more information on adding support libraries
to your project, see [Getting started with Android Jetpack](/jetpack/getting-started).

**Caution:** Be sure to use the `androidx`
implementation of the media router framework. Do not use the older `android.media` package.
...
This is how apps that support [Google Cast](https://developers.google.com/cast/), like
[Chromecast](http://www.google.com/chromecast), work.
...
see the [Action Bar](/guide/topics/ui/actionbar)
developer guide.
...
The [Android BasicMediaRouter](https://github.com/android/media-samples/tree/main/BasicMediaRouter)
and [MediaRouter](https://github.com/android/media-samples/tree/main/MediaRouter/)
