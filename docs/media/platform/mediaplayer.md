---
title: About MediaPlayer  |  Android media  |  Android Developers
...
# About MediaPlayer Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** You can play back the audio data only to the standard output device. That
is, the mobile device speaker or a Bluetooth headset. You cannot play sound
