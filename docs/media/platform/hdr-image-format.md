---
title: Ultra HDR Image Format v1.1  |  Android media  |  Android Developers
...
# Ultra HDR Image Format v1.1 Stay organized with collections Save and categorize content based on your preferences.
...
information](/static/guide/topics/media/images/hdrimageformatexample.png)
...
* HDR display
  ...
  + A display designed for HDR content. These displays typically produce a
    ...
    800 cd/m2 or greater, and typically also have better contrast
...
and what regions of luminance it affected.  
...
the maximum and minimum gain needed to convert between the two renditions.  
...
content boost, and are compromised at other boost factors.  
...
requirements enumerated in the [Motivation](#motivation) section.  
...
both JPEG images](/static/guide/topics/media/images/hdrimageformatwithisoexample.png)
...
**Note:** Android supports ISO 21496-1 encoding from and decoding to
[`Bitmap`](/reference/android/graphics/Bitmap "Android Bitmap class") for JPEG starting on Android 15 (API level 35).
Android 15 encodes both Ultra HDR v1 metadata and ISO 21496-1 metadata when
encoding Ultra HDR JPEG files from `Bitmap` objects. In addition, the
[libultrahdr](https://github.com/google/libultrahdr "libultrahdr on GitHub") library in AOSP supports
ISO 21496-1 encoding when the appropriate
[flag](https://github.com/google/libultrahdr/blob/46f1337fbc63eee76d4554375269b95fd5f3ff58/lib/src/jpegr.cpp#L56 "libultrahdr ISO 21406-1 encoding flag") is enabled.
...
* Add [ISO 21496-1 Compatibility](#iso_21496_1_compatibility) section.
