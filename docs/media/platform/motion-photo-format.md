---
title: Motion Photo format 1.0  |  Android media  |  Android Developers
...
# Motion Photo format 1.0 Stay organized with collections Save and categorize content based on your preferences.
...
* [Ultra HDR Image Format v1.0 | Android Developers](/guide/topics/media/platform/hdr-image-format) (Ultra HDR)
* [ISO 16684-1:2011(E) XMP Specification Part 1](https://github.com/adobe/XMP-Toolkit-SDK/blob/main/docs/XMPSpecificationPart1.pdf)
  (XMP)
...
The image file may have a gainmap, as is the case with [Ultra HDR JPEGs](/guide/topics/media/platform/hdr-image-format).
...
[the Ultra HDR image specification](/guide/topics/media/platform/hdr-image-format#GContainer_details),
...
![Line diagram demonstrating the arrangement of elements in an HEIC motion file](/static/images/media/platform/motion-photo-heic.png)
...
byte stream in [the format described in "Syntax"](#metadata-syntax).
