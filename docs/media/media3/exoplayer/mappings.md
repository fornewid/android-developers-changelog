...
When migrating to Media3, consider reading our AndroidX Media3 [migration guide](https://developer.android.com/guide/topics/media/media3/getting-started/migration-guide).
