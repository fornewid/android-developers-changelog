...
5. Implement `MySessionCallback` as required by your app. This is optional. If
   ...
   [`MediaSession.Callback.onAddMediaItems()`](https://github.com/androidx/media/blob/1.11.0/demos/session/src/main/java/androidx/media3/demo/session/PlaybackService.kt#L184). It serves various current and
   ...
   be found [in the `PlaybackService` of the session demo app](https://github.com/androidx/media/blob/1.11.0/demos/session/src/main/java/androidx/media3/demo/session/PlaybackService.kt#L184).
...
3. **Change your service to inherit from a `MediaLibraryService`** instead of
   ...
   - **Implement MediaLibraryService.MediaLibrarySessionCallback:** Building
     ...
     [`MediaLibraryService.MediaLibrarySessionCallback`](https://github.com/androidx/media/blob/1.11.0/libraries/session/src/main/java/androidx/media3/session/MediaLibraryService.java#L127) that implements
     ...
     Find the [full API of the MediaLibrarySessionCallback](https://github.com/androidx/media/blob/1.11.0/libraries/session/src/main/java/androidx/media3/session/MediaLibraryService.java#L127) in the API
     documentation.
   - **Implement [`MediaSession.Callback.onAddMediaItems()`](https://github.com/androidx/media/blob/1.11.0/demos/session/src/main/java/androidx/media3/demo/session/PlaybackService.kt#L184)** : The callback
   ...
   - The general **asynchronous programming model changed to `Futures`** in
     ...
     [return an immediate Future to directly return a value](https://github.com/androidx/media/blob/1.11.0/demos/session/src/main/java/androidx/media3/demo/session/PlaybackService.kt#L136).
