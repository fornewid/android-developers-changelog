...
> [!IMPORTANT]
> **Important:** Media and video apps are considered separate categories for cars, as explained in the [Apps category table](https://developer.android.com/training/cars#supported-app-categories). For details on apps that play video, see [Video category](https://developer.android.com/training/cars#video).

Media apps let users browse and play music, radio, audiobooks, and other audio
content in the car. For more information, see
[Build audio playback apps for cars](https://developer.android.com/media/implement/surfaces/cars#build_audio_playback_apps_for_cars) and
...
[Build video playback apps for Android Automotive OS](https://developer.android.com/media/implement/surfaces/cars#build_video_playback_apps_for_Android_Automotive_OS) and
...
See
[Declare the AAOS hardware feature](https://developer.android.com/training/cars/distribute#automotive-manifest)
