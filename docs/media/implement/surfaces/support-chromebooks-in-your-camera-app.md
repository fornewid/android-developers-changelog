---
title: Support Chromebooks in your camera app  |  Android media  |  Android Developers
...
# Support Chromebooks in your camera app Stay organized with collections Save and categorize content based on your preferences.
...
**Caution:** The `android.hardware.camera` feature applies only to back
...
**Note:** If your app requires a camera, specify `required="true"` for
`android.hardware.camera.any`. That way, devices that don't have a camera won't
