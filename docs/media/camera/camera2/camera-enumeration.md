---
title: Camera lenses and capabilities  |  Android media  |  Android Developers
...
[`CameraCharacteristics.LENS_FACING`](/reference/android/hardware/camera2/CameraCharacteristics#LENS_FACING).
...
[`CameraMetadata.REQUEST_AVAILABLE_CAPABILITIES_BACKWARD_COMPATIBLE`](/reference/android/hardware/camera2/CameraMetadata#REQUEST_AVAILABLE_CAPABILITIES_BACKWARD_COMPATIBLE)
...
![](/static/images/training/camera/camera2/camera-enumeration-1.png)
...
configurations. For more information on accounting for edge cases, see [`CameraMetadata.REQUEST_AVAILABLE_CAPABILITIES_LOGICAL_MULTI_CAMERA`](/reference/android/hardware/camera2/CameraMetadata#REQUEST_AVAILABLE_CAPABILITIES_LOGICAL_MULTI_CAMERA).

## Create compatible apps

For apps still using the deprecated Camera API, the number of cameras
that
[`Camera.getNumberOfCameras()`](/reference/android/hardware/Camera#getNumberOfCameras%28%29)
...
[`Camera.CameraInfo.orientation`](/reference/android/hardware/Camera.CameraInfo#orientation).

In general, use the
[`Camera.getCameraInfo()`](/reference/android/hardware/Camera#getCameraInfo%28int,%20android.hardware.Camera.CameraInfo%29)
API to query all camera
[`orientation`](/reference/android/hardware/Camera.CameraInfo#orientation)s,
...
direction. If an external camera is connected, you might assume that the user
prefers it as the default.