...
[Camera2](https://developer.android.com/training/camera2) and [CameraX](https://developer.android.com/training/camerax) provide an Extensions API that lets your app access the following extensions that vendors have implemented on Android devices:
...
The [Camera2](https://developer.android.com/training/camera2/extensions-api) and [CameraX](https://developer.android.com/training/camerax/extensions-api) Extension APIs expose the same set of extensions, which are available on many [supported devices](https://developer.android.com/training/camera/supported-devices).
...
For a list of known devices that support extensions, see [Supported devices](https://developer.android.com/training/camera/supported-devices). To check if an extension is available on your device, see the [Camera2 Extensions API](https://developer.android.com/training/camera2/extensions-api) and [CameraX Extensions API](https://developer.android.com/training/camerax/extensions-api) documentation, respectively.
