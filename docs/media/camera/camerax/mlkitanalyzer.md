---
title: ML Kit Analyzer  |  Android media  |  Android Developers
...
# ML Kit Analyzer Stay organized with collections Save and categorize content based on your preferences.
...
* The transformation [Matrix](/reference/android/graphics/Matrix)
  based on `COORDINATE_SYSTEM_VIEW_REFERENCED` that represents the target coordinate system.
* The camera frames.
