---
title: Choose the best low light option  |  Android media  |  Android Developers
...
# Choose the best low light option Stay organized with collections Save and categorize content based on your preferences.
...
* To capture high-quality still images in low-light conditions, use the [night
  mode camera extension](/reference/android/hardware/camera2/CameraExtensionCharacteristics#EXTENSION_NIGHT).
...
* For real-time use cases, like a camera preview in low light, use *low light
  ...
  + Some devices support [*Low Light Boost AE Mode*](/media/camera/lowlight/low-light-boost-ae). This mode fine-tunes
  ...
  + Google Play services provides the software-based [*Google Low Light
    Boost*](/media/camera/lowlight/low-light-boost-gp) library, which can run on many devices that don't
