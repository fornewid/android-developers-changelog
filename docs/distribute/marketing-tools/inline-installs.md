...
To invoke inline install half sheet from an app, create an instance of the[`Intent`](https://developer.android.com/reference/android/content/Intent)class, which opens a deep link URL. Use the following sample code (Kotlin or Java) as a guideline.  
