---
title: Truecaller brings ~40% subscribers back with real time developer notifications  |  Developer stories  |  Android Developers
...
# Truecaller brings ~40% subscribers back with real time developer notifications Stay organized with collections Save and categorize content based on your preferences.
...
In addition, using the SUBSCRIPTION\_CANCELED notification, Truecaller was able
...
* For grace period and on-hold users, they recovered 40% of reactivated
  accounts versus 15% before using RTDN . They also saw users
  reactivating up to 3 weeks later.
* For cancelled users, a full 20% were now resubscribing to the premium service
  versus 3% earlier.
