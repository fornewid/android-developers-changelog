...
[Monzo](https://monzo.com/) is a bank and app offering digital financial services. Their mission is to make money work for everyone. Monzo's design system started to deviate from Material Design so they wanted an **easy way to write and maintain custom components** that are constantly evolving---so they chose Jetpack Compose.
