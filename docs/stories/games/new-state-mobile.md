---
title: NEW STATE Mobile reduces GPU usage by 22% with Android GPU Inspector  |  Developer stories  |  Android Developers
...
# NEW STATE Mobile reduces GPU usage by 22% with Android GPU Inspector Stay organized with collections Save and categorize content based on your preferences.
...
![Screenshot from NEW STATE Mobile](/static/images/cards/distribute/stories/newstate-mobile.jpg "Figure 
   1: Screenshot from NEW STATE Mobile")
...
![Screenshot from NEW STATE Mobile](/static/images/cards/distribute/stories/newstate-mobile-2.jpg "Figure 
   2: Screenshot from NEW STATE Mobile")
...
![Internal data showing GPU usage reduction](/static/images/cards/distribute/stories/newstate-data.jpg "Figure 
   3: Screenshot from NEW STATE Mobile")
