---
title: Kuro Games reduces 9.68% power consumption through Android Studio Power Profiler and ODPM for Wuthering Waves  |  Developer stories  |  Android Developers
...
# Kuro Games reduces 9.68% power consumption through Android Studio Power Profiler and ODPM for Wuthering Waves Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/images/cards/distribute/stories/kuro_game_screenshot.jpg)
...
![](/static/images/cards/distribute/stories/kuro_AS_screenshot.png)


**Figure 2.**
Android Studio Power Profiler Screenshot
...
**Note:** Screen brightness contributes significantly to power consumption,
so it is important to set the same brightness throughout power consumption testing.
...
* Changing the CPU core scheduling strategy and adjusting priority of different
  threads to reduce the workload of big cores
* Pre-compiling the PSO (Pipeline State Object) to reduce the runtime shader
  compiling workload of CPU
* Implementing PVS (Potentially Visible Sets) culling to reduce the GPU rendering
  workload
...
**Note:** If you don't have a customized profile system, you can refer to this
[blog post](https://android-developers.googleblog.com/2024/04/how-to-effectively-ab-test-power-consumption-for-your-android-app-features.html)
about how to compare power consumption ODPM data of different tests with the same duration through Power Profiler.
...
![](/static/images/cards/distribute/stories/kuro_powerrail_data.png)
...
"S2S\_VDD\_G3D"; specific knowledge of the device hardware is required to
