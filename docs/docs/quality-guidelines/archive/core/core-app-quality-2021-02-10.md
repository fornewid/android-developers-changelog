---
title: https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10
url: https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10
source: md.txt
---

*This is an archived copy, last updated on February 10, 2021. You can also [view the current
...
|---|---|---|---|
| Navigation | VX-N1 | [CR-3](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-3) | The app supports standard [Back button navigation](https://developer.android.com/design/patterns/navigation) and does not make use of any custom, on-screen "Back button" prompts. |
| Navigation | VX-N2 | [CR-3](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-3) | The app supports [gesture navigation](https://developer.android.com/training/gestures/gesturenav) for going back / going to the home screen. |
| Navigation | VX-N3 | [CR-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-1) [CR-3](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-3) [CR-5](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-5) | The app correctly preserves and restores user or app state. The app preserves user or app state when leaving the foreground and prevents accidental data loss due to back-navigation and other state changes. When returning to the foreground, the app should restore the preserved state and any significant stateful transaction that was pending. Examples include: changes to editable fields, game progress, menus, videos, and other sections of the app or game. 1. When the app is resumed from the Recents app switcher, the app returns the user to the exact state in which it was last used. 2. When the app is resumed after the device wakes from the sleep (locked) state, the app returns the user to the exact state in which it was last used. 3. When the app is relaunched from Home or All Apps, it should do one of the following, depending on how much time has passed since it was last used: - If the app was last used a short time ago (minutes), restore the app state as close as possible to its previous state. - If more time has passed since the app was last used, try to restore the app as close as possible to its previous state; or start it from its home screen or some other default state. |
| Notifications | VX-S1 | [CR-9](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-9) | Notifications follow Material Design [guidelines](https://material.io/design/platform-guidance/android-notifications.html). In particular: 1. Notifications are not used for cross-promotion, or advertising another product, as this is strictly prohibited by the Play Store. 2. Appropriately define [Notification Channels](https://developer.android.com/training/notify-user/channels) according to best practices, rather than serving all notifications from one channel. 3. Selecting [the correct notification priority](https://android-developers.googleblog.com/2018/12/notifications-from-twitter-app.html). 4. Multiple notifications are stacked into [a single notification group](https://developer.android.com/training/notify-user/group), where possible. 5. Set [timeouts](https://developer.android.com/reference/androidx/core/app/NotificationCompat.Builder#setTimeoutAfter(long)) for notifications where appropriate. 6. Notifications are persistent only if related to ongoing events, such as music playback (more under the [Functionality section](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#fn)) or a phone call. |
| Notifications | VX-S2 | [CR-9](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-9) | For messaging / social apps and conversations: 1. Use the [MessagingStyle](https://developer.android.com/reference/androidx/core/app/NotificationCompat.MessagingStyle) notifications for conversations. 2. Support the [direct reply action](https://developer.android.com/training/notify-user/build-notification#reply-action). 3. Support [conversation shortcuts](https://developer.android.com/guide/topics/ui/conversations#shortcuts), and implement best practices for getting the [best direct share ranking](https://developer.android.com/training/sharing/receive#get-best-ranking). 4. Support [bubbles](https://developer.android.com/guide/topics/ui/bubbles). |
| UI and Graphics | VX-U1 | [CR-5](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-5) | The app supports both landscape and portrait orientations (if possible). Orientations expose largely the same features and actions and preserve functional parity. Minor changes in content or views are acceptable. |
| UI and Graphics | VX-U2 | [CR-5](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-5) | The app uses the whole screen in both orientations and does not letterbox to account for orientation changes. Minor letterboxing to compensate for small variations in screen geometry is acceptable. |
| UI and Graphics | VX-U3 | [CR-5](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-5) | The app correctly handles rapid transitions between display orientations without rendering problems or losing state. |
| Visual quality | VX-V1 | [CR-all](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#core) | The app displays graphics, text, images, and other UI elements without noticeable distortion, blurring, or pixelation. 1. The app should use [vector drawables](https://developer.android.com/guide/topics/graphics/vector-drawable-resources) where possible. 2. The app provides high-quality graphics for all targeted screen sizes and form factors. 3. No aliasing at the edges of menus, buttons, and other UI elements is visible. |
| Visual quality | VX-V2 | [CR-all](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#core) | The app displays text and text blocks in an acceptable manner for each of the app's supported languages. 1. Composition is acceptable in all supported form factors. 2. No cut-off letters or words are visible. 3. No improper word wraps within buttons or icons are visible. 4. There is sufficient spacing between text and surrounding elements. |
| Visual quality | VX-V3 | [CR-all](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#core) | The app's content, and all web contents referred to by the app, support [dark theme](https://developer.android.com/guide/topics/ui/look-and-feel/darktheme). |
...
| Area | ID | Tests | Description |
|---|---|---|---|
| Audio | FN-A1 | [CR-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-1) [CR-8](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-8) | Audio resumes when the app returns to the foreground, or indicates to the user that playback is in a paused state. |
| Audio | FN-A2 | [CR-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-1) [CR-2](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-2) [CR-8](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-8) | If audio playback is a core feature, the app should support [background playback](https://developer.android.com/guide/topics/media/mediaplayer#mpandservices). |
| Audio | FN-A3 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | When the user initiates audio playback, the app should do one of the following within one second: 1. Start playing the audio. 2. Provide a visual indicator that the audio data is being prepared. |
| Audio | FN-A4 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | The app should request [audio focus](https://developer.android.com/guide/topics/media-apps/audio-focus) when audio starts playing and abandon audio focus when playback stops. |
| Audio | FN-A5 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | The app should [handle other apps' requests for audio focus](https://developer.android.com/guide/topics/media-apps/audio-focus#audio-focus-change). For example, an app might reduce playback volume when another app plays speech. |
| Media | FN-M1 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) [CR-6](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-6) [CR-8](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-8) | If the app plays audio in the background, it must create a [Notification styled with MediaStyle](https://android-developers.googleblog.com/2020/08/playing-nicely-with-media-controls.html). |
| Media | FN-M2 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | If the app plays video, it should support [picture-in-picture](https://developer.android.com/guide/topics/ui/picture-in-picture) playback. |
| Media | FN-M3 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | If the app encodes video, it should do so using the HEVC video compression standard. |
| Sharing | FN-S1 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | The app should use the [Android Sharesheet](https://developer.android.com/training/sharing/send) when sharing content. It can suggest targets that are unavailable to custom solutions. |
| Background Service | FN-B1 | [CR-6](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-6) | The app avoids running background services where possible. To ensure the smooth running of the user's device, the system applies various [restrictions on background services](https://developer.android.com/about/versions/oreo/background#services). These are not considered good uses of background services: - Maintaining a network connection for notifications - Maintaining a Bluetooth connection - Keeping the GPS powered-on Learn how to [choose the right solution for your work](https://developer.android.com/guide/background#categories_of_background_tasks). |
| Background Service | FN-B2 | [CR-10](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-10) | The app properly supports the power management features that were introduced in Android 6.0 (Doze and App Standby). In the case where core functionality is disrupted by power management, only qualified apps may request an exemption. See [Support for other use cases](https://developer.android.com/training/monitoring-device-state/doze-standby#other_use_cases) in Doze and App Standby. |
...
| Area | ID | Tests | Description |
|---|---|---|---|
| Stability | PS-S1 | [CR-all](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#core) [SD-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#SD-1) | The app does not [crash](https://developer.android.com/topic/performance/issues/crash) or [block the UI thread](https://developer.android.com/topic/performance/issues/anr) causing ANR (Android Not Responding") errors. Utilize [Google Play's pre-launch report](https://support.google.com/googleplay/android-developer/answer/9842757) to identify potential stability issues. After deployment, pay attention to the [Android Vitals](https://developer.android.com/google/play/vitals) page in the Google Play developer console. |
| Performance | PS-P1 | [CR-all](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#core) [SD-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#SD-1) | [The app loads quickly](https://medium.com/androiddevelopers/testing-app-startup-performance-36169c27ee55) or provides onscreen feedback to the user (a progress indicator or similar cue) if the app takes longer than two seconds to load. |
| Performance | PS-P2 | [CR-all](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-all) [SD-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#SD-1) | Apps should render frames every 16ms to achieve 60 frames per second. Developers can use the [Profile HWUI rendering](https://developer.android.com/topic/performance/rendering/inspect-gpu-rendering) option in testing. If there are issues, tools are available to help diagnose [slow rendering](https://developer.android.com/topic/performance/issues/render). |
| Performance | PS-P3 | [PM-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#PM-1) | With StrictMode enabled (see [StrictMode Testing](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#strictmode), below), no red flashes (performance warnings from StrictMode) are visible when testing the app. Any red flashes indicate bad behaviors regarding storage, network access, or memory leaks. |
| SDK | PS-T1 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | The app runs on the latest public version of the Android platform without crashing or severely impacting core functionality. |
| SDK | PS-T2 | [SP-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#SP-1) | The app [targets the latest Android SDK](https://developer.android.com/distribute/best-practices/develop/target-sdk) by setting the `targetSdk` value. |
| SDK | PS-T3 | [SP-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#SP-1) | The app is built with the latest SDK by setting the `compileSdk` value. |
| SDK | PS-T4 | [SP-2](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#SP-2) [SP-3](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#SP-3) | Any third-party SDKs used are up-to-date. Any improvements to these SDKs, such as stability, compatibility, or security, should be available to users in a timely manner. The developer is accountable for the entire app's codebase, inclusive of any third-party SDKs used. |
| SDK | PS-T5 | [CR-0](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#CR-0) | The app does not use [non-SDK interfaces](https://developer.android.com/distribute/best-practices/develop/restrictions-non-sdk-interfaces). |
| Battery | PS-B1 | [BA-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#BA-1) | The app properly supports the power management features that were introduced in Android 6.0 (Doze and App Standby). In the case where core functionality is disrupted by power management, only qualified apps may request an exemption. During development, developers can test app standby and doze behavior using [these ADB commands](https://developer.android.com/training/monitoring-device-state/doze-standby#testing_doze_and_app_standby). In terms of battery usage, developers can use the [Android Studio energy profiler](https://developer.android.com/studio/profile/energy-profiler) or the [Battery Historian](https://developer.android.com/topic/performance/power/battery-historian) tool, combined with planned background work, to diagnose unexpected battery use. |
...
| Area | ID | Tests | Description |
|---|---|---|---|---|
| Policies | GP-P1 | [GP-all](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#gp) | The app strictly adheres to the terms of the [Google Play Developer Content Policy](http://play.google.com/about/developer-content-policy.html) and does not offer inappropriate content, does not use the intellectual property or brand of others, and so on. |
| Policies | GP-P2 | [GP-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#GP-1) | The app maturity level is set appropriately, based on the [Content Rating Guidelines](http://support.google.com/googleplay/android-developer/bin/answer.py&answer=188189). |
| App Details Page | GP-D1 | [GP-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#GP-1) [GP-2](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#GP-2) | The app's feature graphic follows the guidelines outlined in this [support article](https://support.google.com/googleplay/android-developer/answer/9866151?visit_id=637408759199927231-2278064029&rd=1#feature_graphic_requirements). Make sure that: 1. The app listing includes a high-quality feature graphic. 2. The feature graphic does not contain device images, screenshots, or small text that will be illegible when scaled down and displayed on the smallest screen size that your app is targeting. 3. The feature graphic does not resemble an advertisement. |
| App Details Page | GP-D2 | [GP-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#GP-1) | The app's screenshots and videos do not show or reference non-Android devices. |
| App Details Page | GP-D3 | [GP-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#GP-1) | The app's screenshots or videos do not represent the content and experience of your app in a misleading way. |   |
| User Support | GP-X1 | [GP-1](https://developer.android.com/docs/quality-guidelines/archive/core/core-app-quality-2021-02-10#GP-1) | Common user-reported bugs in the Reviews tab of the Google Play page are addressed if they are reproducible and occur on many different devices. If a bug occurs on only a few devices, you should still address it if those devices are particularly popular or new. |
...
| Core Suite | CR-5 | From each app screen, rotate the device between landscape and portrait orientation at least three times. |
