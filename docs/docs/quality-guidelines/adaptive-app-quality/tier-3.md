---
title: https://developer.android.com/docs/quality-guidelines/adaptive-app-quality/tier-3
...
| Test ID | Guideline IDs | Description |
|---|---|---|
| T-Stylus_Basic | [Stylus_Basic](https://developer.android.com/docs/quality-guidelines/adaptive-app-quality/tier-3#Stylus_Basic) | Using a stylus, navigate through the app, select UI elements, scroll through lists and pickers, and generally interact with the app. |
