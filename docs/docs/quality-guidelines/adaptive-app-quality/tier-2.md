...
| ID | Feature | Description |
| --- | --- | --- |
| T-Keyboard\_Navigation | [T-Keyboard\_Navigation](#T-Keyboard_Navigation) | Navigate through the app's focusable components using the Tab and arrow keys of an external keyboard. |
