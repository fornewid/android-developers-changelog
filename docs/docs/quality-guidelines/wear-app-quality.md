...
core app quality requirements](/docs/quality-guidelines/core-app-quality). To filter for guidelines that are relevant
...
34) or higher](https://support.google.com/googleplay/android-developer/answer/11926878) to be submitted to Google Play. [Wear OS 5](/training/wearables/versions/5) is based on
this version.  
...
| Area | Requirement | ID | Benchmark |
| --- | --- | --- | --- |
| SDK | Target API level | `WO-P1` | Ensure that your app meets Google Play's [target API level requirements](/google/play/requirements/target-sdk). |
