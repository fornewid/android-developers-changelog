...
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_target_dont.png)  
cancel

### Don't

Make touch targets too small.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_contrast_do.png)  
check_circle

### Do

Ensure sufficient color contrast.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_contrast_dont.png)  
cancel

### Don't

Use colors with insufficient color contrast.  
Alas, your browser doesn't support HTML5 video. That's OK! You can still [download the video](https://developer.android.com/static/images/design/ui/mobile/layout-basics-video-1.mp4) and watch it with a video player. **Video 1:**Don't create a widget with inaccurate preview.
...
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_edges_dont.png)  
cancel

### Don't

Make a custom size that doesn't fill the grid bounds.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_header_do.png)  
check_circle

### Do

Provide a header that meets widget specs.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_header_dont.png)  
cancel

### Don't

Use custom specs for size and titles.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_genericdescription_do.png)  
check_circle

### Do

Include a unique succinct description.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_genericdescription_dont.png)  
cancel

### Don't

Provide a generic description.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_radius_do.png)  
check_circle

### Do

Use system corner radius.  
![](https://developer.android.com/static/images/guide/topics/widgets/quality-guidelines/widgets_quality_radius_dont.png)  
cancel
