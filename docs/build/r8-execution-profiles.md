---
title: Configure how R8 runs  |  Android Studio  |  Android Developers
...
[Apply the settings plugin](/studio/build/android-settings-plugin#apply-settings-plugin), and then add the `android` block to
