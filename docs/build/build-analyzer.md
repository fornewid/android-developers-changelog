---
title: Troubleshoot build performance with Build Analyzer  |  Android Studio  |  Android Developers
...
**Note:** The Build Analyzer doesn't display data for all tasks in your build.
Instead, it focuses on only the tasks that determine your build's total
duration.
...
2. To open the **Build** window, select **View > Tool Windows > Build** from
   the menu bar.
3. To view the build report in the **Build Analyzer**, click the
   **Build Analyzer** tab in the **Build** window.
...
![](/static/studio/images/build/build-analyzer/analyzer-overview.png)


**Figure 1.** The Build Analyzer overview
page gives a summary of the findings.
...
![](/static/studio/images/plugins-breakdown.png)


**Figure 2.** The Build Analyzer provides a
breakdown of plugins that affect your build's duration.
...
![](/static/studio/images/tasks-breakdown.png)


**Figure 3.** The Build Analyzer provides a
breakdown of tasks most responsible for your build's duration.
...
![](/static/studio/images/build/build-analyzer/inspect-warning.png)
...
![](/static/studio/images/build/build-analyzer/build-analyzer-download-impact.png)
