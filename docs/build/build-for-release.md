---
title: Build your app for release to users  |  Android Studio  |  Android Developers
...
The **Run** ![](/static/studio/images/buttons/toolbar-run.png) button builds and deploys your app to a device. However,
...
first [select the build variant](/studio/run#changing-variant) you
want to use.
...
**Note:** The **Run** ![](/static/studio/images/buttons/toolbar-run.png) button builds an APK with `testOnly="true"`,
