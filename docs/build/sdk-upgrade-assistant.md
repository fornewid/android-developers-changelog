---
title: Use the Android SDK Upgrade Assistant  |  Android Studio  |  Android Developers
...
* It tries to filter the full list of changes to only show steps relevant
  ...
  **Note:** If you need to reset the step filters, close and reopen your
  project or restart the Studio IDE. The SDK Upgrade Assistant filters the
  migration steps once at the beginning of each project session, so you might
  want to reset the step filters if you've checked out another version of your
  project for which previously hidden steps apply.
