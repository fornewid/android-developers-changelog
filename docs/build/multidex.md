...
file by declaring them with the [`multiDexKeepProguard`](/reference/tools/gradle-api/9.1/com/android/build/api/dsl/VariantDimension#multiDexKeepProguard()) property in your build type. If a class is matched in
