...
- [Configure publication variants](https://developer.android.com/studio/publish-library/configure-pub-variants). Publication variants let you publish different versions of your library, such as for debug versus release.
