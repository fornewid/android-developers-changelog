---
title: Prepare your library for release  |  Android Studio  |  Android Developers
...
**Note:** A library project does not have an
`applicationId`; that is a property of applications only.
...
**Note:** AAR metadata does not contain properties that are important at runtime and
therefore is not typically found in compiled Android apps.
...
[Test fixtures](/reference/tools/gradle-api/9.1/com/android/build/api/dsl/TestFixtures)
