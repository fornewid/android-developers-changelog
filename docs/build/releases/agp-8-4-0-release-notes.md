---
title: Android Gradle Plugin 8.4.0 (Apr 2024)  |  Android Developers
...
# Android Gradle Plugin 8.4.0 (Apr 2024) Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Gradle | 8.6 | 8.6 | To learn more, see [updating Gradle](/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
...
to adjust [library keep rules](/build/shrink-code#keep-code) in case there are
...
[code shrinker](/build/shrink-code) won't run on them.
