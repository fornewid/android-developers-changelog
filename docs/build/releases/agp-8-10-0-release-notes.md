---
title: Android Gradle Plugin 8.10.0 (May 2025)  |  Android Developers
...
# Android Gradle Plugin 8.10.0 (May 2025) Stay organized with collections Save and categorize content based on your preferences.
...
* [Source level breaking change: `finalizeDsl` now requires use of parameterized types.](/build/releases/gradle-plugin-api-updates#api-finalizeDsl)
