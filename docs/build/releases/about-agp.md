...
**Important:** You can use an agent skill to help you upgrade your project to AGP
version 9.x. If your app doesn't use Kotlin Multiplatform (KMP), try the AGP 9
upgrade skill from the [Android skills repository](https://github.com/android/skills). If
your app uses KMP, try the skill from
[JetBrains](https://github.com/Kotlin/kotlin-agent-skills/tree/main/skills/kotlin-tooling-agp9-migration).
...
the plugin to version 9.2.0 from the
...
numbers, such as
`'com.android.tools.build:gradle:9.2.+'`.
...
example sets the Gradle version to 9.4.1 using the Gradle Wrapper.
...
example sets the Gradle version to 9.4.1 in the
