---
title: Android Gradle plugin 9.2.0  |  Android Studio  |  Android Developers
...
# Android Gradle plugin 9.2.0 Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Gradle | 9.5.0-milestone-5 | 9.5.0-milestone-5 | To learn more, see [updating Gradle](/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
