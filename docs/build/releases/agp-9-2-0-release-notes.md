...
|---:|:---:|:---:|:---:|
| Gradle | 9.5.0-milestone-7 | 9.5.0-milestone-7 | To learn more, see [updating Gradle](https://developer.android.com/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
