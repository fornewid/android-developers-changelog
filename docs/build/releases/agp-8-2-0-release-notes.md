---
title: Android Gradle Plugin 8.2.0 (Nov 2023)  |  Android Developers
...
# Android Gradle Plugin 8.2.0 (Nov 2023) Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Gradle | 8.2 | 8.2 | To learn more, see [updating Gradle](/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
...
* You can manually modify the JDK path to trigger sync without opening your
  project first.
* Fewer errors related to incompatible Gradle and project JDK versions since
  there is a single source of truth for your Gradle JDK selection.
