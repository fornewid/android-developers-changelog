...
Android Gradle Plugin 8.13.0 is a major release that includes a variety of new features and improvements.

## Android Gradle plugin 8.13.2

**Kotlin 2.3 support** : Android Gradle plugin 8.13.2 uses R8 8.13.19 which [supports Kotlin 2.3](https://developer.android.com/build/kotlin-support).

## Compatibility

The maximum API level that Android Gradle Plugin 8.13 supports is API level 36.1. Here is other compatibility info:
