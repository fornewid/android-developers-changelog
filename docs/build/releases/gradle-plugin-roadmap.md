---
title: Android Gradle Plugin DSL/API migration timeline  |  Android Studio  |  Android Developers
...
* The previous interfaces and classes used in the old Variant API are now
  deprecated, and require [explicit opt-in](/build/releases/agp-9-0-0-release-notes#android-gradle-plugin-new-dsl) to use.
...
* The previous interfaces and classes used in the DSL are now deprecated,
  and require [explicit opt-in](/build/releases/agp-9-0-0-release-notes#android-gradle-plugin-new-dsl) to use.
...
**Important:** We would like your feedback on the removal of internal AGP classes.
Please let us know about your use case, including specific examples of what you
need access to, by submitting your feedback on this
[tracking issue](https://issuetracker.google.com/219002669).