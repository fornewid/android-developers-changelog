---
title: Android Gradle plugin 9.1.0 (March 2026)  |  Android Studio  |  Android Developers
...
# Android Gradle plugin 9.1.0 (March 2026) Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Gradle | 9.3.1 | 9.3.1 | To learn more, see [updating Gradle](/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
