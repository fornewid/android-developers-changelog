...
:
    ...
    - DSA and ECDSA keys can now sign APK packages. **Note:** The [Android keystore](https://developer.android.com/training/articles/keystore) provider no longer supports [DSA keys on Android 6.0](https://developer.android.com/about/versions/marshmallow/android-6.0-changes#behavior-keystore) (API level 23) and higher.
