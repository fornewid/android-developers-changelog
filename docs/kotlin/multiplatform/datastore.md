---
title: Set up DataStore for KMP  |  Kotlin  |  Android Developers
...
# Set up DataStore for KMP Stay organized with collections Save and categorize content based on your preferences.
...
the system, which might be cleaned upon reboot. On macOS, you can instead use
the `~/Library/Application Support/[your-app]` folder.