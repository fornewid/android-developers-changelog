...
This is a minor update that includes [bug fixes](https://developer.android.com/studio/releases/fixed-bugs/studio/2025.1.2#android-studio-narwhal-feature-drop-%7C-2025.1.2-patch-1) and improvements to
...
the [Prompt Library](https://developer.android.com/studio/releases#prompt-library). You can also mention your
...
The [embedded Layout Inspector](https://developer.android.com/studio/debug/layout-inspector) now supports XR
...
16 KB page sizes](https://developer.android.com/guide/practices/page-sizes). To help you navigate this
