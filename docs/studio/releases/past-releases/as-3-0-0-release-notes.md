...
APK is built to [enable debugging](/studio/debug#enable-debug) and
...
[Profile and Debug Pre-built APKs](/studio/debug/apk-debugger).

![](/static/studio/images/debug/apk-debugging_2x.png)
...
[Device File Explorer guide](/studio/debug/device-file-explorer).

![](/static/studio/images/debug/device-file-explorer_2x.png)
...
(these require that you [install the Instant Apps Development SDK](/topic/instant-apps/getting-started/setup#setup-sdk)).

![](/static/studio/images/projects/instant-apps-module_2x.png)
...
options](/studio/run/rundebugconfig#general-tab): Select **Run >
Edit Configurations**, select your Instant App module, and then set the URL
under **Launch Options**.

For more information, see
[Android Instant Apps](/topic/instant-apps).
...
For more information, see how to [create an Android Things project](/things/training/first-device/create-studio-project).

## Adaptive Icons wizard

Image Asset Studio now supports [vector drawables](/guide/topics/graphics/vector-drawable-resources) and
...
[Adaptive Icons](/guide/practices/ui_guidelines/icon_design_adaptive).

![](/static/studio/images/write/image-asset-studio_2x.png)
...
![](/static/studio/images/write/font-download_2x.png)
...
The [App Links Assistant](/studio/write/app-link-indexing)
...
![](/static/studio/images/write/applinks-smartlock-callout_2x.png)
...
Assistant can create for you](#app-links-assistant).
...
![](/static/studio/images/write/intent-url-validation_2x.png)

## Layout Editor

The [Layout Editor](/studio/write/layout-editor) has been updated
...
* New error panel below the editor, showing all issues with suggestions to
  fix (if available).
* Various UI enhancements for building with `ConstraintLayout`, including
  the following:
  + New support to [create barriers](/training/constraint-layout#constrain-to-a-barrier).
  + New support to create groups: In the toolbar, select **Guidelines >
    Add Group** (requires [ConstraintLayout 1.1.0 beta 2](https://androidstudio.googleblog.com/2017/10/constraintlayout-110-beta-2.html)
    or higher)
  + New UI to create chains: Select multiple views, and then right-click
    and select **Chain**.

![](/static/studio/images/write/layout-editor-errors_2x.png)

## Layout Inspector

The [Layout Inspector](/studio/debug/layout-inspector) includes
...
![](/static/studio/images/debug/layout-inspector_2x.png)

## APK Analyzer

You can now use the APK Analyzer from the command line with the
[`apkanalyzer`](/studio/command-line/apkanalyzer) tool.
...
For more information, see [Analyze Your Build with APK Analyzer](/studio/debug/apk-analyzer).
...
Learn more about [Google's Maven repository here](/studio/build/dependencies#google-maven).
...
* Native debugging with Android Studio no longer supports 32-bit Windows.
  ...
  code, you should keep using [Android Studio 2.3](/studio/archive#android-studio-2-3-3).
* Upgraded the base IDE to
  [IntelliJ 2017.1.2](https://confluence.jetbrains.com/display/IDEADEV/IntelliJ+IDEA+2017.1.2+Release+Notes),
  which adds a number of new features from
  [2016.3](https://www.jetbrains.com/idea/whatsnew/#v2016-3) and
  [2017.1](https://blog.jetbrains.com/idea/2017/02/intellij-idea-2017-1-public-preview-java-9-debugger-vcs-search-editor-and-many-more/),
...
* Also see the latest [Android Emulator updates](/studio/releases/emulator).