---
title: Android Studio Koala Feature Drop | 2024.1.2 (August 2024)  |  Android Developers
...
# Android Studio Koala Feature Drop | 2024.1.2 (August 2024) Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/studio/images/device-streaming-kfd.png)
...
![](/static/studio/images/usb-check.png)
...
![](/static/studio/images/sign-in-flow.png)
...
![Device UI Setting Shortcuts in Running Device Window](/static/studio/preview/features/images/device-ui-settings-shortcut.gif)
...
![](/static/studio/images/task-based-profiler.png)
...
`Command+'`. You can still customize it on the **Keymap** settings
page.