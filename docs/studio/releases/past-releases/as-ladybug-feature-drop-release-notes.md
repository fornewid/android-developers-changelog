...
[Android Studio Ladybug Canary 2+](https://developer.android.com/studio/preview)
now supports Wear Tile Animation Previews, making it easier than ever to inspect
and debug your [tile animations](https://developer.android.com/training/wearables/tiles/animations)
directly within the IDE. This feature builds upon the
[Wear Tiles Preview](https://developer.android.com/training/wearables/tiles/preview)
...
2. Add tiles and tooling libraries:
   ...
   2. `libs.versions.toml` file:
      ...
      ```
3. Set up Previews for your Tiles Services. Refer to the [tiles preview guide](https://developer.android.com/training/wearables/tiles/preview) for detailed instructions. If your tiles include animations, the [Animation
   Preview](https://developer.android.com/develop/ui/compose/tooling/animation-preview) will automatically appear, allowing you to inspect and debug them.
...
[Motion Editor](https://developer.android.com/studio/write/motion-editor) as part of our ongoing transition
from XML to [Jetpack Compose](https://developer.android.com/compose). Compose offers a more modern and
efficient approach to building animations, and we encourage developers to start
using [Compose Animation Preview](https://developer.android.com/develop/ui/compose/tooling/animation-preview)
for new projects.
...
- [Gemini code
  transforms](https://developer.android.com/studio/preview/gemini/ai-code-completion#gemini-code-transforms)
...
integration](https://developer.android.com/build/dependencies#sdk-insights) now includes warnings from
...
follow [best practices](https://developer.android.com/guide/practices/sdk-best-practices).
...
is useful for testing [health and fitness apps](https://developer.android.com/health-and-fitness), especially
on Wear OS devices.
...
[known issue](https://developer.android.com/studio/known-issues#run-config-missing-gradle) that was
