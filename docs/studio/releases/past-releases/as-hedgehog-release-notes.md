...
See [Profileable power rails](https://developer.android.com/studio/profile/power-profiler#power-rails)
for a list of supported subsystems.

The [System Trace](https://developer.android.com/studio/profile/cpu-profiler)
...
[Live Edit](https://developer.android.com/jetpack/compose/tooling/iterative-development#live-edit) in Android
Studio Hedgehog includes a new shortcut for manual mode (**Push Manually** ):
<kbd>Control+\</kbd> (<kbd>Command+\</kbd> for macOS). Manual mode is helpful
...
[Multipreview API](https://developer.android.com/jetpack/compose/tooling/previews#preview-multipreview)
...
[debugger](https://developer.android.com/studio/debug) lists the parameters of the composable and their
...
mirroring using the [**Running Devices** window](https://developer.android.com/studio/releases/past-releases/as-hedgehog-release-notes#running-devices) or the
...
![](https://developer.android.com/static/studio/images/run/running_devices-hardware_inpu_action.png)
...
[Layout Inspector](https://developer.android.com/studio/debug/layout-inspector) directly in the
...
[3D mode](https://developer.android.com/studio/debug/layout-inspector#rotate-layout) is only available in
[snapshots](https://developer.android.com/studio/debug/layout-inspector#capture-layout-snapshots).

To help us improve the embedded Layout Inspector, please send us
[feedback](https://developer.android.com/studio/report-bugs).
...
The
[new UI](https://developer.android.com/studio/releases/past-releases/as-giraffe-release-notes#new-ui-theme)
...
The [SDK Upgrade Assistant](https://developer.android.com/build/sdk-upgrade-assistant) provides a
...
you can use [an earlier version of Android Studio](https://developer.android.com/studio/archive). If a given version of Android
...
using [Gradle-managed devices](https://developer.android.com/studio/test/gradle-managed-devices). Test Lab
...
3. Configure your local environment.
   ...
   2. Authorize the use of your user credentials for API access. We recommend
      ...
      [DSL](https://developer.android.com/studio/releases/past-releases/as-hedgehog-release-notes#ftl-gmd-dsl) in the module-level build script:
