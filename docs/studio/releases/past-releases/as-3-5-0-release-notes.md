...
We also want to thank all of our [community contributors](https://developer.android.com/studio/releases/past-releases/as-3-5-0-release-notes#3-5-community-contributors) who have helped with this release.
...
In addition to adding [incremental annotation processing support](https://developer.android.com/studio/releases/past-releases/as-3-5-0-release-notes#incremental_ap) for Data Binding, the IDE improves smart editor features and performance when creating data binding expressions in XML.
