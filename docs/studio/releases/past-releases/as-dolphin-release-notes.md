...
[Animation Preview](https://developer.android.com/jetpack/compose/tooling#animations) to inspect and
...
Open the [Layout Inspector](https://developer.android.com/studio/debug/layout-inspector) window and connect to
...
[Use the Wear OS emulator pairing assistant](https://developer.android.com/training/wearables/get-started/creating#pairing-assistant).
...
specific to [Wear OS](https://developer.android.com/training/wearables) like watch faces, Tiles,
...
![View mode selector](https://developer.android.com/static/studio/images/releases/logcat-view-modes-button.png).
...
![Query history selector](https://developer.android.com/static/studio/images/releases/logcat-query-history.png)
...
![Favourite query](https://developer.android.com/static/studio/images/releases/logcat-favourite.png)
