...
presentation and export the stack frame as discussed in the [Examine Frames guide](https://www.jetbrains.com/help/idea/2026.1/examining-suspended-program.html#examine-frames).
...
4. The **Java Data Type Renderers** dialog displays. Follow the instructions at
   [Java Data type renderers](https://www.jetbrains.com/help/idea/2026.1/java-type-renderers.html).