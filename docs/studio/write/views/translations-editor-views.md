---
title: https://developer.android.com/studio/write/views/translations-editor-views
url: https://developer.android.com/studio/write/views/translations-editor-views
source: md.txt
---
...
translated text in the Design Editor](https://developer.android.com/studio/write/views/translations-editor-views#display-translated).
...
layout direction properties](https://developer.android.com/studio/write/views/translations-editor-views#text-and) in the [Layout Editor](https://developer.android.com/studio/write/layout-editor).
...
[refactor](https://developer.android.com/studio/write/views/translations-editor-views#refactor-project) the project for RTL support. In English, the text direction
