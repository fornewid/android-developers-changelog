---
title: Create resizable bitmaps (9-patch files)  |  Android Studio  |  Android Developers
...
1. In Android Studio, right-click the PNG image you'd like to create
   a NinePatch image from, then click **Create 9-patch file**.
2. Enter a filename for your NinePatch image and click **OK**. Your image
...
4. Click within the 1-pixel perimeter to draw the lines that define the stretchable
