...
3. Fill out the details in the dialog:
   ...
   * **Directory name**: The directory must be named in a way that's specific
     ...
     directory name manually (use **Available qualifiers** instead).
   * **Available qualifiers**: Instead of manually including configuration qualifiers
     in your directory name, you can add them by selecting a qualifier from the
     list and clicking **Add** ![](/static/studio/images/buttons/ic_add-arrows.png).
...
**Note:** Autocompletion isn't supported for inline resources. When developing
