---
title: https://developer.android.com/studio/views/layout-editor
url: https://developer.android.com/studio/views/layout-editor
source: md.txt
---

[Jetpack Compose implementation](https://developer.android.com/jetpack/compose/tooling/previews)
...
[building a layout with `ConstraintLayout`](https://developer.android.com/training/constraint-layout).

This page provides an overview of the Layout Editor. To learn more about layout
fundamentals, see [Layouts](https://developer.android.com/guide/topics/ui/declaring-layout).
...
![code mode icon](https://developer.android.com/static/images/studio/write/code-mode-icon-2x.png)
...
7. **Language** : Select the language to show for your UI strings. This list
   ...
   with Translations Editor](https://developer.android.com/studio/write/translations-editor).

> [!NOTE]
> **Note:** Unless you add a new layout file from **Layout
> Variants**, these configurations don't affect your app's code or manifest. They affect only the layout preview.
...
[create layout variations](https://developer.android.com/studio/views/layout-editor#create-variant), as described in a section on this
...
**Search**
![palette search button](https://developer.android.com/static/studio/images/buttons/search.png)
...
[automatically create constraints](https://developer.android.com/training/constraint-layout#use-autoconnect-and-infer-constraints)
...
5. The icons to the right of each attribute value indicate whether the
   ...
   ![solid indicator icon](https://developer.android.com/static/studio/images/buttons/layout-editor-indicator-solid.png) when the value is a resource reference
   and empty
   ![empty indicator icon](https://developer.android.com/static/studio/images/buttons/layout-editor-indicator-empty.png) when the value is hardcoded to
...
![design time view attributes window](https://developer.android.com/static/images/studio/write/layout-editor-design-time-view-attributes-2x.png) **Figure 6.** The **Design-time
...
![red circle exclamation icon indicating a layout error](https://developer.android.com/static/studio/images/buttons/layout-editor-errors.png)
for errors or an orange triangle exclamation icon
![orange triangle exclamation icon indicating a layout warning](https://developer.android.com/static/studio/images/buttons/layout-editor-warnings-inline.png)
...
library](https://developer.android.com/jetpack/androidx/releases/core), you can select from hundreds of fonts
