---
title: Create a project  |  Android Studio  |  Android Developers
...
with AI](/studio/gemini/create-a-new-project-with-ai).

## Choose your project type

In the **New Project** screen that appears, you can select the type of project
you want to create from categories of device form factors, shown in the
**Templates** pane. For example, figure 1 shows the project templates for phone
and tablet.

![](/static/studio/images/new-project-templates.png)


**Figure 1.** Choose the type of project
you want to create on the **New Project** screen.
...
project with C/C++ support](/studio/projects/add-native-code#new-project) to learn more about the options you need to
configure.

![Configure your new project with a few settings.](/static/studio/images/projects/new-project-wizard-configure-2x.png)
...
2. Specify the **Package name**. By default, this package name becomes your
   project's namespace (used to access your project resources) and your
   project's application ID (used as the ID for publishing). To learn more, see
   [Configure the app module](/studio/build/configure-app-module).
3. Specify the **Save location** where you want to locally store your project.

   **Note:** On macOS, we recommend saving your project in the
   `/Users/user_name/AndroidStudioProjects` directory.
   Certain versions of macOS include a security feature called Transparency,
   Consent, and Control (TCC) that protects specific folders, including
   `Documents`, `Desktop`, and `Downloads`. If you use these folders, the
   [project files](/studio/projects#ProjectFiles) might not show up correctly in
   Android Studio unless you give Android Studio special permission to access
   those folders.
4. Select the **Language** you want Android Studio to use when creating sample
   code for your new project. **Kotlin is the recommended language** and is
   required for modern frameworks like Jetpack Compose. Java is supported but
...
5. Select the **Minimum API level** you want your app to support. When you
   ...
   ![A helper that shows cumulative distribution of different API levels.](/static/studio/images/projects/new-project-wizard-choose-api-level_2x.png)


   **Figure 3.** A help screen that shows
   the cumulative distribution of different API levels.
6. Your project is configured to use AndroidX libraries by default, which
   ...
   learn more, read the [AndroidX overview](/jetpack/androidx).
...
get you started. If you decide to add support for a different device form factor
later, you can [add a module](/studio/projects/add-app-module) to your project. And if you want to share code
and resources between modules, you can do so by creating an [Android
library](/studio/projects/android-library).

For more information about the Android project structure and module types, read
the [Projects overview](/studio/projects). If you're new to Android development altogether,
see [Get started with Android](/training).
...
2. In the window that appears, navigate to the root directory of the project
   you want to import.
3. Click **OK**.
...
To learn more, see [Build and run your app](/studio/run) and the guides that cover
running on the [Android Emulator](/studio/run/emulator) and on [physical hardware devices](/studio/run/device).