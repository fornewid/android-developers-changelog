...
To learn more, see [Build and run your app](/studio/run). This guide covers
running on the [Android Emulator](/studio/run/emulator) and [physical hardware
devices](/studio/run/device).