...
Add C and C++ code to your Android project by placing the code into a `cpp` directory in your project module. When you build your project, this code is compiled into a native library that Gradle can package with your app. Your Java or Kotlin code can then call functions in your native library through the Java Native Interface (JNI). To learn more about using the JNI framework, read [JNI tips for Android](https://developer.android.com/training/articles/perf-jni).

Android Studio supports CMake, which is useful for cross-platform projects. Android Studio also supports [`ndk-build`](https://developer.android.com/ndk/guides/ndk-build), which can be faster than CMake but only supports Android. Using both CMake and `ndk-build` in the same module is not currently supported.

To import an existing `ndk-build` library into your Android Studio project, learn how to [link Gradle to your native library project](https://developer.android.com/studio/projects/gradle-external-native-builds).

This page shows you how to [set up Android Studio](https://developer.android.com/studio/projects/add-native-code#download-ndk) with the necessary build tools, [create a new project](https://developer.android.com/studio/projects/add-native-code#new-project) with C/C++ support, and [add new C/C++ files](https://developer.android.com/studio/projects/add-native-code#create-sources) to your project.
...
3. [Configure Gradle](https://developer.android.com/studio/projects/gradle-external-native-builds) by providing a path to your CMake or `ndk-build` script file. Gradle uses the build script to import source code into your Android Studio project and package your native library into the app.

Once you configure your project, access your native functions from Java or Kotlin code using the [JNI framework](http://docs.oracle.com/javase/7/docs/technotes/guides/jni/spec/jniTOC.html). To build and run your app, click **Run** ![run then run app from the menu bar](https://developer.android.com/static/studio/images/buttons/toolbar-run.png).
...
- [The Android Native Development Kit (NDK)](https://developer.android.com/ndk): a toolset that lets you use C and C++ code with Android. NDK provides platform libraries that let you manage native activities and access physical device components, such as sensors and touch input.
...
To create a new project with support for native code, the process is similar to [creating any other Android Studio project](https://developer.android.com/studio/projects/create-project), but with an additional step:
...
To verify that Gradle packages the native library in the app, use the [APK Analyzer](https://developer.android.com/studio/debug/apk-analyzer):
...
After you add new C/C++ files to you project, you still need to [configure CMake](https://developer.android.com/studio/projects/configure-cmake) to include the files in your native library.
