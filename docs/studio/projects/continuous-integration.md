...
[Android Emulator](https://developer.android.com/studio/run/emulator-commandline) or use
...
> command line using
> `sdkmanager`](https://developer.android.com/studio/command-line/sdkmanager#accept-licenses).