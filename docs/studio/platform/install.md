---
title: Install Android Studio for Platform  |  Android Developers
...
# Install Android Studio for Platform Stay organized with collections Save and categorize content based on your preferences.
...
| CPU | x86\_64 CPU architecture; 2nd generation Intel Core or newer, or AMD processor with support for AMD Virtualization (AMD-V) and SSSE3. | Latest Intel Core processor |
