...
requirements. Then
[download the latest version of Android Studio](https://developer.android.com/studio/platform).
...
3. On the first launch, you'll be prompted to
   ...
   wizard**](https://developer.android.com/studio/platform/projects/create-project). Follow the prompts to
