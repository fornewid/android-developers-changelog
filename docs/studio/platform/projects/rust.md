---
title: Rust support in ASfP  |  Android Studio for Platform  |  Android Developers
...
# Rust support in ASfP Stay organized with collections Save and categorize content based on your preferences.
...
1. **Enable Rust**
   ...
   * When creating a **new project** in the setup wizard, simply check the
     box for Rust:
   ![Rust checkbox in new project setup wizard.](/static/studio/platform/images/rust-new_project.png)
...
* You should see `rust-project.json` in your project view (under the source
  ...
  ![Ensure that rust-project.json has been generated.](/static/studio/platform/images/rust-verify.png)
...
* **Code completion:** Get intelligent suggestions for Rust code, including
  ...
  ![Rust cross-module code completion example](/static/studio/platform/images/asfp-rust-cross_module_completions.png)
...
* **Navigation:** Quickly jump to definitions and find usages of Rust symbols
  across your project.
  ![Rust code navigation example](/static/studio/platform/images/rust-code_navigation.png)


  Navigating to the definition of a Rust symbol.


  ![Rust find usages example](/static/studio/platform/images/rust-find_usages.png)


  Finding all usages of a Rust symbol.
* **Tooltips:** Hover over symbols to see type information and documentation.
  ![Rust tooltip example](/static/studio/platform/images/rust-cross_module_tooltips.png)
...
* **Inlay hints:** View type information and other contextual hints directly
  in the editor.
  ![Rust inlay hints example](/static/studio/platform/images/rust-inlay_hints.png)
...
* **Structure view:** Navigate the structure of your Rust files using the
  **Structure** tool window (View > Tool Windows > Structure).
  ![Rust structure view example](/static/studio/platform/images/rust-structural_views.png)
...
* **Refactoring:** Safely rename symbols and have all usages updated.
  ![Rust rename symbol refactoring example](/static/studio/platform/images/rust-rename_symbol_refactor.png)
...
* **Real-time analysis:** Get instant feedback on errors and warnings in your
  Rust code.
  ![Rust real-time code analysis example](/static/studio/platform/images/rust-real_time_code_analysis.png)
