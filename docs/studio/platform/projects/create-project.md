...
Android Studio for Platform (ASfP) helps you set up your development environment for the [Android Open Source Project (AOSP)](https://source.android.com/). This page explains how to start a new project or import an existing one.
...
For detailed information on all configuration options, see the [Projects overview](https://developer.android.com/studio/platform/projects). After editing `.asfp-project`, you'll need to sync the project for the changes to take effect.
