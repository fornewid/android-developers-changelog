...
- **Rust language support:** Full IDE support for Rust development within
  ...
  analysis. See [Rust support in ASfP](https://developer.android.com/studio/platform/projects/rust) for
...
- **New project configuration:** Introducing the `.asfp-project` YAML file for
  ...
  overview](https://developer.android.com/studio/platform/projects) for more information.
