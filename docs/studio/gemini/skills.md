...
- **One directory per skill:** Each skill must have its own unique directory that includes a `SKILL.md` file and any [additional resources](https://developer.android.com/studio/gemini/skills#directories).
...
- **Body content:** Aim for 10k--20k characters (\~2,500--5,000 tokens). If your instructions exceed this, consider moving detailed documentation to a resource file as described in [Optional skill directories](https://developer.android.com/studio/gemini/skills#directories).
