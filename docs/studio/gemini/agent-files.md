---
title: https://developer.android.com/studio/gemini/agent-files
...
1. Create an `AGENTS.md` file anywhere in your project's file system. Gemini
   ...
   work](https://developer.android.com/studio/gemini/agent-files#how-agent-files-work).
...
2. Add your instructions. Write your instructions using Markdown. For
   ...
   [See example instructions](https://developer.android.com/studio/gemini/agent-files#example-instructions).
...
[Rules](https://developer.android.com/studio/gemini/rules) also let you define instructions and preferences
...
about skills, see the [Android skills overview](https://developer.android.com/tools/agents/android-skills).