---
title: Use a local model  |  Android Studio  |  Android Developers
...
# Use a local model Stay organized with collections Save and categorize content based on your preferences.
...
Studio; however, [Gemini in Android Studio](/gemini-in-android) typically provides the best AI
...
**Caution:** Local models typically offer lower performance compared to cloud-based
Gemini models. You might experience less accurate responses, higher latency,
and limited feature support. We recommend using [Gemini in Android Studio](/gemini-in-android)
for the best experience.

### Try the Gemma 4 model

If you need to use a local model, we recommend trying [Gemma 4](https://android-developers.googleblog.com/2026/04/android-studio-supports-gemma-4-local.html), a
...
| Model | Total RAM needed | Storage |
| --- | --- | --- |
| Gemma E4B | 12 GB | 4 GB |
| Gemma 26B MoE | 24 GB | 17 GB |

See the [setup guide](#set-up-local-model-support) for instructions on how to download and run Gemma 4 locally
on your machine.

## Set up local model support

1. Download and install the [latest version of Android Studio](/studio/releases).
...
3. Add the model provider to Android Studio.
   ...
   * Enable a model
   ![Android Studio settings dialog showing the Gemini section with an option to enable offline mode.](/static/studio/gemini/images/local-model-provider-settings.png)
...
4. Download and install a model of your choice.
   ...
   ![Android Studio settings dialog showing a list of available
          local models.](/static/studio/gemini/images/available-local-models.png)
