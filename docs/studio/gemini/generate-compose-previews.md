---
title: Generate Compose previews  |  Android Studio  |  Android Developers
...
# Generate Compose previews Stay organized with collections Save and categorize content based on your preferences.
...
](/static/studio/gemini/images/compose-preview-generation.mp4)
...
* Within any composable, right-click and navigate to **Gemini > Generate
  ...
  **Note:** You only see the option to generate Compose previews for the whole file
  if there are multiple composables in the file that don't have associated
  previews.

  ![Compose preview generation from context menu](/static/studio/gemini/images/compose-preview-menu.png)
* If you don't have any previews set up yet, in the empty preview panel click
  **Auto-generate Compose Previews for this file**.

  ![Compose preview generation from preview panel](/static/studio/gemini/images/compose-preview-panel.png)
