---
title: Chat with Gemini  |  Android Studio  |  Android Developers
url: https://developer.android.com/studio/gemini/chat
source: html-scrape
---
...
# Chat with Gemini Stay organized with collections Save and categorize content based on your preferences.



**Tip:** Starting with Android Studio Narwhal Feature Drop, Gemini in Android
Studio has [Agent Mode](/studio/gemini/agent-mode). Agent Mode can handle complex tasks that span
multiple steps and files, going beyond what you can do with chat alone.

The main interface for interacting with Gemini is the chat window. You can
use it to ask questions ranging from very open-ended ones to specific problems
...
* Can you show me how to do it in Compose?
  ...
  ](/static/studio/videos/gemini-asset-1.mp4)
...
* How do I analyze UI performance issues in my app?
...
![Show Query History icon](/static/studio/gemini/images/gemini-show-query-history.png)
in the Gemini chat box. A menu appears with all the queries you've submitted in
this coding session.

![The Gemini query history menu showing previous queries.](/static/studio/gemini/images/query-history.png)


**Figure 1:** The Gemini query history menu showing previous queries.
...
conversation. If your chat history is no longer relevant to what you're trying
to achieve, reset the chat history by clicking
**Clear Conversation History** ![Clear Conversation History icon](/static/studio/images/gemini-reset-chat.png)
in the Gemini pane.

## Manage multiple conversation threads

You can organize your conversation with Gemini in Android Studio into
...
To continue learning about Gemini in Android Studio, consider the following:

* For tips on how to get the most out of chats with Gemini in Android Studio,
  see [Best practices](/studio/gemini/best-practices).
* Browse the [Prompt Gallery](/studio/gemini/prompt-gallery) for inspiration on how to use Gemini.
* Help Gemini understand the context for your query by skillfully
  [attaching files](/studio/gemini/attach-file) and
  [attaching images](/studio/gemini/attach-image).