---
title: Manage dependencies with AI  |  Android Studio  |  Android Developers
...
# Manage dependencies with AI Stay organized with collections Save and categorize content based on your preferences.
