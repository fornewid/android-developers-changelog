---
title: Attach an image to your query  |  Android Studio  |  Android Developers
...
# Attach an image to your query Stay organized with collections Save and categorize content based on your preferences.
...
![Attach Image File icon](/static/studio/images/attach-image-file.png)
...
* If you have a mock-up of the UI you'd like, Gemini can provide the code that
  ...
  [Now in Android](https://github.com/android/nowinandroid) app, it can provide the Compose code to
  ...
  see [Generate UI with image attachments](/studio/gemini/generate-ui-with-images).

  ![The 'Now in Android' app, showing a feed of articles with titles, topics, and bookmark icons.](/static/studio/images/nia-screenshot-2.png)
  ![Gemini's code response displaying Jetpack Compose code that recreates the UI from the 'Now in Android' screenshot.](/static/studio/images/gias-response-2.png)
...
* If you want to learn how an app is constructed, Gemini can explain how the UI
  ...
  ![A single news article detail in the 'Now in Android' app, showing a title, author, and description.](/static/studio/images/nia-screenshot-1.png)
  ![Gemini's explanation of the Jetpack Compose composables and data flow for the news article detail screen.](/static/studio/images/gias-response-1.png)
...
* If you have an app architecture diagram, Gemini can suggest code to create the
  ...
  ![A simplified app architecture diagram showing UI, ViewModel, Repository, and Data Source components with arrows indicating data flow.](/static/studio/gemini/images/architecture-diagram.png)
...
* If you notice a UI bug, take a screenshot and ask Gemini to brainstorm
  ...
  ![A mobile app screenshot showing a UI bug where a text element is overlapping or misaligned, highlighted with a red circle.](/static/studio/gemini/images/ui-bug.png)
