---
title: Get started with Gemini in Android Studio for businesses  |  Android Developers
url: https://developer.android.com/studio/gemini/get-started-businesses
source: html-scrape
---
...
# Get started with Gemini in Android Studio for businesses Stay organized with collections Save and categorize content based on your preferences.
...
To get started with Gemini in Android Studio for businesses, your team needs to
...
1. [Set up Gemini Code Assist](https://developers.google.com/gemini-code-assist/docs/set-up-gemini-standard-enterprise). This step is typically done by an admin.
2. [Complete the business tier onboarding flow in Gemini in Android Studio](#gemini-businesses-onboarding).

## Business tier onboarding for developers
...
4. Select **Gemini for businesses** when given the choice of product tier.
   ...
   ![attempt-right](/static/studio/gemini/images/gemini-for-businesses-onboarding.png)
...
![](/static/studio/gemini/images/gemini-for-businesses-label.png)