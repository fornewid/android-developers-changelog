...
development tasks. You can describe a high-level goal, and the agent creates and
...
1. Click **Agent** ![](https://developer.android.com/static/studio/images/agent-icon.png) in the tool window bar. Sign in and onboard if you need to.
...
- **Test and verify changes on a device.**
  ...
  the connected device, inspect what is shown on the screen, take
