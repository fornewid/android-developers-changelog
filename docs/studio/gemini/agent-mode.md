---
title: Agent Mode  |  Android Studio  |  Android Developers
...
# Agent Mode Stay organized with collections Save and categorize content based on your preferences.
...
1. Click **Gemini**
   ![](/static/studio/images/gemini-icon.png)
...
[](/static/studio/videos/agent-viewmodel.mp4)
...
![Agent Mode waits for you to accept or reject a change.](/static/studio/images/agent-accept-changes.png)
...
![Auto-approve changes suggested by the agent.](/static/studio/images/agent-auto-approve.png)
...
![The agent builds your project and assesses if there are errors.](/static/studio/images/agent-build-help.png)
...
[](/static/studio/videos/agent-dark-mode.mp4)
...
[](/static/studio/videos/agent-fake-data.mp4)


**Figure 6:** The agent generating mock data.

* **Test and verify changes on a device.**
  The AI agent in Android Studio has access to tools to deploy an app to
  the connected device, inspect what is currently shown on the screen, take
  screenshots, check Logcat for errors, and interact with the running
  app through `adb shell input`. This lets the agent help you with
  changes or fixes that involve re-running the app, checking for
  errors, and verifying that a particular update was made successfully (for
  example, by taking and reviewing screenshots).

![](/static/studio/preview/features/images/device-interaction-tools.gif)


**Figure 7:** The agent tests and verifies changes on a device.
