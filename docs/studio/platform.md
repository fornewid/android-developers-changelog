...
Get the official IDE for Android platform development, now powered by Agent Mode in Gemini in Android Studio.
...
Learn how to set up your platform development environment, configure Android Studio for Platform, and start developing in the Android Open Source Project. [Learn more](http://developer.android.com/studio/platform/intro) Install

### [Install ASfP](http://developer.android.com/studio/platform/install)

Step-by-step instructions to install ASfP on your Linux machine. Tutorial
...
To unlock additional enterprise-grade privacy, security, and other features, you can upgrade by purchasing a Gemini Code Assist license.
...
Easily manage your project setup with the new `.asfp-project` YAML file. This new format replaces the previous JSON configuration, offering a clearer way to define project directories, modules, build flags, and language support. [Set up projects](https://developer.android.com/studio/platform/intro) ![YAML Project Configuration in ASfP](https://developer.android.com/static/studio/platform/images/asfp-new-project-config.png) Develop

### Rust language support

Develop platform code in Rust with features like code completion, cross-module navigation, find usages, inlay hints, and refactoring, making it easier to work with Rust in your Android projects. [Explore features](https://developer.android.com/studio/platform/intro) ![Rust support in ASfP](https://developer.android.com/static/studio/platform/images/asfp-rust-cross_module_completions.png)
...
Write better code, work faster, and be more productive with an intelligent code editor that provides code completion for Kotlin, Java, and C/C++ programing languages. [Edit platform code](https://developer.android.com/studio/platform/intro) ![Code editing in ASfP](https://developer.android.com/static/studio/platform/images/text_screen.png) Debug

### Java and C++ debugging support

Attach the debugger to an Android process to debug the Java and C++ programming languages. [Debug platform code](https://developer.android.com/studio/platform/debug) ![Debugging in ASfP](https://developer.android.com/static/studio/platform/images/debug_screen.png) Test

### Testing support

Run `atest` from inside the IDE. [Test platform code](https://developer.android.com/studio/platform/test) ![Testing in ASfP](https://developer.android.com/static/studio/platform/images/test_screen.png)

### Android Studio for Platform downloads

Download the latest version of Android Studio for Platform. For more information, see the [Android Studio for Platform release notes](https://developer.android.com/studio/platform/releases).

| Platform | Is Canary? | Android Studio package |
|---|---|---|
| Linux (64-bit) | No | <button class="devsite-dialog-button button-white button-regular" data-modal-dialog-id="asfp_linux_bundle_download">asfp-panda-2-2025.3.2.6-linux.deb</button> |
| Linux (64-bit) | Yes | <button class="devsite-dialog-button button-white button-regular" data-modal-dialog-id="asfp_canary_linux_bundle_download">asfp-canary-panda-2-2025.3.2.2-linux.deb</button> |

More downloads are available in the [download archives](https://developer.android.com/studio/platform/releases/archive).
...
14.1 The License Agreement constitutes the whole legal agreement between you and Google and governs your use of the SDK (excluding any services which Google may provide to you under a separate written agreement), and completely replaces any prior agreements between you and Google in relation to the SDK. 14.2 You agree that if Google does not exercise or enforce any legal right or remedy which is contained in the License Agreement (or which Google has the benefit of under any applicable law), this will not be taken to be a formal waiver of Google's rights and that those rights or remedies will still be available to Google. 14.3 If any court of law, having the jurisdiction to decide on this matter, rules that any provision of the License Agreement is invalid, then that provision will be removed from the License Agreement without affecting the rest of the License Agreement. The remaining provisions of the License Agreement will continue to be valid and enforceable. 14.4 You acknowledge and agree that each member of the group of companies of which Google is the parent will be third party beneficiaries to the License Agreement and that such other companies will be entitled to directly enforce, and rely upon, any provision of the License Agreement that confers a benefit on (or rights in favor of) them. Other than this, no other person or company will be third party beneficiaries to the License Agreement. 14.5 EXPORT RESTRICTIONS. THE SDK IS SUBJECT TO UNITED STATES EXPORT LAWS AND REGULATIONS. YOU MUST COMPLY WITH ALL DOMESTIC AND INTERNATIONAL EXPORT LAWS AND REGULATIONS THAT APPLY TO THE SDK. THESE LAWS INCLUDE RESTRICTIONS ON DESTINATIONS, END USERS AND END USE. 14.6 The rights granted in the License Agreement may not be assigned or transferred by either you or Google without the prior written approval of the other party. Neither you nor Google will be permitted to delegate their responsibilities or obligations under the License Agreement without the prior written approval of the other party. 14.7 The License Agreement, and your relationship with Google under the License Agreement, will be governed by the laws of the State of California without regard to its conflict of laws provisions. You and Google agree to submit to the exclusive jurisdiction of the courts located within the county of Santa Clara, California to resolve any legal matter arising from the License Agreement. Notwithstanding this, you agree that Google will still be allowed to apply for injunctive remedies (or an equivalent type of urgent legal relief) in any jurisdiction. *April 28, 2026* I have read and agree with the above terms and conditions <button class="button button-disabled"> Download Android Studio for Platform for Linux </button> [Download Android Studio for Platform for Linux](https://dl.google.com/android/asfp/asfp-canary-Panda%202-2025.3.2.2-linux.deb)

*asfp-canary-panda-2-2025.3.2.2-linux.deb*