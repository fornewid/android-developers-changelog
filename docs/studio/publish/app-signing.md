---
title: https://developer.android.com/studio/publish/app-signing
...
Bundles](https://developer.android.com/guide/app-bundle), you need to sign your app bundle with an upload
...
> [!NOTE]
> **Note:** If you are building a Wear OS app, the process for signing the app can differ from the process described on this page. See the information about [packaging and publishing Wear OS
> apps](https://developer.android.com/training/wearables/apps/packaging).
...
keystores](https://developer.android.com/studio/publish/app-signing#certificates-keystores). You keep the upload key and use it to sign
...
private upload key](https://developer.android.com/studio/publish/app-signing#reset_upload_key).
...
release](https://developer.android.com/studio/publish/app-signing#sign-apk).
...
- **Upload key:** The key you use to sign the app bundle or APK before you
  upload it for [app signing with Google Play](https://developer.android.com/studio/publish/app-signing#app-signing-google-play). You must
...
and Run Your App](https://developer.android.com/tools/building/building-studio).
...
8. If you would like to build and sign your app with your upload key, continue
   ...
   [Sign your app with your upload key](https://developer.android.com/studio/publish/app-signing#sign_release). If you only want to
...
separate upload key](https://developer.android.com/studio/publish/app-signing#register_upload_key) with Google Play to sign and upload
...
4. Specify the path to your keystore, the alias for your key, and enter the
   ...
   and key, first [Generate an upload key and keystore](https://developer.android.com/studio/publish/app-signing#generate-key) and then
...
to read the [Launch overview](https://developer.android.com/distribute/best-practices/launch). Otherwise,
continue to the page about how to [Upload your app to the Play
Console](https://developer.android.com/studio/publish/upload-bundle).

## Using Play App Signing

As described earlier in this page, configuring
[Play App Signing](https://developer.android.com/studio/publish/app-signing#app-signing-google-play) is required to
...
4. After you choose a release track, configure app signing under the **App
   ...
   - To use the same key as another app on your developer account, select **Change app signing key \> Use the same key as another app in this
     account** , select an app, and then click **Continue**.
   - To provide your own signing key for Google to use when signing your app, select **Change app signing key** and select one of the **Export and
     upload** options that lets you securely upload a private key and its public certificate.

> [!NOTE]
> **Note:** If you haven't already accepted the [Terms of
> Service](https://play.google.com/about/play-app-signing-terms.html), you are required to review the terms and select **Accept** to continue.
...
to [Reset a lost or compromised private upload key](https://developer.android.com/studio/publish/app-signing#reset_upload_key).
...
option to [reset a lost or compromised private upload key](https://developer.android.com/studio/publish/app-signing#reset_upload_key).
...
[reset a lost or compromised private upload key](https://developer.android.com/studio/publish/app-signing#reset_upload_key).
...
in the Play Console or [when resetting your upload key](https://developer.android.com/studio/publish/app-signing#reset_upload_key).
...
Files](https://developer.android.com/studio/publish/app-signing#secure-shared-keystore). For more about keeping your signing information secure, see
[Keep your key secure](https://developer.android.com/studio/publish/app-signing#secure_key), below.
...
more information, see [Configuring Signing Settings](https://developer.android.com/studio/build/build-variants#signing).
...
When you use
[Play App Signing](https://developer.android.com/studio/publish/app-signing#google-play-app-signing),
...
[Play App Signing](https://developer.android.com/studio/publish/app-signing#app-signing-google-play)), securing your app
...
1. Create a signing configuration, and assign it to one or more build types. These instructions assume you have configured a single signing configuration for your release build type, as described in [Configure
   the build process to automatically sign your app](https://developer.android.com/studio/publish/app-signing#sign-auto), above.
