...
app](https://developer.android.com/studio/publish/app-signing#sign-apk), the next step is to upload it to
Google Play to inspect, test, and publish your app. Before you get started, you
must meet the following requirements:

- If you haven't already done so, [enroll in Play App Signing](https://developer.android.com/studio/publish/app-signing#enroll), which is the mandatory way to
