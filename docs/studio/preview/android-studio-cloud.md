---
title: Android Studio Cloud  |  Android Developers
...
# Android Studio Cloud Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** **Android Studio Cloud** is in the experimental phase. Its features and
capabilities are subject to change substantially.
...
Steps | || [Try Android Studio Cloud](https://studio.firebase.google.com/new/android-studio) and name your workspace. |  |
...
* Deploy your app on a virtual or physical device.
  ...
  + If you deploy to the [Android emulator](/studio/run/emulator), we recommend using the
  ...
  ![Device manager UI example](/static/studio/images/preview/android-studio-cloud/android-emulator-device-manager.png)
  + Alternatively, you can deploy to a physical device by using
    [Android Device Streaming](/studio/run/android-device-streaming), powered by Firebase. Running the app on a real
...
![Welcome to Android Studio UI](/static/studio/images/preview/android-studio-cloud/get-from-vcs.png)
...
* To interact with Android Studio Cloud you must use a
  [Linux keyboard mapping](https://resources.jetbrains.com/storage/products/intellij-idea/docs/IntelliJIDEA_ReferenceCard.pdf).
...
* If you are logging into Android Studio, accounts that require **physical** two
  ...
  supported, for example authenticator apps like [Google Authenticator](https://support.google.com/accounts/answer/1066447?co=GENIE.Platform%3DAndroid).
...
![Choose password for new keyring UI example](/static/studio/images/preview/android-studio-cloud/choose-password-for-keyring.png)

* Ignore popups related to updates from the Linux machines for now.

![Linux software updater notification example](/static/studio/images/preview/android-studio-cloud/linux-software-updater.png)
...
![CLick Locate in generated APK notification](/static/studio/images/preview/android-studio-cloud/generate-apk.png)