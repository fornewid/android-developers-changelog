---
title: Compose Preview Screenshot Testing Release Notes  |  Android Studio  |  Android Developers
...
# Compose Preview Screenshot Testing Release Notes Stay organized with collections Save and categorize content based on your preferences.
...
* Enhanced the reporting to include percentage difference and other metadata
  related to new and reference images.
...
* For a host machine using JDK 24 or higher, compatible JDK (11-23) will be
  picked up, provided one is installed.
