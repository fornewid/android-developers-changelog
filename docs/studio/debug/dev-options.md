...
Tap **Profile GPU Rendering** and then **On screen as bars** to display the GPU rendering profile as bars, as shown in figure 9. For more information, see [Profile GPU rendering speed](https://developer.android.com/topic/performance/rendering/inspect-gpu-rendering#profile_rendering).
