---
title: https://developer.android.com/studio/debug/apk-debugger
url: https://developer.android.com/studio/debug/apk-debugger
source: md.txt
---

Android Studio 3.0 and higher lets you profile and debug APKs that have
[debugging enabled](https://developer.android.com/studio/debug#enable-debug) without having
...
You can
[use the Android profiler](https://developer.android.com/studio/profile/android-profiler) to start
testing your app's performance.

To debug your app's Kotlin or Java code, you need to
[attach the Kotlin or Java sources](https://developer.android.com/studio/debug/apk-debugger#attach_java) and add breakpoints in the
Kotlin or Java source files. Similarly, to debug your native code, you must
[attach the native debug symbols](https://developer.android.com/studio/debug/apk-debugger#attach_native).
...
[debug your app](https://developer.android.com/studio/debug). To
