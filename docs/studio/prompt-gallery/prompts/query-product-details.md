---
title: https://developer.android.com/studio/prompt-gallery/prompts/query-product-details
url: https://developer.android.com/studio/prompt-gallery/prompts/query-product-details
source: md.txt
---

Create the code to query for [`ProductDetails`](https://developer.android.com/reference/com/android/billingclient/api/ProductDetails), complete
