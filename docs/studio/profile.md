...
- An app with a release build variant that has the `profileable` manifest
  ...
  [`profileable`](https://developer.android.com/guide/topics/manifest/profileable-element) manifest
  configuration:
...
[debuggable](https://developer.android.com/studio/debug) app instead if you need to record Java/Kotlin
...
use development tools such as the [debugger](https://developer.android.com/studio/debug); however, it comes
...
2. Select a profiling task from the **Tasks** section. For more info about the
   ...
   [inspecting your app live](https://developer.android.com/studio/profile/inspect-app-live).
...
![](https://developer.android.com/static/studio/images/buttons/profiler-export-recording.png).
Not all trace types can be exported.

To import a trace, for example from a previous run of Android Studio, click
**Import recording**
![](https://developer.android.com/static/studio/images/buttons/profiler-import-recording.png)
...
![](https://developer.android.com/static/studio/images/buttons/profiler-settings.png).
