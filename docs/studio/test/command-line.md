...
| `func` | `true` | Runs all test classes that extend `https://developer.android.com/reference/android/test/InstrumentationTestCase`. |
| `unit` | `true` | Runs all test classes that do *not* extend either `InstrumentationTestCase` or `https://developer.android.com/reference/android/test/PerformanceTestCase`. |
