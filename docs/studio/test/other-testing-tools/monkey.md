---
title: UI/Application Exerciser Monkey  |  Android Studio  |  Android Developers
...
| `-c <main-category>` | If you specify one or more categories this way, the Monkey will *only* allow the system to visit activities that are listed with one of the specified categories. If you don't specify any categories, the Monkey will select activities listed with the category Intent.CATEGORY\_LAUNCHER or Intent.CATEGORY\_MONKEY. To specify multiple categories, use the -c option multiple times — one -c option per category. |
