---
title: Other testing tools  |  Android Studio  |  Android Developers
...
# Other testing tools Stay organized with collections Save and categorize content based on your preferences.
...
* [Espresso Test Recorder](/studio/test/other-testing-tools/espresso-test-recorder)
  ...
  Espresso API.
* For stress-testing your app, use the [Monkey](/studio/test/other-testing-tools/monkey).
