---
title: MonkeyImage  |  Android Studio  |  Android Developers
...
# MonkeyImage Stay organized with collections Save and categorize content based on your preferences.
...
| `MonkeyImage` | [getSubImage](#getSubImage) (*tuple* rect)  Creates a new `MonkeyImage` object from a rectangular selection of the current image. |
| *boolean* | [sameAs](#sameAs) (`MonkeyImage` other, *float* percent)  Compares this `MonkeyImage` object to another and returns the result of the comparison. The `percent` argument specifies the percentage difference that is allowed for the two images to be "equal". |
