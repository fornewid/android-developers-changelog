...
- Search for and navigate to a specific class in your project using the
  **Navigate to Class** action. To bring up the **Navigate to Class** action,
  press <kbd>Control+N</kbd> (<kbd>Command+O</kbd> on macOS).
...
- Navigate to a file or folder using the **Navigate to File** action. To
  bring up the **Navigate to File** , press <kbd>Control+Shift+N</kbd>
  (<kbd>Command+Shift+O</kbd> on macOS). To search for folders rather
...
- Navigate to a method or field by name using the **Navigate to Symbol**
  ...
  <kbd>Control+Alt+Shift+N</kbd> (<kbd>Command+Option+O</kbd> on macOS).
...
[Configure custom keymaps](https://developer.android.com/studio/intro/keyboard-shortcuts#custom) section.
