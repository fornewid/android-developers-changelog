...
[basic emulator navigation capabilities](https://developer.android.com/studio/run/emulator#navigate) and
...
with it, see [the emulator feature comparison](https://developer.android.com/studio/run/emulator-comparison).
