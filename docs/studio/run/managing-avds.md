...
### Try Android CLI to create and manage Android Virtual Devices
...
After creating your devices, you can see a list of all the devices
...
[`minSdk`](https://developer.android.com/reference/tools/gradle-api/9.4/com/android/build/api/dsl/BaseFlavor#minSdk()) attribute in the app manifest file. For more
