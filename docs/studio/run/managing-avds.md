...
[`minSdk`](https://developer.android.com/reference/tools/gradle-api/9.2/com/android/build/api/dsl/BaseFlavor#minSdk()) attribute in the app manifest file. For more
