---
title: Inspect trace logs with Traceview  |  Android Studio  |  Android Developers
...
# Inspect trace logs with Traceview Stay organized with collections Save and categorize content based on your preferences.
...
* A [timeline pane](#timeline_pane) that describes when each
  thread enters and exits a method
* A [profile pane](#profile_pane) that summarizes the execution
  of each thread over the period of the trace log
...
![Traceview timeline pane](/static/studio/images/profile/traceview_timeline_pane.png)
...
![Traceview profile pane.](/static/studio/images/profile/traceview_profile_pane.png)
