---
title: Sample the callstack  |  Android Studio  |  Android Developers
...
**Note:** To sample the callstack, you must deploy your app to a device running
...
* Expand the thread of interest and use
  [keyboard shortcuts](/studio/profile/cpu-profiler#ui-shortcuts)
