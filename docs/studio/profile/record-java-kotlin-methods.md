---
title: Record Java/Kotlin methods  |  Android Studio  |  Android Developers
...
* Tracing: Instruments your app at runtime to record a timestamp at the
  ...
  **Note:** The timing information from tracing might deviate from production due to
  the overhead introduced by the instrumentation itself.
...
**Note:** If you're interested in tracing methods with lifecycles so short that
they're likely to begin and end in between a sampling interval, and thus get
missed by the profiler, you should try tracing instead.
