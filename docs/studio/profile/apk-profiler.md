...
[attach the Kotlin or Java sources](https://developer.android.com/studio/profile/apk-profiler#attach_java) and add breakpoints in the
Kotlin or Java source files. Similarly, to debug your native code, you must
[attach the native debug symbols](https://developer.android.com/studio/profile/apk-profiler#attach_native).
