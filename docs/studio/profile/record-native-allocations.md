...
When you run the [**Track Memory Consumption (Native Allocations)**](https://developer.android.com/studio/profile#start-profiling) task,
...
size, see [Edit the recording configuration](https://developer.android.com/studio/profile#edit-recording).