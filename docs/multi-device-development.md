...
To demystify building cross-device experiences, we've built a software stack that abstracts away the underlying connectivity technologies. You no longer need to worry about the [connectivity capabilities](/guide/topics/connectivity) of your users' devices.

![](https://developer.android.com/static/images/picto-icons/responsive-layout.svg)

### Flexible developer toolkit

With our modular approach, you can mix and match our [Cross device SDK](/guide/topics/connectivity/cross-device-sdk/overview) with other Google solutions. Adopt the tools you need to build compelling multidevice experiences.
...
* Start reading an article on your phone and finish it on your tablet without losing
  your place.
