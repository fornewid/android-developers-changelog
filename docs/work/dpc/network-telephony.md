...
`https://developer.android.com/reference/android/provider/CallLog` also shows the
...
- To see how the policy is set, use
  `https://developer.android.com/reference/android/app/admin/DevicePolicyManager#getCrossProfileContactsSearchDisabled(android.content.ComponentName)`.

- To enable or disable searching work contacts by the personal profile, use
  `https://developer.android.com/reference/android/app/admin/DevicePolicyManager#setCrossProfileContactsSearchDisabled(android.content.ComponentName,%20boolean)`.
...
If `https://developer.android.com/reference/android/os/UserManager#DISALLOW_CONFIG_VPN`
is `true`, the user is prevented from configuring the VPN. Enable
`https://developer.android.com/reference/android/os/UserManager#DISALLOW_DEBUGGING_FEATURES`
...
1. Install a VPN app that implements `https://developer.android.com/reference/android/net/VpnService`. You can find active VPN services by using an intent filter that matches the action `https://developer.android.com/reference/android/net/VpnService#SERVICE_INTERFACE`.
2. Declare a `https://developer.android.com/reference/android/net/VpnService` in the app's manifest guarded by the permission `https://developer.android.com/reference/android/Manifest.permission#BIND_VPN_SERVICE`.
3. Configure the `https://developer.android.com/reference/android/net/VpnService` so it's started by the system. Avoid setting the VPN app to start itself by listening for a system boot and controlling its own life cycle.
4. Set the [managed
...
calling
`https://developer.android.com/reference/android/app/admin/DevicePolicyManager#setAlwaysOnVpnPackage(android.content.ComponentName,%20java.lang.String,%20boolean)`.
...
`https://developer.android.com/reference/android/app/admin/DevicePolicyManager#getAlwaysOnVpnPackage(android.content.ComponentName).`
...
In the [TestDPC](https://github.com/googlesamples/android-testdpc) app, `https://github.com/googlesamples/android-testdpc/blob/master/app/src/main/java/com/afwsamples/testdpc/policy/networking/AlwaysOnVpnFragment.java` uses these APIs to enable the setting for an always-on VPN connection.

In the following example:

- The [managed
  configurations](https://developer.android.com/work/managed-configurations.html) of the VPN service are set by the `https://developer.android.com/reference/android/app/admin/DevicePolicyManager` using its `https://developer.android.com/reference/android/app/admin/DevicePolicyManager#setApplicationRestrictions(android.content.ComponentName,%20java.lang.String,%20android.os.Bundle)` method.
...
- The `DevicePolicyManager` then enables the always-on VPN connection for the VPN package using `https://developer.android.com/reference/android/app/admin/DevicePolicyManager#setAlwaysOnVpnPackage(android.content.ComponentName,%20java.lang.String,%20boolean)`, and enabling lockdown mode.
...
`https://developer.android.com/reference/android/net/wifi/WifiEnterpriseConfig#setCaCertificate(java.security.cert.X509Certificate)`
...
SSID, include all relevant CAs in the wireless configuration using `https://developer.android.com/reference/android/net/wifi/WifiEnterpriseConfig#setCaCertificates(java.security.cert.X509Certificate%5B%5D)`.
...
`https://developer.android.com/reference/android/net/wifi/WifiEnterpriseConfig#getCaCertificates()` to return a list of
`https://developer.android.com/reference/javax/security/cert/X509Certificate` objects.
...
2. Create a new `https://developer.android.com/reference/android/net/wifi/WifiConfiguration` and set its SSID and key management.
3. Set up the `https://developer.android.com/reference/android/net/wifi/WifiEnterpriseConfig` instance on this `WifiConfiguration`.
   1. Identify the server with a list of `https://developer.android.com/reference/java/security/cert/X509Certificate` objects using `https://developer.android.com/reference/android/net/wifi/WifiEnterpriseConfig#setCaCertificate(java.security.cert.X509Certificate)`.
...
4. Add the network with the `https://developer.android.com/reference/android/net/wifi/WifiManager`.
...
`https://developer.android.com/reference/android/provider/CallLog`
...
`https://developer.android.com/reference/android/telecom/Call.Details#PROPERTY_ENTERPRISE_CALL`.
