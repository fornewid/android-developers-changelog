...
- Enable programmatic configuration of your app using MCM (as mentioned in
  [Messages MCM schema](https://developer.android.com/work/dpc/rcs-messages-archival#google-messages-mcm-schema)), so users don't need to sign in or specify server
