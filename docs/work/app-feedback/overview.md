...
If your app supports [managed configurations](https://developer.android.com/work/managed-configurations),
...
4. The EMM provider retrieves the keyed app states set by the app and displays them in its EMM console. For example:
   ...
   [`SEVERITY_ERROR`](https://developer.android.com/reference/androidx/enterprise/feedback/KeyedAppState#SEVERITY_ERROR)
...
Add Google's Maven repository as a repository location in your project's [`settings.gradle`](https://developer.android.com/studio/build#settings-file)
file, as shown below:
...
Add the following dependency to your module-level [`build.gradle`](https://developer.android.com/studio/build#module-level)
file:
...
[`KeyedAppStatesReporter`](https://developer.android.com/reference/androidx/enterprise/feedback/KeyedAppStatesReporter).
...
The [`setStates()`](https://developer.android.com/reference/androidx/enterprise/feedback/KeyedAppStatesReporter#setStates(java.util.Collection<androidx.enterprise.feedback.KeyedAppState>))
