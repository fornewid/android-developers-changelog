...
![](/static/wear/images/design/media-hero.png)
...
![](/static/wear/images/design/media-browse.png)

**Browse**

Helps users find media and content by prioritizing downloaded items.

![](/static/wear/images/design/media-entity.png)
...
![](/static/wear/images/design/media-podcast.png)
...
![](/static/wear/images/design/media-music-long.png)
**Music**

![](/static/wear/images/design/media-podcast-long.png)
**Podcasts or audiobooks**
...
![](/static/wear/images/design/media-volume-indicator.png)

Show the indicator only when the RSB or bezel is rotated

![](/static/wear/images/design/media-headphones.png)
...
![](/static/wear/images/design/media-playback-without-previous-song.png)
Playback queue **without** previous songs

![](/static/wear/images/design/media-playback-with-previous-song.png)
Playback queue **with** previous songs
...
![](/static/wear/images/design/media-aod.svg)
...
![](/static/wear/images/design/media-loading.png)
**Loading or Placeholder state**

![](/static/wear/images/design/media-loaded.png)
**Loaded state**

![](/static/wear/images/design/media-loading-2.png)
**Loading or Placeholder state**

![](/static/wear/images/design/media-loaded-2.png)
**Loaded state**
...
![](/static/wear/images/design/media-tile-options.png)
**Selectable media options**

![](/static/wear/images/design/media-tile-playing.png)
**Media playing**