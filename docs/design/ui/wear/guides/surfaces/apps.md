...
url: https://developer.android.com/design/ui/wear/guides/surfaces/apps
source: html-scrape
---
...
![alt text](/static/wear/images/design/apps-overview-focused-updated.png)

**Focused**
Focus on critical tasks to help people get things done within seconds.

![alt text](/static/wear/images/design/apps-overview-shallowlinear.png)

**Shallow and linear**
Avoid creating hierarchies deeper than two levels. Aim to display content and navigation inline when possible.

![alt text](/static/wear/images/design/apps-overview-scrolling.png)
...
![alt text](/static/wear/images/design/apps-overview-fixedheightcontainer.png)

**Variable height containers**

![alt text](/static/wear/images/design/apps-overview-varheightcontainer.png)

**Height and width greater than viewport**

![alt text](/static/wear/images/design/apps-overview-beyondviewport.png)

**Paginated container**

![alt text](/static/wear/images/design/apps-overview-pagedcontainer.png)
...
![alt text](/static/wear/images/design/apps-overview-signin.png)