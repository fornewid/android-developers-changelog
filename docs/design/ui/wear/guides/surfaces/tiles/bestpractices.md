---
title: Best practices for tiles  |  Wear  |  Android Developers
...
# Best practices for tiles Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/wear/images/design/tiles-bestpractices-DOdesignforblack.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTforblack.png)
...
![](/static/wear/images/design/tiles-bestpractices-DOleaveouticon-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTaddicon-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-hidetitle-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTshowapptitle-updated.png)

cancel

### Don't do this

If you do not hide the app title on small screen, and have two rows, the height of the components will not adhere to our accessibility standards, and be less than the minimum tap target size.
In this example the space for the buttons is smaller than 48dp, so it clips.
...
![](/static/wear/images/design/tiles-bestpractices-DOsingleusecase-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTmultipleusecases-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DOusecontainers-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTusenocontainers-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DOmakeactionsclear-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTmakeactionsunclear-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DOvisuallyprioritize-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTmonochrome-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DOsimplecontainers-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTuseextracontainers-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DOfunctionalcontainers-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONToverusecontainers-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DOsimplecharts-updated.png)
...
![](/static/wear/images/design/tiles-bestpractices-DONTdetailedcharts-updated.png)
