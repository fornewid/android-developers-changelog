---
title: Tile (empty) states  |  Wear  |  Android Developers
...
# Tile (empty) states Stay organized with collections Save and categorize content based on your preferences.




![](/static/wear/images/design/tiles-bestpractices-states-hero-updated.png)
...
![alt text](/static/wear/images/design/tiles-bestpractices-states-signin-updated.png)

## Error states

Provide a clear call-to-action to fix potential issues when viewing your Tile data.

![alt text](/static/wear/images/design/tiles-bestpractices-states-error-updated.png)

## Empty states (no data)

Describe what is causing the lack of data and how a user can rectify the issue.

![alt text](/static/wear/images/design/tiles-bestpractices-states-emptynodata-updated.png)
...
![alt text](/static/wear/images/design/tiles-bestpractices-states-emptycontent-updated.png)
...
![alt text](/static/wear/images/design/tiles-bestpractices-states-emptyprogress-updated.png)
