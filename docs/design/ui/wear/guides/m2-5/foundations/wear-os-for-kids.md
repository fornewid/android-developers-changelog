---
title: Design experiences for kids on Wear OS  |  Android Developers
url: https://developer.android.com/design/ui/wear/guides/m2-5/foundations/wear-os-for-kids
source: html-scrape
---
...
# Design experiences for kids on Wear OS Stay organized with collections Save and categorize content based on your preferences.
...
![Examples of apps designed for kids](/static/wear/images/design/wear-os-for-kids-header.png)
...
* **Words and sounds**: The words (text) and sounds are developmentally useful
  and comprehensible.
* **Interaction design**: The app is designed in an intuitive way that makes it
  easy for kids to use and navigate a Wear OS interface.
* **Art and animation**: The art and animation are high-quality and helps a user
  understand the app and/or adds delight.

![Clear directions to swipe left or right within the app](/static/wear/images/design/thoughtfully-designed-do.png)

check\_circle

### Do

* Use vocabulary that your target age group can understand, and leverage audio
  and voiceover where appropriate.
...
* Make sure physical interactions and gestures are easy for kids in the target
  age group to do.
...
![Several buttons and many lines of text](/static/wear/images/design/thoughtfully-designed-dont.png)

cancel

### Don't

* Expect existing phone or tablet-based app experiences to be copy-and-paste
  ready for an experience on Wear OS.
* Rely on large amounts of text or excessive scrolling, especially for younger
  children.
...
* Cause frustration with unresponsive touch targets or non-intuitive placement
  of touch targets.
...
* **Relevant**: Content features topics, information, and activities that are
  relevant, familiar, interesting, and useful.

![Large and engaging pictures of musical instruments](/static/wear/images/design/appealing-do.png)

check\_circle

### Do

* Know your target age, what they like and enjoy, or what is important to
  their daily lives.
...
![A graph of bitcoin prices during the past month](/static/wear/images/design/appealing-dont.png)
...
![A list of moods for children to choose from](/static/wear/images/design/enriching-do.png)
...
* Support developmentally appropriate activities that foster healthy habits
  and promote positive self-image.
* Create positive framing around fitness tracking and goals and provide
  meaningful rewards.

![A tile that shows calories burned and steps taken](/static/wear/images/design/enriching-dont.png)
...
* Utilize manipulative in-game reward strategies, such as events that make a
  child feel like a character in the game will be harmed, disappointed, or
  otherwise upset if the child doesn't complete a given activity or action.