---
title: Canonical adaptive design layouts  |  Wear  |  Android Developers
...
# Canonical adaptive design layouts Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/wear/images/design/canonical-tiles-header.png)
...
![](/static/wear/images/design/canonical-tiles-examples.png)
...
**Note:** While scrolling views need to be constrained mostly in the vertical
direction, non-scrolling views need to be constrained both vertically and
horizontally. This generally makes non-scrolling views more challenging to
build, and more at-risk of broken layouts on devices with larger screen sizes.

### Non-scrolling app layouts

![](/static/wear/images/design/canonical-non-scrolling-header.png)
...
![](/static/wear/images/design/canonical-non-scrolling-examples.png)
...
* Fitness screens can gain additional metrics, and elements could grow in
  size.
...
![](/static/wear/images/design/canonical-scrolling-header.png)
...
![](/static/wear/images/design/canonical-scrolling-examples.png)
