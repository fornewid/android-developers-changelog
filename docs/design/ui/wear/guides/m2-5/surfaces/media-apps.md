---
title: Media apps  |  Wear  |  Android Developers
...
![](/static/wear/images/media-apps/MP_1_Hero.png)
...
Reduce your app hierarchy and expose media for the user. Design with a flat information architecture that allows users to quickly access lists and showcase thumbnails for users. Consider using custom design components for Wear OS. For more information, check out design recommendations for [Chips](https://android.devsite.corp.google.com/design/ui/wear/guides/components/chips) and [Cards](https://android.devsite.corp.google.com/design/ui/wear/guides/components/cards).
...
![](/static/wear/images/media-apps/MP_4_Screens.png)
...
![](/static/wear/images/media-apps/Image-MediaVolume.png)
...
![](/static/wear/images/media-apps/MP_5_DownloadMedia1.png)

When the user browses media, display the most recently downloaded media:

![](/static/wear/images/media-apps/MP_6_DownloadMedia2.png)
...
![](/static/wear/images/media-apps/MP_7_DownloadMedia3.png)
...
![](/static/wear/images/media-apps/MP_8_DownloadMedia4.png)
...
![](/static/wear/images/media-apps/MP_9_DownloadMedia5.png)

For more information, see the [Media Toolkit](https://github.com/google/horologist#-media) on GitHub.

## Adaptive layouts

The larger screen adaptations for media apps are solely focused on the media player experience. All other elements are captured in [Chips](https://android.devsite.corp.google.com/design/ui/wear/guides/components/chips), [Buttons](https://android.devsite.corp.google.com/design/ui/wear/guides/components/buttons), [Dialogs](https://android.devsite.corp.google.com/design/ui/wear/guides/components/dialogs), and [Lists](https://android.devsite.corp.google.com/design/ui/wear/guides/components/lists) pages that describe proper app behavior to accommodate larger screens.

![](/static/wear/images/media-apps/media-adaptive-layouts-usage.png)
...
![](/static/wear/images/media-apps/Mockup_Elements-Button2.png)
![](/static/wear/images/media-apps/Mockup_Elements-Button3.png)

![](/static/wear/images/media-apps/Mockup_Elements-Button2+Icon-Sm.png)
![](/static/wear/images/media-apps/Mockup_Elements-Button2+Icon-Lg.png)

![](/static/wear/images/media-apps/Mockup_Elements-Button1-Sm.png)
![](/static/wear/images/media-apps/Mockup_Elements-Button1-Lg.png)
...
![](/static/wear/images/media-apps/Media-Button-LS.png)
...
![](/static/wear/images/media-apps/Media-Top.png)
...
![](/static/wear/images/media-apps/Media-Top-1.png)
![](/static/wear/images/media-apps/Media-Top-2.png)

![](/static/wear/images/media-apps/Media-Top-3.png)
![](/static/wear/images/media-apps/Media-Top-4.png)
...
![](/static/wear/images/media-apps/Media-Bottom-2-Sm-1.png)
![](/static/wear/images/media-apps/Media-Bottom-2-Sm.png)
![](/static/wear/images/media-apps/Media-Bottom-1-Sm.png)
![](/static/wear/images/media-apps/Media-Bottom-2+Icon-Sm.png)

**Small Wear OS screens (<225dp)**

* Recommended to have maximum 2 buttons on smaller screens
  with 2 buttons on the smallest screen size
* The minimum tap target for the bottom buttons must be
  48dp (H) x 48dp (W)
* Icons should sit in the middle area of the tap target

![](/static/wear/images/media-apps/Media-Bottom-3-Lg.png)
![](/static/wear/images/media-apps/Media-Bottom-2-Lg.png)
![](/static/wear/images/media-apps/Media-Bottom-1-Lg.png)
![](/static/wear/images/media-apps/Media-Bottom-2+Icon-Lg.png)

**Larger Wear OS screens / breakpoint (>225dp)**

* Recommended to have maximum 3 buttons aon larger screens
  with 3 buttons on the smallest of these "larger screens"
* The minimum tap target for the bottom buttons must be
  48dp (H) x 48dp (W)
* Icons should sit in the middle area of the tap target (but have top/bottom
  alignment and internal padding to create a rounded effect)