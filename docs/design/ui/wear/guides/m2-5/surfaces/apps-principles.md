---
title: App design principles  |  Wear  |  Android Developers
...
# App design principles Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/wear/images/surfaces/apps_4.png)
...
![](/static/wear/images/surfaces/apps_5.png)
...
![](/static/wear/images/surfaces/apps_6.png)
...
![](/static/wear/images/surfaces/apps_13.png)
...
![](/static/wear/images/surfaces/apps_3.png)
...
![](/static/wear/images/surfaces/apps_14.png)
...
![](/static/wear/images/surfaces/apps_1.png)
...
![](/static/wear/images/surfaces/apps_10.png)
...
![](/static/wear/images/surfaces/apps_12.png)
...
![](/wear/images/surfaces/apps_1.png%22)

## Content containers

See the following examples of content containers.

![Example of Button row layout](/static/wear/images/surfaces/apps_2.png)

**Figure 1.** Container of fixed height.

![Example of Button column layout](/static/wear/images/surfaces/apps_11.png)

**Figure 2.** Container of variable height.

![Example of Button row layout](/static/wear/images/surfaces/apps_9.png)

**Figure 3.** Container of height and width greater than the viewport.

![Example of Button column layout](/static/wear/images/surfaces/apps_8.png)

**Figure 4.** A paginated container.

![Example of Button row layout](/static/wear/images/surfaces/apps_7.png)

**Figure 5a.** Content pages that take the full dimension of the screen and are
paginated vertically.

**Note:** Users find vertical layouts much easier to navigate than paginated
UI's. Paginated UI's are best for situations when the user needs to navigate
content using gross gestures, such as when working out or on the go. Because of
this, they are generally used in workout and media app UIs.