---
title: Confirmation overlay  |  Wear  |  Android Developers
...
# Confirmation overlay Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/wear/images/confirmation-overlay/Confirmation-overlay-notifications-example.png)

Show a confirmation overlay if a change in action doesn't cause a change in the UI:

![](/static/wear/images/confirmation-overlay/confirmation-overlay-message-message-sent.png)
...
![](/static/wear/images/confirmation-overlay/confirmation-overlay-margins-adaptive-layouts.png)

![](/static/wear/images/confirmation-overlay/confirmation-overlay-margins-adaptive-layouts-2.png)
...
![](/static/wear/images/confirmation-overlay/confirmation-overlay-margins-rigid-line-lenght-guidelines-adaptive-layouts.png)