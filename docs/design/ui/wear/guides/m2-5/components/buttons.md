---
title: Buttons  |  Wear  |  Android Developers
...
![Button anatomy diagram](/static/wear/images/buttons/button-anatomy.png)
...
![Toggle button examples](/static/wear/images/buttons/buttons-related-components-toggle-buttons.png)
...
![Compact buttons example](/static/wear/images/buttons/buttons-related-components-compact-buttons.png)
...
![Button hierarchy diagram](/static/wear/images/buttons/buttons-hierarchy.png)
...
Alternatively, use the custom [OutlinedButton](/reference/kotlin/androidx/wear/compose/material/OutlinedButton.composable#OutlinedButton(kotlin.Function0,androidx.compose.ui.Modifier,kotlin.Boolean,androidx.wear.compose.material.ButtonColors,androidx.compose.foundation.interaction.MutableInteractionSource,androidx.compose.ui.graphics.Shape,androidx.wear.compose.material.ButtonBorder,kotlin.Function1)) component for a medium emphasis button. This has a transparent background, a primary variant colored stroke of 60% opacity, and primary colored content.
...
![Large button diagram](/static/wear/images/buttons/buttons-large.png)
...
![Default button diagram](/static/wear/images/buttons/buttons-default.png)
...
![Small button diagram](/static/wear/images/buttons/buttons-related-sizes-small.png)
...
![Extra small button diagram](/static/wear/images/buttons/buttons-xsmall.png)
...
![](/static/wear/images/buttons/buttons-usage-media-workout.png)
...
![](/static/wear/images/buttons/buttons-usage-alarm-timer.png)

## Adaptive layouts

![](/static/wear/images/buttons/buttons-adaptive-layouts-buttons.png)

### **Responsive behavior**

![One button anatomy diagram](/static/wear/images/buttons/anatomy-large-screen-one-button.png)
...
![Two buttons anatomy diagram](/static/wear/images/buttons/anatomy-large-screen-two-buttons.png)
...
![](/static/wear/images/buttons/buttons-adaptive-layout-IME-buttons.png)

**1 or 2 Buttons**

IMEs with 2 or a single button lockup always stretch all the way to the side margins regardless of screen size.

![](/static/wear/images/buttons/Comparison-three-buttons.png)
