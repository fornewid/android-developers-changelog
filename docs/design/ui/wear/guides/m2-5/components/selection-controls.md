---
title: Selection controls  |  Wear  |  Android Developers
url: https://developer.android.com/design/ui/wear/guides/m2-5/components/selection-controls
source: html-scrape
---
...
# Selection controls Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/wear/images/design/controls_1.png)

**Figure 1.** A checkbox list that allows multiple selections.

![](/static/wear/images/design/controls_3.png)

**Figure 2.** A radio button list that only allows a single selection.

![](/static/wear/images/design/controls_2.png)
