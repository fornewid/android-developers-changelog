...
The [Chip](https://developer.android.com/reference/kotlin/androidx/wear/compose/material/Chip.composable#Chip(kotlin.Function0,androidx.wear.compose.material.ChipColors,androidx.wear.compose.material.ChipBorder,androidx.compose.ui.Modifier,kotlin.Boolean,androidx.compose.foundation.layout.PaddingValues,androidx.compose.ui.graphics.Shape,androidx.compose.foundation.interaction.MutableInteractionSource,androidx.compose.ui.semantics.Role,kotlin.Function1)) component is an interactive element that represents an input, attribute, or action.
...
![](https://developer.android.com/static/wear/images/chips/Colour_Gradient-1.png) **Standard Chip**
...
![](https://developer.android.com/static/wear/images/chips/Colour_Gradient-2.png) **Image Chip**
...
![](https://developer.android.com/static/wear/images/chips/chips-image.png) **Chip with background image**
...
![](https://developer.android.com/static/wear/images/chips/avatar-chip.png) **Avatar Chip**
...
![](https://developer.android.com/static/wear/images/chips/compact-chip.png) **Compact Chip**
...
![](https://developer.android.com/static/wear/images/chips/chips-button-hierarchy.png.png) Use different color fills to denote chip hierarchy. Design each screen to contain a single prominent chip for the primary action.  
...
![](https://developer.android.com/static/wear/images/chips/Default_Chip.png) ![](https://developer.android.com/static/wear/images/chips/chips-compact.png) **Default Chip**
...
![](https://developer.android.com/static/wear/images/chips/chips-fills-width.png) **Responsive behavior**
