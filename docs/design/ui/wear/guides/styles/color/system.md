---
title: Color system  |  Wear  |  Android Developers
...
[](/static/wear/images/design/color-system.mp4)
...
![](/static/wear/images/design/color-hue.png)
...
![](/static/wear/images/design/color-chroma.png)
...
![](/static/wear/images/design/color-tone.png)
...
![Higher seed values represent colors that are closer to white](/static/wear/images/design/color-seed-overview-spectrum.png)


Each Watch face defines two seed colors, used for primary and
tertiary palettes.

![](/static/wear/images/design/color-seed-algorithm.png)


These seeds are put through an algorithm that becomes five tonal
...
![](/static/wear/images/design/color-seed-application.png)


Each design token is then applied to the SysUI, tiles and apps
...
![](/static/wear/images/design/color-palette-seed.png)

Color palette (from Watch face seed colors)

![](/static/wear/images/design/color-theme-seed-tile.png)

Color theme applied to a Tile

![](/static/wear/images/design/color-theme-seed-app.png)
...
![](/static/wear/images/design/color-palette-brand.png)

Color palette (from artwork seed colors)

![](/static/wear/images/design/color-theme-brand-tile.png)

Color theme applied to a Tile

![](/static/wear/images/design/color-theme-brand-app.png)
