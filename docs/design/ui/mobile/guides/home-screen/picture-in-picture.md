---
title: Picture-in-picture  |  Mobile  |  Android Developers
...
# Picture-in-picture Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/images/design/ui/mobile/pip-1-continue-video-experience.png)


**Figure 1:** Your users can continue their video experience
even when not in your app

## Takeaways

* Make sure UI elements are hidden and video playback continues when the
...
![Default PiP controls](/static/images/design/ui/mobile/pip-2-default-controls.png)

Default PiP controls.

![Example of custom PiP controls](/static/images/design/ui/mobile/pip-3-custom-controls.png)
...
* An activity can enter PiP mode when the user taps the home button or swipes up
  ...
  ![](/static/images/design/ui/mobile/pip-4-wayfinding.png)
...
![](/static/images/design/ui/mobile/PiP_defaultControls_fullWidth.png)
...
![](/static/images/design/ui/mobile/pip-6-toggling-between-min-max-size.png)
...
![](/static/images/design/ui/mobile/pip-7-stashed.png)
...
![](/static/images/design/ui/mobile/pip-8-swiping-down.png)
...
[download the video](/static/images/design/ui/mobile/PiP-video-1-before-setAutoEnterEnabled.mp4) and watch it with a video player.
](/static/images/design/ui/mobile/PiP-video-1-before-setAutoEnterEnabled.mp4)
...
Alas, your browser doesn't support HTML5 video. That's OK! You can still
[download the video](/static/images/design/ui/mobile/PiP-video-2-after.mp4) and watch it with a video player.
](/static/images/design/ui/mobile/PiP-video-2-after.mp4)

Polished transition experience with `setAutoEnterEnabled` added to the app.

**Note:** Setting `setAutoEnterEnabled(true)` also disables seamless resizing for
non-video content—for example, maps.
...
Alas, your browser doesn't support HTML5 video. That's OK! You can still
[download the video](/static/images/design/ui/mobile/PiP-video-3-before-sourceRectHint.mp4) and watch it with a video player.
](/static/images/design/ui/mobile/PiP-video-3-before-sourceRectHint.mp4)
**Video 3:** Less polished transition experience when
PiP does not have `sourceRectHint` properly implemented
