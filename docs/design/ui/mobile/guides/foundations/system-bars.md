---
title: Android system bars  |  Mobile  |  Android Developers
...
# Android system bars Stay organized with collections Save and categorize content based on your preferences.



![](/static/images/design/ui/mobile/system-bars-hero.png)
...
![](/static/images/design/ui/mobile/system-bars-image-behind.png)


**Figure 1.** Images behind system bars.

**Note:** System bars and navigation can vary by device manufacturer. Older devices
may have hardware navigation buttons instead of software buttons.
...
* Use [`WindowInsets`](/reference/android/view/WindowInsets) to properly handle system bar intrusions and ensure
  your content is not obscured in your adaptive layouts.
* Use [canonical layouts](/develop/ui/compose/layouts/adaptive/canonical-layouts), which use the screen space efficiently.
...
![](/static/images/design/ui/mobile/system-bars-status-bar-region-highlighted.png)
...
[System bar icons](/develop/ui/compose/system/insets-views-compose#system-bar-icons).

![](/static/images/design/ui/mobile/system-bars-status-bar-light-dark-theme.png)
...
design](/design/ui/mobile/guides/home-screen/notifications).

![](/static/images/design/ui/mobile/system-bars-notification-icon.png)
...
![](/static/images/design/ui/mobile/system-bars-do-and-dont.png)


**Figure 5.** Do go edge-to-edge to enhance your content. Don't
have opaque system bars.
...
![](/static/images/design/ui/mobile/system-bars-gradient-protection.png)
...
![](/static/images/design/ui/mobile/system-bars-gesture-handle.png)
...
For more information, see [Build adaptive navigation](/develop/ui/compose/layouts/adaptive/build-adaptive-navigation).

#### Navigation icons

Navigation icons can also appear differently depending on user-set preferences
or themes. For more information, see [System bar icons](/develop/ui/compose/system/insets-views-compose#system-bar-icons).
...
![](/static/images/design/ui/mobile/system-bars-dynamic-color-adaptation.png)


**Figure 8.** Dynamic color adaptation.

Transparent gesture navigation bars are always recommended.

![](/static/images/design/ui/mobile/system-bars-do.png)
...
![](/static/images/design/ui/mobile/system-bars-dont.png)
...
![](/static/images/design/ui/mobile/system-bars-translucent-scrim.png)


**Figure 9.** Dynamic color adaptation, with a transparent scrim.
...
![](/static/images/design/ui/mobile/system-bars-on-screen-keyboard.png)


**Figure 10.** On-screen keyboard with navigation bars.

Each navigation type reacts appropriately to the [on-screen keyboard](/develop/ui/views/layout/sw-keyboard) to allow
...
[Adaptive layouts](/design/ui/mobile/guides/layout-and-content/adapt-layout) optimize available display space. They organize the app UI
...
For more information, see [Canonical layouts](/develop/ui/compose/layouts/adaptive/canonical-layouts).
...
![](/static/images/design/ui/mobile/system-bars-display-cutouts.png)
...
![](/static/images/design/ui/mobile/system-bars-immersive-mode.png)


**Figure 12.** Immersive mode showing a full-screen experience
on a landscape-oriented mobile device.
...
information, see [Immersive content](/design/ui/mobile/guides/layout-and-content/immersive-content) and [Hide the system bars for immersive
mode](/develop/ui/views/layout/immersive).