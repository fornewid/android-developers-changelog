---
title: Canonical layouts  |  Mobile  |  Android Developers
...
![](/static/images/design/ui/mobile/layout-basics-22-canonical-layouts.png)
...
* **Dynamic content** is content that your app serves on-the-fly, and is ideal for
  showing user-generated content or reflect the user's preference or actions.
  For example, imagine a photo app with a scrollable list of user-generated
  photos, which is unique for each user and changes as the user uploads more
  images. These images are dynamic content.
...
![](/static/images/design/ui/mobile/layout-basics-23-one-dimension-collection.png)
...
![](/static/images/design/ui/mobile/layout-basics-24-feed-layout.png)
...
![](/static/images/design/ui/mobile/layout-basics-25-bottom-sheets.png)


**Figure 24:** Bottom sheets can act as supporting content to
the primary view
