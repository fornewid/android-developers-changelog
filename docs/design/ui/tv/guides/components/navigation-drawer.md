---
title: Navigation drawer  |  TV  |  Android Developers
...
![Cover Navigation Drawer](/static/design/ui/tv/guides/components/images/covers/cover-navigation-drawer.webp)
...
| Implementation | [Jetpack Compose (NavigationDrawer)](/reference/kotlin/androidx/tv/material3/NavigationDrawer.composable#NavigationDrawer(kotlin.Function2,androidx.compose.ui.Modifier,androidx.tv.material3.DrawerState,kotlin.Function0))   [Jetpack Compose (ModalNavigationDrawer)](/reference/kotlin/androidx/tv/material3/ModalNavigationDrawer.composable#ModalNavigationDrawer(kotlin.Function2,androidx.compose.ui.Modifier,androidx.tv.material3.DrawerState,androidx.compose.ui.graphics.Brush,kotlin.Function0)) | Available |
...
1. **Standard navigation drawer** — Expands to
   create additional space for navigation, pushing the page content aside.
2. **Modal navigation drawer** — Appears as an
   overlay on top of the app's content with a scrim that helps to
   improve readability when the drawer is expanded.

![Standard Navigation Drawer](/static/design/ui/tv/guides/components/images/navigation-drawer/standard-navigation-drawer.webp)

![Modal Navigation Drawer](/static/design/ui/tv/guides/components/images/navigation-drawer/modal-navigation-drawer.webp)

## Standard navigation drawer

### Anatomy

![Standard navigation drawer anatomy](/static/design/ui/tv/guides/components/images/navigation-drawer/standard-navigation-drawer-anatomy.webp)

1. **Top section:** Features the app logo. Serves as a button to
   switch profiles or to trigger search action. In the collapsed state,
   only the icon remains visible in the top container.
2. **Navigation item:** Each item in the navigation rail features
   a combination of an icon and text, with only the icon visible
   in the collapsed state.
3. **Navigation rail:** The Navigation Rail is a column that
...
4. **Bottom section:** Can have one to three action buttons,
...
[
](/static/design/ui/tv/guides/components/images/navigation-drawer/standard-navigation-drawer-motion.mp4)

## Modal navigation drawer

### Anatomy

![Modal navigation drawer anatomy](/static/design/ui/tv/guides/components/images/navigation-drawer/modal-navigation-drawer-anatomy.webp)

1. **Top section:** Features the app logo. Serves as a button to switch
...
5. **Bottom section:** Can have one to three action buttons,
   which are ideal for pages like settings, help, or profile.
...
[
](/static/design/ui/tv/guides/components/images/navigation-drawer/modal-navigation-drawer-motion.mp4)
...
![Standard Navigation Drawer](/static/design/ui/tv/guides/components/images/navigation-drawer/gradient-scrim.webp)

Gradient scrim

![Modal Navigation Drawer](/static/design/ui/tv/guides/components/images/navigation-drawer/solid-scrim.webp)

Solid scrim

## Spec

![Spec Width](/static/design/ui/tv/guides/components/images/navigation-drawer/spec-width.webp)

![Spec Padding](/static/design/ui/tv/guides/components/images/navigation-drawer/spec-padding.webp)

![Navigation Item Spec](/static/design/ui/tv/guides/components/images/navigation-drawer/nav-item-spec.webp)
...
![Active indicator](/static/design/ui/tv/guides/components/images/navigation-drawer/modal-drawer-selected.webp)
...
![Dividers (optional)](/static/design/ui/tv/guides/components/images/navigation-drawer/dividers.webp)
...
![Badge Expanded](/static/design/ui/tv/guides/components/images/navigation-drawer/badge-expand.webp)

Badge expanded

![Badge Collapsed](/static/design/ui/tv/guides/components/images/navigation-drawer/badge-collapse.webp)
...
![](/static/design/ui/tv/guides/components/images/navigation-drawer/labels-do.webp)
...
![](/static/design/ui/tv/guides/components/images/navigation-drawer/label-dont.webp)
...
![](/static/design/ui/tv/guides/components/images/navigation-drawer/no-icons.webp)
...
![](/static/design/ui/tv/guides/components/images/navigation-drawer/no-mixing-icons.webp)
...
![](/static/design/ui/tv/guides/components/images/navigation-drawer/navigation-count-do.webp)
...
![](/static/design/ui/tv/guides/components/images/navigation-drawer/navigation-count-dont.webp)
...
Immersive list](/design/ui/tv/guides/components/immersive-list)

[Next

Featured carousel

arrow\_forward](/design/ui/tv/guides/components/featured-carousel)