---
title: Color system  |  TV  |  Android Developers
...
# Color system Stay organized with collections Save and categorize content based on your preferences.
...
* Android TV adheres to Google's Material color guidelines,
  but optimizes for TV.
* Build from dark themes, to create cinematic experiences.
* Use the [Material Theme Builder](https://m3.material.io/theme-builder#/custom)
  to create a theme.
...
![Key Colors](/static/design/ui/tv/guides/styles/images/color-system/five-key-colors.webp)
...
![Color theme generation process](/static/design/ui/tv/guides/styles/images/color-system/color-theme-genertion.webp)
...
![Accent Primary](/static/design/ui/tv/guides/styles/images/color-system/accent-primary.webp)
...
![Accent Secondary](/static/design/ui/tv/guides/styles/images/color-system/accent-secondary.webp)
...
**Note:** The tertiary color role is left for makers to use at their discretion
and is intended to support broader color expression in products.

![Accent tertiary](/static/design/ui/tv/guides/styles/images/color-system/accent-tertiary.webp)
...
![Surfaces](/static/design/ui/tv/guides/styles/images/color-system/surfaces.webp)
...
![Outline](/static/design/ui/tv/guides/styles/images/color-system/outline.webp)
...
![Dynamic Color](/static/design/ui/tv/guides/styles/images/color-system/dynamic-color.webp)
...
![Dynamic color application example](/static/design/ui/tv/guides/styles/images/color-system/example.webp)
...
TV app icon guidelines](/design/ui/tv/guides/system/tv-app-icon-guidelines)

[Next

Typography

arrow\_forward](/design/ui/tv/guides/styles/typography)