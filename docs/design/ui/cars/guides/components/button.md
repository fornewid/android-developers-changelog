...
- Keep labels short to avoid truncation -- especially on the
  [Navigation template](https://developer.android.com/design/ui/cars/guides/templates/navigation-template), where space is limited.

![Examples](https://developer.android.com/static/images/design/ui/cars/components/button-3.png) Example of a button design

### Primary buttons

In the [Message](https://developer.android.com/design/ui/cars/guides/templates/message-template), [Long Message](https://developer.android.com/design/ui/cars/guides/templates/long-message-template), and
[Pane](https://developer.android.com/design/ui/cars/guides/templates/pane-template) templates, which feature
