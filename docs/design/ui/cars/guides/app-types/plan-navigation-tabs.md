---
title: Plan navigation tabs  |  Cars  |  Android Developers
...
# Plan navigation tabs Stay organized with collections Save and categorize content based on your preferences.
...
Most cars have already established the structure and visual display of app bars.
To create tabs in a templated media app, see
[Using SectionedItemTemplate inside a TabTemplate](/training/cars/apps/media#sectioned-tab).
...
**Note:** Top-level content categories are browsable media items that are the
children of the root media item in your content hierarchy. Google provides icons
and labels as resources associated with these browsable media items. For
details, consult [Build your content hierarchy](/training/cars/media/create-media-browser/content-hierarchy).

![Navigation tabs example](/static/images/design/ui/cars/app-cuj/navigation-fig-1.png)
...
**Note:** Be sure to allow car makers to use labels without icons when both won't
fit.