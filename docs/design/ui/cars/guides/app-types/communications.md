---
title: Communication apps  |  Cars  |  Android Developers
...
# Communication apps Stay organized with collections Save and categorize content based on your preferences.
...
Library, [communication apps](/training/cars/communication) provide a variety of
ways to help drivers stay connected while focusing on the road.

![Communication apps](/static/images/design/ui/cars/app-cuj/communications.png)


Example of communication apps in Android Auto.
...
[CallsManager APIs](/reference/androidx/core/telecom/CallsManager).
...
* **App icon:** Supply an app icon that will be easy for users to identify at
  a small size, in a badge on a notification.
* **Message ordering:** Make sure your app's messages are appropriately
  grouped and sequentially ordered.

See
[Extend messaging notifications to Android Auto](/training/cars/communication/notification-messaging)
to learn more.
