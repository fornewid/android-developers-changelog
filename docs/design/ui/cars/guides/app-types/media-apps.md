...
Safety is key for any app that will be used while driving. Media experiences for
...
Media templates provide guardrails to help you customize key components of your
app while relying on Google's auto industry expertise for the design foundations
and safety considerations.

If you use templates to create your app, you can customize the browsing
structure to suit your needs. Optional extra steps for templated apps include
