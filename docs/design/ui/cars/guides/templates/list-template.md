---
title: List template  |  Cars  |  Android Developers
...
# List template Stay organized with collections Save and categorize content based on your preferences.
...
* Use [Rows](/design/ui/cars/guides/components/row#row-items) as switches or radio buttons.

You can also provide tabbed navigation by embedding lists on the
[Tab template](/design/ui/cars/guides/templates/tab-template) and show a list on a map using the
[Map + Content template](/design/ui/cars/guides/templates/map-content-template).

![](/static/images/design/ui/cars/templates/list-template-1.png)


List template


![](/static/images/design/ui/cars/templates/list-template-5.png)


List template with sections


![](/static/images/design/ui/cars/templates/list-template-2.png)


List template in a map

Includes:

* Optional [header](/design/ui/cars/guides/components/header): When this template is embedded in the
  [Tab template](/design/ui/cars/guides/templates/tab-template), the header is replaced with tabs.
* List items (where the number of items and the amount of text in a row can
  vary):
  + **Number of list items.** The number of items allowed to be shown
    ...
    vehicle, use the [ConstraintManager API](/training/cars/apps#constraint-manager).
  + **Amount of text per item.** Secondary text in list rows can be longer
    than 2 rows when parked. See [More list text while parked](/design/ui/cars/guides/templates/list-template#parked).
* Optional [floating action button](/design/ui/cars/guides/components/fab)

To learn more about what you can do with rows in the List template, see
[Row options for List template only](/design/ui/cars/guides/components/row#row-options) and the examples in [Sample flows](/design/ui/cars/guides/flows/overview).
...
truncated to 2 lines while driving. Any text intended to be read while
driving should be displayed at the beginning of the secondary text.

![](/static/images/design/ui/cars/templates/list-template-3.png)


Driving


![](/static/images/design/ui/cars/templates/list-template-4.png)
