---
title: Plan voice actions  |  Cars  |  Android Developers
...
# Plan voice actions Stay organized with collections Save and categorize content based on your preferences.
...
talking to Google Assistant, so they can keep their eyes on the road.
...
or onscreen affordance. Once invoked, Google Assistant can
...
**Note:** For details about how to build support for voice actions into your app,
consult Support voice actions and Google Assistant and media apps.
