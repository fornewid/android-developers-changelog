---
title: Define user tasks  |  Cars  |  Android Developers
...
# Define user tasks Stay organized with collections Save and categorize content based on your preferences.
...
* **Minimize attention needed for tasks**:
  ...
  [keeping task flows short](/design/ui/cars/guides/ux-requirements/plan-task-flows#short).
...
* **Minimize user input**: When possible, present
  ...
  [voice input](/design/ui/cars/guides/components/plan-communications) while driving.
...
be throttled to minimize distraction. For details, see [What is a refresh?](/design/ui/cars/guides/ux-requirements/plan-task-flows#refresh)