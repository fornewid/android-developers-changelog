---
title: Onboarding  |  AI Glasses  |  Android Developers
...
# Onboarding Stay organized with collections Save and categorize content based on your preferences.
...
onboarding](/design/ui/mobile/guides/patterns/onboarding).
...
![Examples of just in time onboarding](/static/images/design/ui/glasses/guides/onboarding_in-app.png)
...
![Caution adding to the onboarding flow](/static/images/design/ui/glasses/guides/onboarding_upfront_caution.webp)

**Caution:** Adding too many steps to an onboarding process might deter users from
...
![](/static/images/design/ui/glasses/guides/onboarding_on-glasses_do.png)
...
![](/static/images/design/ui/glasses/guides/onboarding_on-glasses_dont.png)
...
![Condensed onboarding flow for mobile to glasses](/static/images/design/ui/glasses/guides/onboarding_flow_mobile-first.webp)

For more on [permissions](/design/ui/ai-glasses/guides/interaction/permissions).

**Note:** If a user installs an app from a glasses intent, through
sharing or from the Google Play Store, deeplink into a glasses flow. For
example, once the app finishes downloading and the user grants permissions,
prompt glasses feature discovery and education.
...
![Onboarding flow from glasses](/static/images/design/ui/glasses/guides/onboarding_flow_glasses-to-mobile-first.png)
...
![Onboarding flow on glasses](/static/images/design/ui/glasses/guides/onboarding_flow_glasses-edu.png)
...
![Interstitial user education](/static/images/design/ui/glasses/guides/onboarding_edu_context.png)
...
* If using the camera or microphone, remind users about this use, and explain
  ...
  ![](/static/images/design/ui/glasses/guides/onboarding_edu_guess.png)
...
![User education example](/static/images/design/ui/glasses/guides/onboarding_discovery.png)
...
education motion assets After Effects file](/design/ui/ai-glasses/guides/interaction/Glasses_userEdu_motion.aep)** for customizing and
...
file](/design/ui/ai-glasses/guides/interaction/Glasses_userEdu_motion.aep), when open:
...
![After effects menu color picker](/static/images/design/ui/glasses/guides/glasses_onboarding_AE.png)
...
* If a user hasn't granted permissions, or they were previously denied, alert
  the user and deep link to settings where they can request them.
* Consider including links to help & support to relearn or better understand
  using their glasses features.

## Components & Patterns

Include user education within the Glasses activity using Jetpack Compose Glimmer
components, [earcons](/design/ui/ai-glasses/guides/interaction/earcons), and [audio queues](/design/ui/ai-glasses/guides/interaction/audio-input).

* Onboarding on glasses should follow audio focus states.
* For visual elements, consider using gesture hints, [buttons](/design/ui/ai-glasses/guides/components/buttons), and
  [cards](/design/ui/ai-glasses/guides/components/cards).
* Read about common layouts and components for [mobile onboarding](/design/ui/mobile/guides/patterns/onboarding).
* Onboarding on glasses should follow audio focus states.
* For visual elements, consider using gesture hints, [buttons](/design/ui/ai-glasses/guides/components/buttons), and
  [cards](/design/ui/ai-glasses/guides/components/cards).
* Read about common layouts and components for [mobile onboarding](/design/ui/mobile/guides/patterns/onboarding).
...
Earcons](/design/ui/ai-glasses/guides/interaction/earcons)

[Next

Overview

arrow\_forward](/design/ui/ai-glasses/guides/styles/overview)