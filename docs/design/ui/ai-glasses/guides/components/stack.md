...
frame.](https://developer.android.com/static/images/design/ui/glasses/guides/glasses_components_stacks.png)
...
e](https://developer.android.com/static/images/design/ui/glasses/guides/glasses_components_stack_use_traversal.png)

Stacks can traversed one item at a time.

Upon touch input, stacks are able to present one item at a time by moving
vertically, and become lists to show more than one element
at a time. The list should use default containers and focus states.

![Design elements should be anchored to the bottom of the
frame.](https://developer.android.com/static/images/design/ui/glasses/guides/glasses_components_stack_use_depth.png)
...
Swiping past the start or end of a stack shows the standard stretch animation,
reinforcing the beginning or end of a stack.

![Design elements should be anchored to the bottom of the
frame.](https://developer.android.com/static/images/design/ui/glasses/guides/glasses_components_stack_anatomy.png)
...
![](https://developer.android.com/static/images/design/ui/glasses/guides/glasses_components_stack_opacity_do.png)

### Do

Retain opacity of UI elements as they scroll to reduce visual noise. ![](https://developer.android.com/static/images/design/ui/glasses/guides/glasses_components_stack_opacity_dont.png)

### Don't

Adjust opacity on stack items on scroll.