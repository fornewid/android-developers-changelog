...
The [full guide for receiving messages reliably](https://developer.android.com/social-and-messaging/guides/communication/receiving-messages) includes detail on how to
...
your app to include [media capture](https://developer.android.com/media/camera/camerax) and [playback](https://developer.android.com/media/media3/exoplayer). Other ways to help
