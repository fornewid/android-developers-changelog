---
title: Take your messaging to the next level — basic, better, and best  |  Android social  |  Android Developers
...
# Take your messaging to the next level — basic, better, and best Stay organized with collections Save and categorize content based on your preferences.
...
* **Notifications**
  ...
  + [Wait to show the notification permission](/develop/ui/views/notifications/notification-permission#wait-to-show-prompt) until the user is familiar
    with your app. Trigger the permission from a user action if possible.
  ...
  + Make thoughtful use of [notification channels](/develop/ui/views/notifications/channels), potentially including
    custom [importance level](/develop/ui/views/notifications/channels#importance) and notification behaviors for notification
    channels.
  + Support [conversation notifications](/develop/ui/views/notifications/conversations#api-notifications) with [long-lived shortcuts](/develop/ui/views/notifications/conversations#api-shortcuts) so
    users can add people and group shortcuts to their homescreens.
