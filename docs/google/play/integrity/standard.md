...
/// Check for https://developer.android.com/reference/native/play/core/group/integrity.
StandardIntegrityErrorCode error_code =
...
[INTEGRITY_TOKEN_PROVIDER_INVALID](https://developer.android.com/google/play/integrity/error-codes#iErr_19)
...
2. On your app's server, fetch the access token from your service account
   ...
   > Library](https://developers.google.com/api-client-library), which is available in many programming languages, [including
