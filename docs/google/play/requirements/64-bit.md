...
7. If you already see both libraries being packaged, you can skip ahead to [testing your app on 64-bit hardware](https://developer.android.com/google/play/requirements/64-bit#test-64-bit-hardware).
...
You can choose to [return to the latest public build](https://developer.android.com/google/play/requirements/64-bit#public) at any time.
