---
title: Play Install Referrer API  |  Other Play guides  |  Android Developers
...
# Play Install Referrer API Stay organized with collections Save and categorize content based on your preferences.
