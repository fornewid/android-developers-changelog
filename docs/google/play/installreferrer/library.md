---
title: Play Install Referrer Library  |  Other Play guides  |  Android Developers
...
# Play Install Referrer Library Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** If you are developing your app using a language other than the Kotlin
programming language or the Java programming language, you can interact directly
with the AIDL file by using the [Play Install Referrer
...
1. Call the
   [`newBuilder()`](/reference/com/android/installreferrer/api/InstallReferrerClient#newBuilder(android.content.Context))
