---
title: App Licensing  |  Other Play guides  |  Android Developers
...
# App Licensing Stay organized with collections Save and categorize content based on your preferences.
...
**[Licensing Overview](/google/play/licensing/overview)**
:   Describes how the service works and what a typical licensing implementation looks
    like.

**[Setting Up for Licensing](/google/play/licensing/setting-up)**
...
**[Adding Server-Side License Verification to Your App](/google/play/licensing/server-side-verification)**
:   Provides a step-by-step guide to add server-side licensing verification to your application.

**[Licensing Reference](/google/play/licensing/licensing-reference)**
