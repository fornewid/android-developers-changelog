---
title: Migrate to Google Play Billing Library 7 from versions 5 or 6  |  Android Developers
...
# Migrate to Google Play Billing Library 7 from versions 5 or 6 Stay organized with collections Save and categorize content based on your preferences.
...
* Update `setReplaceProrationMode` to
  [`setSubscriptionReplacementMode`](/reference/com/android/billingclient/api/BillingFlowParams.SubscriptionUpdateParams.Builder#setSubscriptionReplacementMode).
* Update `setReplaceSkusProrationMode` to
  [`setSubscriptionReplacementMode`](/reference/com/android/billingclient/api/BillingFlowParams.SubscriptionUpdateParams.Builder#setSubscriptionReplacementMode).
