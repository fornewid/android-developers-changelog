...
[`queryPurchasesAsync(QueryPurchaseParams, PurchasesResponseListener)`](https://developer.android.com/reference/com/android/billingclient/api/BillingClient#queryPurchasesAsync(com.android.billingclient.api.QueryPurchasesParams,com.android.billingclient.api.PurchasesResponseListener)).

See the [Processing Purchases](https://developer.android.com/google/play/billing/integrate#process) section of our integration
guide
for more details.
