...
![Lifecycle states and transition events for one-time purchases.](https://developer.android.com/static/images/google/play/billing/lifecycle/one-time-states.svg) **Figure 1** Lifecycle states and transition events for one-time purchases.
...
- Setup [`Real-time developer notifications`](https://developer.android.com/google/play/billing/getting-ready#enable-rtdn "Real-time developer notifications") and enable `Get all notifications for subscriptions and one-time products` to receive updates on the status of purchases.
