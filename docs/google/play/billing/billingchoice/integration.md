...
![The billing choice flow showing the sequence of API calls and user interactions for the four integration scenarios.](https://developer.android.com/static/images/google/play/billing/billingchoice/billing-choice-3.png)
...
4. Call [`launchBillingFlow`](https://developer.android.com/reference/com/android/billingclient/api/BillingClient#launchBillingFlow(android.app.Activity,com.android.billingclient.api.BillingFlowParams)) to trigger the purchase flow when the user
   ...
   1. Pass [`DeveloperBillingOptionParams`](https://developer.android.com/reference/com/android/billingclient/api/DeveloperBillingOptionParams) to [`BillingFlowParams`](https://developer.android.com/reference/com/android/billingclient/api/BillingFlowParams).
