...
> SDK Manager](https://developer.android.com/studio/intro/update#sdk-manager). The SDK Manager installs R8 retrace in
...
[Decode an obfuscated stack trace](https://developer.android.com/studio/build/shrink-code#decode-stack-trace).