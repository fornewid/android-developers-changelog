...
The `avdmanager` tool is deprecated. Instead, use the Android CLI [`android emulator`](https://developer.android.com/tools/agents/android-cli) command to create AVDs.

    android emulator [create|remove]

<br />

If you're using Android Studio, then you don't need to use this tool and you
can instead
[create and manage AVDs from the IDE](https://developer.android.com/studio/run/managing-avds).
