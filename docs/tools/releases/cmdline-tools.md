...
Alternatively, you can [download the latest stable version](https://developer.android.com/studio#command-tools)
directly.
...
[set your update channel](https://developer.android.com/studio/preview/install-preview#change_your_update_channel)
...
Updated in December 2020. Adds the [`retrace`](https://developer.android.com/studio/command-line/retrace)
tool.
