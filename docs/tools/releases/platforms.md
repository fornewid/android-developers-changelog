---
title: SDK Platform release notes  |  Android Studio  |  Android Developers
...
# SDK Platform release notes Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/studio/images/intro/sdk-manager-platforms_2x.png)
...
* Several **System Image** packages. At least one of these is required to run
  that version on the [Android Emulator](/studio/run/emulator).
  ...
  variations to match your computer's processor architecture (such as x86\_64
...
**Important:** To see the most recent Android system components in the Android SDK
Manager, you must first install the most recent [Android SDK Command-Line
tools](/studio#command-line-tools-only) package.

## Android 16 (API level 36)

For details about the platform changes, see the [Android 16 documentation](/about/versions/16).
...
For details about the platform changes, see the [Android 15 documentation](/about/versions/15).
...
For details about the platform changes, see the [Android 14 documentation](/about/versions/14).
...
For details about the platform changes, see the [Android 13 documentation](/about/versions/13).
...
:   For details about the platform changes, see
    the [12L documentation](/about/versions/12/12L).
...
:   For details about the platform changes, see the
    [Android 12 documentation](/about/versions/12).
...
:   This Automated Test Device (ATD) image is an
    ...
    * Disabling hardware renderer drawing.
    ...
    Test Devices](/studio/test/gradle-managed-devices#gmd-atd).

## Android 11 (API level 30)

For details about the platform changes, see the [Android 11 documentation](/about/versions/11).
...
For details about the platform changes, see [Android 10 for Developers](/about/versions/10/highlights).
...
For details about the platform changes, see [Android 9 for developers](/about/versions/pie/android-9.0).
...
For details about the platform changes, see [Android 8.1 for developers](/about/versions/oreo/android-8.1).
...
For details about the platform changes, see [Android 8.0 for developers](/about/versions/oreo/android-8.0).
...
For details about the platform changes, see [Android 7.1 for developers](/about/versions/nougat/android-7.1).
...
[Android 7.1 API Overview](/about/versions/nougat/android-7.1).
...
For details about the platform changes, see [Android 7.0 for developers](/about/versions/nougat/android-7.0).

#### Revision 1 (August 2016)

Initial release for Android 7.0 (API level 24). For more information, see
the [Android 7.0 API Overview](/about/versions/nougat/android-7.0).
...
For details about the platform changes, see the [Android 6.0 changes](/about/versions/marshmallow/android-6.0-changes) and
[Android 6.0 APIs](/about/versions/marshmallow/android-6.0).
...
the [Android 6.0 API Overview](/about/versions/marshmallow/android-6.0).
...
For details about the platform changes, see the [Lollipop overview](/about/versions/lollipop) and
[Android 5.1 API changes](/about/versions/lollipop/android-5.1).

#### Revision 1 (March 2015)

Initial release for Android 5.1 (API level 22). For more information, see
the [Android 5.1 API Overview](/about/versions/lollipop/android-5.1).
...
For details about the platform changes, see the [Lollipop overview](/about/versions/lollipop) and
[Android 5.0 API changes](/about/versions/lollipop/android-5.0).
...
the [Android 5.0 API Overview](/about/versions/lollipop/android-5.0).
...
For details about the platform changes, see the [KitKat overview](/about/versions/kitkat) and
[Android 4.4 API changes](/about/versions/kitkat/android-4.4).

#### Revision 2 (December 2013)

Maintenance release. The system version is 4.4.2. For more information,
see the [Android 4.4 API Overview](/about/versions/kitkat/android-4.4).
...
[Android 4.4 API Overview](/about/versions/kitkat/android-4.4).
...
For details about the platform changes, see the [Jelly Bean overview](/about/versions/jelly-bean) and
[Android 4.3 API changes](/about/versions/android-4.3).
...
For details about the platform changes, see the [Jelly Bean overview](/about/versions/jelly-bean) and
[Android 4.2 API changes](/about/versions/android-4.2).
...
For details about the platform changes, see the [Jelly Bean overview](/about/versions/jelly-bean) and
[Android 4.1 API changes](/about/versions/android-4.1).
...
Dependencies:
:   Requires [SDK Tools r12](/studio/releases/sdk-tools) or
    higher.
...
Dependencies:
:   Requires [SDK Tools r11](/studio/releases/sdk-tools) or
    higher.
...
Dependencies:
:   Requires [SDK Tools r10](/studio/releases/sdk-tools) or
    higher.
