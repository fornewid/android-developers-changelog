...
packages, and update packages. For more information, see the following sections.
...
You must accept the necessary license for each package you have installed.
This step occurs during the installation flow when you install packages from
within Android Studio.

If you don't have Android Studio installed, or it's for a CI server or other
