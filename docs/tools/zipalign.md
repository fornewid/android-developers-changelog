---
title: zipalign  |  Android Studio  |  Android Developers
...
# zipalign Stay organized with collections Save and categorize content based on your preferences.
...
`mmap(2)`, removing the need to copy this data in RAM and reducing your app's memory usage.
...
| -P <pagesize\_kb> | aligns uncompressed `.so` files to the specified page size in KiB. Valid options for `<pagesize_kb>` are 4, 16, and 64. |
