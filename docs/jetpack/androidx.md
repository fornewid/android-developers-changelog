...
[Gradle](https://gradle.org/) build tool with
[Android Gradle plugin](/build/releases/gradle-plugin) and don't test or
maintain compatibility with any other build configuration.
