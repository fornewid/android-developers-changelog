---
title: Test  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.test.core.app](/reference/kotlin/androidx/test/core/app/package-summary)  
[androidx.test.espresso](/reference/kotlin/androidx/test/espresso/package-summary)
...
| --- | --- | --- | --- | --- |
| annotation | [1.0.1](/jetpack/androidx/releases/test#annotation-1.0.1) | - | - | [1.1.0-alpha04](/jetpack/androidx/releases/test#annotation-1.1.0-alpha04) || core | [1.7.0](/jetpack/androidx/releases/test#core-1.7.0) | [1.7.0-rc01](/jetpack/androidx/releases/test#core-1.7.0-rc01) | - | - || espresso | [3.7.0](/jetpack/androidx/releases/test#espresso-3.7.0) | [3.7.0-rc01](/jetpack/androidx/releases/test#espresso-3.7.0-rc01) | - | - || espresso-device | [1.1.0](/jetpack/androidx/releases/test#espresso-device-1.1.0) | [1.1.0-rc01](/jetpack/androidx/releases/test#espresso-device-1.1.0-rc01) | - | - || ext.junit | [1.3.0](/jetpack/androidx/releases/test#ext.junit-1.3.0) | [1.3.0-rc01](/jetpack/androidx/releases/test#ext.junit-1.3.0-rc01) | - | - || ext:junit-gtest | - | - | - | [1.0.0-alpha01](/jetpack/androidx/releases/test#ext:junit-gtest-1.0.0-alpha01) || ext.truth | [1.7.0](/jetpack/androidx/releases/test#ext.truth-1.7.0) | [1.7.0-rc01](/jetpack/androidx/releases/test#ext.truth-1.7.0-rc01) | - | - || monitor | [1.8.0](/jetpack/androidx/releases/test#monitor-1.8.0) | - | - | [1.9.0-alpha01](/jetpack/androidx/releases/test#monitor-1.9.0-alpha01) || orchestrator | [1.6.1](/jetpack/androidx/releases/test#orchestrator-1.6.1) | [1.6.0-rc01](/jetpack/androidx/releases/test#orchestrator-1.6.0-rc01) | - | - || runner | [1.7.0](/jetpack/androidx/releases/test#runner-1.7.0) | [1.7.0-rc01](/jetpack/androidx/releases/test#runner-1.7.0-rc01) | - | - || rules | [1.7.0](/jetpack/androidx/releases/test#rules-1.7.0) | [1.7.0-rc01](/jetpack/androidx/releases/test#rules-1.7.0-rc01) | - | - || services | [1.6.0](/jetpack/androidx/releases/test#services-1.6.0) | [1.6.0-rc01](/jetpack/androidx/releases/test#services-1.6.0-rc01) | - | - |

This library was last updated on: January 14, 2026
**Note:** This page includes release notes for Test components that shipped in
the AndroidX library. For earlier updates that appeared in the support library
see the [archive page](/jetpack/androidx/releases/archive/test).
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:192735%20status:open)
...
* Update bazel toolchain:
  + bazel version 7.5.0
  + rules\_jvm\_external 6.7
  + rules\_java 8.6.3
  + rules\_kotlin 2.1.3
  + rules\_android 0.6.3
...
* Add new lower level screenshot APIs View.captureToBitmap, WindowCapture.captureToBitmap,
  Bitmap.writeToTestStorage and DeviceCapture.takeScreenshot screenshots.
...
* Add new experimental APIs for screenshots. These APIs will automatically
  select the highest fidelity for taking screenshots based on platform API level,
  and support the Automated Test Device (ATD) emulator images.
...
* Add ActivityScenario#launchActivityForResult API and modify
  ActivityScenario#launch to remove use of Bootstrap Activity API.
  This change should improve performance and stability of ActivityScenario#launch.
  ActivityScenario#getResult will now enforce that it can only be used with
  ActivityScenario#launchActivityForResult

**Bug fixes**

* Fix ActivityScenario#launch when targeting and running on Android 33
* Use elapsedRealtime instead of currentTimeMillis to track ActivityScenario
  timeouts.
...
* Modify ActivityScenario#launch to remove use of Bootstrap Activity API.
  This change should improve performance and stability of ActivityScenario#launch.
  ActivityScenario#getResult will now enforce that it can only be used with
  ActivityScenario#launchActivityForResult
...
* Add ActivityScenario#launchActivityForResult API. This API will replace use
  of ActivityScenario#launch when retrieving activity results.
...
* Fix deadlock in espresso in Robolectric INSTRUMENTATION\_TEST + paused looper.
...
* Mark generated IInteractionExecutionStatus class as RestrictTo LIBRARY\_GROUP
...
* Reference doc cleanup: Correct parameter names and remove obsolete 'beta'
  statements from IdlingThreadPoolExecutor and UriIdlingResource

**Dependency changes**

* Update to androidx.test:monitor:1.6.1 to supporting saving screenshots on
  espresso test failures without test storage
...
* Adjust reference docs to state set up guide is now located at https://developer.android.com/studio/test/espresso-api#set\_up\_your\_project\_for\_the\_espresso\_device\_api
...
* monitor has a dependency on androidx.tracing:1.1.0. Depending on configuration,
  gradle may downgrade this to 1.0.0 at runtime causing
  'No static method forceEnableAppTracing' errors. As a workaround, add an explicit
  'implementation androidx.tracing:1.1.0' dependency.
...
* Fix the default implementation of PlatformTestStorage. This will enable
  espresso to save screenshots on test failures when androidx.test.services is not
  configured
...
* Major release toolchain update. APK is now signed with a different key
  and you will need to uninstal any previous orchestrator ('adb uninstall androidx.test.orchestrator')
...
* Mark androidx.test.services.\*\* as RestrictTo LIBRARY\_GROUP
* Add CustomFilter API
* Add PackagePrefixClasspathSuite API
* Mark PermissionRequester as RestrictTo LIBRARY\_GROUP instead of ExperimentalTestApi
* minSdkVersion is now 19
...
* Force initialization of instrumentationRunListener, to prevent NPEs when instrumenting
  system server process.
* Attempt to avoid outputting a test result summary which exceeds binder transaction limit.
* Wait up to 2 seconds for activity finisher to run, to prevent situations
  where it finishes activities mid-test
...
* Denote the long standing @Beta/@ExperimentalTestApi androidx.test.runner.screenshot as stable
  but deprecated (in favor of new androidx.test.core/espresso screenshot APIs)
...
* Promote long standing @Beta/@ExperimentalTestApi GrantPermissionRule and ServiceTestRule
  as stable APIs
* Promote long standing @Beta/@ExperimentalTestApi AtraceLogger and ProviderTestRule
  as stable but deprecated APIs
...
* Adding a LocalSocket-based protocol for the ShellExecutor to talk to the
  ...
  (e.g. by the low memory killer) between the start of the app\_process that
...
* Major release toolchain update:
  + classes are now compiled to java8 bytecode
  + javac compiler switched to OpenJDK 17.
  + APK is now signed with a different key
    and you will need to uninstall any previous APK ('adb uninstall androidx.test.services')
...
* Major release toolchain update:
  ...
  + javac compiler switched to OpenJDK 11.
  + APK is now signed with a different key
    and you will need to uninstal any previous orchestrator ('adb uninstall androidx.test.services')
...
* Improve documentation for -e timeout\_msec and AndroidJUnit4.
...
* Add QUERY\_ALL\_PACKAGES permission to the Android Test Orchestrator and Android Test Services APK to work properly on Android API R+.
* Add support for classpath scanning test discovery for multidex instrumentation apks on android APIs < 21.
...
* Set correct meta state for ACTION\_UP
* Fix missing missing androidx\_test\_espresso\_contrib\_drawer\_layout\_tag field [#671]
...
* Runner 1.2.0-alpha03
  + Add a tests\_regex AJUR option to run tests matching a given regular expression.
* Rules 1.2.0-alpha03
* Truth 1.2.0-alpha03
