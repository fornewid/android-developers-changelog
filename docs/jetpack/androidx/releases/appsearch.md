...
[User Guide](https://developer.android.com/guide/topics/search/appsearch) [Code Sample](https://github.com/android/search-samples/tree/main/AppSearchSample) AppSearch is an on-device search library for managing locally stored structured data, with APIs for indexing data and retrieving data using full-text search. Use it to build custom in-app search capabilities for your users.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
|---|---|---|---|---|
| August 26, 2026 | [1.1.0](https://developer.android.com/jetpack/androidx/releases/appsearch#1.1.0) | - | - | [1.2.0-alpha02](https://developer.android.com/jetpack/androidx/releases/appsearch#1.2.0-alpha02) |

## Declaring dependencies

To add a dependency on AppSearch, you must add the Google Maven repository to your
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1012737+status:open)
...
`androidx.appsearch:appsearch-*:1.2.0-alpha02` is released. Version 1.2.0-alpha02 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/1abcb4178d48853948b9b566cabff9222d90ab69..f7a145855e4766e37411cde8f059c83a8f42d365/appsearch).

**API Changes**

- Make `SearchSpec.Builder#addFilterDocumentIds` and related methods non-experimental ([I28986](https://android-review.googlesource.com/#/q/I28986c6c2e278f2042afb31a863c04a381b1786a), [b/540346408](https://issuetracker.google.com/issues/540346408))
- Additional refactoring to make AppSearch TakenAction classes extendable ([Ibb625](https://android-review.googlesource.com/#/q/Ibb6253153e21299840f3737fc0ac2ea6b2ff58d5), [b/521419188](https://issuetracker.google.com/issues/521419188))
- Observer callbacks added to `ReadOnlyGlobalSearchSession` which adds the API to `EnterpriseGlobalSearchSession` in preparation for support in future SDKs ([I0db22](https://android-review.googlesource.com/#/q/I0db226d5c296d1cfdcf1c6171fd820652213b313), [b/454623046](https://issuetracker.google.com/issues/454623046), [b/422241546](https://issuetracker.google.com/issues/422241546))
- Refactors `AppSearch` `TakenAction` and Built-in types to be extendable outside of Jetpack ([Icfa9b](https://android-review.googlesource.com/#/q/Icfa9b7af4142d3879796f5246c03562cb0f61d03), [b/372929164](https://issuetracker.google.com/issues/372929164))
- Added APIs to support direct loading of int8 quantized embeddings in `EmbeddingVector`. ([I0be71](https://android-review.googlesource.com/#/q/I0be711d08847def8fb6fb50933a44d75d50dc314), [b/390450012](https://issuetracker.google.com/issues/390450012))
- Introduce ANN APIs for embedding search ([I86e6b](https://android-review.googlesource.com/#/q/I86e6b77f5933fb2305d14cc4e10772cff016c24c), [b/448886757](https://issuetracker.google.com/issues/448886757))

**Bug Fixes**

- Fixes a bug where setSchema with migrators ignored the forceOverride parameter ([Id3c4f](https://android-review.googlesource.com/#/q/Id3c4f8c134a113c53f18159b2aa5ceb0fabd113c), [b/384981085](https://issuetracker.google.com/issues/384981085))

### Version 1.2.0-alpha01

March 25, 2026

`androidx.appsearch:appsearch-*:1.2.0-alpha01` is released. Version 1.2.0-alpha01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/1ba9efeef17e71a00ddd145f3d0c5c2de2544c2c..1abcb4178d48853948b9b566cabff9222d90ab69/appsearch).

**API Changes**

- Disable and hide delete propagation API ([Ia4073](https://android-review.googlesource.com/#/q/Ia4073aafe8fb73b3f95246ec03c8eb5cb2b58819), [b/384947619](https://issuetracker.google.com/issues/384947619))
- Change `setSchemaTypeWipeoutAccountPropertyPaths` to take set. ([If442c](https://android-review.googlesource.com/#/q/If442cb14a8acbfc181172680d2ba3924da292dd1), [b/470398298](https://issuetracker.google.com/issues/470398298))
- Support visibility for `Process#isPccUid` ([I2ee69](https://android-review.googlesource.com/#/q/I2ee69f41949793c483d19754812313e1bb7eaefc), [b/463863587](https://issuetracker.google.com/issues/463863587))
- Hides some unintentionally exposed constructors in `AppSearch` built-in types ([I98583](https://android-review.googlesource.com/#/q/I98583b2cfe653effac9c022a713fce143b958abe), [b/463386955](https://issuetracker.google.com/issues/463386955))
- Adds `AppSearchSchema#fromDocumentClass` which returns the generated schema for a @Document-annotated class ([I599ad](https://android-review.googlesource.com/#/q/I599ad75e97188406c6a49fd69fc591753344d93b), [b/458101236](https://issuetracker.google.com/issues/458101236))
- Add `setSchemaTypeWipeoutAccountPropertyPaths` to `GetSchemaResponse` ([I8f6d4](https://android-review.googlesource.com/#/q/I8f6d499d2fc0105454a6e9409546b232a358a239), [b/413089233](https://issuetracker.google.com/issues/413089233))
- Add set wipe out account API in `SetSchemaRequest`. ([Id5a47](https://android-review.googlesource.com/#/q/Id5a47ae2738d2930b6334506511aff427ab9869f), [b/413089233](https://issuetracker.google.com/issues/413089233))
- Added a builder class to create built-in-type Account ([I29d07](https://android-review.googlesource.com/#/q/I29d07b58ad30a4528f77334f66c50349a7235b6d), [b/429110646](https://issuetracker.google.com/issues/429110646))
- Add `AppSearch` delete propagation API ([I57f89](https://android-review.googlesource.com/#/q/I57f899a1f1bbe368ffcdbaca44e703ac6aa11892), [b/384947619](https://issuetracker.google.com/issues/384947619))
- Adds a shared interface for `GlobalSearchSession` and `EnterpriseGlobalSearchSession` ([If2a70](https://android-review.googlesource.com/#/q/If2a70af93529325e2666aff0af3b237a55992e39), [b/422241546](https://issuetracker.google.com/issues/422241546))
- Clean `ExperimentalAppSearchApi` from Blob API ([I610e8](https://android-review.googlesource.com/#/q/I610e816d6e32913211980d8e52dcd2ae1040af7b), [b/273591938](https://issuetracker.google.com/issues/273591938))
- Adds a builtin Nickname type ([I8aba0](https://android-review.googlesource.com/#/q/I8aba0d22d2c3dba89fe07b8a37c3ba16ed746af3))
- Adds an Action Accumulator API ([I3f778](https://android-review.googlesource.com/#/q/I3f778e8babf1e6441ba039e4a5f18cc310b1ac2d), [b/395157195](https://issuetracker.google.com/issues/395157195))
- Moves get indexable nested properties to new feature ([I4cf95](https://android-review.googlesource.com/#/q/I4cf95c3e9b70f491b3233ca73a28f0c074e847f3), [b/407815165](https://issuetracker.google.com/issues/407815165))
...
- Add new built-in type account ([Iadad6](https://android-review.googlesource.com/#/q/Iadad6c4fe37d35357824ad07ef9ae963b294c5fd), [b/422079057](https://issuetracker.google.com/issues/422079057))
- Add `AppSearchResult#RESULT_UNAVAILABLE` result error code ([I48411](https://android-review.googlesource.com/#/q/I484111dd1b51c44075f9eff3c537c43e665d05c3), [b/407815165](https://issuetracker.google.com/issues/407815165), [b/404210068](https://issuetracker.google.com/issues/404210068), [b/415387509](https://issuetracker.google.com/issues/415387509), [b/419875333](https://issuetracker.google.com/issues/419875333), [b/417461575](https://issuetracker.google.com/issues/417461575), [b/415031127](https://issuetracker.google.com/issues/415031127), [b/357835538](https://issuetracker.google.com/issues/357835538))
- Adds an Action Accumulator API ([I97818](https://android-review.googlesource.com/#/q/I97818a96e12cdd5422338a031619e3513c92b375), [b/395157195](https://issuetracker.google.com/issues/395157195))
- Add new `AppSearchResult` code `RESULT_ABORTED` ([I6c375](https://android-review.googlesource.com/#/q/I6c37543a5eeedc2cb73c5ac2912def3ef28440f2), [b/409070736](https://issuetracker.google.com/issues/409070736))
- Amended Event to requires API O. ([I4433b](https://android-review.googlesource.com/#/q/I4433b41436698f5f0c8149f4b223f14d05942332), [b/399728815](https://issuetracker.google.com/issues/399728815))
- Added new `AppSearch` builtin schema `SportsEvent` ([I0dea6](https://android-review.googlesource.com/#/q/I0dea67280602a00d2b83c7c742d9dc2f5abbf641), [b/399728815](https://issuetracker.google.com/issues/399728815))
- Added new `AppSearch` builtin schema `SportsTeam` ([I073cd](https://android-review.googlesource.com/#/q/I073cddac6cba5ff886e6318526f494a5002fad48), [b/399728815](https://issuetracker.google.com/issues/399728815))
- Added new `AppSearch` builtin schema `SportsOrganization` ([I5729c](https://android-review.googlesource.com/#/q/I5729ce0dcc91ccb1ce1c5508c43737ae177501f0), [b/399728815](https://issuetracker.google.com/issues/399728815))
- Added new `AppSearch` builtin schema `Organization` ([I4bb2d](https://android-review.googlesource.com/#/q/I4bb2d7713fc2180c64187757fa4e698cc54ee282), [b/399728815](https://issuetracker.google.com/issues/399728815))
- Added new `AppSearch` builtin schema `Event` ([Ifd646](https://android-review.googlesource.com/#/q/Ifd64688ca2e268174b6f04410a8033350731e541), [b/399728815](https://issuetracker.google.com/issues/399728815))
...
- Make `WebPage` extendable ([I622f7](https://android-review.googlesource.com/#/q/I622f7f26a4dda919a8e3fdeeceeb7848c16e1ca5), [b/399220908](https://issuetracker.google.com/issues/399220908))
- Add source field to `WebPage` ([Ic4d7b](https://android-review.googlesource.com/#/q/Ic4d7b15d9c55437c9cc80290824316f0acf81cf5), [b/399220908](https://issuetracker.google.com/issues/399220908))
- Change `TextMatchInfo`'s constructor params ([Ie29c3](https://android-review.googlesource.com/#/q/Ie29c3a4e425847ef263094dcd672b1d5e802d19d), [b/403591188](https://issuetracker.google.com/issues/403591188), [b/395128139](https://issuetracker.google.com/issues/395128139))
...
- `SearchFeatures` and `RankingFeatures`. ([I54b7d](https://android-review.googlesource.com/#/q/I54b7d621d66e29607d654661f3bde712f0cb7551), [b/387291182](https://issuetracker.google.com/issues/387291182))
- Use new delete propagation flag ([If21ae](https://android-review.googlesource.com/#/q/If21ae4f3bbe0b2eb2376d2e81a102575c2d9d196), [b/384947619](https://issuetracker.google.com/issues/384947619))
- Adds more detailed internal logging ([I10604](https://android-review.googlesource.com/#/q/I10604db6faf2221dc42fc55540189ab6865c4e5f), [b/448872333](https://issuetracker.google.com/issues/448872333))
- Adds back `allowoptimization` to proguard keep rule for `AppSarchDocumentClassMap` ([I0bd88](https://android-review.googlesource.com/#/q/I0bd88826523819fe13feb4ca22e3a53f0bd90d2d), [b/440484133](https://issuetracker.google.com/issues/440484133))
- Fixes a bug in optimized builds where references to `AppSearch` document classes could be replaced by unrelated classes due to horizontal class merging ([I93f20](https://android-review.googlesource.com/#/q/I93f2035b8fd64f28974df86d616d1e9becb3f515), [b/440484133](https://issuetracker.google.com/issues/440484133))
- Add `ISOLATED_STORAGE` feature ([Ifb963](https://android-review.googlesource.com/#/q/Ifb963feacd8f787ccc882529b1acade25a66427c))
