---
title: Slidingpanelayout  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.slidingpanelayout.widget](/reference/kotlin/androidx/slidingpanelayout/widget/package-summary)

Implement a sliding pane UI pattern.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| January 26, 2022 | [1.2.0](/jetpack/androidx/releases/slidingpanelayout#1.2.0) | - | - | - |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:460835%20status:open)
...
* SlidingPaneLayout now allows registering
  multiple PanelSlideListeners.
...
* `SlidingPaneLayout` now depends on [Window `1.0.0-rc01`](/jetpack/androidx/releases/window#1.0.0-rc01), fixing incompatibilities with previous beta versions of AndroidX Window.
...
* SlidingPaneLayout now depends on [Window 1.0.0-alpha10](/jetpack/androidx/releases/window#1.0.0-alpha10).
...
* SlidingPaneLayout now depends on [Window `1.0.0-alpha09`](/jetpack/androidx/releases/window#1.0.0-alpha09).
...
* SlidingPaneLayout now allows registering
  multiple PanelSlideListeners. ([I50ce2](https://android-review.googlesource.com/#/q/I50ce2f92348cc3c9e6ee8a7e27ae64e62e88e88f))
...
* `SlidingPaneLayout` now implements the [`Openable`](/reference/androidx/customview/widget/Openable) interface added in [CustomView `1.1.0`](/jetpack/androidx/releases/customview#1.1.0).
...
* `SlidingPaneLayout` now implements the `Openable` interface added in [CustomView `1.1.0-alpha02`](/jetpack/androidx/releases/customview#1.1.0-alpha02), mirroring the change in [DrawerLayout `1.1.0-alpha04`](/jetpack/androidx/releases/drawerlayout#1.1.0-alpha04). ([b/129979320](https://issuetracker.google.com/issues/129979320))