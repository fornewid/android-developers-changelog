---
title: Constraintlayout  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.constraintlayout.widget](/reference/kotlin/androidx/constraintlayout/widget/package-summary)
...
| --- | --- | --- | --- | --- |
| constraintlayout | [2.2.1](/jetpack/androidx/releases/constraintlayout#constraintlayout-2.2.1) | - | - | - || constraintlayout-compose | [1.1.1](/jetpack/androidx/releases/constraintlayout#constraintlayout-compose-1.1.1) | - | - | - || constraintlayout-core | [1.1.1](/jetpack/androidx/releases/constraintlayout#constraintlayout-core-1.1.1) | - | - | - |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:323867%20status:open)
...
[`ConstraintLayout`](/reference/androidx/constraintlayout/widget/ConstraintLayout) and [`MotionLayout`](/reference/androidx/constraintlayout/motion/widget/MotionLayout) for Compose.
...
android:layout\_width and android:layout\_height are back being non-optional due to compatibility issues.
...
* android:layout\_width and android:layout\_height are now optional, with wrap\_content as default behavior
* new layout\_constraintWidth and layout\_constraintHeight attributes for expressing dimension constraints
...
* MotionLayout adds ViewTransitions, allowing single view transitions for
  mutation of constraintsets
