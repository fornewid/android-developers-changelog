---
title: Enterprise  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.enterprise.feedback](/reference/kotlin/androidx/enterprise/feedback/package-summary)

Create enterprise-ready applications.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| January 13, 2021 | [1.1.0](/jetpack/androidx/releases/enterprise#1.1.0) | - | - | - |

## Declaring dependencies

To add a dependency on Enterprise Feedback, you must add the Google Maven repository to your
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:606794%20status:open)
...
`androidx.enterprise:enterprise-feedback:1.0.0-alpha01` introduces
`KeyedAppStatesReporter` and `KeyedAppStatesService`, which allow apps to report
