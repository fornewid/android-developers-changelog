---
title: Customview  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.customview.poolingcontainer](/reference/kotlin/androidx/customview/poolingcontainer/package-summary)  
[androidx.customview.view](/reference/kotlin/androidx/customview/view/package-summary)  
[androidx.customview.widget](/reference/kotlin/androidx/customview/widget/package-summary)
...
| --- | --- | --- | --- | --- |
| customview | [1.2.0](/jetpack/androidx/releases/customview#customview-1.2.0) | - | - | - || customview-poolingcontainer | [1.1.0](/jetpack/androidx/releases/customview#customview-poolingcontainer-1.1.0) | - | - | - |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:460211%20status:open)
...
* Add a new `PoolingContainer` library that allows for listening
  to dispose events of a container that manages its children outside the View
  hierarchy. This will later be added as a dependency of `Compose` and `RecyclerView` ([I0e3f6](https://android-review.googlesource.com/#/q/I0e3f61f2a38f28a3fa9e5cbd50dbfb10c0871984), [b/196371929](https://issuetracker.google.com/issues/196371929))
...
* Added a new [`Openable`](/reference/androidx/customview/widget/Openable) interface for layouts that can transition between an ‘open’ and ‘closed’ state.
...
* Added a new `Openable` interface for layouts that can transition between an ‘open’ and ‘closed’ state. `DrawerLayout` now implements this interface in [DrawerLayout `1.1.0-alpha04`](/jetpack/androidx/releases/drawerlayout#1.1.0-alpha04). ([b/129979320](https://issuetracker.google.com/issues/129979320))
