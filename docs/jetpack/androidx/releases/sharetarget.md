...
[existing issues](https://issuetracker.google.com/issues?q=componentid:586834+status:open)
...
For more information on how to use the ShareTarget module, please refer to the [Providing Direct Share targets guide](https://developer.android.com/develop/ui/compose/sharing/receive#providing-direct-share-targets).
