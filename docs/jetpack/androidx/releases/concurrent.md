...
|---|---|---|---|---|
| July 29, 2026 | [1.3.0](https://developer.android.com/jetpack/androidx/releases/concurrent#1.3.0) | - | - | [1.4.0-alpha01](https://developer.android.com/jetpack/androidx/releases/concurrent#1.4.0-alpha01) |

## Declaring dependencies

To add a dependency on Futures, you must add the Google Maven repository to your
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:790637+status:open)
...
`androidx.concurrent:concurrent:1.4.0-alpha01`, `androidx.concurrent:concurrent-futures:1.4.0-alpha01`, and `androidx.concurrent:concurrent-futures-ktx:1.4.0-alpha01` are released. Version 1.4.0-alpha01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/6d6c8782f1e2f710a8f305225f8cf20699dbafb2..61ee8cd421d0c0252d8db0253b739de537999371/concurrent).

**API Changes**

- Add a utility method to get serial executors. ([I19fd6](https://android-review.googlesource.com/#/q/I19fd6eb363c61ab9a072dd979a41c5b769b9ab34), [b/532183522](https://issuetracker.google.com/issues/532183522))

**External Contribution**

- Merge concurrent-ktx into the concurrent library. All Kotlin extensions are now part of the main concurrent artifact. concurrent-ktx is now an empty artifact for compatibility. ([Ibaed2](https://android-review.googlesource.com/#/q/Ibaed204240ec46f894b542752d2fe1d7b6524421))
