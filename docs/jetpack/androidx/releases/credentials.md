...
[User Guide](https://developer.android.com/training/sign-in/passkeys)  
API Reference  
...
|-------------------|------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|--------------|----------------------------------------------------------------------------------------------|
| December 17, 2025 | [1.5.0](https://developer.android.com/jetpack/androidx/releases/credentials#1.5.0) | [1.6.0-rc01](https://developer.android.com/jetpack/androidx/releases/credentials#1.6.0-rc01) | -            | [1.6.0-rc01](https://developer.android.com/jetpack/androidx/releases/credentials#1.6.0-rc01) |

## Declaring dependencies

To add a dependency on credentials, you must add the Google Maven repository to your project. Read[Google's Maven repository](https://developer.android.com/studio/build/dependencies#google-maven)for more information.
...
**Bug Fixes** - Provided fallback solution when platform credential manager is not available. ([b/310701473](https://issuetracker.google.com/issues/310701473)) - Fix NPE caused by`clearCredentialState`API ([b/327686881](https://issuetracker.google.com/issues/327686881))
...
| **Note:** All projects should use the[latest 1.2 version of`androidx.credentials`](https://developer.android.com/jetpack/androidx/releases/credentials#latest). Earlier versions of`androidx.credentials`will throw an exception`UnsupportedOperationException("Post-U not supported yet")`when run on Android 14.
