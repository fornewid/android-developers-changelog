---
title: Vectordrawable  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.vectordrawable.graphics.drawable](/reference/kotlin/androidx/vectordrawable/graphics/drawable/package-summary)

Render vector graphics.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| May 1, 2024 | [1.2.0](/jetpack/androidx/releases/vectordrawable#1.2.0) | - | - | - |

## Declaring dependencies

To add a dependency on VectorDrawable, you must add the Google Maven repository to your
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:460297%20status:open)
...
See [`SeekableAnimatedVectorDrawable`](/reference/androidx/vectordrawable/graphics/drawable/SeekableAnimatedVectorDrawable) for the details.
