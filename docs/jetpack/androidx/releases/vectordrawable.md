...
[User Guide](https://developer.android.com/guide/topics/graphics/vector-drawable-resources) Render vector graphics.
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:460297+status:open)
