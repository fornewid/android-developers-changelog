...
[existing issues](https://issuetracker.google.com/issues?q=componentid:460913+status:open)
...
recently updated [Settings guide](https://developer.android.com/guide/topics/ui/settings) and [sample
