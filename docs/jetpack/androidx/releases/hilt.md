...
[User Guide](https://developer.android.com/training/dependency-injection/hilt-android) [Code Sample](https://github.com/android/architecture-samples/tree/views-hilt) [Codelab](https://codelabs.developers.google.com/codelabs/android-hilt/#0) Extend the functionality of [Dagger Hilt](https://dagger.dev/hilt) to enable dependency injection of certain classes from the androidx libraries.
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:874079+status:open)
...
`androidx.hilt:hilt-*:1.4.0-rc01` is released. Version 1.4.0-rc01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/df4b49eda6f6834b6bc4c8aa30a581fa577a511e..c66bb6dc33517adb67ab112e01dc90717615caa7/hilt).

No significant changes since version 1.4.0-alpha01.

### Version 1.4.0-beta01

April 22, 2026

`androidx.hilt:hilt-*:1.4.0-beta01` is released. Version 1.4.0-beta01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/97db31fffa2902bcae14976e21a5a23562131bc6..13d567e2ebb0051bcb4043bcac17e5c6c80ffffc/hilt).

**API Changes**

- Simplify the `rememberHiltViewModelFactory`API by removing the `ViewModelStoreOwner` parameter. Use the `delegateFactory parameter` to provide custom factory logic when necessary. ([I3611a](https://android-review.googlesource.com/#/q/I3611adc20951347a614dbb5fbb5d0e9a408969cc))
- Introduce `rememberHiltViewModelFactory()` to allow manual creation of Hilt-injected ViewModels. This is particularly useful when providing a default factory to the `rememberViewModelStoreOwner` API. ([If7517](https://android-review.googlesource.com/#/q/If751760e2bee243b6788e0207fed83892c24efae))
...
`androidx.hilt:hilt-*:1.4.0-alpha01` is released. Version 1.4.0-alpha01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/d697e229a0933b8ef4811164e4b20f24eafafe4b..1abcb4178d48853948b9b566cabff9222d90ab69/hilt).

- The library version now requires the KGP version to be at least 2.2.0 ([I39f21](https://android-review.googlesource.com/#/q/I39f21fa33b8fc94c210440a0213ef591b6a77abc), [b/477205839](https://issuetracker.google.com/issues/477205839))
