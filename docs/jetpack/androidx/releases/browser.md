...
[User Guide](https://developer.chrome.com/docs/android/custom-tabs/) Display webpages in the user's default browser.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
|---|---|---|---|---|
| March 25, 2026 | [1.10.0](https://developer.android.com/jetpack/androidx/releases/browser#1.10.0) | - | - | - |

## Declaring dependencies

To add a dependency on Browser, you must add the Google Maven repository to your project. Read [Google's Maven repository](https://developer.android.com/studio/build/dependencies#google-maven) for more information.
...
Your feedback helps make Jetpack better. Let us know if you discover new issues or have ideas for improving this library. Please take a look at the [existing issues](https://issuetracker.google.com/issues?q=componentid:460372+status:open) in this library before you create a new one. You can add your vote to an existing issue by clicking the star button.
