...
- Add an Intent to allow launching the initial url in an external app ([Ifed54](https://android-review.googlesource.com/c/platform/frameworks/support/+/3682822))
...
- Allow Null for `pageUrl` in `ContentActionSelectedData`. ([Id9349](https://android-review.googlesource.com/c/platform/frameworks/support/+/3682822))
