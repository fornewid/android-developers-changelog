---
title: navigation3  |  Jetpack  |  Android Developers
...
| --- | --- | --- | --- | --- |
| April 08, 2026 | [1.1.0](/jetpack/androidx/releases/navigation3#1.1.0) | - | - | [1.2.0-alpha01](/jetpack/androidx/releases/navigation3#1.2.0-alpha01) |
...
```
dependencies {
    implementation "androidx.navigation3:navigation3-runtime:1.2.0-alpha01"
    implementation "androidx.navigation3:navigation3-ui:1.2.0-alpha01"
}
```
...
* Navigation3 now depends on [NavigationEvent Alpha08](/jetpack/androidx/releases/navigationevent#1.0.0-alpha08).
