...
API Reference  
[androidx.camera.camera2](/reference/kotlin/androidx/camera/camera2/package-summary)  
[androidx.camera.core](/reference/kotlin/androidx/camera/core/package-summary)  
[androidx.camera.extensions](/reference/kotlin/androidx/camera/extensions/package-summary)  
[androidx.camera.lifecycle](/reference/kotlin/androidx/camera/lifecycle/package-summary)  
[androidx.camera.view](/reference/kotlin/androidx/camera/view/package-summary)  
[androidx.camera.video](/reference/kotlin/androidx/camera/video/package-summary)  
[androidx.camera.mlkit.vision](/reference/kotlin/androidx/camera/mlkit/vision/package-summary)  
[androidx.camera.viewfinder](/reference/kotlin/androidx/camera/viewfinder/package-summary)  
[androidx.camera.effects](/reference/kotlin/androidx/camera/effects/package-summary)
...
devices](/training/camerax/devices).
...
* From [Camera `1.2.2`](#1.2.2): Fixed the issue where CameraX Extensions don't work properly when proguard is enabled on some devices such as Pixel ([I90aa2](https://android-review.googlesource.com/#/q/I90aa210540cc985c49816d8ae74bda526cccbbbe))
...
* Fix JPEG image corruption issue if writing Exif location data on some Samsung Android 12 devices. ([b/263289024](https:///issuetracker.google.com/issues/263289024))
...
* Release to support [Camera-Core 1.0.0-beta10](#camera-core-1.0.0-beta10)
...
**Caution:** Please do not use **Camera-Core Version 1.0.0-beta09** as there is a Known Issue around image capture. Please do not use this version in your applications. Instead use [`Camera-Core Version 1.0.0-beta10`](#camera-core-1.0.0-beta10) and above.
...
* `Camera2Config` is now available for use with initializing and configuring a Camera2-based implementation for CameraX. More details on how to use this in initialization are in the [camera-core section](#camera2-core-1.0.0-alpha07) of the release notes.
...
* `CameraInfo.isFlashAvailable()` has been removed. Torch overrides flash functionality. More detail is included in the [reference documentation](/reference/androidx/camera/core/Preview#public-methods_1).
...
* A preference for a “nearest mod16” for JPEG or video encoding. See [`CameraCharacteristics#SCALER_STREAM_CONFIGURATION_MAP`](/reference/android/hardware/camera2/CameraCharacteristics#SCALER_STREAM_CONFIGURATION_MAP)
...
* See notes in the [camera-core](/jetpack/androidx/releases/camera#camera2-core-1.0.0-alpha07) section for how to perform initialization of CameraX using a `ProcessCameraProvider`.
