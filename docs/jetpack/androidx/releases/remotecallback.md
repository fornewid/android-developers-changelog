---
title: Remotecallback  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.remotecallback](/reference/kotlin/androidx/remotecallback/package-summary)  
[androidx.remotecallback.compiler](/reference/kotlin/androidx/remotecallback/compiler/package-summary)

Create a wrapper that makes it easier for developers to provide a PendingIntent.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| November 19, 2025 | - | - | - | [1.0.0-alpha03](/jetpack/androidx/releases/remotecallback#1.0.0-alpha03) |

## Feedback

Your feedback helps make Jetpack better. Let us know if you discover new issues or have
ideas for improving this library. Please take a look at the
[existing issues](https://issuetracker.google.com/issues?q=componentid:878799%20status:open)
