---
title: navigationevent  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.navigationevent](/reference/kotlin/androidx/navigationevent/package-summary)
...
| --- | --- | --- | --- | --- |
| March 27, 2026 | [1.0.2](/jetpack/androidx/releases/navigationevent#1.0.2) | - | [1.1.0-beta01](/jetpack/androidx/releases/navigationevent#1.1.0-beta01) | - |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1777955%20status:open)
...
* [Navigationevent Version 1.1.0-beta01](/jetpack/androidx/releases/navigationevent#1.1.0-beta01)
...
* Add `OnForwardCompletedFallback` to
  `NavigationEventDispatcher`, enabling a default system
  behavior for unhandled forward navigation events. ([Iac620](https://android-review.googlesource.com/#/q/Iac6205388c43b21e51406b0aa5c42040b2ad325d), [b/489138116](https://issuetracker.google.com/issues/489138116))

### Version 1.1.0-alpha01

February 25, 2026

`androidx.navigationevent:navigationevent-*:1.1.0-alpha01` is released. Version 1.1.0-alpha01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/a7bd43e4ff5a6c4f70a22b93597ac88425fe5e84..c640b9aa8e30b5db9ee258561ad1fc4bc947e69d/navigationevent).

**New Features**

* Support all Kotlin Multiplatform (KMP) targets in NavigationEvent-Compose. Decouple owner resolution from `LocalView` to allow platform hosts to provide a default `LocalNavigationEventDispatcherOwner` while maintaining `LocalView` as a safe fallback on Android. ([Iae980](https://android-review.googlesource.com/#/q/Iae98083eb2c25556d3c6f385ef0948197a2208e8), [b/434940570](https://issuetracker.google.com/issues/434940570), [Iccf58](https://android-review.googlesource.com/#/q/Iccf58b765b5c005e49db1b7cc740c0463897d4e4))

**API Changes**

* Add `NavigationEvent.toBackEvent()` and `BackEvent.toNavigationEvent()` extension functions to convert between Android's `BackEvent` and `NavigationEvent`. ([Ie3b71](https://android-review.googlesource.com/#/q/Ie3b71219bd08caa63daccd9d0237c6fd977583b4), [b/477001292](https://issuetracker.google.com/issues/477001292))
...
* To handle `NavigationEvent`s, you can implement your own `NavigationEventHandler` that overrides the desired functions. You then need to add the handler to a `NavigationEventDispatcher`. Starting with the [Activity `1.12.0`](/jetpack/androidxactivity#1.12.0) release, `ComponentActivity` implements the new `NavigationEventDispatcherOwner` interface, which provides a dispatcher that is ready to use :
...
* Added default parameters to `NavigationEvent` to allow for easier instantiation and to simplify testing which should be used in place of `TestNavigationEvent`. ([I5dc49](https://android-review.googlesource.com/#/q/I5dc49bfda688c13287343d711eb30424925b00ff),
  [I232f4](https://android-review.googlesource.com/#/q/I232f4e164c4fc370dbce5fec7d990de6e0de4daa))
...
* `NavigationEventInputHandler` has been made into an abstract class to replace the previous `AbstractNavigationEventInputHandler` with an implementation in `DirectNavigationEventInputHandler` ([Iadde5](https://android-review.googlesource.com/#/q/Iadde55d642f71285a8887ae4145f36eb801bbb6e),
  [Ifed40](https://android-review.googlesource.com/#/q/Ifed405ac4658fbfac889bed991266cc04e65cdd0)[I3897c](https://android-review.googlesource.com/#/q/I3897cdedbeabbb22174560595413e215b9237d95), [b/432616296](https://issuetracker.google.com/issues/432616296), [b/435416924](https://issuetracker.google.com/issues/435416924))
