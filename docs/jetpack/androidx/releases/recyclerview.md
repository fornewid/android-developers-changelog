---
title: Recyclerview  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.recyclerview.selection](/reference/kotlin/androidx/recyclerview/selection/package-summary)  
[androidx.recyclerview.widget](/reference/kotlin/androidx/recyclerview/widget/package-summary)
...
| --- | --- | --- | --- | --- |
| recyclerview | [1.4.0](/jetpack/androidx/releases/recyclerview#recyclerview-1.4.0) | - | - | - || recyclerview-selection | [1.2.0](/jetpack/androidx/releases/recyclerview#recyclerview-selection-1.2.0) | - | - | [1.3.0-alpha01](/jetpack/androidx/releases/recyclerview#recyclerview-selection-1.3.0-alpha01) |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:460887%20status:open)
...
`androidx.recyclerview:recyclerview:1.4.0-rc01` is released, with no changes since [1.4.0-alpha02](#recyclerview-1.4.0-alpha02)/. Version 1.4.0-rc01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/8c4071562bd7e22b937284d71fb7aca9c4cd662c..dfd74da8dfb752e0d0981903430e71ecb70097e1/recyclerview/recyclerview).
...
`androidx.recyclerview:recyclerview:1.4.0-beta01` is released, with no changes since [1.4.0-alpha02](#recyclerview-1.4.0-alpha02). Version 1.4.0-beta01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/9130b719318a69f2f3eaf82c32b131232fd721cb..8c4071562bd7e22b937284d71fb7aca9c4cd662c/recyclerview/recyclerview).
...
This and higher versions of RecyclerView are not compatible with lower versions of ViewPager2. If you are currently using `androidx.viewpager2:viewpager2:1.0.0` or lower, make sure to update to [`androidx.viewpager2:viewpager2:1.1.0-alpha01`](/jetpack/androidx/releases/viewpager2#1.1.0-alpha01).

**New Features**

* **MergeAdapter**

  + [MergeAdapter](/reference/androidx/recyclerview/widget/MergeAdapter): A new RecyclerView Adapter that can combine multiple adapters linearly.
...
* Fixed an "Application Not Responding" when overriding `RecyclerViewAccessibilityDelegate.ItemDelegate`
  ([aosp/1138057](https://android-review.googlesource.com/c/platform/frameworks/support/+/1138057/), [aosp/1133434](https://android-review.googlesource.com/c/platform/frameworks/support/+/1133434/))
...
* RV OnItemTouchListener's previously couldn’t intercept on ACTION\_UP, preventing OnItemTouchListener’s from blocking other code from responding to ACTION\_UP. This is now fixed: ([aosp/916137](https://android-review.googlesource.com/c/916137/))
...
* Fixed `ConcurrentModificationException` when data set changed with removing
  selection.
...
* Deprecated methods:
  + [SelectionTracker.Builder#withPointerTooltype](/reference/androidx/recyclerview/selection/SelectionTracker.Builder#withPointerTooltypes(int...))
  + [SelectionTracker.Builder#withGestureTooltype](/reference/androidx/recyclerview/selection/SelectionTracker.Builder#withGestureTooltypes(int...))
  ...
  + Default tooltypes are [FINGER](/reference/android/view/MotionEvent#TOOL_TYPE_FINGER) for Gesture and [MOUSE](/reference/android/view/MotionEvent#TOOL_TYPE_MOUSE) for Pointer.