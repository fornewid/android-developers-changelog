---
title: Biometric  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.biometric](/reference/kotlin/androidx/biometric/package-summary)

Authenticate with biometrics or device credentials, and perform cryptographic operations.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| March 25, 2026 | [1.1.0](/jetpack/androidx/releases/biometric#1.1.0) | - | - | [1.4.0-alpha06](/jetpack/androidx/releases/biometric#1.4.0-alpha06) |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:559537%20status:open)
...
* Update `registerForAuthenticationResult()` to use
  `ComponentActivity` instead `FragmentActivity` for broader compatibility. ([Id5db6](https://android-review.googlesource.com/#/q/Id5db612b62fe6758ea095d7e816f0afb6de26c9d), [b/349213716](https://issuetracker.google.com/issues/349213716))
...
* The [activity-result-pattern Biometric library](https://developer.android.com/reference/androidx/biometric/AuthenticationUtils) introduces new API changes:
  + The `onAuthFailure` callback has been moved to `AuthenticationResultCallback` and renamed to `onAuthAttemptFailed`. ([Ied96b](https://android-review.googlesource.com/#/q/Ied96b1a29c9e82347f08e947fb56da81356d5c5d), [/Id6a73](https://android-review.git.corp.google.com/#/q/Id6a7379e2ca6a2ad1a135ca751214957a2be8df7))
...
* Add APIs to support logo (for privileged apps only)
  ...
  + `BiometricPrompt.PromptInfo#getLogoDescription`
    [58c35c6](https://android.googlesource.com/platform/frameworks/support/+/58c35c67770fa9af042d5949f42d3e67c6dabee5)
...
* Added suspending coroutine extensions for CredentialAuthPrompt
  similar to those that exist for other AuthPrompt types. ([I9ac70](https://android-review.googlesource.com/#/q/I9ac70c62d19f3b3d07d60023aabaf7c0e39eabac))
