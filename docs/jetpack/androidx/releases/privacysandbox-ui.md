...
|---|---|---|---|---|
| December 17, 2025 | - | - | - | [1.0.0-alpha17](https://developer.android.com/jetpack/androidx/releases/privacysandbox-ui#1.0.0-alpha17) |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1331007+status:open)
