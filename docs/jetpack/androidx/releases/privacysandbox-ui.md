---
title: Privacysandbox UI  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.privacysandbox.ui](/reference/kotlin/androidx/privacysandbox/ui/package-summary)

TODO

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| December 17, 2025 | - | - | - | [1.0.0-alpha17](/jetpack/androidx/releases/privacysandbox-ui#1.0.0-alpha17) |

## Declaring dependencies

To add a dependency on privacysandbox-ui, you must add the Google Maven repository to your
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1331007%20status:open)
...
`androidx.privacysandbox.ui:ui-*:1.0.0-alpha17` is released. Version 1.0.0-alpha17 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/cd41781824511ce4d5c4a05d2df4aaaee669f0bc..ec985eed3cba8444e5aaa52a748333397a1298f3/privacysandbox/ui).
...
- `minSdk` was changed from API 21 to 23 ([Ifa120](https://android-review.googlesource.com/#/q/Ifa120936e7e99ae0ad79c689ee0b0bbbe946a761), [b/380448311](https://issuetracker.google.com/issues/380448311))
- Decouple the experimental `SandboxedSdkUi` from the unexperimental one. ([Ie9154](https://android-review.googlesource.com/#/q/Ie9154e05df8c7ec1eada23d0d8e55d1bc5dfcecf), [b/430118542](https://issuetracker.google.com/issues/430118542))
- `SdkSandboxControllerCompat` migrated to `sdkruntime-provider` ([Id99fb](https://android-review.googlesource.com/#/q/Id99fbe22fd999a9857e47d0e6aeb9f0567ef9225), [b/426122358](https://issuetracker.google.com/issues/426122358))
- Client app can not change the z-level of the provider UI relative to the client window using `SandboxedSdkView` or `SandboxedSdkUi`. ([I87e9f](https://android-review.googlesource.com/#/q/I87e9f50449bcdef9feb0538f1b56b1af59ba301e), [b/413659157](https://issuetracker.google.com/issues/413659157))
...
* Added `PoolingContainer` support to `SharedUiContainer` session management: shared UI session is not closed in case the container is within a `PoolingContainer`. ([Iabe16](https://android-review.googlesource.com/#/q/Iabe160213d3c65501575760e9e345c6bd10d0a72), [b/352500350](https://issuetracker.google.com/issues/352500350))
...
* Added `SharedUiContainer` that can host client-owned and provider-owned UI. It places all of its child views in the top left corner.
  ([Ia7310](https://android-review.googlesource.com/#/q/Ia7310cc5be45e54912aebee0669aab6152de59bd))
