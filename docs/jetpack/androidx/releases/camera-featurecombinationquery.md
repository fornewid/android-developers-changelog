...
|---|---|---|---|---|
| February 11, 2026 | [1.5.3](https://developer.android.com/jetpack/androidx/releases/camera-featurecombinationquery#1.5.3) | - | [1.6.0-beta02](https://developer.android.com/jetpack/androidx/releases/camera-featurecombinationquery#1.6.0-beta02) | - |
...
dependencies {
    ...
    implementation "androidx.camera.featurecombinationquery:featurecombinationquery:1.6.0-beta02"

    // Optional [recommended]: Use to enable play services as a query provider
    implementation "androidx.camera.featurecombinationquery:featurecombinationquery-play-services:1.6.0-beta02"
}
```
