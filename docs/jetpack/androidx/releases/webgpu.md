---
title: webgpu  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.webgpu](/reference/kotlin/androidx/webgpu/package-summary)

A modern GPU API for graphics and compute from Kotlin.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| February 11, 2026 | - | - | - | [1.0.0-alpha04](/jetpack/androidx/releases/webgpu#1.0.0-alpha04) |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1960262%20status:open)
