---
title: graphics  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.graphics](/reference/kotlin/androidx/graphics/package-summary)
...
| --- | --- | --- | --- | --- |
| graphics-core | [1.0.4](/jetpack/androidx/releases/graphics#graphics-core-1.0.4) | - | - | - || graphics-path | [1.0.1](/jetpack/androidx/releases/graphics#graphics-path-1.0.1) | [1.1.0-rc01](/jetpack/androidx/releases/graphics#graphics-path-1.1.0-rc01) | - | - || graphics-shapes | [1.1.0](/jetpack/androidx/releases/graphics#graphics-shapes-1.1.0) | - | - | - |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1262687%20status:open)
...
`androidx.graphics:graphics-shapes:1.1.0-beta01` is released. Version 1.1.0-beta01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/46295bc0b75a16f452e8e0090e8de41073d4dbb6..def3e53c2013cff4f8a9ddd8e8be7b016a9d2c42/graphics/graphics-shapes).
...
`androidx.graphics:graphics-shapes:1.1.0-alpha01` is released. Version 1.1.0-alpha01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/17aea5b083ca354fcad646462e8d3d0c211f1eae..46295bc0b75a16f452e8e0090e8de41073d4dbb6/graphics/graphics-shapes).
...
* Allow shapes to be pre-rotated to start at a different point. This change allows `pillStar` shapes to start their curves from a non-default point on the perimeter. This can be useful when animating the stroking of the shape's path, to start drawing from a specific location on the shape's outline.
  ([Ifbb4d](https://android-review.googlesource.com/#/q/Ifbb4dd34cfa414430829533613fda13b8916535e), [b/324303807](https://issuetracker.google.com/issues/324303807))
...
* Fixed issue where error logs would show error 300d (EGL\_BAD\_SURFACE).
