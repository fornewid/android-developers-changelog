...
|---|---|---|---|---|
| September 23, 2026 | [1.4.0](https://developer.android.com/jetpack/androidx/releases/compose-material3#1.4.0) | - | - | [1.5.0-alpha29](https://developer.android.com/jetpack/androidx/releases/compose-material3#1.5.0-alpha29) |
...
## Compose Material3 A2UI Version 1.0

### Version 1.0.0-alpha01

September 23, 2026

`androidx.compose.material3:material3-a2ui:1.0.0-alpha01` is released. Version 1.0.0-alpha01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/4655a1cce41f181b9bbdb8f0a963f20b1f020101/compose/material3/material3-a2ui).

**New Features**

The Jetpack Compose Agent-to-UI (A2UI) renderer provides an implementation of the [A2UI protocol](https://a2ui.org/), enabling AI agents to generate rich, interactive user interfaces that render native Compose components---without executing arbitrary code. This library provides a ready-to-use implementation of the standard A2UI Basic Catalog specification, built using Material Design 3 components.
...
- Added `MaterialImageComponent` to support rendering images in the A2UI catalog. Test: `MaterialImageComponentTest` into androidx-main
- Added `MaterialImageComponent` to support rendering images in the A2UI catalog. ([I868fe](https://android-review.googlesource.com/#/q/I868feffde3d322619fd423fdf886ee7f4403a865))
...
- Deprecated stateless `Slider` and `RangeSlider` overloads in favor of their stateful versions. Renamed `activeRangeStart` and `activeRangeEnd` in `RangeSliderState` to `startValue` and `endValue`, deprecating older unpromoted and experimental Slider APIs with `DeprecationLevel.HIDDEN`. ([If8995](https://android-review.googlesource.com/#/q/If8995438653fe44d5d108787e920c7fe06f6ff69))
- Added `A2uiSurface` composable and `A2uiSurfaceDefaults` for rendering A2UI surfaces. ([I6e276](https://android-review.googlesource.com/#/q/I6e276310a4560fe8994bd30848f164b4f9a323c2), [b/544713825](https://issuetracker.google.com/issues/544713825))
...
- [NavigationSuiteScaffold](https://developer.android.com/reference/kotlin/androidx/compose/material3/adaptive/navigationsuite/package-summary#NavigationSuiteScaffold(kotlin.Function1,androidx.compose.ui.Modifier,androidx.compose.material3.adaptive.navigationsuite.NavigationSuiteType,androidx.compose.material3.adaptive.navigationsuite.NavigationSuiteColors,androidx.compose.ui.graphics.Color,androidx.compose.ui.graphics.Color,kotlin.Function0))
  ...
  - [NavigationSuite](https://developer.android.com/reference/kotlin/androidx/compose/material3/adaptive/navigationsuite/NavigationSuite.composable#NavigationSuite(androidx.compose.ui.Modifier,androidx.compose.material3.adaptive.navigationsuite.NavigationSuiteType,androidx.compose.material3.adaptive.navigationsuite.NavigationSuiteColors,kotlin.Function1))
...
### Version 1.5.0-alpha29

September 23, 2026

`androidx.compose.material3:material3-*:1.5.0-alpha29` is released. Version 1.5.0-alpha29 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/e4bd62f853853bf3522ed15681c58ef28b09ed44..3991baac26fe4b1099b35ec36fc40a116cca22f5/compose/material3).

**API Changes**

- **Source breaking change** : `onValueChange` is now a required parameter in `Slider` and `RangeSlider` and its order in the parameter list has changed

**Bug Fixes**

- `DatePicker` now resolves in 1 frame by computing month navigation availability directly from the displayed month index. ([I08db7](https://android-review.googlesource.com/#/q/I08db7973b21ec076f76456926a35d6f15ffdb401))
- `TimeInput` now internally uses the new `TextFieldState` text field APIs. ([Ia7492](https://android-review.googlesource.com/#/q/Ia7492b79370ed4c48ba6f6512021d9795e0ca0d1), [b/353692863](https://issuetracker.google.com/issues/353692863))
- `DateInput` now internally uses the new `TextFieldState` text field APIs. ([I5ad3d](https://android-review.googlesource.com/#/q/I5ad3d9297690778c8f8403dbf9d90209418ec16a), [b/353692863](https://issuetracker.google.com/issues/353692863))
- `Slider` and `RangeSlider` now handle `onValueChange` and `onValueChangeFinished` directly in their implementations instead of passing them into `SliderState` and `RangeSliderState`. ([I959ac](https://android-review.googlesource.com/#/q/I959ac9a6e2adbf55969b16c9dbe75e92faa1c7ad))

### Version 1.5.0-alpha28

September 09, 2026

`androidx.compose.material3:material3-*:1.5.0-alpha28` is released. Version 1.5.0-alpha28 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/f3ed195f0c9ef9eafe437351d974c9ec49ecc2ea..e4bd62f853853bf3522ed15681c58ef28b09ed44/compose/material3).

**API Changes**

- Renamed and simplified the multi-aspect carousel API to a global `carouselParallaxScrollEffect` modifier ([I46b17](https://android-review.googlesource.com/#/q/I46b17fbc7eb3b0d061ce059234976a7d5a9912b5))
- Removed deprecated `ToggleButton` overloads. Added utility functions (`contentPaddingFor`, `shapesFor`) and default constants (including `size`) to `ToggleButtonDefaults`, `ElevatedToggleButtonDefaults`, `FilledTonalToggleButtonDefaults`, and `OutlinedToggleButtonDefaults`. ([I998cf](https://android-review.googlesource.com/#/q/I998cf18c0880f30a68e5be04faf9f65d5c192190))
- Deprecated stateless `Slider` and `RangeSlider` overloads in favor of their stateful versions. Renamed `activeRangeStart` and `activeRangeEnd` in `RangeSliderState` to `startValue` and `endValue`, deprecating older unpromoted and experimental Slider APIs with `DeprecationLevel.HIDDEN`. ([If8995](https://android-review.googlesource.com/#/q/If8995438653fe44d5d108787e920c7fe06f6ff69))

  To migrate `Slider`, from:
  `kotlin
  ...
  To migrate `RangeSlider`, from:
  `kotlin
  var range by remember { mutableStateOf(0.2f..0.8f) }
  RangeSlider(value = range, onValueChange = { range = it })`
  To:
  `kotlin
  val state = remember { RangeSliderState(startValue = 0.2f, endValue = 0.8f) }
  RangeSlider(state = state)`
- Add enabled boolean and disabled color params to `ScrollField` ([Iab612](https://android-review.googlesource.com/#/q/Iab61234eee7cb08a56fceec0662031c8fb6662e6))

**Bug Fixes**

- Add focus ring support for `ScrollField`. ([If21d6](https://android-review.googlesource.com/#/q/If21d62b64ce61062fef82a506495e0937f1d5ee3))
- Make design feedback adjustments for expressive `TimePicker` in dial mode. ([I8795e](https://android-review.googlesource.com/#/q/I8795e1940eed2779a9bde406a835a4c7073d638e))
- Make padding adjustments for expressive `TimePicker` in scroll and input mode. ([Iddb33](https://android-review.googlesource.com/#/q/Iddb335d93eb206d21e16406bb74481ede39d89aa))
- Updates toggle height/layout calculation based on item count for expressive `TimePicker.kt` in uncontained mode. ([I30700](https://android-review.googlesource.com/#/q/I30700af712234d9a6b8a4a747fa5d736dfdc4d70))
- Fixed an issue where AM/PM controls were truncated in `TimePicker` when large text or font scaling was enabled. ([Iaca60](https://android-review.googlesource.com/#/q/Iaca60a918c140a3e702f6261bf538c9b8eada89f))
...
### Version 1.5.0-alpha27

August 26, 2026

`androidx.compose.material3:material3-*:1.5.0-alpha27` is released. Version 1.5.0-alpha27 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/384f3c27346bf5812f359330dc2310f0cbb66402..e803e681a62cf709ac0eef07a56ac6cc0bba332a/compose/material3).

**API Changes**

- Renamed `RichTimePickerDialog` to `VibrantTimePickerDialog`, renamed `richColors` to `vibrantColors` in `TimePickerDefaults` and `TimeInputDefaults`, renamed `richContainerColor` and `richShape` to `vibrantContainerColor` and `vibrantShape` in `TimePickerDialogDefaults`, and renamed unselected color properties to `periodSelectorContainerColor`, `periodSelectorContentColor`, `timeSelectorContainerColor`, `timeSelectorContentColor`, and `clockDialContentColor`. ([Iea5aa](https://android-review.googlesource.com/#/q/Iea5aa467256e7e84889eaa46325ed79445ffdf5d))
- Update the Rich `TimePicker` API to allow for an uncontained scroll/input dialog. ([I2b3b6](https://android-review.googlesource.com/#/q/I2b3b625f1fd185d19d26dede024f261ddfa4af8f))
- Introduced `SelectableDropdownMenuItem` and `CheckableDropdownMenuItem` for selectable and checkable expressive menu items. Updated `DropdownMenuItem` with shape to use `MenuItemColors`, and added `MenuDefaults.itemVibrantColors()` to support vibrant `MenuItemColors`. ([I160ca](https://android-review.googlesource.com/#/q/I160ca23104cb58328af2c05ff946c5166a8fc91a))
- Added opinionated expressive `ToggleButton`, `ElevatedToggleButton`, `FilledTonalToggleButton`, and `OutlinedToggleButton` overloads with `ButtonSize` and `icon` slot. Simplified `ToggleButtonDefaults`, `ElevatedToggleButtonDefaults`, `FilledTonalToggleButtonDefaults`, and `OutlinedToggleButtonDefaults` method names to `colors()` and `border()`. ([Iab484](https://android-review.googlesource.com/#/q/Iab484ab734ad5fedd308c54fcfbe9ddf37d0b391))
- Removed deprecated overloads of `pinnedScrollBehavior` and `enterAlwaysScrollBehavior` from `TopAppBarDefaults`. Use the overloads that take `ScrollableState` instead. ([Idef9d](https://android-review.googlesource.com/#/q/Idef9d20d5c9fd92e61d6d4bd27b717ea601ea93a))
- Removed deprecated experimental API `LocalMotionScheme` from `MaterialTheme`. Use `MaterialTheme.motionScheme` instead. ([I4b61d](https://android-review.googlesource.com/#/q/I4b61dd15fae45469a3cb9b0ee25b1448d66dd525))
- Added `TimeInputDefaults` and `TimeInputColors` for `TimeInput`. ([I7534e](https://android-review.googlesource.com/#/q/I7534e77ac6a8ae9da3789ff29878460edd2f153d))

**Bug Fixes**

- Fixed an issue where `ScrollDisplayModeToggle` announced 'Switch to scroll mode' while in scroll mode. ([I2d588](https://android-review.googlesource.com/#/q/I2d588d1c52938f7f4b7d2243b6e52d61e003ee5e))
- Fixed an issue where `DropdownMenuItem` without a leading icon did not align trailing icons to the end of the menu item. ([Ia24ff](https://android-review.googlesource.com/#/q/Ia24ff1947a6d41a5af08d5fd2eeaab88e57e0bbf), [b/542873381](https://issuetracker.google.com/issues/542873381))

### Version 1.5.0-alpha26

August 12, 2026

`androidx.compose.material3:material3-*:1.5.0-alpha26` is released. Version 1.5.0-alpha26 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/61ee8cd421d0c0252d8db0253b739de537999371..4d087bd6f764b8425a70fd94102f855aa382d94b/compose/material3).

**API Changes**

- Added `ElevatedToggleButtonDefaults`, `FilledTonalToggleButtonDefaults`, and `OutlinedToggleButtonDefaults`, and cleaned up non-semantic shape properties in `ToggleButtonDefaults`. ([Ia0a85](https://android-review.googlesource.com/#/q/Ia0a85049faad6c4d8ee40f2914a15f7dba6600f9))
- Fixed a11y contrast issue for the horizontal `NavigationItem`'s label in high contrast themes. The label's color is now specified via `selectedTextColorTopIconPosition` (vertical item's label color, which has not changed) and `selectedTextColorStartIconPosition` (horizontal item's label color, now set to match `selectedIconColor`). To revert this update, pass in `ShortNavigationBarItemDefaults`/`WideNavigationRailItemDefaults`.colors().copy(`selectedTextColorStartIconPosition` = `MaterialTheme`.`colorScheme`.secondary) ([I85855](https://android-review.googlesource.com/#/q/I858557f11ab08313701b24d3eb36ad4e82aa9d6d), [b/490910896](https://issuetracker.google.com/issues/490910896))
- Scroll offset variables have been removed from `SearchBarScrollBehavior` and should now be accessed via the new class `SearchBarScrollState`. ([Ib24e4](https://android-review.googlesource.com/#/q/Ib24e4c9fe816ea9fc2d3e27fd77929b75a688048))
- Promoted `BottomAppBar` and its associated methods to stable. These APIs no longer require the @`ExperimentalMaterial3Api` opt-in. ([I42c61](https://android-review.googlesource.com/#/q/I42c61cd5206432c0cc61f3effbbf96566d4ad271))
- Saved active selection mode in `TimePickerState` across state restorations and added `initialSelection` parameter to `TimePickerState` factory function. ([Iad905](https://android-review.googlesource.com/#/q/Iad9051244ec30787c66dcd97117c117cae87c27b))
...
- Fixed an issue where partial color customization in `MenuDefaults.itemColors` overwrote unprovided colors with `Color.Unspecified`. ([Iea847](https://android-review.googlesource.com/#/q/Iea847ef041dddb07cf56d502fe54215c344a7c0b))
- Fixed `TalkBack` announcements to read formatted time values in the scrollable `TimePicker`. ([Ice981](https://android-review.googlesource.com/#/q/Ice981f51427a1e0ecdb597b2011cfda3f10a0de0))
- Fixed a crash in `ExposedDropdownMenu` when screen height is smaller than menu height. ([I6adf1](https://android-review.googlesource.com/#/q/I6adf1591ede0e755c7d8d94b4d52549a1d9d00ad))
- Fixed wrong content padding of wide navigation rail. Bottom padding is now 0. To revert this update you can set `contentPadding = PaddingValues(0.dp,44.dp,0.dp,44.dp)`. ([I572bb](https://android-review.googlesource.com/#/q/I572bb9f18fcb772426dcd09ece5f9663c1fbc6da))
- Updated the public API surface to align with recent API review feedback. ([I71aff](https://android-review.googlesource.com/#/q/I71aff5d529bc7bdc45ae2161d0d15658b18f1571), [b/532657001](https://issuetracker.google.com/issues/532657001))

**External Contribution**

- Fixed Material3 `Slider` `Label` not showing while dragging the slider by its thumb with a mouse. ([I97a6d](https://android-review.googlesource.com/#/q/I97a6d289dca13068ce0d8879e3ce348d4f36cbf2), [b/533483487](https://issuetracker.google.com/issues/533483487))
...
- Added a new `material3-ripple` library ([I1b3a3](https://android-review.googlesource.com/q/I1b3a3e310538661ae4f1bc36bcbd6dd88f044f28)), which adds support for drawing ripples that visually display focus using inset focus rings instead of an opacity layer. This new library acts as a replacement for `material-ripple`, and expected usage is similar:
...
- [`HorizontalCenteredHeroCarousel`](https://developer.android.com/reference/kotlin/androidx/compose/material3/carousel/HorizontalCenteredHeroCarousel.composable#HorizontalCenteredHeroCarousel(androidx.compose.material3.carousel.CarouselState,androidx.compose.ui.Modifier,androidx.compose.ui.unit.Dp,androidx.compose.ui.unit.Dp,androidx.compose.foundation.gestures.TargetedFlingBehavior,kotlin.Boolean,androidx.compose.ui.unit.Dp,androidx.compose.ui.unit.Dp,androidx.compose.foundation.layout.PaddingValues,kotlin.Function2))
- [`VerticalDragHandle`](https://developer.android.com/reference/kotlin/androidx/compose/material3/VerticalDragHandle.composable#VerticalDragHandle(androidx.compose.ui.Modifier,androidx.compose.material3.DragHandleSizes,androidx.compose.material3.DragHandleColors,androidx.compose.material3.DragHandleShapes,androidx.compose.foundation.interaction.MutableInteractionSource))
- Secure text fields for password entry fields
  - [`SecureTextField`](https://developer.android.com/reference/kotlin/androidx/compose/material3/OutlinedSecureTextField.composable#OutlinedSecureTextField(androidx.compose.foundation.text.input.TextFieldState,androidx.compose.ui.Modifier,kotlin.Boolean,androidx.compose.ui.text.TextStyle,androidx.compose.material3.TextFieldLabelPosition,kotlin.Function1,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Boolean,androidx.compose.foundation.text.input.InputTransformation,androidx.compose.foundation.text.input.TextObfuscationMode,kotlin.Char,androidx.compose.foundation.text.KeyboardOptions,androidx.compose.foundation.text.input.KeyboardActionHandler,kotlin.Function2,androidx.compose.ui.graphics.Shape,androidx.compose.material3.TextFieldColors,androidx.compose.foundation.layout.PaddingValues,androidx.compose.foundation.interaction.MutableInteractionSource))
...
- Added Material 3 decorators for `BasicTextField2`
  ...
  - [`OutlineTextfield`](https://developer.android.com/reference/kotlin/androidx/compose/material3/OutlinedTextField.composable#OutlinedTextField(androidx.compose.foundation.text.input.TextFieldState,androidx.compose.ui.Modifier,kotlin.Boolean,kotlin.Boolean,androidx.compose.ui.text.TextStyle,androidx.compose.material3.TextFieldLabelPosition,kotlin.Function1,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Boolean,androidx.compose.foundation.text.input.InputTransformation,androidx.compose.foundation.text.input.OutputTransformation,androidx.compose.foundation.text.KeyboardOptions,androidx.compose.foundation.text.input.KeyboardActionHandler,androidx.compose.foundation.text.input.TextFieldLineLimits,kotlin.Function2,androidx.compose.foundation.ScrollState,androidx.compose.ui.graphics.Shape,androidx.compose.material3.TextFieldColors,androidx.compose.foundation.layout.PaddingValues,androidx.compose.foundation.interaction.MutableInteractionSource))
...
- [Segmented Button](https://m3.material.io/components/segmented-buttons/overview)
  ...
  - [SingleChoiceSegmentedButtonRow](https://developer.android.com/reference/kotlin/androidx/compose/material3/SingleChoiceSegmentedButtonRow.composable#SingleChoiceSegmentedButtonRow(androidx.compose.ui.Modifier,androidx.compose.ui.unit.Dp,kotlin.Function1))
...
- [Time Pickers](https://m3.material.io/components/time-pickers/overview)
  - [TimePicker](https://developer.android.com/reference/kotlin/androidx/compose/material3/TimePicker.composable#TimePicker(androidx.compose.material3.TimePickerState,androidx.compose.ui.Modifier,androidx.compose.material3.TimePickerColors,androidx.compose.material3.TimePickerLayoutType))
  - [TimeInput](https://developer.android.com/reference/kotlin/androidx/compose/material3/TimeInput.composable#TimeInput(androidx.compose.material3.TimePickerState,androidx.compose.ui.Modifier,androidx.compose.material3.TimePickerColors))
