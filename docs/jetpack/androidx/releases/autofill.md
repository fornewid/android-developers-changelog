---
title: Autofill  |  Jetpack  |  Android Developers
...
[User Guide](/guide/topics/text/autofill)  [Code Sample](https://github.com/android/input-samples)

API Reference  
[androidx.autofill](/reference/kotlin/androidx/autofill/package-summary)

Improve autofill accuracy via extending hints.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| June 4, 2025 | [1.3.0](/jetpack/androidx/releases/autofill#1.3.0) | - | - | - |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:670328%20status:open)
...
* Added new autofill hints for some requested types (Email OTP, Granular
  address fields, Promo codes, UPI ID). ([I89e2f](https://android-review.googlesource.com/#/q/I89e2f2b9631c8369c07248b32c239bde37f5aab8))
...
* Adds a set of APIs to support constructing Autofill inline suggestions, a new feature that was introduced in Android 11. See [the IME Autofill Guide](/guide/topics/text/ime-autofill) for more information.
* Specifically, v1 UI template [InlineSuggestionUi](/reference/androidx/autofill/inline/v1/InlineSuggestionUi) is introduced, with example code in the javadoc, to help IME developers to specify inline suggestion styles, and Autofill provider developers to construct inline suggestion contents.
