---
title: Security  |  Jetpack  |  Android Developers
...
[User Guide](/topic/security/data)  [Code Sample](https://github.com/android/security-samples)

API Reference  
[androidx.security.crypto](/reference/kotlin/androidx/security/crypto/package-summary)
...
| --- | --- | --- | --- | --- |
| security-crypto | [1.1.0](/jetpack/androidx/releases/security#security-crypto-1.1.0) | - | - | - || security-app-authenticator | [1.0.0](/jetpack/androidx/releases/security#security-app-authenticator-1.0.0) | - | - | - || security-app-authenticator-testing | [1.0.0](/jetpack/androidx/releases/security#security-app-authenticator-testing-1.0.0) | - | - | - || security-identity-credential | - | - | - | [1.0.0-alpha03](/jetpack/androidx/releases/security#security-identity-credential-1.0.0-alpha03) |
...
* Fixed issue retrieving key/values associated with shared preferences from
  [`getAll()`](/reference/androidx/security/crypto/EncryptedSharedPreferences#getAll()).
