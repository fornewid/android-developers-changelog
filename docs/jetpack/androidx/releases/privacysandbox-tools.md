...
|---|---|---|---|---|
| December 17, 2025 | - | - | - | [1.0.0-alpha14](https://developer.android.com/jetpack/androidx/releases/privacysandbox-tools#1.0.0-alpha14) |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1276143+status:open)
