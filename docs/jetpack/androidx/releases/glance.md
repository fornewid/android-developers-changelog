...
| --- | --- | --- | --- | --- |
| December 3, 2025 | [1.1.1](/jetpack/androidx/releases/glance#1.1.1) | [1.2.0-rc01](/jetpack/androidx/releases/glance#1.2.0-rc01) | - | - |
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1097239%20status:open)
...
* Simplify state handling by make `PreferencesGlanceStateDefinition` the default state handling.
  Removed `GlanceAppWidget.updateAppWidgetState` and introduced `updateAppWidgetState` that uses `Preferences` by default. ([I58963](https://android-review.googlesource.com/#/q/I589635adb59bcb4c6f87fd2c37e9f5db433fb360))
...
* Correct handling of OPTIONS\_APPWIDGET\_SIZES if present but empty. ([I01f82](https://android-review.googlesource.com/#/q/I01f8212b96b44467bfa336b8831f76369d702214))
