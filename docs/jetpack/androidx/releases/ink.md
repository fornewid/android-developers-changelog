...
Inspire best-in-class pen apps. Lower the developer barrier to entry for high performance, beautiful inking experiences. Supports Inking on Android and server-side JVM (currently supported on Linux for x86\_64).

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| June 17, 2026 | [1.0.0](/jetpack/androidx/releases/ink#1.0.0) | - | - | [1.1.0-alpha04](/jetpack/androidx/releases/ink#1.1.0-alpha04) |
