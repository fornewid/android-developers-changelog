---
title: Migrate to AndroidX  |  Jetpack  |  Android Developers
...
# Migrate to AndroidX Stay organized with collections Save and categorize content based on your preferences.
...
**Caution:** As of late 2021, most of the library ecosystem already supports
AndroidX natively. This means that your project is most likely already using
AndroidX libraries directly and there is no need to follow the steps in this
migration guide. Additionally, the
[`enableJetifier`](#migrate_an_existing_project_using_android_studio)
flag mentioned in this guide can lead to slower build times and should not be
used unless it’s necessary.
...
**Note:** We recommend working in a separate branch when migrating. Also try to
avoid refactoring your code while performing the migration.
