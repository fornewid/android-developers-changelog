...
> [Android Studio Chipmunk](https://developer.android.com/studio/preview/features#jetifier-build-analyzer).

## Prerequisites

Before you migrate, bring your app up to date.
We recommend updating your project to use the final version of the support
library: [version 28.0.0](https://developer.android.com/topic/libraries/support-library/revisions#28-0-0).
