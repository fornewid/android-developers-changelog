---
title: Distribution dashboard  |  Platform  |  Android Developers
...
# Distribution dashboard Stay organized with collections Save and categorize content based on your preferences.
...
* Distributions of installs, revenue, and issue rates for your app and for
  peersets of your choice.
* Data broken out by Android version, RAM, SoC, Vulkan version, OpenGL ES
  version, screen metrics, and ABI.
* Historical trends.
* CSV exports.
...
during a 28-day period ending on November 24, 2025.*
...
This section provides data about the relative number of Vulkan capable devices supported by each
[Android Vulkan Profile](/ndk/guides/graphics/android-baseline-profile).
