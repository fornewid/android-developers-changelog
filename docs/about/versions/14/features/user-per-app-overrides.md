---
title: Large screen user per-app overrides  |  Android Developers
...
# Large screen user per-app overrides Stay organized with collections Save and categorize content based on your preferences.
