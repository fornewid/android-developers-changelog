---
title: Migrate apps to Android 14  |  Android Developers
...
# Migrate apps to Android 14 Stay organized with collections Save and categorize content based on your preferences.
...
changes for all apps](/about/versions/14/behavior-changes-all). These changes might affect your app, even if you don't
...
**review the [behavior changes for all apps](/about/versions/14/behavior-changes-all)** introduced in
...
interfaces](/about/versions/14/changes/non-sdk-14)**. You should replace any restricted interface your app uses with
...
[behavior changes that affect apps targeting Android 14](/about/versions/14/behavior-changes-14).
...
toggles](/about/versions/14/migration#using_app_compatibility_toggles) to test your app with selected changes enabled.
...
`compileSdkVersion`, and re-compile the app. See the [SDK setup guide](/about/versions/14/setup-sdk) for
details.
...
changes](/about/versions/14/behavior-changes-14) before getting started.
...
**[behavior changes for apps targeting Android 14](/about/versions/14/behavior-changes-14)**. It's
...
Make sure to review and **test for uses of [restricted non-SDK interfaces](/about/versions/14/changes/non-sdk-14)**
...
see [Compatibility framework changes (Android 14)](/about/versions/14/reference/compat-framework-changes).