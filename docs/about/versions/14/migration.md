...
Android 14 to ensure a great experience for users updating to the
...
changes for all apps](https://developer.android.com/about/versions/14/behavior-changes-all). These changes might affect your app, even if you don't
change its `targetSdkVersion`.
Get Android 14 Flash an Android 14 system image to your device, or download
...
that your app originally targeted - no need to target Android 14.
Publish Sign, upload, and publish your updated Android App Bundle
or APK.

### Perform compatibility testing

For the most part, testing compatibility with Android 14 is
similar to ordinary app testing. This is a good time to review the [core app
quality guidelines](https://developer.android.com/docs/quality-guidelines/core-app-quality) and [best practices for testing](https://developer.android.com/training/testing).

To test, install your current published app on a device running
Android 14, and work through all the flows and functionality
while looking for issues. To help you focus your testing,
**review the [behavior changes for all apps](https://developer.android.com/about/versions/14/behavior-changes-all)** introduced in
Android 14 that can affect how your app functions or cause your
app to crash.

Also make sure to **review and test for uses of [restricted non-SDK
interfaces](https://developer.android.com/about/versions/14/changes/non-sdk-14)** . You should replace any restricted interface your app uses with
...
sure they work as expected on Android 14 and follow best
...
full support for Android 14 by updating its `targetSdkVersion`
and taking advantage of new APIs and capabilities in Android 14.
You can make these updates as soon as you're ready, keeping in mind the [Google
Play requirements](https://developer.android.com/distribute/play-policies) for targeting the new platform.

As you plan your work to fully support Android 14, review the
[behavior changes that affect apps targeting Android 14](https://developer.android.com/about/versions/14/behavior-changes-14).
...
toggles](https://developer.android.com/about/versions/14/migration#using_app_compatibility_toggles) to test your app with selected changes enabled.

The following steps describe how to fully support Android 14.
Get Android 14 SDK Install the latest version of Android Studio preview to build
with Android 14. Make sure you have an Android 14 device or
emulator.  
...
Android 14. Identify areas where your app might be affected,
and plan how to support them.
Check against new privacy changes Make code and architecture changes needed to support Android 14's
user privacy changes.
Adopt Android 14 features Take advantage of Android 14 APIs to bring new features and
capabilities to your apps. Recompile for Android 14.
Test Test on an Android 14 device or emulator. Focus on areas
...
Final update Once Android 14 APIs are final, update your
...
To start testing for full Android 14 support, use the latest
preview version of Android Studio to download the Android 14 SDK
and any other tools you need. Next, update your app's `targetSdkVersion` and
`compileSdkVersion`, and re-compile the app. See the [SDK setup guide](https://developer.android.com/about/versions/14/setup-sdk) for
details.

### Test your Android 14 app

Once you've compiled the app and installed it on a device running
Android 14, begin testing to ensure that the app works properly
when targeting Android 14. Some behavior changes apply only when
your app is targeting the new platform, so you'll want to [review those
changes](https://developer.android.com/about/versions/14/behavior-changes-14) before getting started.
...
**[behavior changes for apps targeting Android 14](https://developer.android.com/about/versions/14/behavior-changes-14)** . It's
...
Make sure to review and **test for uses of [restricted non-SDK interfaces](https://developer.android.com/about/versions/14/changes/non-sdk-14)**
...
Android 14 includes compatibility toggles that make it easier to test your app
...
development for Android 14 support, the toggles can help. For more information,
see [Compatibility framework changes (Android 14)](https://developer.android.com/about/versions/14/reference/compat-framework-changes).