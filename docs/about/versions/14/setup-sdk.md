---
title: Set up the Android 14 SDK  |  Android Developers
...
# Set up the Android 14 SDK Stay organized with collections Save and categorize content based on your preferences.
...
2. In the **SDK Platforms** tab, expand the **Android 14.0 ("UpsideDownCake")**
...
perform app compatibility testing by using a debuggable app, an Android 14
device, and the [compatibility framework](/about/versions/14/reference/compat-framework-changes), without changing your app to
