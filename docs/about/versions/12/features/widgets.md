---
title: Android 12 widgets improvements  |  Android Developers
...
# Android 12 widgets improvements Stay organized with collections Save and categorize content based on your preferences.
...
![Alt text](/static/images/appwidgets/widget-intro.png "Widget examples")
...
**Caution:** The dimensions of rounded corners may vary across devices because
the size of the corner radius is controllable by both device
manufacturers (up to 16dp) and third-party launchers. We recommend
refreshing the widget to help avoid unsatisfactory results.
...
![Tokyo weather widget](/static/images/appwidgets/widget-weather.png)
...
![](/static/images/appwidgets/home.png)
