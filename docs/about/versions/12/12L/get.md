---
title: Get 12L  |  Android Developers
...
# Get 12L Stay organized with collections Save and categorize content based on your preferences.
...
4. In Android Studio, click **Tools > Device Manager**, then click **Create
   ...
   ![](/static/images/about/versions/12/12L-create-avd.png)
...
6. Find the 12L system image, called **Android API 32**, and click **Download**
   ...
   **Next**.
   ...
   ![](/static/images/about/versions/12/12L-system-image.png)
7. Finalize other settings for your virtual device, then click **Finish**.

   ![](/static/images/about/versions/12/12L-device-configuration.png)
8. After returning to the list of virtual devices in the Device Manager, find
   your 12L virtual device and click **Launch**
   ![](/static/images/about/versions/12/12L-launch-avd-icon.png) to
   start it.

   ![](/static/images/about/versions/12/12L-launch-avd-full.png)
...
**Note:** Future Android 12 platform updates might not be available for some of
these devices if the device's support window has passed.
