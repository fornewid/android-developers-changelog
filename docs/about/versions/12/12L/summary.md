...
You can get started by downloading the [12L emulator](https://developer.android.com/about/versions/12/12L/get#set-up-avd) or by [getting 12L on a partner device](https://developer.android.com/about/versions/12/12L/get#on_partner).
...
The new Taskbar is reported to applications as an Inset, even though 12L doesn't introduce a new inset API.
...
For more details, see [Device compatibility mode](https://developer.android.com/guide/practices/device-compatibility-mode).
...
New checks were added to assess each app's quality against our [large screen app quality guidelines](https://developer.android.com/docs/quality-guidelines/large-screens-app-quality) to ensure that we surface the best possible apps on those devices. When an app is not optimized for large screens, large screen users now see a notice on the app's Play Store listing page to help them find apps that will work best on their device.

Play is also introducing large-screen-specific app ratings, as [announced in August 2021](https://android-developers.googleblog.com/2021/08/making-ratings-and-reviews-better-for.html), so users will be able to rate how your app works on their large screen devices.
...
As the 12L feature drop comes to more and more large screen devices, now is the time to test your apps and optimize them for large screens.

You can get started by [setting up the 12L emulator](https://developer.android.com/about/versions/12/12L/get) or by [getting 12L on a partner device](https://developer.android.com/about/versions/12/12L/get#on_partner). You'll be able to see the latest system UI changes for large screens, try your apps with the taskbar and split screen mode, test your app in compatibility mode, and even try activity embedding with the Jetpack WindowManager APIs.
...
After [creating virtual devices for 12L](https://developer.android.com/about/versions/12/12L/get), you'll want to test your app with some common large screen use cases to make sure that your app responds how you want. Here are a few recommended areas, with links to more details about related resources that can help you optimize your app for large screens:
