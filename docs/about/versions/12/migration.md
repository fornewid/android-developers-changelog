...
changes for all apps](https://developer.android.com/about/versions/12/behavior-changes-all). These changes might affect your app, even if you don't
change its `targetSdkVersion`.
Get Android 12 Flash an Android 12 system image to your device, or download
...
**review the [behavior changes for all apps](https://developer.android.com/about/versions/12/behavior-changes-all)** introduced in
...
interfaces](https://developer.android.com/about/versions/12/non-sdk-12)** . You should replace any restricted interface your app uses with
...
[behavior changes that affect apps targeting Android 12](https://developer.android.com/about/versions/12/behavior-changes-12).
...
toggles](https://developer.android.com/about/versions/12/migration#using_app_compatibility_toggles) to test your app with selected changes enabled.

The following steps describe how to fully support Android 12.
Get Android 12 SDK Install the latest version of Android Studio preview to build
...
Check against new privacy changes Make code and architecture changes needed to support Android 12's
user privacy changes.
Adopt Android 12 features Take advantage of Android 12 APIs to bring new features and
capabilities to your apps. Recompile for Android 12.
Test Test on an Android 12 device or emulator. Focus on areas
...
Final update Once Android 12 APIs are final, update your
...
`compileSdkVersion`, and re-compile the app. See the [SDK setup guide](https://developer.android.com/about/versions/12/setup-sdk) for
details.
...
changes](https://developer.android.com/about/versions/12/behavior-changes-12) before getting started.
...
**[behavior changes for apps targeting Android 12](https://developer.android.com/about/versions/12/behavior-changes-12)** . It's
also a good time to check your app against the [core app quality guidelines](https://developer.android.com/develop/quality-guidelines/core-app-quality)
and [best practices for testing](https://developer.android.com/training/testing).

Make sure to review and **test for uses of [restricted non-SDK interfaces](https://developer.android.com/about/versions/12/non-sdk-12)**
...
see [Compatibility framework changes (Android 12)](https://developer.android.com/about/versions/12/reference/compat-framework-changes).