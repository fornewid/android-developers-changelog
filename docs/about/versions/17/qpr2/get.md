---
title: https://developer.android.com/about/versions/17/qpr2/get
url: https://developer.android.com/about/versions/17/qpr2/get
source: md.txt
---

![Android logo below the word 'Android'](https://developer.android.com/static/images/lockups/android-stacked.svg)

You can get Android 17 QPR 2 in any of the following ways:

- [Get Android 17 QPR 2 on a Google Pixel device](https://developer.android.com/about/versions/17/qpr2/get#on_pixel)
- [Set up the Android Emulator](https://developer.android.com/about/versions/17/qpr2/get#on_emulator)
- [Get a generic system image (GSI)](https://developer.android.com/about/versions/17/qpr2/get#on_gsi)

## Get Android 17 Beta on a Google Pixel device

To get Android 17 QPR 2 on a supported Google Pixel device, [enroll your device in the Android Beta for Pixel program](https://g.co/androidbeta).

<br />

Enrolling is a simple and fast process, and it's highly recommended for early adopters and developers. In most cases, you don't need to do a full reset of your data to move to the Android 17 QPR 2 Beta, but it's recommended that you back up data before enrolling your device.
...
[Enroll in Android 17 QPR 2 Beta for Pixel](https://www.google.com/android/beta)

### Supported Google Pixel devices

Android 17 QPR 2 OTAs and downloads are available for the following Pixel devices:
...
Alternatively, if you'd rather flash your device, we recommend using the [Android Flash Tool](https://flash.android.com/preview/cinnamonbun-qpr2-beta2). If you need to flash your device manually for some other reason, you can get an Android 17 QPR 2 system image for your device on the [Pixel downloads page](https://developer.android.com/about/versions/17/qpr2/download). See the general instructions on the downloads page for how to flash a system image to your device. This approach can be useful when you need more control over testing, such as for automated testing or regression testing. Android 17 QPR 2 Beta images are available for [supported Pixel devices](https://developer.android.com/about/versions/17/qpr2/get#google-pixel-devices).
...
- [Phone](https://developer.android.com/about/versions/17/qpr2/get#phone-avd)
- [Tablet or large-screen device](https://developer.android.com/about/versions/17/qpr2/get#large-screen-avd)
...
5. From the **Phone Category tab** , select a device definition for a [supported Pixel device](https://developer.android.com/about/versions/17/qpr2/get#on_pixel), then click the **Next** button.
