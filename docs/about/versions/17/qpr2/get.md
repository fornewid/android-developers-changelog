...
To get Android 17 QPR 2 on a supported Google Pixel device, [enroll your device
in the Android Beta for Pixel program](https://g.co/androidbeta).
...
your data to move to the Android 17 QPR 2 Beta, but it's recommended that you
...
[Enroll in Android 17 QPR 2 Beta for
Pixel](https://www.google.com/android/beta)

### Supported Google Pixel devices

Android 17 QPR 2 OTAs and downloads are available for the following Pixel
devices:
...
5. From the **Phone Category tab** , select a device definition for a
   [supported Pixel device](https://developer.android.com/about/versions/17/qpr2/get#on_pixel), then click the **Next** button.
