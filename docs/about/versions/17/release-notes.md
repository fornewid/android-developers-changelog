...
* **Cleartext Deprecation**: [`android:usesCleartextTraffic`](/guide/topics/manifest/application-element#usesCleartextTraffic)
  is deprecated. Apps targeting SDK 37+ relying on this attribute will default to blocking cleartext; migrate to [**Network Security Configuration**](/training/articles/security-config).
