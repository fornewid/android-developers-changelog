---
title: https://developer.android.com/about/versions/17/changes/bg-audio
...
| Audio playback | Playback is silenced No exceptions, no failure message provided by any API | [`AudioTrack.write()`](https://developer.android.com/reference/android/media/AudioTrack#write(float[],%20int,%20int,%20int)) (NDK) [`AAudioStream_write`](https://developer.android.com/ndk/reference/group/audio#group___audio_1ga052d406b198490072eb04b5f2074c9a3) [OpenSL ES for Android](https://developer.android.com/ndk/guides/audio/opensl/opensl-for-android) Any client side media libraries that manage playback such as media3, Exoplayer and Oboe could also be impacted. |
| Audio focus request | Returns `AUDIOFOCUS_REQUEST_FAILED` No effect on audio playback of other apps, no focus acquired | [`AudioManager.requestAudioFocus()`](https://developer.android.com/reference/android/media/AudioManager#requestAudioFocus(android.media.AudioFocusRequest)) |
| Volume and ringer mode APIs | No effect on ringer mode or volume (method call is silently ignored) No exceptions, no failure message provided by any API | [`AudioManager.setStreamVolume()`](https://developer.android.com/reference/android/media/AudioManager#setStreamVolume(int,%20int,%20int)) [`AudioManager.setStreamMute()`](https://developer.android.com/reference/android/media/AudioManager#setStreamMute(int,%20boolean)) [`AudioManager.adjustStreamVolume()`](https://developer.android.com/reference/android/media/AudioManager#adjustStreamVolume(int,%20int,%20int)) [`AudioManager.adjustVolume()`](https://developer.android.com/reference/android/media/AudioManager#adjustVolume(int,%20int)) [`AudioManager.adjustSuggestedStreamVolume()`](https://developer.android.com/reference/android/media/AudioManager#adjustSuggestedStreamVolume(int,%20int,%20int)) [`AudioManager.setRingerMode()`](https://developer.android.com/reference/android/media/AudioManager#setRingerMode(int)) |