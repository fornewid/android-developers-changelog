---
title: https://developer.android.com/about/versions/16/release-notes
...
| **API diff** | - [Baklava Beta 2 → API 36](https://developer.android.com/sdk/api_diff/36-incr/changes) - [API 35 → API 36](https://developer.android.com/sdk/api_diff/36/changes) |
...
| **API diff** | - [Baklava Beta 1 → Baklava Beta 2](https://developer.android.com/sdk/api_diff/b-beta2-incr/changes) - [API 35 → Baklava Beta 2](https://developer.android.com/sdk/api_diff/b-beta2/changes) |
...
| **API diff** | - [Baklava DP2 → Baklava Beta 1](https://developer.android.com/sdk/api_diff/b-beta1-incr/changes) - [API 35 → Baklava Beta 1](https://developer.android.com/sdk/api_diff/b-beta1/changes) |
...
- Get a [Generic System Image](https://developer.android.com/about/versions/16/gsi-release-notes) (GSI)
...
- Fixed issue that caused the radar map to disappear in the Pixel weather app. ([Issue# 407282089](https://issuetracker.google.com/issues/407282089))
- Fixed issues that impacted haptic performance and delayed feedback (Issues # [400455826](https://issuetracker.google.com/issues/400455826), [398829454](https://issuetracker.google.com/issues/398829454))
...
- Fixed issue that caused a system restart when a call was answered in some situations ([Issue # 402639338](https://issuetracker.google.com/issues/402639338))
...
- Apps that depend on any of the following libraries might experience intermittent crashes and other stability issues because these libraries rely on [internal ART structures](https://developer.android.com/about/versions/16/behavior-changes-all#art-changes):
...
- Fixed an issue that caused haptic feedback to be miscalibrated in some cases. ([Issue #392319999](https://issuetracker.google.com/issues/392319999), [Issue #400455826](https://issuetracker.google.com/issues/400455826))
- Fixed an issue that caused excessive battery drain even while a device wasn't in use. ([Issue #398329457](https://issuetracker.google.com/issues/398329457))
...
- Fixed an issue that caused the system Settings app to crash repeatedly on launch if the system language was set to a language other than English. ([Issue #403303683](https://issuetracker.google.com/issues/403303683))
- Fixed an issue that caused the screen brightness to oscillate between an app-specified brightness setting and the automatic, system-specified or user-specified brightness settings. ([Issue #392522561](https://issuetracker.google.com/issues/392522561))
...
- Get a [generic system image (GSI)](https://developer.android.com/about/versions/16/get#on_gsi).
...
- Fixed various issues that were causing excessive battery drain in some cases. ([Issue #396603519](https://issuetracker.google.com/issues/396603519), [Issue #396757426](https://issuetracker.google.com/issues/396757426), [Issue #400066003](https://issuetracker.google.com/issues/400066003), [Issue #397088375](https://issuetracker.google.com/issues/397088375))
- Fixed issues that sometimes caused devices to reboot unexpectedly. ([Issue #400003800](https://issuetracker.google.com/issues/400003800))
- Fixed an issue that caused the At a Glance widget to display out of date information on the always-on-display. ([Issue #392132215](https://issuetracker.google.com/issues/392132215))
...
- Fixed an issue that sometimes prevented devices from entering Doze mode. ([Issue #396603519](https://issuetracker.google.com/issues/396603519))
- Fixed issues that caused some animations to appear choppy while configuring live wallpapers. ([Issue #397659072](https://issuetracker.google.com/issues/397659072))
...
- [Improved security against Intent redirection attacks](https://developer.android.com/about/versions/16/behavior-changes-all#intent-redirect-attacks)
- [Edge to edge opt-out going away](https://developer.android.com/about/versions/16/behavior-changes-16#edge-to-edge)
- [Elegant font APIs deprecated and disabled](https://developer.android.com/about/versions/16/behavior-changes-16#elegant-text-height)
- [Hybrid auto-exposure](https://developer.android.com/about/versions/16/features#hybrid-auto-exposure)
- [Precise color temperature and tint adjustments](https://developer.android.com/about/versions/16/features#color-temperature-tint)
- [Motion photo capture intent actions](https://developer.android.com/about/versions/16/features#motion-photos)
- [UltraHDR image enhancements](https://developer.android.com/about/versions/16/features#ultra-hdr)
- [Custom graphical effects with AGSL](https://developer.android.com/about/versions/16/features#agsl)
- [Measurement system customization](https://developer.android.com/about/versions/16/features#measurement-systems)
- [Content handling for live wallpapers](https://developer.android.com/about/versions/16/features#live-wallpapers)
- [Headroom APIs in ADPF](https://developer.android.com/about/versions/16/features#headroom-apis)
- [Key sharing API](https://developer.android.com/about/versions/16/features#key-sharing)
- [Standardized picture and audio quality framework for TVs](https://developer.android.com/about/versions/16/features#media-quality-apis)
- [Improved accessibility APIs](https://developer.android.com/about/versions/16/features#a11y-apis)
...
- Fixed an issue that sometimes caused the system UI to crash when interacting with certain elements in WebViews. ([Issue #392011635](https://issuetracker.google.com/issues/392011635))
- Fixed issues that sometimes caused devices to freeze and restart during calls. ([Issue #392364716](https://issuetracker.google.com/issues/392364716))
- Fixed issues that caused the Google Home app to crash intermittently when running on Android 16 Beta builds. ([Issue #391922779](https://issuetracker.google.com/issues/391922779))
- Fixed issues where the language picker menu (accessed by long pressing the spacebar) was changing the window, which caused the IME to hide in apps that had set their `softInputMode` to `STATE_ALWAYS_HIDDEN`. ([Issue #388201594](https://issuetracker.google.com/issues/388201594))
...
- [Support for 3-button navigation](https://developer.android.com/about/versions/16/behavior-changes-all#three-button-predictive-back)
- [Virtual device owner overrides](https://developer.android.com/about/versions/16/behavior-changes-all#virtual-device-owner-overrides)
- [Migration or opt-out required for predictive back](https://developer.android.com/about/versions/16/behavior-changes-16#predictive-back)
...
- [Generic ranging APIs](https://developer.android.com/about/versions/16/features#generic-ranging)
- [Advanced Professional Video](https://developer.android.com/about/versions/16/features#apv)
- [Vertical text](https://developer.android.com/about/versions/16/features#vertical-text)
- [Phone as microphone input for voice calls with LEA hearing aids](https://developer.android.com/about/versions/16/features#lea-phone-input)
- [Ambient volume controls for LEA hearing aids](https://developer.android.com/about/versions/16/features#lea-ambient-volume)
...
- An issue with Java LazyValue ClassLoader sometimes causes apps to crash with a `ClassNotFoundException`.
- Simulated touch events fail while using ADB or accessibility services.
...
- [Predictive back updates](https://developer.android.com/about/versions/16/features#predictive-back-updates)
- [Richer haptics](https://developer.android.com/about/versions/16/features#rich-haptics)
- [System-triggered profiling](https://developer.android.com/about/versions/16/features#system-triggered-profiling)
- [Start component in ApplicationStartInfo](https://developer.android.com/about/versions/16/features#start-component)
- [Better job introspection](https://developer.android.com/about/versions/16/features#feature-pending-job-reason-history)
- [Adaptive refresh rate](https://developer.android.com/about/versions/16/features#arr)
- [Ranging with enhanced security](https://developer.android.com/about/versions/16/features#secure-ranging)
- [Photo picker improvements](https://developer.android.com/about/versions/16/features#photo-picker-improvements)
- [Health Connect updates](https://developer.android.com/about/versions/16/features#health-connect)
...
- Fixed an issue that sometimes caused the screen brightness on a device to be set to 0% when the device was woken up. ([Issue #379979158](https://issuetracker.google.com/issues/379979158))
- Fixed an issue that caused the Terminal app to display a "No local assets" error when launched. ([Issue #380010668](https://issuetracker.google.com/issues/380010668))
...
- [Photo picker improvements](https://developer.android.com/about/versions/16/features#photo-picker-improvements)
- [Health Connect updates](https://developer.android.com/about/versions/16/features#health-connect)
- [Privacy Sandbox on Android](https://developer.android.com/about/versions/16/features#privacy-sandbox)
