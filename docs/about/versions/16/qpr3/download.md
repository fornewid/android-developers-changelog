...
Use the following links and instructions to update your supported device to the latest build. See [Get Android 16 QPR3](https://developer.android.com/about/versions/16/qpr3/get) for other ways to get Android 16 QPR3 for testing and development.
...
Connect your device over USB, then navigate to Android Flash Tool using the following link and follow the onscreen guidance: <https://flash.android.com/preview/baklava-qpr3-beta2.1>.
...
You can choose to [return to the latest public build](https://developer.android.com/about/versions/16/qpr3/download#public) at any time.
