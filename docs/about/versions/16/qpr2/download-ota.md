...
Applying an OTA image can help you recover a device that received an OTA update for an Android 16 Beta build but wouldn't start up after the update was installed. If you are trying to get Android 16 on your device but you aren't trying to recover from a failed OTA update, see [Get Android 16](https://developer.android.com/about/versions/16/qpr2/get) instead.
