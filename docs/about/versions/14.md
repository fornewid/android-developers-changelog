---
title: Android 14  |  Android Developers
...
### [Android 14](https://developer.android.com/about/versions/14/get)
...
[Get started](https://developer.android.com/about/versions/14/get)
[Test your app](https://developer.android.com/about/versions/14/get#on_emulator)
...
1. **Set up a runtime environment** — see [Get Android 14](/about/versions/14/get)
   to flash a Google Pixel device or set up an emulator.
2. **Set up Android Studio** — try the Android 14 SDK and tools. See the [SDK setup](/about/versions/14/setup-sdk) page for steps.- **Learn about what's new** — review the [behavior changes for all apps](/about/versions/14/behavior-changes-all) and the
     [behavior changes for apps targeting
     Android 14](/about/versions/14/behavior-changes-14) that might've affected your app.
   - **Test your app** — run through all flows to look for issues.
     [Toggle behavior changes](/about/versions/14/reference/compat-framework-changes)
     at runtime to isolate issues.
   - **Update your app** — target Android 14 if possible, and test with users
