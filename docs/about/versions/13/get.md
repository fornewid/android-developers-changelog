...
4. In Android Studio, click **Tools \> AVD Manager**, and follow the
   ...
   Be sure to select a device definition for a [supported Pixel device](https://developer.android.com/about/versions/13/get#on_pixel)
...
8. After returning to the list of virtual devices in the Device Manager, find
   ...
   ![](https://developer.android.com/static/images/about/versions/13/13-launch-avd-icon.png) to
   start it.
...
[Downloads section](https://developer.android.com/topic/generic-system-image/releases#android-gsi-13) on the
GSI binaries page.
...
[Android Emulator for TV](https://developer.android.com/training/tv/start/start#run-on-a-virtual-device).
