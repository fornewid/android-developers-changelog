...
28+](https://developer.android.com/about/versions/pie/android-9.0-changes-28).
...
[`CALL_LOG`](https://developer.android.com/reference/android/Manifest.permission_group#CALL_LOG) [permission
group](https://developer.android.com/guide/topics/permissions/overview#perm-groups) and moves the
[`READ_CALL_LOG`](https://developer.android.com/reference/android/Manifest.permission#READ_CALL_LOG),
[`WRITE_CALL_LOG`](https://developer.android.com/reference/android/Manifest.permission#WRITE_CALL_LOG), and
...
[runtime
permissions best practices](https://developer.android.com/distribute/best-practices/develop/runtime-permissions), it can handle the change in permission group.
...
[phone state
broadcast](https://developer.android.com/reference/android/telephony/TelephonyManager#action_phone_state_changed),
such as for incoming and outgoing calls and are accessible from the
[`PhoneStateListener`](https://developer.android.com/reference/android/telephony/PhoneStateListener) class.
Without the
[`READ_CALL_LOG`](https://developer.android.com/reference/android/Manifest.permission#READ_CALL_LOG)
...
[Wi-Fi scanning restrictions](https://developer.android.com/guide/topics/connectivity/wifi-scan#wifi-scan-restrictions).
...
method, which returns a [`WifiInfo`](https://developer.android.com/reference/android/net/wifi/WifiInfo)
...
The [`NETWORK_STATE_CHANGED_ACTION`](https://developer.android.com/reference/android/net/wifi/WifiManager#NETWORK_STATE_CHANGED_ACTION)
...
[Restrictions on Non-SDK Interfaces](https://developer.android.com/about/versions/pie/restrictions-non-sdk-interfaces)
...
example](https://developer.android.com/training/articles/security-ssl#HttpsExample).
...
includes](https://developer.android.com/about/versions/oreo/android-8.0-changes#security-all).
...
[`NoSuchAlgorithmException`](https://developer.android.com/reference/java/security/NoSuchAlgorithmException).
...
device](https://developer.android.com/about/versions/marshmallow/android-6.0#adoptable-storage) technology
...
tests, see [Set up project for Android Test](https://developer.android.com/training/testing/set-up-project).

#### Test suite build changes

The `addRequirements()` method in the
[`TestSuiteBuilder`](https://developer.android.com/reference/android/test/suitebuilder/TestSuiteBuilder)
...
The `https://developer.android.com/reference/android/os/StrictMode` class is a development tool that helps
...
`https://developer.android.com/reference/android/os/NetworkOnMainThreadException` when using the
`https://developer.android.com/reference/android/os/StrictMode.ThreadPolicy.Builder#detectNetwork()` or
`https://developer.android.com/reference/android/os/StrictMode.ThreadPolicy.Builder#detectAll()` methods to get a
...
tagged using the
`https://developer.android.com/reference/android/net/TrafficStats#setThreadStatsTag(int)` method,
...
with a `https://developer.android.com/reference/android/os/ParcelFileDescriptor` container.
...
`https://developer.android.com/reference/android/app/usage/NetworkStatsManager#queryDetailsForUidTag(int, java.lang.String, long, long, int, int)` method.
...
`https://developer.android.com/reference/android/net/TrafficStats#untagSocket(java.net.Socket)` before sending the
socket.

## Reported amount of available bytes in socket

The `https://developer.android.com/reference/java/net/SocketImpl#available()` method returns `0` when it's called
after invoking the `https://developer.android.com/reference/java/net/SocketImpl#shutdownInput()` method.

## More detailed network capabilities reporting for VPNs

In Android 8.1 (API level 27) and lower, the
`https://developer.android.com/reference/android/net/NetworkCapabilities` class only reported a limited set of
information for VPNs, such as
`https://developer.android.com/reference/android/net/NetworkCapabilities#TRANSPORT_VPN`, but omitting
`https://developer.android.com/reference/android/net/NetworkCapabilities#NET_CAPABILITY_NOT_VPN`. This limited
information made it difficult to determine if using a VPN would result in charges
to the app's user. For example, checking
`https://developer.android.com/reference/android/net/NetworkCapabilities#NET_CAPABILITY_NOT_METERED` would not
...
The public APIs that rely on these files, `https://developer.android.com/reference/android/net/TrafficStats` and
`https://developer.android.com/reference/android/app/usage/NetworkStatsManager`, continue to work as intended.
...
Manifest](https://developer.android.com/reference/android/R.attr#screenOrientation), or programmatically
with [setRequestedOrientation()](https://developer.android.com/reference/android/app/Activity#setRequestedOrientation(int)).
...
use a nonstandard [`ClassLoader`](https://developer.android.com/reference/java/lang/ClassLoader) structure,
...
with a [`NoClassDefFoundError`](https://developer.android.com/reference/java/lang/NoClassDefFoundError),
...
[`getCameraIdList()`](https://developer.android.com/reference/android/hardware/camera2/CameraManager#getCameraIdList()).
