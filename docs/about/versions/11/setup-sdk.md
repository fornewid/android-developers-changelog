---
title: Set up the Android 11 SDK  |  Android Developers
...
# Set up the Android 11 SDK Stay organized with collections Save and categorize content based on your preferences.
...
2. In the **SDK Platforms** tab, expand the **Android 11.0 ("R")** section and
...
**Note:** If you're not ready yet to fully support Android 11, you can still perform
app compatibility testing using a debuggable app, an Android 11 device, and the
[compatibility framework](/guide/app-compatibility/test-debug), without changing either your app's
