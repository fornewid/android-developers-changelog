---
title: Updates to non-SDK interface restrictions in Android 11  |  Android Developers
...
# Updates to non-SDK interface restrictions in Android 11 Stay organized with collections Save and categorize content based on your preferences.
...
* Non-SDK interfaces that were unsupported (greylisted) in Android 10 (API
  level 29) that are now [blocked in Android 11 (API level 30)](#new-blocked).
* Non-SDK interfaces that were [added to the Android SDK in Android 11](#new-sdk).
