...
**review the [behavior changes for all apps](https://developer.android.com/about/versions/15/behavior-changes-all)** introduced in
...
interfaces](https://developer.android.com/about/versions/15/changes/non-sdk-15)** . You should replace any restricted interface your app uses with
...
[behavior changes that affect apps targeting Android 15](https://developer.android.com/about/versions/15/behavior-changes-15).
...
`compileSdkVersion`, and re-compile the app. See the [SDK setup guide](https://developer.android.com/about/versions/15/setup-sdk) for
details.
...
changes](https://developer.android.com/about/versions/15/behavior-changes-15) before getting started.
...
**[behavior changes for apps targeting Android 15](https://developer.android.com/about/versions/15/behavior-changes-15)** . It's
...
Make sure to review and **test for uses of [restricted non-SDK interfaces](https://developer.android.com/about/versions/15/changes/non-sdk-15)**
...
see [Compatibility framework changes (Android 15)](https://developer.android.com/about/versions/15/reference/compat-framework-changes).