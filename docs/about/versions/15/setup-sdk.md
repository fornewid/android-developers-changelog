...
device (including [virtual devices](https://developer.android.com/studio/run/managing-avds)), and the [compatibility framework](https://developer.android.com/about/versions/15/reference/compat-framework-changes),
