...
The easiest way to get Android 15 QPR2 on a Pixel device is to [enroll your
...
Tool](https://flash.android.com/preview/vic-qpr2-beta3).

If you'd rather flash your device manually, you can get a system image for your
device on the [Factory images for Google Pixel](https://developer.android.com/about/versions/15/download) page. See the general
...
ready to download a GSI binary, see the [Downloads section](https://developer.android.com/about/versions/15/gsi-release-notes#downloads) on the GSI
binaries page.