---
title: Get Android 15 QPR beta builds  |  Android Developers
...
# Get Android 15 QPR beta builds Stay organized with collections Save and categorize content based on your preferences.
...
* [Get QPR2 on a Google Pixel device](#on_pixel)
...
device on the [Factory images for Google Pixel](/about/versions/15/download) page. See the general
...
ready to download a GSI binary, see the [Downloads section](/about/versions/15/gsi-release-notes#downloads) on the GSI
binaries page.