---
title: https://developer.android.com/about/versions/15/get
url: https://developer.android.com/about/versions/15/get
source: md.txt
---
...
- [Get Android 15 on a Google Pixel device](https://developer.android.com/about/versions/15/get#on_pixel)
- [Set up the Android Emulator](https://developer.android.com/about/versions/15/get#on_emulator)
- [Get a generic system image (GSI)](https://developer.android.com/about/versions/15/get#on_gsi)

## Get Android 15 on a Google Pixel device

If you have a [supported Pixel device](https://developer.android.com/about/versions/15/get#google-pixel-devices), you can [check and update your Android version](https://support.google.com/pixelphone/answer/7680439) to receive Android 15 over the air.

In most cases, you don't need to do a full reset of your data to move to Android 15, but it's recommended that you back up data before installing Android 15 on your device.
...
Alternatively, if you'd rather flash your device, we recommend using the [Android Flash Tool](https://flash.android.com/release/15.0.0).

If you need to flash your device manually for some other reason, you can get the Android 15 system image for your device on the [Pixel downloads page](https://developers.google.com/android/images). Read the general instructions for how to [flash a system image](https://developers.google.com/android/images#instructions) to your device. This approach can be useful when you need more control over testing, such as for automated testing or regression testing.
...
- [Phone](https://developer.android.com/about/versions/15/get#phone-avd)
- [Tablet or large-screen device](https://developer.android.com/about/versions/15/get#large-screen-avd)
...
4. In Android Studio, click **Tools \> Device Manager** , then click **Add a new device ![](https://developer.android.com/static/studio/images/buttons/ic_plus_dark.png) \> Create Virtual Device** in the **Device Manager** panel.
   ...
   Studio](https://developer.android.com/static/about/versions/15/images/15-create-avd.png)
5. Select a device definition for a [supported Pixel device](https://developer.android.com/about/versions/15/get#on_pixel) in the **Phone** Category tab, then click **Next**.

6. Find the Android 15 system image, called **VanillaIceCream** , and click **Download** ![](https://developer.android.com/static/about/versions/15/images/15-studio-download.png) next to the **Release Name** to get it. After the download completes, select this system image and click **Next**.

7. Finalize other settings for your virtual device, then click **Finish**.

8. After returning to the list of virtual devices in the Device Manager, find your Android 15 virtual device and click **Start** ![](https://developer.android.com/static/about/versions/15/images/15-launch-avd-icon.png).
...
![](https://developer.android.com/static/about/versions/15/images/15-resizable-emulator.png) Use the resizable device definition for the Android Emulator to test Android 15 in a variety of large screen scenarios.
...
- [Behavior changes that affect all apps](https://developer.android.com/about/versions/15/behavior-changes-all)
- [Behavior changes that affect only apps that target Android 15](https://developer.android.com/about/versions/15/behavior-changes-15)

To learn more about new APIs and features available in Android 15, read [Android 15 features](https://developer.android.com/about/versions/15/features).