---
title: Ice Cream Sandwich  |  Android Developers
url: https://developer.android.com/about/versions/android-4.0-highlights
source: html-scrape
---

* [Android Developers](https://developer.android.com/)

# Ice Cream Sandwich Stay organized with collections Save and categorize content based on your preferences.
...
* [Android 4.0 for Users](#UserFeatures)
* [Android 4.0 for Developers](#DeveloperApis)

## Android 4.0 for Users

[![](/static/sdk/images/4.0/home.png)](/static/sdk/images/4.0/home-lg.png)
[![](/static/sdk/images/4.0/lock.png)](/static/sdk/images/4.0/lock-lg.png)
...
simple, intuitive gestures. Refined **animations** and feedback
throughout the system make interactions engaging and interesting. An entirely
**new typeface** optimized for high-resolution screens improves
readability and brings a polished, modern feel to the user interface.
...
**Multitasking** is a key strength of Android and it's made even
...
[![](/static/sdk/images/4.0/tasks.png)](/static/sdk/images/4.0/tasks-lg.png)

The Recent Apps list makes
multitasking simple.

[![](/static/sdk/images/4.0/lock-camera.png)](/static/sdk/images/4.0/lock-camera-lg.png)

Jump to the camera or see
notifications without unlocking.

[![](/static/sdk/images/4.0/contact-call.png)](/static/sdk/images/4.0/contact-call-lg.png)


For incoming calls, you can
respond instantly by text.

Rich and interactive **notifications** let users keep in
...
[![](/static/sdk/images/4.0/allapps.png)](/static/sdk/images/4.0/allapps-lg.png)
[![](/static/sdk/images/4.0/calendar-widget.png)](/static/sdk/images/4.0/calendar-widget-lg.png)
...
in All Apps launcher, users can now simply **drag an app** to get
information about it or immediately uninstall it, or disable a pre-installed app.
...
[![](/static/sdk/images/4.0/text-replace.png)](/static/sdk/images/4.0/text-replace-lg.png)

A spell-checker lets you find errors and fix them faster.

[![](/static/sdk/images/4.0/tts.png)](/static/sdk/images/4.0/tts-lg.png)

A powerful voice input
engine lets you dictate continuously.
...
**spell-checker** that locates and underlines errors and suggests
...
third-party dictionaries, spell-checkers, and other text services.

**Powerful voice input
engine**

Android 4.0 introduces a powerful new voice input engine that offers a
...
want, using the language they want. Users can **speak continuously** for a prolonged
...
[![](/static/sdk/images/4.0/usage-all.png)](/static/sdk/images/4.0/usage-all-lg.png)
[![](/static/sdk/images/4.0/usage-maps.png)](/static/sdk/images/4.0/usage-maps-lg.png)
...
for users who are blind or have visual impairments. Most important is a new
...
to offer an improved accessibility experience. The **Browser**
...
**touch gesture** during setup (clockwise square from upper left)
...
[![](/static/sdk/images/4.0/contact-faves.png)](/static/sdk/images/4.0/contact-faves-lg.png)
[![](/static/sdk/images/4.0/contact-connect.png)](/static/sdk/images/4.0/contact-connect-lg.png)
[![](/static/sdk/images/4.0/contact-email.png)](/static/sdk/images/4.0/contact-email-lg.png)
...
**People app** that offers richer profile information, including a
...
[![](/static/sdk/images/4.0/camera.png)](/static/sdk/images/4.0/camera-lg.png)
[![](/static/sdk/images/4.0/gallery-edit.png)](/static/sdk/images/4.0/gallery-edit-lg.png)
[![](/static/sdk/images/4.0/gallery-share.png)](/static/sdk/images/4.0/gallery-share-lg.png)

Capture the picture you want,
edit, and share instantly.

**Rich and versatile camera
capabilities**

The Camera app includes many new features that let users capture special moments
with great photos and videos. After capturing images, they can edit and share
them easily with friends.
...
To make it easier to take great pictures of people, built-in **face
...
![](/static/sdk/images/4.0/gallery-widget.png)
...
their best, the Gallery now includes a powerful **photo editor**.
...
![](/static/sdk/images/4.0/live-effects.png)
...
**change the background** behind them to any stock or custom image,
for just the right setting when shooting video. Also available for video is
...
[![](/static/sdk/images/4.0/screenshot.png)](/static/sdk/images/4.0/screenshot-lg.png)
...
screenshots. Hardware buttons let them snap a **screenshot** and
store it locally. Afterward, they can view, edit, and share the screen shot in
Gallery or a similar app.

### Cloud-connected experience

[![](/static/sdk/images/4.0/browser-tabs.png)](/static/sdk/images/4.0/browser-tabs-lg.png)
[![](/static/sdk/images/4.0/browser.png)](/static/sdk/images/4.0/browser-lg.png)
...
![](/static/sdk/images/4.0/bbench.png)
...
In Android 4.0, email is easier to send, read, and manage. For composing
...
**integrated menu** of accounts and recent labels. To help users
...
[![](/static/sdk/images/4.0/beam.png)](/static/sdk/images/4.0/beam-lg.png)
...
Android Beam is an innovative, convenient feature for sharing across two
...
[![](/static/sdk/images/4.0/face-unlock.png)](/static/sdk/images/4.0/face-unlock-lg.png)

Face recognition lets you
...
Support for **Wi-Fi peer-to-peer (P2P)** lets users connect directly to nearby peer
...
Android 4.0 brings a unified UI framework that lets developers create
...
— as well as new elements and APIs.

For developers, the unified UI framework in Android 4.0 means new UI tools,
...
Android 4.0 extends social and sharing features to any application on the
device. Applications can integrate contacts, profile data, stream items,
and calendar events from any of the user’s activities or social networks.
...
the provider and display it in their applications.

The social API lets applications store standard contact data as well as new
...
auto-complete, to keep the most relevant contacts ranked closest to the top.

Applications can also let users set up a social connection to a contact from
...
to create the social connection.

Building on the social API, developers can add powerful new interactions that
span multiple social networks and contacts sources.
...
With user permission, any application can add events to the shared database
...
For lighter-weight access to calendar services, the Calendar app defines a
...
restaurant reservations or booking time with friends.
...
played in the call log tab of the platform’s Phone app.
...
For developers, Android Beam is a new way of triggering almost any type of
...
data over Bluetooth, without the need for user-visible pairing.

Even if developers do not add custom interactions based on Android Beam they
...
download or purchase the app right away.

**Modular sharing
widget**

The UI framework includes a new widget, ShareActionProvider, that lets
...
dispatching the intent when the user chooses from the menu.
...
Applications can now send processed data to the platform as a multiplexed
...
To support this low-level streaming, the platform introduces a new native API
based on [Khronos
OpenMAX AL 1.0.1](http://www.khronos.org/openmax/al/). The API is implemented on the same underlying services as
...
available in an upcoming release of the Android NDK.
...
A set of high-performance transformation filters let developers apply rich
...
Android 4.0 adds a new audio remote control API that lets media applications
...
playback without having to unlock and navigate to the music app.

Using the audio remote control API, any music or media app can register to
...
needed. Android's Wi-Fi P2P framework complies with the Wi-Fi Alliance's [Wi-Fi Direct™](http://www.wi-fi.org/discover-and-learn/wi-fi-direct)
certification program.

Wi-Fi peer-to-peer (P2P) opens new opportunities for developers to add innovative
...
connect a group of users for gaming, print files, and more.

**Bluetooth Health Device
Profile (HDP)**

Developers can now build powerful medical applications that use Bluetooth to
...
data analysis services, and others.

Using a framework API, applications can use Bluetooth to discover nearby
...
monitors, blood meters, thermometers, and scales.
...
A new layout, GridLayout, improves the performance of Android applications by
...
A new TextureView object lets developers directly integrate OpenGL ES
...
of having that surface participate fully in the normal view hierarchy.
...
**Text services API for
integrating spelling checkers**

Android 4.0 lets applications query available text services such as
...
Android 4.0 adds new accessibility features and an enhanced API to let
...
navigation, better feedback, and richer user interfaces.

**Accessibility
API**

To let applications manage interactions more effectively when accessibility
...
provides extra information about the event context.

Using the accessibility record and related APIs, applications can now access
...
A new framework API lets developers write text-to-speech engines and make
them available to any app requesting TTS capabilities.

### Efficient network usage

In Android 4.0, users can see how much network data their running apps are
...
Android 4.0 makes it easier for applications to manage authentication and
...
certificates and CAs securely.

**Address Space Layout
Randomization**

Android 4.0 now provides address space layout randomization (ASLR) to help
...
platform that provides access to L2TP and IPSec protocols.

**Device policy management
for camera**

The platform adds a new policy control for administrators who manage devices
