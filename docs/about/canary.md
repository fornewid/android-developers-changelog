---
title: Android Canary  |  Platform  |  Android Developers
...
# Android Canary Stay organized with collections Save and categorize content based on your preferences.
...
4. In Android Studio, click **Tools > Device Manager**, then click **Add a new
   device ![plus](/static/studio/images/buttons/ic_plus_dark.png) >
   Create Virtual Device** in the **Device Manager** panel.
5. Select a device definition, then click **Next**.
6. Find the Android Canary system image and click
   **Download**
