---
title: Trade-in mode on Android 16+  |  Android Developers' Blog
...
* Device information
  ...
  + API level to ensure correct OS version, e.g., launch\_level : 34
* Battery heath
  + Cycle count
  + Health
  + State, e.g., unknown, good, overheat, dead, over\_voltage, unspecified\_failure, cold, fair, not\_available, inconsistent
...
* And the list keeps growing! Stay up to date [here](https://androidsource.devsite.corp.google.com/docs/core/perf/trade-in-mode).
