---
title: Increasing app discovery and engagement on Google TV  |  Android Developers' Blog
...
[](/static/blog/assets/videos/GTV_Gemini_GOA_Toverview_72a7786a02/GTV_Gemini_GOA_Toverview_72a7786a02.mp4)
...
![GTV Pointer Remote Demo_SHELL (1).gif](/static/blog/assets/GTV_Pointer_Remote_Demo_SHELL_1_0c03db4156_xvSkx.webp)
...
* If you haven't already, now is the time to adopt [Jetpack Compose](/compose). Hover, scroll, and clicks are common input modalities that are supported on various form factors, and building your app with an adaptive UI framework enables code reusability and reduced maintenance.
...
* ## [Paul Lammertsma](/blog/authors/paul-lammertsma)
  ...
  [read\_more
  View profile](/blog/authors/paul-lammertsma)

  ![](/static/blog/assets/Paul_Lammertsma_2f7e1baf32_Z28iSTy.webp)
