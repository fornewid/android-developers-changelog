---
title: Android XR Updates for Unity, Unreal, and Godot  |  Android Developers' Blog
...
The [**Android XR Engine Hub**](/develop/xr/engine-hub) is currently available for Windows and is your mission control for development. It unifies your workflow across Unity, Unreal Engine, and Godot by serving as a high-speed bridge thatstreams device-created perception data straight from your device into the engine of your choice.

![DirectPreview_Low.gif](/static/blog/assets/Direct_Preview_Low_5bb20ac62c_Zf6Hp9.webp)
...
* **XR\_EXT\_hand\_tracking & hand\_interaction:** Streams 26-point hand meshes and joint data for immediate interaction testing.
* **XR\_EXT\_eye\_gaze\_interaction:** Virtualizes eye-gaze data to test UI and foveated logic on your PC.
* **XR\_EXT\_palm\_pose & XR\_EXT\_uuid:** Real-time precision tracking and persistent object ID streaming.
...
* [Learn more about Direct Preview](/develop/xr/engine-hub)
...
![ue5_1-02-ue-project-creation.png](/static/blog/assets/ue5_1_02_ue_project_creation_05b09f41b6_ZeLC3Q.webp)
...
* [View the Unreal Engine Developer Guide](/develop/xr/unreal)
...
* [View the Godot Developer Guide](/develop/xr/godot)
...
* [Interaction Framework Documentation](/develop/xr/axrif)
...
* ## [Luke Hopkins](/blog/authors/luke-hopkins)
  ...
  ![View Luke Hopkins's profile](/static/blog/assets/Luke_Hopkins_9c1e15d778_Z2o9b3q.webp)
...
* ## [Ryan Bartley](/blog/authors/ryan-bartley)
  ...
  [read\_more
  View profile](/blog/authors/ryan-bartley)

  ![View Ryan Bartley's profile](/static/blog/assets/Ryan_Bartley_35cf836cd8_ZgTUAO.webp)
