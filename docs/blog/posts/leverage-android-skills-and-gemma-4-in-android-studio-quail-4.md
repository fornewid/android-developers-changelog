---
title: Leverage Android skills and Gemma 4 in Android Studio Quail 4  |  Android Developers' Blog
...
Android Studio comes preloaded with [23 curated skills](/tools/agents/android-skills/browse), including:
...
* **System requirements:**You can run the smallest models with 12GB of RAM, but machines with 32GB+ RAM will run best. Please refer to [hardware requirements](/studio/gemini/use-a-local-model#try-the-gemma-4-model).
...
![as-agent-gemma2.gif](/static/blog/assets/as_agent_gemma2_89c9104c58_1hTG1Y.webp)
...
![Qual4InlineAsset_Canavs.png](/static/blog/assets/Qual4_Inline_Asset_Canavs_367ae7672f_ZcsFEm.webp)
...
* **API Key:**Use the latest Gemini models, such as Gemini 3.7 Flash, in your development flow as soon as they are available with your [Google AI Studio API key](/studio/gemini/add-api-key).  You can also use the [API key from other model providers](/studio/gemini/use-a-remote-model) like Anthropic or OpenAI right in Android Studio
...
#### [**Android Studio Quail 2**](/blog/posts/android-studio-quail-2-is-stable-multi-task-with-the-android-studio-ai-agent)
...
#### [**Android Studio Quail 3**](/studio/releases/past-releases/as-quail-3-release-notes)
...
👉[**Download Android Studio Quail 4 Stable Today**](/studio)

As always, your feedback shapes the future of Android development. Please check out[known issues](/studio/known-issues) or file bug reports and feature requests directly on our[official bug tracker](/studio/report-bugs).
...
* ## [Amman Asfaw](/blog/authors/amman-asfaw)
  ...
  [read\_more
  View profile](/blog/authors/amman-asfaw)
