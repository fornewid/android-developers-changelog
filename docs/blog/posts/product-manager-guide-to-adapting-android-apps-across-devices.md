---
title: A product manager's guide to adapting Android apps across devices  |  Android Developers' Blog
...
![500-plus-devices.png](/static/blog/assets/500_plus_devices_6428a9ddd7_Z2f6hLh.webp)
...
![goodbye.png](/static/blog/assets/goodbye_80078e92da_Z1xEPSX.webp)
...
![android-16-form-factors_2.png](/static/blog/assets/android_16_form_factors_2_a6f81b479e_Z1eUyG0.webp)
...
![three-step-workflow.png](/static/blog/assets/three_step_workflow_d6b69bf56a_Z20A1oX.webp)
...
2. **Address common UI issues:** Assess what feels awkward in your app UI today. We have a lot of guidance available on how you can easily translate your mobile app to other screens.
   1. Check the [Large screens design gallery](/large-screens/gallery) for inspiration and understanding how your app UI can evolve across devices using proven solutions to common UI challenges.
   ...
   3. Identify patterns where [canonical layouts](/develop/ui/compose/layouts/adaptive/canonical-layouts) (e.g. list-detail) could solve any UI awkwardness you identified. Could a list-detail view improve your app's navigation? Would a supporting pane on the side make better use of the extra space than a bottom sheet?
3. **Optimize your app incrementally, screen by screen:** It may be helpful to prioritize how you approach optimization because not everything needs to be perfectly adaptive on day one. Incrementally improve your app based on what matters most – it's not all or nothing.
   1. Start with the foundations. Check out the [large screen app quality guidelines](/docs/quality-guidelines/large-screen-app-quality) which tier and prioritize the fixes that are most critical to users. Remove orientation restrictions to support portrait and landscape, and ensure support for resizability (for when users are in split screen), and prevent major stretching of buttons, text fields, and images. These foundational fixes are critical, especially with API changes in Android 16 that will make these aspects even more important.
...
Maximize your apps' impact and unlock new user experiences. Learn more about [building adaptive apps](/adaptive-apps) today.
