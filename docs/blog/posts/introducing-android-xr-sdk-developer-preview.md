---
title: Introducing Android XR SDK Developer Preview  |  Android Developers' Blog
...
The Android XR SDK is built on the existing foundations of Android app development. We're also bringing the Play Store to Android XR, where [**most Android**](/develop/xr/get-started#app-manifest) **apps will automatically be made available** without any additional development effort. Users will be able to discover and use your existing apps in a whole new dimension. To differentiate your existing Compose app, you may [opt-in](/develop/xr/jetpack-xr-sdk/material-design#use-enablexrcomponentoverrides), to automatically spatialize Material Design (M3) components and [Compose for adaptive layouts](/develop/ui/compose/layouts/adaptive) in XR.

![apps_optimized.webp](/static/blog/assets/apps_optimized_9427c22aa9_Z1rpw7o.webp)
...
The Jetpack XR SDK includes new [Jetpack](/jetpack) libraries purpose-built for XR. The highlights include:

* [**Jetpack Compose for XR**](/develop/xr/jetpack-xr-sdk/develop-ui) - enables you to declaratively create spatial UI layouts and spatialize your existing 2D UI built with Compose or Views
* [**Material Design for XR**](/develop/xr/jetpack-xr-sdk/material-design) - includes components and layouts that automatically adapt for XR
* [**Jetpack SceneCore**](/develop/xr/jetpack-xr-sdk#jetpack-scenecore) - provides the foundation for building custom 3D experiences
* [**ARCore for Jetpack XR**](/develop/xr/jetpack-xr-sdk/work-with-arcore) - brings powerful perception capabilities for your app to understand the real world
...
![jetnews.webp](/static/blog/assets/jetnews_6820eb2c7d_Z1cnsAA.webp)

*The JetNews sample app is an Android large-screen app adapted for Android XR*

We're also introducing new tools and capabilities to the latest preview of [Android Studio Meerkat](/studio/preview) to boost productivity and simplify your creation process for Android XR.
...
Learn more about the XR enabled tools in [Android Studio and the Android XR Emulator](/develop/xr/jetpack-xr-sdk/studio-tools).

![xr_emulator2.webp](/static/blog/assets/xr_emulator2_0d97fadcd3_6dHpr.webp)
...
Check out our [getting started guide for unity](/develop/xr/unity) and [Unity’s blog post](https://on.unity.com/3DdnxJW) to learn more.

![vacation_simulator.webp](/static/blog/assets/vacation_simulator_65f68eaafa_VwB4c.webp)
...
Learn more about [developing with WebXR](/develop/xr/develop-with-webxr).

![webxr_blur.webp](/static/blog/assets/webxr_blur_fe9ecfa326_1zv9Yg.webp)
...
We’re continuing the Android tradition of building with open standards. At the heart of the Android perception stack is **OpenXR** - a high-performance, cross-platform API focused on portability. Android XR is compliant with [OpenXR 1.1](https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html), and we’re also expanding the Open XR standards with leading-edge [vendor extensions](/develop/xr/openxr/extensions) to introduce powerful world-sensing capabilities such as:

* AI-powered [hand mesh](/develop/xr/openxr/extensions/XR_ANDROID_hand_mesh), designed to adapt to the shape and size of hands to better represent the diversity of your users
* [Detailed depth textures](/develop/xr/openxr/extensions/XR_ANDROID_depth_texture) that allow real world objects to occlude virtual content
* Sophisticated [light estimation](/develop/xr/openxr/extensions/XR_ANDROID_light_estimation), for lighting your digital content to match real-world lighting conditions
* [New trackables](/develop/xr/openxr/extensions/XR_ANDROID_trackables_object) that let you bring real world objects like laptops, phones, keyboards, and mice into a virtual environment
...
We couldn't be more proud or excited to be announcing the Developer Preview of the Android XR SDK. We’re releasing this developer preview, because we want to build the future of XR together with you. We welcome your [feedback](/develop/xr/support) and can’t wait to work with you and build your ideas and suggestions into the platform. Your passion, expertise, and bold ideas are absolutely essential as we continue to build Android XR.
