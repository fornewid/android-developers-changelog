---
title: Brighten Your Real-Time Camera Feeds with Low Light Boost  |  Android Developers' Blog
...
![LLB_IG_demo_white_background.gif](/static/blog/assets/LLB_IG_demo_white_background_c12989c682_k2r0k.webp)
...
![lowlight.png](/static/blog/assets/lowlight_b6a40d505e_QudAb.webp)
...
![lowlight1.png](/static/blog/assets/lowlight1_136eb50ee9_ZIxJEY.webp)
...
**Mechanism:**  
This mode is supported on devices running Android 15 and newer and requires the OEM to have implemented the support in HAL (currently available on Pixel 10 devices). It integrates directly with the camera's Image Signal Processor (ISP). If you set [CaptureRequest.CONTROL\_AE\_MODE](/reference/android/hardware/camera2/CaptureRequest#CONTROL_AE_MODE) to [CameraMetadata.CONTROL\_AE\_MODE\_ON\_LOW\_LIGHT\_BOOST\_BRIGHTNESS\_PRIORITY](/reference/android/hardware/camera2/CameraMetadata#CONTROL_AE_MODE_ON_LOW_LIGHT_BOOST_BRIGHTNESS_PRIORITY), the camera system takes control.
...
![low-light-boost-processor-diagram.png](/static/blog/assets/low_light_boost_processor_diagram_0dd70eed34_1IY9im.webp)
...
Just because you requested the mode doesn't mean it's currently "boosting." The system only activates the boost when the scene is actually dark. You can set up an [Observer](/reference/androidx/lifecycle/Observer) to update your UI (like showing a moon icon) or convert to a Flow using the extension function asFlow().
...
You can read the full guide on[Low Light Boost AE Mode here](/media/camera/lowlight/low-light-boost-ae).
...
Detailed implementation steps for the client and session can be found in the[Google Low Light Boost guide](/media/camera/lowlight/low-light-boost-gp).
...
* ## [Donovan McMurray](/blog/authors/donovan-mcmurray)
  ...
  [read\_more
  View profile](/blog/authors/donovan-mcmurray)
