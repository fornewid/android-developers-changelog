---
title: Under the hood: Android 17’s lock-free MessageQueue  |  Android Developers' Blog
...
##### [Charles Munger](/blog/authors/charles-munger) & [Shai Barack](/blog/authors/shai-barack)
...
The [Looper](/reference/android/os/Looper) drives the UI thread of every Android application. It pulls work from a [MessageQueue](/reference/android/os/MessageQueue), dispatches it to a [Handler](/reference/android/os/Handler), and repeats. For two decades, `MessageQueue` used a single monitor lock (i.e. a `synchronized` code block) to protect its state.
...
![perfetto1.png](/static/blog/assets/perfetto1_441f23086c_22PETm.webp)
...
![launcherJ.png](/static/blog/assets/launcher_J_74ad16e6d4_ZRDexG.webp)
...
The Java programming language offers atomic primitives via [java.util.concurrent.atomic](/reference/java/util/concurrent/atomic/package-summary) that rely on these and other specialized CPU instructions.
...
![dequeue.png](/static/blog/assets/dequeue_17341af975_ZornaQ.webp)
...
![headMessage.png](/static/blog/assets/head_Message_c0bf0dd8c3_mm1mr.webp)
...
![headMessage2.png](/static/blog/assets/head_Message2_2faa5aad41_ZrmXie.webp)
...
![atomicLayout.png](/static/blog/assets/atomic_Layout_a0595dfd75_Z1zR6hw.webp)
...
While developing and testing DeliQueue, the team ran many benchmarks and carefully profiled the new code. One issue identified using the [simpleperf tool](/ndk/guides/simpleperf) was pipeline flushes caused by the `Message` comparator code.
...
![flame2.png](/static/blog/assets/flame2_7a4a6d0dfd_LQVaM.webp)
...
![workspace.png](/static/blog/assets/workspace_9a45a242f0_Z6jExF.webp)
...
* ## [Charles Munger](/blog/authors/charles-munger)
  ...
  [read\_more
  View profile](/blog/authors/charles-munger)
...
* ## [Shai Barack](/blog/authors/shai-barack)
  ...
  [read\_more
  View profile](/blog/authors/shai-barack)
