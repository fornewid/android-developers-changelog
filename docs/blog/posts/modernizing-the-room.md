---
title: Room 3.0 - Modernizing the Room  |  Android Developers' Blog
...
Room 3.0 also requires Coroutines and more specifically DAO functions have to be suspending unless they are returning a reactive type, such as a Flow. Room 3.0 disallows blocking DAO functions. See the [Coroutines on Android documentation](/kotlin/coroutines) on getting started integrating Coroutines into your application.
...
For a brief overview of the SQLiteDriver APIs, check out the [SQLiteDriver APIs documentation](/kotlin/multiplatform/sqlite#sqlite-driver).

For more details on how to migrate Room to use SQLiteDriver APIs, check out the official [documentation to migrate from SupportSQLite](/kotlin/multiplatform/room#migrate-from-support-sqlite).
...
For more details check out the [room-sqlite-wrapper documentation](/kotlin/multiplatform/room#migrate-room-sqlite-wrapper).
...
For more details on how to set up Room for the Web check out the [Room 3.0 release notes](/jetpack/androidx/releases/room3#3.0.0-alpha01).
...
For more details check out the DAO Return Type Converters section in the [Room 3.0 release notes](/jetpack/androidx/releases/room3#3.0.0-alpha01).
...
* ## [Daniel Santiago Rivera](/blog/authors/daniel-santiago-rivera)
  ...
  [read\_more
  View profile](/blog/authors/daniel-santiago-rivera)
