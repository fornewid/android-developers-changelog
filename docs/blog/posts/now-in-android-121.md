---
title: https://developer.android.com/blog/posts/now-in-android-121
...
[Video](https://www.youtube.com/watch?v=WZioeVSgc24)
...
[`VERSION_CODES_FULL`](https://developer.android.com/reference/android/os/Build.VERSION_CODES_FULL) cannot be used in [`uses-sdk`](https://developer.android.com/guide/topics/manifest/uses-sdk-element) manifest attributes.
...
- Interactive chooser sessions keep your app UI active while the sharesheet is open, using [`ChooserManager`](https://developer.android.com/reference/android/service/chooser/ChooserManager) and [`ChooserSession`](https://developer.android.com/reference/android/service/chooser/ChooserSession).
- A new Data Transfer API enables more reliable and secure data migration between Android and iOS, requiring updates to your app's data extraction rules XML and [`BackupAgent`](https://developer.android.com/reference/android/app/backup/BackupAgent) implementation.
- The [`android.graphics.pdf`](https://developer.android.com/reference/android/graphics/pdf/package-summary) package has expanded to support annotating and editing PDF documents via [`PdfRenderer.Page`](https://developer.android.com/reference/android/graphics/pdf/PdfRenderer.Page).
- [`ViewConfiguration`](https://developer.android.com/reference/android/view/ViewConfiguration) values are now tailored to individual virtual devices; migrate to [`ViewConfiguration.get(context)`](https://developer.android.com/reference/android/view/ViewConfiguration#get(android.content.Context)) for multi-display scenarios.
- You gain more granular haptic feedback control by specifying [`VibrationAttributes`](https://developer.android.com/reference/android/os/VibrationAttributes) with [`View.performHapticFeedback(HapticFeedbackRequest)`](https://developer.android.com/reference/android/view/View#performHapticFeedback(android.os.vibrator.HapticFeedbackRequest))
...
- Companion Device Management (CDM) enhancements allow you to provide custom device icons, listen for [`EVENT_ASSOCIATION_REMOVED`](https://developer.android.com/reference/android/companion/DevicePresenceEvent#EVENT_ASSOCIATION_REMOVED) callback, and enable cross-app verification using DeviceId.
- Bluetooth updates include passive scanning support for [`BluetoothLeScanner`](https://developer.android.com/reference/android/bluetooth/le/BluetoothLeScanner) ([`ScanSettings.SCAN_TYPE_PASSIVE`](https://developer.android.com/reference/android/bluetooth/le/ScanSettings#SCAN_TYPE_PASSIVE)), bond loss reasons ([`BluetoothDevice.EXTRA_BOND_LOSS_REASON`](https://developer.android.com/reference/android/bluetooth/BluetoothDevice#EXTRA_BOND_LOSS_REASON)), and direct retrieval of service UUIDs ([`BluetoothDevice.EXTRA_UUID_LE`](https://developer.android.com/reference/android/bluetooth/BluetoothDevice#EXTRA_UUID_LE)).
- Wi-Fi RTT Ranging updates ([`RttStationRangingParams`](https://developer.android.com/reference/android/ranging/wifi/rtt/RttStationRangingParams)) support ranging against stations.
- A new [`PhoneNumberManager`](https://developer.android.com/reference/android/telephony/PhoneNumberManager) is available for parsing and validating phone numbers from IMS P-Associated-URI headers.
- MediaRouter Network Privacy improvements allow casting over new mediums like Bluetooth and UWB; you should use the system Output Switcher or request [`NEARBY_DEVICES`](https://developer.android.com/reference/android/Manifest.permission_group#NEARBY_DEVICES) permissions for custom in-app pickers.
...
- New [`AppWidgetManager`](https://developer.android.com/reference/android/appwidget/AppWidgetManager) APIs allow you to query for widget engagement metrics.
- Debuggable apps installed via ADB will now receive early warnings for 16KB page size compatibility.
- [`ProfilingManager`](https://developer.android.com/reference/android/os/ProfilingManager) adds support for new system-initiated profiling triggers and [`requestRunningSystemTrace`](https://developer.android.com/reference/android/os/ProfilingManager#requestRunningSystemTrace(java.lang.String)) to capture background traces.
...
- More robust testing for desktop and multi-display experiences is enabled with new [`UiAutomation`](https://developer.android.com/reference/android/app/UiAutomation) APIs for screenshots on non-default displays and public [`AccessibilityWindowInfo.refresh`](https://developer.android.com/reference/android/view/accessibility/AccessibilityWindowInfo#refresh()).
- API support is added for the new [`androidx.core:core-backported-fixes`](https://developer.android.com/jetpack/androidx/releases/core#core-backported-fixes_version_10_2) library.
- GUI apps are now supported in the Linux Terminal
- [`WindowInspector.addGlobalWindowViewsListener`](https://developer.android.com/reference/android/view/inspector/WindowInspector#addGlobalWindowViewsListener(java.util.concurrent.Executor,%20java.util.function.Consumer%3Cjava.util.List%3Candroid.view.View%3E%3E)) supports real-time root view change notifications.
...
- [**Gemini in Android Studio: Agent Mode**](https://developer.android.com/studio/gemini/agent-mode) is available for multi-stage coding tasks
- [**Prompt Library** **Rules**](https://developer.android.com/studio/gemini/prompt-library) customize Gemini's AI output for your project's needs.
- [**Transform UI with Gemini**](https://developer.android.com/studio/gemini/labs#transform-ui) uses natural language UI to iterate on Compose UI.
- **Immersive development support** with the embedded [XR Android Emulator](https://developer.android.com/develop/xr/jetpack-xr-sdk/studio-tools#android-xr), a new XR template, and embedded Layout Inspector for XR
- **Expanded device access** via Android Partner Device Labs in Android Device Streaming.
- **Better** [**Compose previews**](https://developer.android.com/develop/ui/compose/tooling/previews) with Improved code navigation and the New Compose preview picker
- **K2 Kotlin compiler** enabled by default for faster build performance
- [**16kb page size tooling**](https://developer.android.com/guide/practices/page-sizes) with lint warnings, analysis, and an emulator to help you prepare for upcoming 16kb page-size devices.
...
The [`LazyLayout`](https://developer.android.com/reference/kotlin/androidx/compose/foundation/lazy/layout/package-summary#LazyLayout(kotlin.Function0,androidx.compose.ui.Modifier,androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState,kotlin.Function2)) building blocks are now stable, and you can define a [`LazyLayoutCacheWindow`](https://developer.android.com/reference/kotlin/androidx/compose/foundation/lazy/layout/LazyLayoutCacheWindow) for improved Lazy List and Grid performance with enhanced prefetching. [`Scrollable2D`](https://developer.android.com/reference/kotlin/androidx/compose/foundation/gestures/package-summary#(androidx.compose.ui.Modifier).scrollable2D(androidx.compose.foundation.gestures.Scrollable2DState,kotlin.Boolean,androidx.compose.foundation.OverscrollEffect,androidx.compose.foundation.gestures.FlingBehavior,androidx.compose.foundation.interaction.MutableInteractionSource)) enables two-dimensional scrolling, including flinging and nested scrolling, with various improvements for scroll and nested scroll interop with Views. An opt-in API ([`Composer.setDiagnosticStackTraceEnabled`](https://developer.android.com/reference/kotlin/androidx/compose/runtime/Composer#setDiagnosticStackTraceEnabled(kotlin.Boolean))) provides richer crash location details in stack traces, recommended for debug builds only. New [`@RememberInComposition`](https://developer.android.com/reference/kotlin/androidx/compose/runtime/annotation/RememberInComposition) and [`@FrequentlyChangingValue`](https://developer.android.com/reference/kotlin/androidx/compose/runtime/annotation/FrequentlyChangingValue) annotations, along with associated Lint checks, are available in a new runtime-annotation library. Context menus can be customized using [`Modifier.appendTextContextMenuComponents`](https://developer.android.com/reference/kotlin/androidx/compose/foundation/text/contextmenu/modifier/package-summary#(androidx.compose.ui.Modifier).appendTextContextMenuComponents(kotlin.Function1)) and [`Modifier.filterTextContextMenuComponents`](https://developer.android.com/reference/kotlin/androidx/compose/foundation/text/contextmenu/modifier/package-summary#(androidx.compose.ui.Modifier).filterTextContextMenuComponents(kotlin.Function1)). Android Gradle Plugin (AGP) / Lint version 8.8.2 or higher is now required.
...
The [`MetadataRetriever`](https://developer.android.com/reference/kotlin/androidx/media3/exoplayer/MetadataRetriever) has been updated to allow you to retrieve media item durations without playback. For Transformer, the release introduces faster trim operations using MP4 edit lists with [`experimentalSetMp4EditListTrimEnabled`](https://developer.android.com/reference/kotlin/androidx/media3/transformer/Transformer.Builder#experimentalSetMp4EditListTrimEnabled(boolean)) and chipset-specific encoder optimizations via [CodecDbLite](https://developer.android.com/reference/androidx/media3/transformer/CodecDbLite), enabled by calling [`setEnableCodecDbLite`](https://developer.android.com/reference/kotlin/androidx/media3/transformer/DefaultEncoderFactory.Builder#setEnableCodecDbLite(boolean)) on [`DefaultEncoderFactory.Builder`](https://developer.android.com/reference/kotlin/androidx/media3/transformer/DefaultEncoderFactory.Builder).

Additional updates include partial download support in [`Downloader`](https://developer.android.com/reference/kotlin/androidx/media3/exoplayer/offline/Downloader) with [`PreCacheHelper`](https://developer.android.com/reference/androidx/media3/exoplayer/source/preload/PreCacheHelper), automatic XR audio routing in ExoPlayer, and more efficient MediaCodec interactions. The MediaSession module now keeps notifications visible longer by default, and the media session demo app showcases playback resumption functionality. A new Composition demo app, built with Kotlin and Compose, demonstrates advanced multi-asset video editing.
...
Jetpack Compose now enables advanced shared element transitions, sophisticated **shape morphing** , and reveal animations. Developers can configure [`SharedTransitionLayout`](https://developer.android.com/reference/kotlin/androidx/compose/animation/package-summary#SharedTransitionLayout(androidx.compose.ui.Modifier,kotlin.Function1)) at the app's top level and use [`Modifier.sharedBounds`](https://developer.android.com/reference/kotlin/androidx/compose/animation/SharedTransitionScope#(androidx.compose.ui.Modifier).sharedBounds(androidx.compose.animation.SharedTransitionScope.SharedContentState,androidx.compose.animation.AnimatedVisibilityScope,androidx.compose.animation.EnterTransition,androidx.compose.animation.ExitTransition,androidx.compose.animation.BoundsTransform,androidx.compose.animation.SharedTransitionScope.ResizeMode,androidx.compose.animation.SharedTransitionScope.PlaceHolderSize,kotlin.Boolean,kotlin.Float,androidx.compose.animation.SharedTransitionScope.OverlayClip)) to link elements.

**Shape morphing** is a key new feature, achieved by leveraging Material 3's AndroidX graphics shape library. This involves creating a Morph object with defined start/end shapes, driving its progress with animateFloat (from [`AnimatedVisibilityScope`](https://developer.android.com/reference/kotlin/androidx/compose/animation/AnimatedVisibilityScope)), and applying it as a clip via a custom [`OverlayClip`](https://developer.android.com/reference/kotlin/androidx/compose/animation/SharedTransitionScope.OverlayClip). Reveal effects use [`skipToLookaheadSize`](https://developer.android.com/reference/kotlin/androidx/compose/animation/SharedTransitionScope#(androidx.compose.ui.Modifier).skipToLookaheadSize()) and [`skipToLookaheadPosition`](https://developer.android.com/reference/kotlin/androidx/compose/animation/SharedTransitionScope#(androidx.compose.ui.Modifier).skipToLookaheadPosition(kotlin.Function0)). All these advanced animations are also compatible with [**predictive back gestures**](https://developer.android.com/guide/navigation/custom-back/predictive-back-gesture).
...
[Video](https://www.youtube.com/watch?v=hAjUByneFEg)
...
- Load RE SDKs using [`SdkSandboxManagerCompat`](https://developer.android.com/reference/kotlin/androidx/privacysandbox/sdkruntime/client/SdkSandboxManagerCompat), observing constraints (e.g., foreground, single-load).
- Shim tooling simplifies low-level inter-process communication.
- Render UI from RE SDKs using [`SandboxedSdkView`](https://developer.android.com/reference/kotlin/androidx/privacysandbox/ui/client/view/SandboxedSdkView) and [`SandboxedUiAdapter`](https://developer.android.com/reference/kotlin/androidx/privacysandbox/ui/core/SandboxedUiAdapter).
- Launch activities from the SDK Runtime using [`SdkActivityLauncher`](https://developer.android.com/reference/androidx/privacysandbox/activity/core/SdkActivityLauncher).

[Video](https://www.youtube.com/watch?v=8ocelXB1Qoc)

## [**WearOS Material 3 shape morphing \| Jetpack Compose Tips**](https://www.youtube.com/watch?v=qEEo6AwgBjU)

Wear OS Material 3 for Compose now simplifies shape morphing. Developers can easily add animated shape changes to round buttons with [`IconButtonDefaults.animatedShapes`](https://developer.android.com/reference/kotlin/androidx/wear/compose/material3/IconButtonDefaults#animatedShapes()), create button groups that animate width changes using the [`ButtonGroup`](https://developer.android.com/reference/kotlin/androidx/compose/material3/package-summary#ButtonGroup(kotlin.Function1,androidx.compose.ui.Modifier,kotlin.Float,androidx.compose.foundation.layout.Arrangement.Horizontal,kotlin.Function1)) component and `Modifier.animateWidth()`, and build vertically scrolling lists ([`TransformingLazyColumn`](https://developer.android.com/reference/kotlin/androidx/wear/compose/foundation/lazy/package-summary#TransformingLazyColumn(androidx.compose.ui.Modifier,androidx.wear.compose.foundation.lazy.TransformingLazyColumnState,androidx.compose.foundation.layout.PaddingValues,androidx.compose.foundation.layout.Arrangement.Vertical,androidx.compose.ui.Alignment.Horizontal,androidx.compose.foundation.gestures.FlingBehavior,kotlin.Boolean,androidx.wear.compose.foundation.rotary.RotaryScrollableBehavior,androidx.compose.foundation.OverscrollEffect,kotlin.Function1))) where items scale and morph using `TransformationSpec` as they approach the screen edges.
[Video](https://www.youtube.com/watch?v=qEEo6AwgBjU)
...
- **TWA display_override Support (Browser):** Added support for the `display_override` TWA manifest property, providing more control over TWA display.
...
[Video](https://www.youtube.com/watch?v=Tb6bGiha6xg)

Now then... 👋

That's it for this edition, with[](http://android-developers.googleblog.com/2025/03/the-third-beta-of-android-16.html)coverage of [Android 16 QPR2 beta 1](http://android-developers.googleblog.com/2025/08/android-16-qpr2-beta-1-is-here.html), the [Android Studio Narwhal feature drop](http://android-developers.googleblog.com/2025/07/android-studio-narwhal-feature-drop-stable-agent-mode.html), [Jetpack Compose 1.9](http://android-developers.googleblog.com/2025/08/whats-new-in-jetpack-compose-august-25-release.html), [Media 3 1.8](http://android-developers.googleblog.com/2025/08/media3-180-whats-new.html), [Shape Morphing](https://www.youtube.com/watch?v=0moEXBqNDZI) and [Autofill in Compose](https://www.youtube.com/watch?v=Tb6bGiha6xg), and much more.
