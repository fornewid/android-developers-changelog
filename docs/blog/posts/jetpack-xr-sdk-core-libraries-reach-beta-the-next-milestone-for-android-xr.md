---
title: Jetpack XR SDK core libraries reach beta: The next milestone for Android XR  |  Android Developers' Blog
...
* [**Jetpack SceneCore**](/jetpack/androidx/releases/xr-scenecore): Build and manipulate the Android XR scene graph with 3D content. You can arrange [3D models](/develop/xr/jetpack-xr-sdk/add-3d-models#place-3d-scenecore), play [spatial audio](/develop/xr/jetpack-xr-sdk/add-spatial-audio), and use the robust [entity-component](/develop/xr/jetpack-xr-sdk/work-with-entities) system to create, control, and manage entities.
* [**ARCore for Jetpack XR**](/jetpack/androidx/releases/xr-arcore): Bring digital content into the real world with perception capabilities. This library powers [depth estimation](/develop/xr/jetpack-xr-sdk/arcore/depth), [persistent anchors](/develop/xr/jetpack-xr-sdk/arcore/anchors), [hit testing](/develop/xr/jetpack-xr-sdk/arcore/planes#perform-hit-test), and [plane identification](/develop/xr/jetpack-xr-sdk/arcore/planes).
* [**XR Runtime**](/jetpack/androidx/releases/xr-runtime): Provides the essential runtime foundation of the SDK, handling device lifecycles, session creation, and system configurations that enable the API surface.
* [**Jetpack Compose for XR**](/jetpack/androidx/releases/xr-compose): Create [spatial UI layouts](/develop/xr/jetpack-xr-sdk/ui-compose) that take advantage of Android XR’s spatial capabilities. This library lets you use familiar Compose concepts to create spatial UIs and will be reaching Beta soon.
...
* **Expanded testing support: New capabilities are now available across the immersive XR libraries, including testing for**[**spatial audio**](/reference/androidx/xr/scenecore/testing/SpatialAudioTrackTester)**,**[**XR devices**](/reference/androidx/xr/runtime/testing/XrDeviceTestRule)**, and**[**session configuration**](/reference/kotlin/androidx/xr/runtime/testing/SessionTestRule)**. See the**[**release notes for each library**](/jetpack/androidx/explorer?case=all) **for details.**
* **Kotlin coroutines support**: To better align with Kotlin coroutines, [Session.create](/reference/kotlin/androidx/xr/runtime/Session) is now  a suspend function.
* **Terminology and class updates**: AnchorEntity has been renamed to [AnchorSpace](/reference/kotlin/androidx/xr/scenecore/AnchorSpace), and both [ActivitySpace](/reference/kotlin/androidx/xr/scenecore/ActivitySpace) and [AnchorSpace](/reference/kotlin/androidx/xr/scenecore/AnchorSpace) now extend a common [SpaceEntity](/reference/kotlin/androidx/xr/scenecore/SpaceEntity) class for more consistent spatial management across scenes.

See the full [release notes](/jetpack/androidx/versions) for each library to check out specific details on naming and API changes.
...
The ecosystem of Android XR devices that power immersive experiences is expanding, ranging from XR headsets to wired XR glasses. There’s never been a better time to start building immersive experiences with the Jetpack XR SDK Beta. Dive in and start building and testing on [Samsung Galaxy XR](https://www.samsung.com/us/xr/galaxy-xr/galaxy-xr/) or [Android XR Emulator](/develop/xr/jetpack-xr-sdk/run/create-avds/xr-headsets-glasses) today.
...
* ## [Amy Zeppenfeld](/blog/authors/amy-zeppenfeld)
  ...
  [read\_more
  View profile](/blog/authors/amy-zeppenfeld)
...
* ## [Greg Underwood](/blog/authors/greg-underwood)
  ...
  [read\_more
  View profile](/blog/authors/greg-underwood)

  ![View Greg Underwood's profile](/static/blog/assets/PXL_20260813_200301431_PORTRAIT_7a5276fd7a_Z1fcMvp.webp)
...
* ## [Yasmine Evjen](/blog/authors/yasmine-evjen)
  ...
  [read\_more
  View profile](/blog/authors/yasmine-evjen)
