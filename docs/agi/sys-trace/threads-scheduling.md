---
title: Analyze thread scheduling  |  Android Developers
url: https://developer.android.com/agi/sys-trace/threads-scheduling
source: html-scrape
---
...
![Game with a well-parallelized main and render thread, as well as a worker thread and audio thread](/static/images/agi/threads-scheduling-images/sample_multithreading.png)
...
**Important:** CPU core affinity has been superseded by the [Performance Hint API](/games/optimize/adpf/performance-hint-api). Use this API when your app is on
a device running Android 12 and later.
...
![Game with main and render thread primarily running on the large cores (CPU 6-7), shown in light blue](/static/images/agi/threads-scheduling-images/sample_bigcores.png)
...
![Game with main (Thread-7) and render thread (Thread-8) that switch between cores, shown in purple](/static/images/agi/threads-scheduling-images/sample_coreswitching.png)
...
* The platform software can't dynamically adjust task placement for runtime
  factors such as load and thermal throttling.
