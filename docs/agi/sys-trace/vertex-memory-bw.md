---
title: Analyze vertex memory bandwidth usage  |  Android Developers
...
# Analyze vertex memory bandwidth usage Stay organized with collections Save and categorize content based on your preferences.
...
![Vertex memory read bandwidth for a single frame, with an average value of 327 MBps and a peak value of 1.16 GBps](/static/images/agi/vertex-memory-bw-images/sample_vert_bw.png)
...
![Average vertex size for a single frame, with an average value of 31.3 bytes](/static/images/agi/vertex-memory-bw-images/sample_bytes_per_vert.png)
