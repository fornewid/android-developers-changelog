---
title: Analyze memory efficiency  |  Android Developers
...
# Analyze memory efficiency Stay organized with collections Save and categorize content based on your preferences.





**Note:** Android Performance Analyzer is the new recommended tool for system
profiling. Learn more and get the public beta release in the [APA docs](/android-performance-analyzer).
...
![Utilization track lining up with the relevant counters below it](/static/images/agi/memory_efficiency-images/image1.png)
...
![Read + Write Total Counters](/static/images/agi/memory_efficiency-images/image2.png)
...
![Vertex + Texture Memory Read Counters](/static/images/agi/memory_efficiency-images/image3.png)
...
![Memory Stall Counters](/static/images/agi/memory_efficiency-images/image4.png)
...
![Utilization track lining up with the counters you are interested in below it](/static/images/agi/memory_efficiency-images/image5.png)
...
![Output External counter tracks](/static/images/agi/memory_efficiency-images/image6.png)
...
![Input Internal counter tracks](/static/images/agi/memory_efficiency-images/image7.png)
...
![Fetch Stalls counter tracks](/static/images/agi/memory_efficiency-images/image8.png)
