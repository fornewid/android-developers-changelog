---
title: System profiling overview  |  Android Developers
...
# System profiling overview Stay organized with collections Save and categorize content based on your preferences.
...
* App trace data including
  [ATrace](https://perfetto.dev/docs/data-sources/atrace) markers
...
* **Frequency and idle states**: Collects CPU core frequency and idle state
  change events, which allows you to inspect how the CPU is scaled up or down
  based on load.
* **Scheduling chains / latency**: Collects additional thread state data about
  thread scheduling delays and preemption.
