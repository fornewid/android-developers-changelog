---
title: Identify your most expensive render passes  |  Android Developers
...
# Identify your most expensive render passes Stay organized with collections Save and categorize content based on your preferences.
...
![Frame Timeline view](/static/images/agi/renderpass-images/image6.png)
...
![Identifying the longest render pass in the Frame Timeline view](/static/images/agi/renderpass-images/image5.png)
...
* If Binning takes up a large portion of time, this suggests a bottleneck with
  vertex data which suggests too many vertices, large vertices, or other
  issues related to vertices.
* If Rendering takes up a majority of time, this suggests that shading is the
  bottleneck. Possible causes may be complex shaders, too many texture fetches,
  rendering to a high resolution framebuffer when it’s not necessary, or other
  related issues.
...
![Identifying GMEM loads and stores](/static/images/agi/renderpass-images/image8.png)
...
![Commands pane](/static/images/agi/renderpass-images/image4.png)
...
![Selecting individual draw calls in the Commands pane](/static/images/agi/renderpass-images/image5.png)
...
![Pipeline pane](/static/images/agi/renderpass-images/image10.png)
...
![Input Assembler section in the Pipeline pane](/static/images/agi/renderpass-images/image11.png)
...
![Vertex Shader section in the Pipeline pane](/static/images/agi/renderpass-images/image3.png)
...
![Rasterizer section in the Pipeline pane](/static/images/agi/renderpass-images/image2.png)
...
![Fragment Shader section in Pipeline pane](/static/images/agi/renderpass-images/image7.png)
...
![Smaller render passes used to downsample the native resolution buffer](/static/images/agi/renderpass-images/image9.png)
