---
title: Analyze vertex formats  |  Android Developers
url: https://developer.android.com/agi/frame-trace/vertex-formats
source: html-scrape
---
...
# Analyze vertex formats Stay organized with collections Save and categorize content based on your preferences.
...
![Frame profiling view for a glDrawElements call, hovered for detail
            on the draw call parameters](/static/images/agi/vertex-formats-images/sample_drawcall.png)
...
![Frame profiling view for a draw call's input assembly, with
            uncompressed vertex attributes](/static/images/agi/vertex-formats-images/sample_bigvertex.png)
...
![Frame profiling view for a draw call's input assembly and state showing the bound vertex buffer](/static/images/agi/vertex-formats-images/sample_attributestreams.png)
