---
title: Commands pane  |  Android Developers
...
# Commands pane Stay organized with collections Save and categorize content based on your preferences.
...
![Viewing an OpenGL trace](/static/images/agi/command-pane-images/command-pane-2.png)


**Figure 2.** Viewing an OpenGL trace


![Viewing a Vulkan trace](/static/images/agi/command-pane-images/command-pane-3.png)


**Figure 3.** Viewing a Vulkan trace


![Viewing a Vulkan trace](/static/images/agi/command-pane-images/command-pane-4.png)
...
![CAPTION](/static/images/agi/command-pane-images/command-pane-5.png)
...
| --- | --- | --- |
| [KHR\_debug](https://www.khronos.org/registry/gles/extensions/KHR/KHR_debug.txt) | `glPushDebugGroupKHR()` | `glPopDebugGroupKHR()` |
| [EXT\_debug\_marker](https://www.khronos.org/registry/gles/extensions/EXT/EXT_debug_marker.txt) | `String` | `String` |
...
| EXTENSION / VERSION | PUSH | POP |
| --- | --- | --- |
| [VK\_EXT\_debug\_marker](https://github.com/KhronosGroup/Vulkan-Docs/blob/1.0/doc/specs/vulkan/chapters/VK_EXT_debug_marker.txt) | `glPushDebugGroupKHR()` | `glPopDebugGroupKHR()` |