...
To see the specific shader bound to a specific stage in the pipeline, view that stage in the[**Pipeline**view](https://developer.android.com/games/agi/refdocs/pipeline-view-pane).
