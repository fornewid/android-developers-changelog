---
title: Android GPU Inspector quickstart  |  Android Developers
...
# Android GPU Inspector quickstart Stay organized with collections Save and categorize content based on your preferences.



This topic describes how to perform
[system profiling](/agi/sys-trace/system-profiler) and
[frame profiling](/agi/frame-trace/frame-profiler)
...
* One of the following operating systems is required:
  ...
  + **Linux**: Java 64-bit JDK or JRE 8 (or newer) is required;
    ...
    is recommended.
* The [adb command line tool](/studio/command-line/adb).
...
* Your Android app must be debuggable; the
  [debuggable attribute](/guide/topics/manifest/application-element#debug)
...
* Your app must have [Vulkan validation layers](/ndk/guides/graphics/validation-layer)
...
* Your app must not report any warnings or errors when it runs with the
  [Vulkan validation layers](/ndk/guides/graphics/validation-layer)
...
* A [supported Android device](/agi/supported-devices) running
  [Android 11 or higher](/about/versions).
* A USB cable.
...
If a device is listed as a [supported device](/agi/supported-devices), you can
...
Make sure you've met all [Android requirements](#android-reqs) and
[computer requirements](#host-reqs) described in the preceding sections, and
...
2. Launch AGI on your computer.
   ...
   ![Welcome screen](/static/images/games/agi/get-started.png)
...
4. Click **Get Started** to display the launch screen.
   ...
   ![AGI launch screen](/static/images/games/agi/agi-launcher.png)
...
5. In the launch screen, click **Capture a new trace**. This displays
   ...
   **Capture System Profile trace** button.
   ...
   ![Capture A New Trace dialog](/static/images/games/agi/capture-new-trace.png)


   **Figure 3: Capture A New Trace** dialog.
...
4. In the **Trace Options** section, click **Configure**. This displays a list
   ...
   ![Capture Config dialog](/static/images/games/agi/capture-config.png)


   **Figure 4:** The profiling options in the
   **Capture System Profile** dialog.
...
6. In the **GPU** section, click **Select**.
   ...
   ![Counter config](/static/images/games/agi/counter-config.png)
...
12. Click **Open Trace**. The initial view that is displayed is
    similar to [systrace](/studio/profile/systrace).

    ![System profile trace](/static/images/games/agi/system-profile.png)


    **Figure 6:** The System Profiler UI.
    ...
    data, see [View an AGI system profile](/agi/sys-trace/system-profiler-gui).

For information about additional settings, see
[system profiling options](/agi/sys-trace/system-profiler#profiling_options).
...
8. Click **Open Trace** to view the profiling data. For information about each
   ...
   [Frame profiling overview](/agi/frame-trace/frame-profiler#frame-views).

For information about additional settings, see
[frame profiling options](/agi/frame-trace/frame-profiler#profiling_options).