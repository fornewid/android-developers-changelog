---
title: Android Automotive OS compatibility mode  |  Android for Cars  |  Android Developers
...
# Android Automotive OS compatibility mode Stay organized with collections Save and categorize content based on your preferences.
...
While this compatibility mode is used by the [Car ready mobile apps](/training/cars/car-ready-mobile-apps) program,
...
[some vehicles](#determine-support) to improve the user experience of apps built for mobile
...
![](/static/training/cars/images/nav-with-compat.png)
...
![](/static/training/cars/images/nav-without-compat.png)
...
cutouts](/training/cars/parked/automotive-os#insets-and-cutouts) can invalidate assumptions made when developing apps primarily for
...
app](/training/cars/parked/automotive-os#driver-distraction), the OS blocks your app's activities automatically when the car enters
...
is no longer visible and transitions to the [*Stopped* lifecycle state](/guide/components/activities/activity-lifecycle#onstop)
when blocked.

**Caution:** This behavior applies to *all* applications running on a device that
supports compatibility mode, not just the apps that run in compatibility mode.
