...
purchase](https://developer.android.com/static/training/cars/images/play-billing.png)

[Google Play Billing](https://developer.android.com/google/play/billing) is supported on cars with Google built-in and uses the
...
Cars with Google built-in support the [Google Play Licensing](https://developer.android.com/google/play/licensing) service, which
