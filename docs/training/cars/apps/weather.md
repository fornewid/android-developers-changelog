---
title: Build a weather app  |  Android for Cars  |  Android Developers
...
# Build a weather app Stay organized with collections Save and categorize content based on your preferences.
...
**Design guidelines:**
Refer to [Weather apps](https://developers.google.com/cars/design/create-apps/app-types/weather)
for UX guidance specific to weather apps.
...
**Important:** Keep the [Weather Functionality](/docs/quality-guidelines/car-app-quality?category=weather#weather-functionality) quality guidelines in mind when
determining what to render on a map
...
**Caution:** Don't include both the `androidx.car.app.MAP_TEMPLATES` and the
`androidx.car.app.NAVIGATION_TEMPLATES` permissions in your manifest, or your
