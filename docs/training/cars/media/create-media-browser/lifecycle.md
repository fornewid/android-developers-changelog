...
2. The host app binds to your media browser service, which the OS starts if it
   ...
   you must create and register a [`MediaSessionCompat`](https://developer.android.com/reference/android/support/v4/media/session/MediaSessionCompat) object and its
   callback object. To learn more, see [Register a media session](https://developer.android.com/training/cars/media/enable-playback#registering_mediasession).

3. AAOS or Android Auto calls your service's [`onGetRoot`](https://developer.android.com/training/cars/media/content-hierarchy#onGetRoot) method to
...
4. AAOS or Android Auto calls your service's [`onLoadChildren()`](https://developer.android.com/reference/androidx/media/MediaBrowserServiceCompat#onLoadChildren(java.lang.String,androidx.media.MediaBrowserServiceCompat.Result%3Cjava.util.List%3Candroid.support.v4.media.MediaBrowserCompat.MediaItem%3E%3E)%5D) method to
   ...
   [Structure the root menu](https://developer.android.com/training/cars/media/content-media-browser/content-hierarchy#root-menu-structure) to learn more about what the system expects.
