---
title: Enable playback control  |  Android for Cars  |  Android Developers
...
# Enable playback control Stay organized with collections Save and categorize content based on your preferences.
...
[`MediaSessionCompat`](/reference/android/support/v4/media/session/MediaSessionCompat) for your service. You must register a session and
implement the associated callback methods.

## Register a media session

In your media browser service's [`onCreate`](/reference/androidx/media/MediaBrowserServiceCompat#onCreate()) method, create an instance of
[`MediaSessionCompat`](/reference/android/support/v4/media/session/MediaSessionCompat), then call [`setSessionToken`](/reference/androidx/media/MediaBrowserServiceCompat#setSessionToken(android.support.v4.media.session.MediaSessionCompat.Token)) to register the
...
providing an implementation of the [`MediaSessionCompat.Callback`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback)
...
OS and Android Auto use the [`MediaSessionCompat.Callback`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback)
class from your app's [`MediaSessionCompat`](/reference/android/support/v4/media/session/MediaSessionCompat) object that they obtained from
...
[`onPrepare`](/reference/android/media/session/MediaSession.Callback#onPrepare())
:   AAOS invokes this method when the media source changes.

[`onPlay`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onPlay())
:   Invoked when the user selects play without choosing a specific item. Your
    ...
    [`onPause`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onPause()), your app resumes playback.

    **Note:** Your app mustn't automatically start playing music when Android
    Automotive OS or Android Auto connect to the media browser service. To learn
    more, see [Set initial PlaybackState](#initial-playback-state).

[`onPlayFromMediaId`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onPlayFromMediaId(java.lang.String,android.os.Bundle))
:   Invoked when the user chooses to play a specific item. The method receives
    the [ID](/cars/media/create-media-browser/content-hierarchy#onLoadChildren) that your media browser service assigned to the media item in the
    content hierarchy.

[`onPlayFromSearch`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onPlayFromSearch(java.lang.String,android.os.Bundle))
...
[`onPause`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onPause())
:   Invoked when the user chooses to pause playback.

[`onSkipToNext`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onSkipToNext())
:   Invoked when the user chooses to skip to the next item.

[`onSkipToPrevious`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onSkipToPrevious())
:   Invoked when the user chooses to skip to the previous item.

[`onStop`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onStop())
...
To learn more about playing audio content, see [Media Player overview](/guide/topics/media/mediaplayer),
[Audio app overview](/training/managing-audio), and the ExoPlayer [overview](/guide/topics/media/exoplayer).

## Set standard playback actions

Android Auto and AAOS display playback controls based on the
actions that are enabled in the [`PlaybackStateCompat`](/reference/android/support/v4/media/session/PlaybackStateCompat)
object. By default, your app must support the following actions:

* [`ACTION_PLAY`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_PLAY())
* [`ACTION_PAUSE`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_PAUSE())
* [`ACTION_STOP`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_STOP())
* [`ACTION_PLAY_FROM_MEDIA_ID`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_PLAY_FROM_MEDIA_ID())
* [`ACTION_PLAY_FROM_SEARCH`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_PLAY_FROM_SEARCH())

Your app can additionally support the following actions if they are relevant to
the app's content:

* [`ACTION_SKIP_TO_PREVIOUS`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_SKIP_TO_PREVIOUS())
* [`ACTION_SKIP_TO_NEXT`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_SKIP_TO_NEXT())

In addition, you can optionally create a play queue for display to for the user.
To do this, call the [`setQueue`](/reference/android/support/v4/media/session/MediaSessionCompat#setQueue(java.util.List%3Candroid.support.v4.media.session.MediaSessionCompat.QueueItem%3E)) and [`setQueueTitle`](/reference/android/support/v4/media/session/MediaSessionCompat#setQueueTitle(java.lang.CharSequence)) methods, enable
the [`ACTION_SKIP_TO_QUEUE_ITEM`](/reference/android/support/v4/media/session/PlaybackStateCompat#ACTION_SKIP_TO_QUEUE_ITEM()) action, and define the callback
[`onSkipToQueueItem`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onSkipToQueueItem(long)).

Also, add support for the **Now playing** icon, which is an indicator for what
is playing. To do this, call the [`setActiveQueueItemId`](/reference/android/support/v4/media/session/PlaybackStateCompat.Builder#setActiveQueueItemId(long)) method and pass
the ID of the playing item in the queue. You need to update
`setActiveQueueItemId` whenever there is a queue change.

**Note:** Adding support for a **Now playing** icon is only required when supporting
a play queue.
...
corresponding callback from [`MediaSessionCompat.Callback`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback).
...
To do so, call the [`setExtras`](/reference/android/support/v4/media/session/MediaSessionCompat#setExtras(android.os.Bundle)) method with an extras bundle that contains
constants that correspond to the reserved functions.
[`SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_NEXT`](/reference/androidx/media/utils/MediaConstants#SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_NEXT())
corresponds to `ACTION_SKIP_TO_NEXT`, and
[`SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_PREV`](/reference/androidx/media/utils/MediaConstants#SESSION_EXTRAS_KEY_SLOT_RESERVATION_SKIP_TO_PREV())
...
the [`PlaybackStateCompat`](/reference/android/support/v4/media/session/PlaybackStateCompat).
...
of your media session to [`STATE_STOPPED`](/reference/android/support/v4/media/session/PlaybackStateCompat#STATE_STOPPED()), [`STATE_PAUSED`](/reference/android/support/v4/media/session/PlaybackStateCompat#STATE_PAUSED()),
[`STATE_NONE`](/reference/android/support/v4/media/session/PlaybackStateCompat#STATE_NONE()), or [`STATE_ERROR`](/reference/android/support/v4/media/session/PlaybackStateCompat#STATE_ERROR()).

**Note:** When `PlaybackStateCompat` is set to `STATE_NONE`, Android Auto and
AAOS make playback UI inaccessible. Only send this state when the app has
nothing to play and the user needs to select new content to initiate playback.
...
media app supports. If [space permits](#reserve-space) (and you don't reserve it), Android
...
Use custom actions to provide behavior distinct from [standard actions](#required-actions).
Don't use them to replace or duplicate standard actions.

To add custom actions, use the [`addCustomAction`](/reference/android/support/v4/media/session/PlaybackStateCompat.Builder#addCustomAction(android.support.v4.media.session.PlaybackStateCompat.CustomAction)) method in the
[`PlaybackStateCompat.Builder`](/reference/android/support/v4/media/session/PlaybackStateCompat.Builder) class. This code snippet shows how to add
...
by overriding the [`onCustomAction`](/reference/android/support/v4/media/session/MediaSessionCompat.Callback#onCustomAction(java.lang.String,%20android.os.Bundle)) method.
...
If the description of that icon matches one of the [`CommandButton.ICON_`](/reference/kotlin/androidx/media3/session/CommandButton#ICON_ALBUM())
constants, set the integer value for the
[`EXTRAS_KEY_COMMAND_BUTTON_ICON_COMPAT`](/reference/androidx/media3/session/MediaConstants#EXTRAS_KEY_COMMAND_BUTTON_ICON_COMPAT()) key of the custom action's
extras. On supported systems, doing so overrides the icon resource passed to
[`CustomAction.Builder`](/reference/android/support/v4/media/session/PlaybackStateCompat.CustomAction.Builder#Builder(java.lang.String,java.lang.CharSequence,int)), allowing system components to consistently render
...
[vector drawables](/guide/topics/graphics/vector-drawable-resources). Use a vector drawable to scale assets without
...
![Samples of off-style custom action icons.](/static/images/training/icon_off.png)
...
can set the [`KEY_CONTENT_FORMAT_TINTABLE_LARGE_ICON_URI`](/reference/androidx/car/app/mediaextensions/MetadataExtras#KEY_CONTENT_FORMAT_TINTABLE_LARGE_ICON_URI()) and the
[`KEY_CONTENT_FORMAT_TINTABLE_SMALL_ICON_URI`](/reference/androidx/car/app/mediaextensions/MetadataExtras#KEY_CONTENT_FORMAT_TINTABLE_SMALL_ICON_URI()) in the extras bundle of the
currently playing media item (passed to [`MediaSession.setMetadata`](/reference/android/media/session/MediaSession#setMetadata(android.media.MediaMetadata))).
Set both extras to accommodate the different layouts.

In addition, you can set the [`KEY_IMMERSIVE_AUDIO`](/reference/androidx/car/app/mediaextensions/MetadataExtras#KEY_IMMERSIVE_AUDIO()) extra
...
To add links, configure the [`KEY_SUBTITLE_LINK_MEDIA_ID`](/reference/androidx/car/app/mediaextensions/MetadataExtras#KEY_SUBTITLE_LINK_MEDIA_ID()) metadata
(to link from the subtitle) or [`KEY_DESCRIPTION_LINK_MEDIA_ID`](/reference/androidx/car/app/mediaextensions/MetadataExtras#KEY_DESCRIPTION_LINK_MEDIA_ID()) (to link
