...
manifest. The next section of this guide, [Create a media browser service](https://developer.android.com/training/cars/media/create-media-browser),
...
By default, the [`android:icon`](https://developer.android.com/guide/topics/manifest/application-element#icon) attribute of your app's
[`<application>`](https://developer.android.com/guide/topics/manifest/application-element) element is used as the launcher icon:
...
service's [`<service>`](https://developer.android.com/guide/topics/manifest/service-element) element:
...
By default, the value of the [`android:label`](https://developer.android.com/guide/topics/manifest/application-element#label) attribute of your app's
...
By default, the accent color is pulled from the [`colorAccent`](https://developer.android.com/reference/android/R.attr#colorAccent) item of the
[`android:theme`](https://developer.android.com/guide/topics/manifest/application-element#theme) style resource of your app's `<application>` element.

To use a different accent color for your in-car experience, include a
[`<meta-data>`](https://developer.android.com/guide/topics/manifest/meta-data-element) element for a different style resource containing a
`colorAccent` item:
