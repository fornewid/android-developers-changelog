...
To target Android Automotive OS devices, your app must have certain manifest entries. After you've opted-in to distributing to Android Automotive OS devices, Google Play reviews compatible apps to help ensure that they're safe for use in a car. See [Distribute to cars](https://developer.android.com/training/cars/distribute) for more details.
