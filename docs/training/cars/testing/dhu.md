...
mechanisms described in [Run the DHU](https://developer.android.com/training/cars/testing/dhu#running-dhu).

> [!NOTE]
> **Note:** If you are testing on a mobile device running Android 10 (API level 29) or higher, you need to sign in to the Google Play Store and update the Android Auto app before running the DHU for the first time. If you are building a media app, you can also test your media session implementation using the [Media Controller
> Test app](https://developer.android.com/guide/topics/media-apps/audio-app/media-controller-test).
...
4. In Android Studio, open the [SDK Manager](https://developer.android.com/studio/intro/update#sdk-manager) and navigate to the **SDK
...
version of Android Studio](https://developer.android.com/studio/preview/install-preview) or [change the update channel](https://developer.android.com/studio/preview/install-preview#change_your_update_channel) of your existing
...
mobile device to a development machine using either the [Accessory Mode](https://developer.android.com/training/cars/testing/dhu#connection-aoap)
(recommended for DHU 2.x), or [ADB Tunneling](https://developer.android.com/training/cars/testing/dhu#connection-adb).
...
server over [Android Debug Bridge (`adb`)](https://developer.android.com/studio/command-line/adb). Follow these steps to set up
...
After the DHU has started, you can use [DHU console commands](https://developer.android.com/training/cars/testing/dhu#dhu-commands) to run and
test your app.
...
simulate controller operations. See the [Rotary controller](https://developer.android.com/training/cars/testing/dhu#test-rotary) section for more
...
| Option | Description |
|---|---|
| `-c`, `--config=FILE` | Use the specified configuration `.ini` file. Refer to the [Configure the DHU](https://developer.android.com/training/cars/testing/dhu#configure-dhu) section for more details. |
...
| `keycode keycode` |   | Send <var translate="no">keycode</var>, one of the names listed in the [Keycodes](https://developer.android.com/training/cars/testing/dhu#test-keycodes) section. |

### Touch and touchpad

When touch or touchpad is [enabled](https://developer.android.com/training/cars/testing/dhu#input-configuration), clicking in the display window, for
...
The DHU has rotary controller support. When it is [enabled](https://developer.android.com/training/cars/testing/dhu#input-configuration), the following
...
corresponding sensors must be enabled with the [configuration](https://developer.android.com/training/cars/testing/dhu#sensor-configuration) `.ini` used
...
available using the [Android Studio Beta update channel](https://developer.android.com/studio/preview/install-preview#change_your_update_channel) ), you can emulate
such a display on your development machine.

This can be done using a configuration file with a cluster `[display]` section.
`[display]` sections support the same [video configuration options](https://developer.android.com/training/cars/testing/dhu#video-configuration) as the
...
sent for that sensor using the [DHU commands](https://developer.android.com/training/cars/testing/dhu#sensors) is ignored. This configuration
