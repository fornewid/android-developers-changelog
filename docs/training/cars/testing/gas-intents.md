...
To learn more about these APIs, see [Implement navigation app intents](https://developer.android.com/develop/devices/assistant/intents-assistant-nav-app)
and [Google Maps for Android Automotive Intents](https://developer.android.com/training/cars/platforms/automotive-os/android-intents-automotive).
...
Equally, these intents describe the interaction between Gemini (or Google
Assistant) and a [navigation](https://developer.android.com/training/cars/apps/navigation) application.
...
to receive intents from Gemini, Google Assistant, or other assistant apps.
...
3. Start the emulator image and sign in to Google Play. Search for and update Gemini or Google Assistant, depending on which you've chosen as your default assistant.
...
[Implement navigation app intents](https://developer.android.com/develop/devices/assistant/intents-assistant-nav-app) and
[Google Maps for Android Automotive Intents](https://developer.android.com/training/cars/platforms/automotive-os/android-intents-automotive) describe the three types of
...
by Gemini or Google Assistant:

1. Go to **Settings \> Google \> Gemini (or Google Assistant) \> Default navigation app.**
...
To add the app to
**Settings \> Google \> Gemini (or Google Assistant) \> Default navigation app**
