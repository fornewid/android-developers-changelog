...
To test an existing statement file, you can use the [Statement List Generator and Tester](https://developers.google.com/digital-asset-links/tools/generator) tool.

The following sections describe how to test your App Links verification manually. If you prefer, you can test verification from Play Deep Links tool or the Android Studio App Links Assistant.
...
The list of hosts that the platform would attempt to verify from the preceding manifest is:
...
The list of hosts that the platform wouldn't attempt to verify from the preceding manifest is:
