...
doubles](https://developer.android.com/training/testing/fundamentals/test-doubles) and you should use libraries that provide utilities to help with
...
can create your own system [manually](https://developer.android.com/training/dependency-injection/manual) but we recommend using a DI framework
like [Hilt](https://developer.android.com/training/dependency-injection/hilt-android) for this.
...
sizes](https://developer.android.com/training/testing/different-screens).
