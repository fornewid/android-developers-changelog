...
If you are implementing a [content provider](https://developer.android.com/guide/topics/providers/content-providers) to store and retrieve data or to
...
[`IsolatedContext`](https://developer.android.com/reference/android/test/IsolatedContext) and [`MockContentResolver`](https://developer.android.com/reference/android/test/mock/MockContentResolver) to access file and
...
Local Unit Test Class](https://developer.android.com/training/testing/local-tests#test-class).
...
extends [`AndroidTestCase`](https://developer.android.com/reference/android/test/AndroidTestCase), so it provides the JUnit testing framework as
...
a normal [`ContentProvider`](https://developer.android.com/reference/android/content/ContentProvider) object, but it takes all of its environment
