---
title: Use test doubles in Android  |  Test your app on Android  |  Android Developers
...
# Use test doubles in Android Stay organized with collections Save and categorize content based on your preferences.
...
**Caution:** There are conflicting definitions depending on the source. A
comprehensive source is [*Mocks aren't Stubs*](https://martinfowler.com/articles/mocksArentStubs.html) by Martin Fowler.**Note:** When using a library or framework, check with the authors to see if they
...
![A fake dependency can return known data without depending on remote data sources](/static/training/testing/fundamentals/fake-deps.png)
...
![](/static/training/testing/fundamentals/bigtest.png)
...
**Note:** On Android, you can also use the [Robolectric](/training/testing/local-tests/robolectric) framework, which
provides a special type of test double, called shadows.
