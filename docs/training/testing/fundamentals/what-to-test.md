...
and [monkey tests](https://developer.android.com/studio/test/monkey). You can also categorize tests by purpose, such as
...
in general. Continue reading about them in [Using test doubles in Android](https://developer.android.com/training/testing/fundamentals/test-doubles).

If you want to learn how to create unit and UI tests, check out the [Testing
codelabs](https://developer.android.com/codelabs/advanced-android-kotlin-training-testing-basics).