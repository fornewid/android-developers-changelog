---
title: What to test in Android  |  Test your app on Android  |  Android Developers
...
# What to test in Android Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** Test coverage is a metric that some testing tools can calculate, and
indicates how much of your code is visited by your tests. It can detect untested
portions of the codebase, but it should not be used as the only metric to claim
