---
title: Declare app permissions  |  Privacy  |  Android Developers
...
# Declare app permissions Stay organized with collections Save and categorize content based on your preferences.
...
* If the permission is an [install-time
  permission](/guide/topics/permissions/overview#install-time), such as a normal
...
* If the permission is a [runtime
  ...
  permission](/guide/topics/permissions/overview#special), and if your app is
  installed on a device that runs Android 6.0 (API level 23) or higher, you must
  request the [runtime permission](/training/permissions/requesting) or [special
...
arrow\_forward](/training/permissions/requesting)