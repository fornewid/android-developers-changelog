---
title: Receive simple data from other apps  |  App data and files  |  Android Developers
...
# Receive simple data from other apps Stay organized with collections Save and categorize content based on your preferences.
...
**Caution:** Although you can receive a MIME type of `*/*`, we strongly discourage
doing so unless your app is fully capable of handling any type of incoming
content.
...
**Note:** For more information about intent filters and intent resolution,
read [Intents and Intent Filters](/guide/components/intents-filters#ifs).
...
**Note:** Effective share targets don't need a label and icon in the associated
activity or intent filter. The receiving app's name and icon alone must be
enough for a user to understand what happens when they share.
...
arrow\_forward](/training/sharing/direct-share-targets)