...
fun MessageDetail(id: String) {
    ...
    ScreenScaffold(
        ...
        // ...https://github.com/android/snippets/blob/e7a7941977ffc6645aa89155f2f94985055e5f46/wear/src/main/java/com/example/wear/snippets/m3/navigation/Navigation.kt#L64-L110
```
