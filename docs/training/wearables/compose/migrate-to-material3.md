...
fun MessageDetail(id: String) {
    ...
    ScreenScaffold(
        ...
        // ...https://github.com/android/snippets/blob/14699840f1b3a7e50f0a020665e1cd96e31f6a47/wear/src/main/java/com/example/wear/snippets/m3/navigation/Navigation.kt#L64-L110
```
