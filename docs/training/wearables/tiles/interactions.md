...
This pattern is ideal for launching an activity with a [deep link](/develop/ui/compose/navigation#deeplinks). The user
...
[`.addNextIntentWithParentStack()`](/develop/ui/compose/navigation#deeplinks) was used, the parent activity is also
