...
val notificationBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
    ...
    .setOngoing(true) // Important!https://github.com/android/snippets/blob/8ab5ab336a1e8bce524070f55afd06eb64a30669/wear/src/main/java/com/example/wear/snippets/alwayson/AlwaysOnService.kt#L148-L167
```
