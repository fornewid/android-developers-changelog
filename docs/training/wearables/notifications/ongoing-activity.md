...
val notificationBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
    ...
    .setOngoing(true) // Important!https://github.com/android/snippets/blob/e7a7941977ffc6645aa89155f2f94985055e5f46/wear/src/main/java/com/example/wear/snippets/alwayson/AlwaysOnService.kt#L148-L167
```
