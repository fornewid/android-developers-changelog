---
title: Optimize watch faces  |  Wear OS  |  Android Developers
...
# Optimize watch faces Stay organized with collections Save and categorize content based on your preferences.
...
* **Brightness:** when a black background is not possible,
  keep the brightness of
  the background color at or below 25% on a
  hue, saturation, value (HSV) or hue, saturation, brightness (HSB) scale. For example,
  if you use the
  [`Color`](/reference/android/graphics/Color)
  class to set a background color defined with the HSV scale,
  use 25 or lower for the value setting, which controls brightness.
...
![](/static/training/wearables/watch-faces/images/ClockHandFull.png)
![](/static/training/wearables/watch-faces/images/ClockHandCropped.png)
...
![](/static/training/wearables/watch-faces/images/BitmapFilterDisabled.png)
![](/static/training/wearables/watch-faces/images/BitmapFilterEnabled.png)
