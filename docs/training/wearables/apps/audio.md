...
example, [managing audio focus](/guide/topics/media/media-apps/audio-focus).
...
* Pause playback if [AudioManager](/reference/android/media/AudioManager) notifies your app that an external
  audio output device [disconnects from the watch](/reference/android/media/AudioDeviceCallback#onAudioDevicesRemoved(android.media.AudioDeviceInfo%5B%5D)).
