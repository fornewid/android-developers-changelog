...
functionality](https://developer.android.com/training/permissions/evaluating) without requesting any permissions.
...
permissions](https://developer.android.com/guide/topics/permissions/requesting#normal-dangerous) on Wear OS:
...
Review the [permission principles](https://developer.android.com/training/permissions/requesting#principles) to make sure you provide the best
experience for your users, and remember to check
[`shouldShowRequestPermissionRationale()`](https://developer.android.com/reference/androidx/core/app/ActivityCompat#shouldShowRequestPermissionRationale(android.app.Activity,%20java.lang.String)) and [provide additional
information](https://developer.android.com/training/permissions/requesting#explain) as needed.
...
[`requestPermissions`](https://developer.android.com/reference/androidx/core/app/ActivityCompat#requestPermissions(android.app.Activity,%20java.lang.String%5B%5D,%20int)) method to trigger the system permissions dialog.
...
Use the [`shouldShowRequestPermissionRationale`](https://developer.android.com/reference/androidx/core/app/ActivityCompat#shouldShowRequestPermissionRationale(android.app.Activity,%20java.lang.String)) method to help your app
decide whether to provide more information. For additional details, see [Request
app permissions](https://developer.android.com/training/permissions/requesting#explain). Alternatively, you can examine how the speaker sample
...
Only an activity can call the [`requestPermissions`](https://developer.android.com/reference/androidx/core/app/ActivityCompat#requestPermissions(android.app.Activity,%20java.lang.String%5B%5D,%20int)) method, so if the
...
[complication](https://developer.android.com/training/wearables/watch-faces/complications) and let the user choose which data to display through the
complication.
...
[`checkSelfPermission`](https://developer.android.com/reference/androidx/core/content/ContextCompat#checkSelfPermission(android.content.Context,%20java.lang.String)) method to see whether the app has permission to
