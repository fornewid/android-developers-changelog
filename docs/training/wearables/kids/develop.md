---
title: Develop experiences for kids on Wear OS  |  Android Developers
...
# Develop experiences for kids on Wear OS Stay organized with collections Save and categorize content based on your preferences.
...
* Use power efficient APIs for [all day activity tracking](/health-and-fitness/guides/health-services/monitor-background) as well as
  tracking [exercises](/health-and-fitness/guides/health-services/active-data).
...
* Don't use [direct sensor tracking](/training/wearables/apps/power#sensors) as this significantly reduces the
  battery life.
