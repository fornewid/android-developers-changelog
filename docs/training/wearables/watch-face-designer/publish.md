---
title: Publish from Watch Face Designer to Google Play  |  Wear OS  |  Android Developers
...
# Publish from Watch Face Designer to Google Play Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** Before you begin, [export your watch face using the Google Play option](/training/wearables/watch-face-designer/export#google-play)
so that you have an Android App Bundle (AAB) file ready.
...
![](/static/wear/images/design/watch-face-designer/play-create.png)
...
![](/static/wear/images/design/watch-face-designer/play-testing.png)
...
![Manage form factors is the 2nd option in the menu](/static/wear/images/design/watch-face-designer/play-wear-os.png)
![](/static/wear/images/design/watch-face-designer/play-add-form-factor.png)
...
![Button appears near the top-right corner of the screen](/static/wear/images/design/watch-face-designer/play-create-track.png)
![Button also appears near the top-right corner of the screen](/static/wear/images/design/watch-face-designer/play-create-release.png)
...
**Caution:** In the **Choose signing key** dialog that appears, select
**Use Google-generated key**:

![Button is in the 'App Bundles' section on the screen](/static/wear/images/design/watch-face-designer/play-signing-key.png)
![Button is on the right](/static/wear/images/design/watch-face-designer/play-google-keys.png)
