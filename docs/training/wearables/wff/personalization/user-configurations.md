...
2. Alternatively, the configuration option can be used in
   ...
   </Condition>https://github.com/android/snippets/blob/b17a50993cce9a7469f3bee2594a4a0dff3b5c11/watchface/src/main/res/raw/watchface_boolean_configuration.xml#L59-L75
   ```
...
2. Alternatively, the configuration option can be used in more complex
   ...
   </Condition>https://github.com/android/snippets/blob/b17a50993cce9a7469f3bee2594a4a0dff3b5c11/watchface/src/main/res/raw/watchface_list_configuration.xml#L58-L74
   ```
