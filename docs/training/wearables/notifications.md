...
![Notification cards on a watch.](https://developer.android.com/static/images/ui/notifications/wear_2x.png) **Figure 1.** The same notification displayed on a phone and on a watch.
...
looks like this:
![Expandable MessagingStyle notification on watch](https://developer.android.com/static/images/ui/notifications/expandable_noti.png) **Figure 2.** Example of a `MessagingStyle` notification on Wear OS.
...
replies directly from the wearable or predefined text responses with
