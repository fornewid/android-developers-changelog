---
title: Create lists on Wear OS  |  Android Developers
...
# Create lists on Wear OS Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/wear/images/06_uilib.png)
...
![](/static/wear/images/wrv_new.gif)
...
* Set the
  [`setEdgeItemsCenteringEnabled(boolean)`](/reference/androidx/wear/widget/WearableRecyclerView#setEdgeItemsCenteringEnabled(boolean)) method to `true`. This
  vertically centers the first and last items on the list on the screen.
* Use the `WearableRecyclerView.setLayoutManager()` method to set the layout of the
  items on the screen.
