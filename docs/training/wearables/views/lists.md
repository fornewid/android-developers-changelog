...
Try the Compose way Jetpack Compose on Wear OS is the recommended UI toolkit for Wear OS. [Create lists using Compose on Wear OS →](https://developer.android.com/training/wearables/compose/lists) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)
...
[`WearableRecyclerView`](https://developer.android.com/reference/androidx/wear/widget/WearableRecyclerView) class, which is a
...
a [circular scrolling gesture](https://developer.android.com/reference/androidx/wear/widget/WearableRecyclerView#setCircularScrollingGestureEnabled(boolean))
...
the [`WearableLinearLayoutManager.LayoutCallback`](https://developer.android.com/reference/androidx/wear/widget/WearableLinearLayoutManager.LayoutCallback) class and override the
[`onLayoutFinished`](https://developer.android.com/reference/androidx/wear/widget/WearableLinearLayoutManager.LayoutCallback#onLayoutFinished(android.view.View, androidx.recyclerview.widget.RecyclerView)) method.
