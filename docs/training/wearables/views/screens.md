...
Try the Compose way Jetpack Compose on Wear OS is the recommended UI toolkit for Wear OS. [Handle different screen sizes using Compose on Wear OS →](https://developer.android.com/training/wearables/compose/screen-size) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)


After you understand how to
[handle different watch shapes](https://developer.android.com/training/wearables/apps/layouts),
...
`https://developer.android.com/reference/androidx/wear/widget/BoxInsetLayout`
