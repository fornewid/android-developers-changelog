...
| Games | Game apps let users play games while the car is parked. The core purpose of these apps is to play games. *Built using:* Views and/or Compose. See [Build games for cars](https://developer.android.com/training/cars/parked/games) for more information. | Android Auto and Android Automotive OS | Only while parked | All track types |
...
- Gemini or Google Assistant can launch any app that's installed in the
  vehicle with voice commands like *"Hey Google, open Example app."*
