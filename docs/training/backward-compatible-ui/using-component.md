...
For the `TabHelperHoneycomb` implementation, all you need is a `https://developer.android.com/reference/android/widget/FrameLayout` to contain the tab contents, since the tab indicators are provided by the `https://developer.android.com/reference/android/app/ActionBar`:
...
In your activity's `https://developer.android.com/reference/android/app/Activity#onCreate(android.os.Bundle)` method, you can obtain a `TabHelper` object and add tabs with the following code:
