...
![Example of tabs running on an Android 2.3 device (using TabHelperEclair).](/static/images/training/backward-compatible-ui-gb.png)

![Example of tabs running on an Android 4.0 device (using TabHelperHoneycomb).](/static/images/training/backward-compatible-ui-ics.png)
