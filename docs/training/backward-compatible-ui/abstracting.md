---
title: Abstract the new APIs  |  Views  |  Android Developers
...
# Abstract the new APIs Stay organized with collections Save and categorize content based on your preferences.
...
![Abstract base classes and version-specific implementations.](/static/images/training/backward-compatible-ui-classes.png)
...
Next, define an abstract class that lets you create and add tabs to an activity, like `ActionBar.newTab()` and `ActionBar.addTab()`:
...
arrow\_forward](/training/backward-compatible-ui/new-implementation)