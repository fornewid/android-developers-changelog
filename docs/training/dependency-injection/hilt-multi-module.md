...
[`Application`](https://developer.android.com/reference/android/app/Application) class needs to have all Hilt
...
Hilt](https://developer.android.com/training/dependency-injection/hilt-android). However, this is not the
case with apps that include [feature
modules](https://developer.android.com/guide/app-bundle/dynamic-delivery#customize_delivery).
...
use [Dagger](https://developer.android.com/training/dependency-injection/dagger-basics) to perform
...
Hilt](https://developer.android.com/training/dependency-injection/hilt-android) page. Suppose you add a
...
modules](https://developer.android.com/training/dependency-injection/dagger-multi-module#dagger-dfm).

For more information about Dagger on Android, see [Using Dagger in Android
apps](https://developer.android.com/training/dependency-injection/dagger-android).