...
`https://developer.android.com/reference/androidx/core/content/FileProvider` component provides the method
`https://developer.android.com/reference/androidx/core/content/FileProvider#getUriForFile(android.content.Context, java.lang.String, java.io.File)` for
...
`https://developer.android.com/reference/android/content/Intent` that contains the data. To learn how to send simple data with an
`https://developer.android.com/reference/android/content/Intent`, see the training class
...
generated by the Android `https://developer.android.com/reference/androidx/core/content/FileProvider` component and
...
:
    ...
    `https://developer.android.com/reference/androidx/core/content/FileProvider` to retrieve file information including
