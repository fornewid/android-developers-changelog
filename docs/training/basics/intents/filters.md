...
support the `https://developer.android.com/reference/android/content/Intent#ACTION_SEND` intent.
...
When an app calls `https://developer.android.com/reference/android/app/Activity#startActivity(android.content.Intent)` or `https://developer.android.com/reference/android/app/Activity#startActivityForResult(android.content.Intent, int)`
...
The system might send a given `https://developer.android.com/reference/android/content/Intent` to an activity if that activity has
...
:   A string naming the action to perform. Usually one of the platform-defined values, such
    as `https://developer.android.com/reference/android/content/Intent#ACTION_SEND` or `https://developer.android.com/reference/android/content/Intent#ACTION_VIEW`.
...
:   A description of the data associated with the intent.<br />
    ...
    **Note:** If you don't need to declare specifics about the data
    `https://developer.android.com/reference/android/net/Uri`, such as when your activity handles
...
:   Provides an additional way to characterize the activity handling the intent, usually related
    ...
    `https://developer.android.com/reference/android/content/Intent#CATEGORY_DEFAULT` by default.
...
For example, suppose your activity handles both text and images for both the `https://developer.android.com/reference/android/content/Intent#ACTION_SEND` and `https://developer.android.com/reference/android/content/Intent#ACTION_SENDTO` intents. In this case, you must define two separate
intent filters for the two actions, because an `ACTION_SENDTO` intent must use the data `https://developer.android.com/reference/android/net/Uri` to specify
...
For more information about sending and receiving `https://developer.android.com/reference/android/content/Intent#ACTION_SEND`
intents that perform social sharing behaviors, see [Receiving simple data from other apps](https://developer.android.com/develop/ui/compose/sharing/receive).
You can also find useful information about sharing data in
[Sharing simple data](https://developer.android.com/develop/ui/compose/notifications) and
...
`https://developer.android.com/reference/android/content/Intent` that is used to start it.

As your activity starts, call `https://developer.android.com/reference/android/app/Activity#getIntent()` to retrieve the
...
`https://developer.android.com/reference/android/app/Activity#onCreate(android.os.Bundle)` or `https://developer.android.com/reference/android/app/Activity#onStart()`.
...
You must always specify a result code with the result. Generally, it's either `https://developer.android.com/reference/android/app/Activity#RESULT_OK` or `https://developer.android.com/reference/android/app/Activity#RESULT_CANCELED`. You can then
provide additional data with an `https://developer.android.com/reference/android/content/Intent`, as necessary.
...
have no need to include the `https://developer.android.com/reference/android/content/Intent`,
you can call `https://developer.android.com/reference/android/app/Activity#setResult(int)`
...
with `https://developer.android.com/reference/android/app/Activity#startActivity(android.content.Intent)` or `https://developer.android.com/reference/android/app/Activity#startActivityForResult(android.content.Intent, int)`. Simply call `https://developer.android.com/reference/android/app/Activity#setResult(int, android.content.Intent)` if the intent that started your activity
