...
Create a [property](https://developer.android.com/guide/topics/manifest/property-element) under the
[`<application>`](https://developer.android.com/guide/topics/manifest/application-element) in your Android
