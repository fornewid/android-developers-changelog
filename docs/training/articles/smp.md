...
See [Further reading](https://developer.android.com/training/articles/smp#more) at the end of the document for
...
Gharachorloo](https://developer.android.com/training/articles/smp#more)):
...
theory and practice: Managing volatility](https://developer.android.com/training/articles/smp#more)*).
...
a win if reads greatly outnumber writes. (See also `https://developer.android.com/reference/java/util/concurrent/atomic/AtomicInteger` for a way to completely
...
the `https://developer.android.com/reference/java/util/concurrent/package-summary` package. The code is well written and well
tested on SMP.
...
particular the importance of declaring Java fields "final" ([Bloch](https://developer.android.com/training/articles/smp#more)).
...
in the next section.
See ([Safe Construction Techniques in Java](https://developer.android.com/training/articles/smp#more)) for
details
...
- Internalize the recommendations in the Concurrency section of *Effective
  Java, 2nd Edition.* (For example, you should avoid calling methods that are meant to be overridden while inside a synchronized block.)
- Read through the `https://developer.android.com/reference/java/util/concurrent/package-summary` and `https://developer.android.com/reference/java/util/concurrent/atomic/package-summary` APIs to see what's available. Consider using concurrency annotations like `@ThreadSafe` and `@GuardedBy` (from net.jcip.annotations).

The [Further Reading](https://developer.android.com/training/articles/smp#more) section in the appendix has links to
...
please see the University of Cambridge page with [collected mappings of atomics to actual processors](https://developer.android.com/training/articles/smp#more).
...
:   The documentation for the `java.util.concurrent` package. Near the bottom of the page is a section entitled "Memory Consistency Properties" that explains the guarantees made by the various classes.
    ...
    `https://developer.android.com/reference/java/util/concurrent/package-summary` Package Summary
...
:   Draft standard for C++ atomic operation features. This version is
...
:   Draft standard for ISO/IEC 9899-201x C atomic operation features.
    For details, also check later defect reports.

    <http://www.open-std.org/jtc1/sc22/wg14/www/docs/n1570.pdf>

C/C++11 mappings to processors (University of Cambridge)
:   Jaroslav Sevcik and Peter Sewell's collection of translations
...
:   Doug Lea wrote this as a companion to the JSR-133 (Java Memory Model) documentation. It contains the initial set of implementation guidelines
...
:   A precise description of the x86 memory model. Precise descriptions of
