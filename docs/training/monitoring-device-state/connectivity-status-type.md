---
title: Monitor connectivity status and connection metering  |  Connectivity  |  Android Developers
...
* [`onAvailable()`](/reference/android/net/ConnectivityManager.NetworkCallback#onAvailable(android.net.Network))
...
* [`onLost()`](/reference/android/net/ConnectivityManager.NetworkCallback#onLost(android.net.Network))
