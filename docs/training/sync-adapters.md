---
title: Transfer data using sync adapters  |  Connectivity  |  Android Developers
...
# Transfer data using sync adapters Stay organized with collections Save and categorize content based on your preferences.
...
This class shows you how to create a sync adapter and the bound `Service` that
...
you need to do real-time data transfer, you should do it in an `AsyncTask` or
an `IntentService`.
