...
through the `https://developer.android.com/reference/android/media/tv/TvInputManager` interface.
...
access through the system TV app. You should register your channels
...
class. This abstract class lets you create a job service that
...
using the UI in the activity. You might also have the app do it automatically
...
is the client that binds to it. The service lifecycle methods
