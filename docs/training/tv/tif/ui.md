...
app, such information shouldn't interfere with the program content playing on the screen.
![](https://developer.android.com/static/images/tv/do-not-attempt.png) **Figure 1.** An overlay message in a live TV app.
...
Once you have determined if the content should or shouldn't be blocked, notify the system TV
app by calling the
