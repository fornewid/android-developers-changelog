...
![](https://developer.android.com/static/images/training/tv/tif/time-shift.png) **Figure 1.** Android TV playback controls used for time-shifting.
...
Use the [TV recording APIs](https://developer.android.com/training/tv/tif/content-recording) if you want
...
time-shifting APIs in your `https://developer.android.com/reference/android/media/tv/TvInputService.Session` class,
...
- `https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTimeShiftPause()`: called when the user pauses playback.
- `https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTimeShiftResume()`: called when the user resumes playback.
- `https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTimeShiftSeekTo(long)`: called when the system needs to seek a new time position. Normally, the new position is between the start position and the current position.
...
[Notify the system about time-shifting status](https://developer.android.com/training/tv/tif/time-shifting#notify-about-timeshift-status)
section.
...
the TIF Companion Library](https://developer.android.com/training/tv/tif/tvinput#TIFCompanion).
...
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#notifyTimeShiftStatusChanged(int)`,
as described in the
[Notify the system about time-shifting status](https://developer.android.com/training/tv/tif/time-shifting#notify-about-timeshift-status)
section.
...
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTimeShiftResume()`.
...
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#notifyTimeShiftStatusChanged(int)` in your
implementation of
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTune(android.net.Uri)` when a user tunes
to a channel.
...
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTune(android.net.Uri)` is called.
...
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTimeShiftGetStartPosition()`
is never greater than the current time position you provide in
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTimeShiftGetCurrentPosition()`.
...
`https://developer.android.com/reference/android/media/tv/TvInputService.Session#onTimeShiftSetPlaybackParams(android.media.PlaybackParams)`
method with a `https://developer.android.com/reference/android/media/PlaybackParams` object that contains
