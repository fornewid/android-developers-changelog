---
title: Using the Leanback UI toolkit  |  Android TV  |  Android Developers
url: https://developer.android.com/training/tv/playback/leanback
source: html-scrape
---
...
# Using the Leanback UI toolkit Stay organized with collections Save and categorize content based on your preferences.
...
For a modern, declarative UI, use [Compose for TV](https://developer.android.com/training/tv/playback/compose) to build
...
Create scrollable layouts](/training/tv/playback/compose/lists)

[Next

Leanback libraries

arrow\_forward](/training/tv/playback/leanback/leanback-libraries)