...
experience for apps of this type should be intuitive, and visually
pleasing and engaging.

Catalog browsers tend to consist of several sections, and each section
...
In the example, `SectionRow` composable function defines how to display
sections.
