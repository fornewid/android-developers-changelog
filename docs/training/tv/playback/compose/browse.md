...
![](/static/training/tv/images/compose-catalogbrowser-example.png)
...
**Note:** `AsyncImage` is a composable that loads an image from the internet.
...
You can highlight some of them with [`Carousel`](/reference/kotlin/androidx/tv/material3/Carousel.composable#Carousel(kotlin.Int,androidx.compose.ui.Modifier,androidx.tv.material3.CarouselState,kotlin.Long,androidx.compose.animation.ContentTransform,androidx.compose.animation.ContentTransform,kotlin.Function1,kotlin.Function2)).
...
[`Carousel`](/reference/kotlin/androidx/tv/material3/Carousel.composable#Carousel(kotlin.Int,androidx.compose.ui.Modifier,androidx.tv.material3.CarouselState,kotlin.Long,androidx.compose.animation.ContentTransform,androidx.compose.animation.ContentTransform,kotlin.Function1,kotlin.Function2))
...
arrow\_forward](/training/tv/playback/compose/details)