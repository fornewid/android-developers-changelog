...
TV hardware is substantially different from other Android devices. TVs don't
...
example, if you have an app that can be started through an `https://developer.android.com/reference/android/content/Intent`,
...
TVs have a different purpose from other devices, so they don't have hardware features that
...
TVs are stationary, indoor devices and don't have built-in global positioning system (GPS)
