...
- **Integrate Watch Next:** Watch Next lets users re-engage with the content in your
  ...
  documentation](https://developer.android.com/training/tv/discovery/watch-next-add-programs) for more details.
...
- **Integrate Google Play Billing:** use the Play Billing library to support in-app purchases and manage subscriptions across both mobile and TV. See the [billing
  documentation](https://developer.android.com/google/play/billing) for more details.
...
[evaluate or
filter](https://developer.android.com/guide/topics/manifest/uses-feature-element#market-feature-filtering)
