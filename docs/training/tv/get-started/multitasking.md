...
![Positioning the PiP window to avoid covering important UI components](https://developer.android.com/static/training/tv/images/keep-clear.png) **Figure 1.** Positioning the PiP window to avoid covering important UI components.
...
relevant value from the following table.
