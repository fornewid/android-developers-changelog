---
title: On-screen keyboard  |  Android TV  |  Android Developers
...
# On-screen keyboard Stay organized with collections Save and categorize content based on your preferences.
...
|  |  |
| --- | --- |
| Email input   **Figure 1.** Email input type. | Password input   **Figure 2.** Password input type. |
| Text input   **Figure 3.** Text input type. | Numeric input   **Figure 4.** Numeric input type. |
...
![Alignment of Gboard](/static/training/tv/images/atv-keyboard-placement.png)
...
![Gboard aligned to the right](/static/training/tv/images/atv-keyboard-placement-example.png)
...
arrow\_forward](/training/tv/get-started/navigation)