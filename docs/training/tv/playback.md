---
title: Build TV playback apps  |  Android TV  |  Android Developers
url: https://developer.android.com/training/tv/playback
source: html-scrape
---
...
# Build TV playback apps Stay organized with collections Save and categorize content based on your preferences.
...
* [Configure your app to use Compose for TV](/training/tv/playback/compose)
* [Create a catalog browser](/training/tv/playback/compose/browse) with Compose for TV
* [Build a details view](/training/tv/playback/compose/details) with Compose for TV

**Note:** The [Leanback UI toolkit](/training/tv/playback/leanback),
