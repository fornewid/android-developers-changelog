...
[recommendations channels](https://developer.android.com/training/tv/discovery/recommendations-channel).
...
[Recommendation Row](https://www.google.com/design/spec-tv/system-overview/recommendation-row.html#recommendation-row-types-of-recommendations) in the Android TV Design Spec.
...
movie, has been played, [remove it](https://developer.android.com/guide/topics/ui/notifiers/notifications#Removing) from the recommendations.
...
To learn more, see
[Recommendation Row](https://www.google.com/design/spec-tv/system-overview/recommendation-row.html#recommendation-row-card-customization) in the Android TV Design Spec.
...
Use
`https://developer.android.com/reference/androidx/core/app/NotificationCompat.Builder#setGroup(java.lang.String)` to set the group key string of a recommendation. For
...
The following code example illustrates how to extend `https://developer.android.com/reference/android/app/IntentService` to
...
the Android framework. The framework receives the recommendations as `https://developer.android.com/reference/android/app/Notification` objects that use a specific template and are marked with a specific
category.
...
class to the notification, and calling `https://developer.android.com/reference/androidx/core/app/NotificationCompat.Builder#build()`.


Also, be sure to call
`https://developer.android.com/reference/androidx/core/app/NotificationCompat.Builder#setLocalOnly(boolean)`
so the `https://developer.android.com/reference/androidx/core/app/NotificationCompat.BigPictureStyle` notification won't show up
on other devices.
...
it at regular intervals. The following code example extends the `https://developer.android.com/reference/android/content/BroadcastReceiver` class to start periodic execution of a recommendation service
every half hour:
...
This implementation of the `https://developer.android.com/reference/android/content/BroadcastReceiver` class must run after start
...
requests the `https://developer.android.com/reference/android/Manifest.permission#RECEIVE_BOOT_COMPLETED` permission.
For more information, see `https://developer.android.com/reference/android/content/Intent#ACTION_BOOT_COMPLETED`.

In your recommendation service class' `https://developer.android.com/reference/android/app/IntentService#onHandleIntent(android.content.Intent)`
