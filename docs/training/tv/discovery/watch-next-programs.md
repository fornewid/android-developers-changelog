...
When you add an audio or video program to the **Play Next** row, you must
include the attributes in the following table in addition to the attributes for
audio and video programs. Each attribute is linked to the corresponding setter
in [`WatchNextProgram.Builder`](https://developer.android.com/reference/androidx/tvprovider/media/tv/WatchNextProgram.Builder).
...
| [Last Engagement Time](https://developer.android.com/reference/androidx/tvprovider/media/tv/WatchNextProgram.Builder#setLastEngagementTimeUtcMillis(long)) | The time the user or app last engaged with the program. |
