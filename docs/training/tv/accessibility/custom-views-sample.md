...
create an activity that uses the Canvas API to draw four images that are
...
Create an activity to load the layout XML file.
...
## Define ExploreByTouchHelper to expose AccessibilityNodeInfo
