---
title: Distribute to Android TV  |  Android Developers
url: https://developer.android.com/training/tv/publishing/distribute
source: html-scrape
---

# Distribute to Android TV Stay organized with collections Save and categorize content based on your preferences.
...
Verify that your app meets the [Android TV app quality](/docs/quality-guidelines/tv-app-quality)
...
[64-bit architectures](/google/play/requirements/64-bit) and [16 KB page sizes](/guide/practices/page-sizes).
...
* Doing so makes it easier for you to manage your store listings and releases
  ...
  mobile app for your TV app. You can use [a dedicated TV track](https://support.google.com/googleplay/android-developer/answer/13295490) to
  control the release of your TV app separately from your mobile app.
* If your app is built using [adaptive app principles](/adaptive-apps), or if
  you do so in the future, using the same package name for both apps lets you
  update your app to support different form factors using a single app bundle.
...
1. **Upload your app bundle:** Upload your Android app bundle (AAB) that
   includes support for Android TV.
2. **Update your store listing:**
   * **Screenshots:** Add at least one Android TV screenshot. These must
     comply with the [screenshot requirements](https://support.google.com/googleplay/android-developer/answer/9866151#zippy=%2Cscreenshots).
   * **Banner:** Add an [Android TV banner graphic](/training/tv/start/start#banner).
...
**Note:** Check that your app meets all requirements to avoid being rejected after
it's reviewed for Android TV quality.

### Results

After you opt in and publish, Google Play submits your app for review against
the [Android TV app quality criteria](/docs/quality-guidelines/tv-app-quality) and notifies you of the
result.
...
* **Approved:** Your app was reviewed and approved. The app becomes
  discoverable to Android TV users.
* **Not approved:** Your app was reviewed and not approved. Check the
...
* [Android TV app quality](/docs/quality-guidelines/tv-app-quality)
* [Launch checklist](/distribute/best-practices/launch/launch-checklist)