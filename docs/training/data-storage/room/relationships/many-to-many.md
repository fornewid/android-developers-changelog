...
[`associateBy`](https://developer.android.com/reference/kotlin/androidx/room/Relation#associateBy()) property in the [`@Relation`](https://developer.android.com/reference/kotlin/androidx/room/Relation) annotation in each of these
...
[`@Transaction`](https://developer.android.com/reference/kotlin/androidx/room/Transaction) annotation to both methods so that the whole
...
> DAOs](https://developer.android.com/training/data-storage/room/accessing-data#query-multiple-tables).