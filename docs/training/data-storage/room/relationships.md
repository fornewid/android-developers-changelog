...
objects](https://developer.android.com/training/data-storage/room/relationships#nested-objects). Your query methods can then return instances of this data class for
use in your app.
...
situations, you can use the [`@Embedded`](https://developer.android.com/reference/androidx/room/Embedded) annotation to represent an object
...
column unique by setting the [`prefix`](https://developer.android.com/reference/androidx/room/Embedded#getPrefix()) property. Room then adds the
