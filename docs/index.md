...
![](/static/images/home/gemma-4-android-lockup.png)

![](/static/images/home/gemma-4-lockup.png)

## Brings the next gen of on-device AI to Android

Get code-assistance in Android Studio and build intelligent experiences that run locally
using the ML Kit GenAI Prompt API.

[Start building with Gemma 4 arrow\_outward](http://android-developers.googleblog.com/2026/03/gemma-4-new-standard-for-local-agentic-intelligence.html)
