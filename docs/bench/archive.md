...
To view historical performance data for previous models, **select a version below**. Select archive leaderboard May 18th, 2026 May 5th, 2026 Apr 7th, 2026 Mar 5th, 2026 [Back to current leaderboard](https://developer.android.com/bench)
-
...
-
  ...
  | Model | Score (%) info Average percentage of 100 test cases successfully resolved across 10 runs for each model | arrow_range Cl range (%) info Expected performance range, reflecting the results' statistical reliability (p-value \< 0.05) | Date |
  |---|---|---|---|
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT 5.5 | **74.0** | 66.8 --- 80.5 | 2026-04-27 |
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT 5.4 | **72.4** | 65.4 --- 79.3 | 2026-03-16 |
  | :gemini: Gemini 3.1 Pro Preview | **72.4** | 65.1 --- 78.8 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Opus 4.7 | **68.7** | 61.2 --- 76.0 | 2026-04-27 |
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT 5.3 Codex | **67.7** | 59.9 --- 75.1 | 2026-03-18 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Opus 4.6 | **66.6** | 59.5 --- 73.9 | 2026-02-26 |
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT 5.2 Codex | **62.5** | 54.6 --- 70.1 | 2026-02-26 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Opus 4.5 | **61.9** | 53.0 --- 70.1 | 2026-02-26 |
  | :gemini: Gemini 3 Pro Preview | **60.4** | 52.3 --- 68.2 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Sonnet 4.6 | **58.4** | 50.4 --- 66.5 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Sonnet 4.5 | **53.8** | 45.5 --- 62.2 | 2026-02-26 |
  | :gemini: Gemini 3 Flash Preview | **42.0** | 36.5 --- 47.6 | 2026-02-26 |
  | :gemini: Gemini 2.5 Flash | **16.7** | 11.5 --- 22.1 | 2026-02-26 |
...
-
  ...
  | Model | Score (%) info Average percentage of 100 test cases successfully resolved across 10 runs for each model | arrow_range Cl range (%) info Expected performance range, reflecting the results' statistical reliability (p-value \< 0.05) | Date |
  |---|---|---|---|
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT-5.4 | **72.4** | 65.1 --- 79.3 | 2026-03-16 |
  | :gemini: Gemini 3.1 Pro Preview | **72.4** | 64.8 --- 79.3 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT-5.3-Codex | **67.7** | 60.1 --- 74.8 | 2026-03-18 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Opus 4.6 | **66.6** | 58.5 --- 74.0 | 2026-02-26 |
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT-5.2-Codex | **62.5** | 54.8 --- 69.8 | 2026-02-26 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Opus 4.5 | **61.9** | 53.8 --- 70.3 | 2026-02-26 |
  | :gemini: Gemini 3 Pro Preview | **60.4** | 52.4 --- 68.1 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Sonnet 4.6 | **58.4** | 50.9 --- 66.5 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Sonnet 4.5 | **54.2** | 46.0 --- 62.1 | 2026-02-26 |
  | :gemini: Gemini 3 Flash Preview | **42.0** | 36.4 --- 47.7 | 2026-02-26 |
  | :gemini: Gemini 2.5 Flash | **16.1** | 11.2 --- 21.2 | 2026-02-26 |
...
-
  ...
  | Model | Score (%) info Average percentage of 100 test cases successfully resolved across 10 runs for each model | arrow_range Cl range (%) info Expected performance range, reflecting the results' statistical reliability (p-value \< 0.05) | Date |
  |---|---|---|---|
  | :gemini: Gemini 3.1 Pro Preview | **72.4** | 65.3 --- 79.8 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Opus 4.6 | **66.6** | 58.9 --- 73.9 | 2026-02-26 |
  | ![](https://developer.android.com/static/images/bench/icons/openai.png) GPT-5.2-Codex | **62.5** | 54.7 --- 70.3 | 2026-02-26 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Opus 4.5 | **61.9** | 53.9 --- 69.6 | 2026-02-26 |
  | :gemini: Gemini 3 Pro Preview | **60.4** | 52.6 --- 67.8 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Sonnet 4.6 | **58.4** | 51.1 --- 66.6 | 2026-02-27 |
  | ![](https://developer.android.com/static/images/bench/icons/anthropic.png) Claude Sonnet 4.5 | **54.2** | 45.5 --- 62.4 | 2026-02-26 |
  | :gemini: Gemini 3 Flash Preview | **42.0** | 36.3 --- 47.9 | 2026-02-26 |
  | :gemini: Gemini 2.5 Flash | **16.1** | 10.9 --- 21.9 | 2026-02-26 |
