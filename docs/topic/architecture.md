...
screens implemented as [fragments](/guide/fragments) or Jetpack Compose destinations.
...
a common mistake to write all your code in an [`Activity`](/guide/components/activities/intro-activities) or a
...
To learn more, see the [UI layer page](/jetpack/guide/ui-layer).
...
* [Dependency injection (DI)](/training/dependency-injection): Dependency injection allows classes to
...
Following the [recommended app architecture](#recommended-app-arch) will help.
...
* Allows the app to scale. More people and more teams can contribute to the
...
* Helps with onboarding. As architecture brings consistency to your project,
  ...
  less amount of time.
* Easier to test. A good architecture encourages simpler types which are
...
these [case studies](/quality) where other companies share their success stories
