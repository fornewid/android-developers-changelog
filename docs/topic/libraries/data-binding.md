---
title: Data Binding Library  |  App architecture  |  Android Developers
...
# Data Binding Library   Part of [Android Jetpack](/jetpack).
...
**Note:** In many cases, [view binding](/topic/libraries/view-binding) can provide
the same benefits as data binding with simpler implementation and better
performance. If you are using data binding primarily to replace `findViewById()`
...
[**Layouts and binding expressions**](/topic/libraries/data-binding/expressions):   The expression language allows you to write expressions that connect
