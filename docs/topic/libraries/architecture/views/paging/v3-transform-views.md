---
title: https://developer.android.com/topic/libraries/architecture/views/paging/v3-transform-views
url: https://developer.android.com/topic/libraries/architecture/views/paging/v3-transform-views
source: md.txt
---

[Concepts and Jetpack Compose implementation](https://developer.android.com/topic/libraries/architecture/paging/v3-transform)
...
separators](https://developer.android.com/topic/libraries/architecture/views/paging/v3-transform-views#separators).
...
in the list to enable them to bind to a different `ViewHolder` type with a
distinct UI. The solution is to create a [Kotlin sealed
...
transformations](https://developer.android.com/topic/libraries/architecture/views/paging/v3-transform-views#basic-transformations).
