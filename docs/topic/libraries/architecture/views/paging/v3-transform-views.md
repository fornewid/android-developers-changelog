---
title: Transform data streams (Views)  |  Android Developers
...
# Transform data streams (Views) Stay organized with collections Save and categorize content based on your preferences.





[Concepts and Jetpack Compose implementationarrow\_forward](/topic/libraries/architecture/paging/v3-transform)
