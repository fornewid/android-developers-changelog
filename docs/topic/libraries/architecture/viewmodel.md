...
using the [saving instance state mechanism](/topic/libraries/architecture/saving-states#onsaveinstancestate). ViewModel provides a convenient
...
**Note:** ViewModel fully supports integration with key Jetpack libraries such as
[Hilt](/training/dependency-injection/hilt-android) and [Navigation](/guide/navigation), as well as [Compose](/jetpack/compose).
...
[SavedStateHandle](/topic/libraries/architecture/viewmodel/viewmodel-savedstate) allows you to persist data not just through configuration
...
To get the [benefits](#viewmodel-benefits) of ViewModel in Compose, host each screen in a Fragment
...
For more information, see the guide on [state hoisting](/jetpack/compose/state-hoisting#viewmodels-as-state-owner) for Jetpack Compose.
...
From lifecycle [version 2.5](/jetpack/androidx/releases/lifecycle#version_25_2) and above, you can pass one or more `Closeable`
