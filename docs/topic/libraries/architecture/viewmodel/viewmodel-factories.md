...
| Key | Functionality |
| --- | --- |
| [`ViewModelProvider.NewInstanceFactory.VIEW_MODEL_KEY`](/reference/androidx/lifecycle/ViewModelProvider.NewInstanceFactory.Companion#VIEW_MODEL_KEY()) | Provides access to the custom key you passed to `ViewModelProvider.get()`. |
| [`ViewModelProvider.AndroidViewModelFactory.APPLICATION_KEY`](/reference/androidx/lifecycle/ViewModelProvider.AndroidViewModelFactory.Companion#APPLICATION_KEY()) | Provides access to the instance of the `Application` class. |
...
* [`AbstractSavedStateViewModelFactory`](/reference/androidx/lifecycle/AbstractSavedStateViewModelFactory) if [`SavedStateHandle`](/reference/androidx/lifecycle/SavedStateHandle#getStateFlow(kotlin.String,kotlin.Any)) needs to
...
ViewModel that takes a repository and a [`SavedStateHandle`](/reference/androidx/lifecycle/SavedStateHandle#getStateFlow(kotlin.String,kotlin.Any)) type as a
dependency:
