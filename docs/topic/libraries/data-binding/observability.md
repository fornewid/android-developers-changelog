...
[fields](https://developer.android.com/topic/libraries/data-binding/observability#observable_fields), [collections](https://developer.android.com/topic/libraries/data-binding/observability#observable_collections), and
[objects](https://developer.android.com/topic/libraries/data-binding/observability#observable_objects).
...
[`Observable`](https://developer.android.com/reference/android/databinding/Observable) interface. In this
...
[`set()`](https://developer.android.com/reference/android/databinding/ObservableField#set) and
[`get()`](https://developer.android.com/reference/android/databinding/ObservableField#get) accessor methods
...
[`ObservableArrayMap`](https://developer.android.com/reference/android/databinding/ObservableArrayMap) class
...
The [`ObservableArrayList`](https://developer.android.com/reference/android/databinding/ObservableArrayList)
...
[`BaseObservable`](https://developer.android.com/reference/android/databinding/BaseObservable) class, which
...
this, assign a [`Bindable`](https://developer.android.com/reference/android/databinding/Bindable) annotation
to the getter and call the
[`notifyPropertyChanged()`](https://developer.android.com/reference/android/databinding/BaseObservable#notifypropertychanged)
...
using a
[`PropertyChangeRegistry`](https://developer.android.com/reference/android/databinding/PropertyChangeRegistry)
...
[`StateFlow`](https://developer.android.com/kotlin/flow/stateflow-and-sharedflow) and
[`LiveData`](https://developer.android.com/topic/libraries/architecture/livedata). For more information about
using `LiveData` in data binding, see [Use LiveData to notify the UI about data
changes](https://developer.android.com/topic/libraries/data-binding/architecture#livedata).
...
If your app uses Kotlin with [coroutines](https://developer.android.com/kotlin/coroutines), you can use
...
Components](https://developer.android.com/topic/libraries/data-binding/architecture#viewmodel), data binding
works seamlessly with [`ViewModel`](https://developer.android.com/reference/androidx/lifecycle/ViewModel)
...
> [!NOTE]
> **Note:** `StateFlow` support is a preview feature that requires version `7.0.0-alpha04` or higher of the [Android Gradle
