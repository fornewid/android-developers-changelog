...
screen. Navigation events are also a common type of events in an Android app.
...
to the caller composable as appropriate.
...
this use case. Here's a similar code:
...
* **Each class should do what they're responsible for, not more.** The UI is in
