---
title: https://developer.android.com/topic/architecture/views/recommendations-views
url: https://developer.android.com/topic/architecture/views/recommendations-views
source: md.txt
---

[Concepts and Jetpack Compose implementation](https://developer.android.com/topic/architecture/recommendations)
...
- You should create [repositories](https://developer.android.com/topic/architecture/data-layer#architecture) even if they only contain a single data source.
...
| Use a single-activity application. Recommended | Use [Navigation Fragments](https://developer.android.com/guide/navigation) to navigate between screens and deep link to your app if your app has more than one screen. |
...
[ViewModels](https://developer.android.com/topic/architecture/ui-layer/stateholders#business-logic) are responsible for providing the UI state and access to the
