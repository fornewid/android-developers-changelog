...
When designing an offline-first app you should start in the [data layer](https://developer.android.com/topic/architecture/data-layer) and
...
> [!NOTE]
> **Note:** A repository with network access in an offline-first app should always have a local data source.
...
In the snippet above, the asynchronous API of choice is [Coroutines](https://developer.android.com/kotlin/coroutines) as the
...
data source alone. This is the pattern used by the [Jetpack Paging Library](https://developer.android.com/topic/libraries/architecture/paging/v3-network-db)
with its [RemoteMediator](https://developer.android.com/reference/kotlin/androidx/paging/RemoteMediator) API.
...
specifying it as [unique work](https://developer.android.com/topic/libraries/architecture/workmanager/how-to/managing-work#unique-work) with the `KEEP` [`ExistingWorkPolicy`](https://developer.android.com/reference/androidx/work/ExistingWorkPolicy):
...
Specifically, the [`Constraints`](https://developer.android.com/reference/androidx/work/Constraints) defined by `SyncConstraints` require that
the [`NetworkType`](https://developer.android.com/reference/androidx/work/NetworkType) be `NetworkType.CONNECTED`. That is, it waits until the
network is available before it runs.

Once the network is available, the [Worker](https://developer.android.com/reference/androidx/work/Worker) drains the unique work queue
