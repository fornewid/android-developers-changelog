...
or higher, and you [enable developer options](https://developer.android.com/studio/debug/dev-options#enable).
...
tool, read [Analyzing with Profile GPU Rendering](https://developer.android.com/topic/performance/rendering/profile-gpu).
...
you should [fix overdraw events](https://developer.android.com/topic/performance/rendering/overdraw#fixing)
whenever possible.
...
[how to reduce
overdraw](https://developer.android.com/topic/performance/rendering/overdraw).
