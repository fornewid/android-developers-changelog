...
and holds a [partial wake lock](https://developer.android.com/topic/performance/vitals/wakelock) while executing the alarm's
...
practices](https://developer.android.com/topic/performance/vitals/wakeup#best_practices) section.
