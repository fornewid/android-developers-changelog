---
title: https://developer.android.com/topic/performance/vitals/slow-session
...
about the metric.
![Pie chart-like graphics that show the number of slow frames and non-slow frames.](https://developer.android.com/static/topic/performance/vitals/images/slow-session.png) **Figure 1.** A slow session in Android vitals.
...
Use [Android Frame Pacing (Swappy)](https://developer.android.com/topic/performance/vitals/slow-session#what_is_swappy),
[Vulkan](https://developer.android.com/topic/performance/vitals/slow-session#what_is_vulkan), and [ADPF](https://developer.android.com/topic/performance/vitals/slow-session#what_is_adpf) to
