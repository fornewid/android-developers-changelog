...
2. Edit instrumentation arguments by clicking next to the **Instrumentation
   arguments** field. ![](https://developer.android.com/static/topic/performance/images/benchmark_images/bench_instr_arg_2.png) **Figure 2.** Edit the instrumentation argument.
3. Click and add the required instrumentation argument. ![](https://developer.android.com/static/topic/performance/images/benchmark_images/bench_instr_arg_3.png) **Figure 3.** Add the instrumentation argument.
...
Microbenchmark](https://developer.android.com/studio/profile/microbenchmark-profile) for available options.
