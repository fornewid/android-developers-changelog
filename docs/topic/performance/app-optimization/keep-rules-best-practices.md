...
- If you use the [`repackageclasses` global option](https://developer.android.com/topic/performance/app-optimization/global-options#global-options), avoid specifying the
...
- Where possible, use `-assumenosideeffects` or `-convertchecknotnull` to
  ...
  app's DEX. For more information, see [Additional rule types](https://developer.android.com/topic/performance/app-optimization/additional-rule-types).
...
[Adopt optimizations incrementally](https://developer.android.com/topic/performance/app-optimization/adopt-optimizations-incrementally#use-package-wide). To use a keep rule for a package define
...
reflection (see the [Gson case study](https://developer.android.com/topic/performance/app-optimization/choose-libraries-wisely#gson-issues)).