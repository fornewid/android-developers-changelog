...
R8 (or enabling [full mode](https://developer.android.com/topic/performance/app-optimization/adopt-optimizations-incrementally#use-compat)) in a big app for the first time, try
...
[targeted keep rules](https://developer.android.com/topic/performance/app-optimization/add-keep-rules) or move to a codegen solution. But
...
back and either add [targeted keep rules](https://developer.android.com/topic/performance/app-optimization/add-keep-rules), or remove the
