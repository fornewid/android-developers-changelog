...
your app's startup period](https://developer.android.com/topic/performance/tracing). This page shows how to
set up your environment for performance testing.

## Use the Macrobenchmark library

The [Macrobenchmark
library](https://developer.android.com/topic/performance/benchmarking/macrobenchmark-overview) measures
...
performance
debugging](https://developer.android.com/studio/profile/measuring-performance#apk-considerations), as they
...
(R8)](https://developer.android.com/studio/build/shrink-code) and disabling obfuscation, with
[`-dontobfuscate`](https://developer.android.com/studio/build/shrink-code#obfuscate) in the proguard file.
It's easier to identify layouts, assets, and resources if the build is
unobfuscated.

Make sure you include the
[profileable](https://developer.android.com/guide/topics/manifest/profileable-element) flag in the manifest
...
Add [custom traces](https://developer.android.com/topic/performance/tracing/custom-events) within your app to
