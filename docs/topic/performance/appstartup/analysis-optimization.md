...
startup](https://developer.android.com/topic/performance/benchmarking/macrobenchmark-metrics#startup-timing).
...
Studio Profilers](https://developer.android.com/studio/profile) to analyze these traces.
