...
options via the `https://developer.android.com/reference/android/graphics/BitmapFactory.Options` class. Setting the `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#inJustDecodeBounds` property to `true` while decoding
avoids memory allocation, returning `null` for the bitmap object but setting `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#outWidth`, `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#outHeight` and `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#outMimeType`. This technique allows you to read the
...
- Dimensions of the target `https://developer.android.com/reference/android/widget/ImageView` or UI component that the image is to be loaded into.
- Screen size and density of the current device.

For example, it's not worth loading a 1024x768 pixel image into memory if it will eventually be
displayed in a 128x96 pixel thumbnail in an `https://developer.android.com/reference/android/widget/ImageView`.

To tell the decoder to subsample the image, loading a smaller version into memory, set `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#inSampleSize` to `true` in your `https://developer.android.com/reference/android/graphics/BitmapFactory.Options` object. For example, an image with resolution 2048x1536 that
is decoded with an `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#inSampleSize` of 4 produces a
bitmap of approximately 512x384. Loading this into memory uses 0.75MB rather than 12MB for the full
image (assuming a bitmap configuration of `https://developer.android.com/reference/android/graphics/Bitmap.Config`). Here's
...
a final value by rounding down to the nearest power of two, as per the `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#inSampleSize` documentation.

To use this method, first decode with `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#inJustDecodeBounds` set to `true`, pass the options
through and then decode again using the new `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#inSampleSize` value and `https://developer.android.com/reference/android/graphics/BitmapFactory.Options#inJustDecodeBounds` set to `false`:
...
This method makes it easy to load a bitmap of arbitrarily large size into an `https://developer.android.com/reference/android/widget/ImageView` that displays a 100x100 pixel thumbnail, as shown in the following example
code:
...
appropriate `https://developer.android.com/reference/android/graphics/BitmapFactory#decodeByteArray(byte[], int, int, android.graphics.BitmapFactory.Options)` method as needed.