...
[Baseline Profile Gradle plugin](https://developer.android.com/topic/performance/baselineprofiles/configure-baselineprofiles).
...
2. Configure the `build.gradle.kts` file for the `:baseline-profile` module. [The configuration is
   essentially the same as for an app](https://developer.android.com/topic/performance/baselineprofiles/create-baselineprofile#create-new-profile-plugin), but make sure to set the `targetProjectPath` to the sample app module.
