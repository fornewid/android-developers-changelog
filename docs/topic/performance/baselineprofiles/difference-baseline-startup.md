---
title: Difference between Baseline Profiles and Startup Profiles  |  App quality  |  Android Developers
...
human-readable baseline profile files generated by [`BaselineProfileRule`](/reference/kotlin/androidx/benchmark/macro/junit4/BaselineProfileRule)
...
[`includeInStartupProfile`](/topic/performance/baselineprofiles/create-baselineprofile#define-generator) configuration field. For more information, see
[Overview of Baseline Profiles](/topic/performance/baselineprofiles/overview).
...
You should generally set [`includeInStartupProfile`](/topic/performance/baselineprofiles/create-baselineprofile#define-generator) to `true` only for test
