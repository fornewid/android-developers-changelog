...
The Baseline Profile Gradle plugin makes it easier to generate and maintain[Baseline Profiles](https://developer.android.com/topic/performance/baselineprofiles/overview). It helps you do the following tasks:
...
To use a[Gradle Managed Device (GMD)](https://developer.android.com/studio/test/gradle-managed-devices)to generate your Baseline Profile, add one in the`build.gradle.kts`configuration of the profile producer module---likely the`:baselineprofile`test module---as shown in the following example:  
...
[Learn more](https://developer.android.com/codelabs/android-macrobenchmark-inspect)  
...
[Learn more](https://developer.android.com/codelabs/android-baseline-profiles-improve)