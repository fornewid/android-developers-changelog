---
title: How the Android Calendar team improved app startup and jank with Baseline Profiles  |  App quality  |  Android Developers
...
* Opening the app in schedule view: initially the default view, so important to
  optimize for users using the app for the first time or who don't change the
  default settings.
* Opening the app in month view: the chosen view for many users, based on user
  data. To track how users are using your app, you can use tools such as
...
* PACKAGE\_NAME: The package name of the app for which you want to
...
* Median interactive app startup (most common scenario) latency decreased from
  775ms to 644ms (17%)
