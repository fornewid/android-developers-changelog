...
Profiles](https://developer.android.com/topic/performance/baselineprofiles/overview#cloud-profiles), which
...
include](https://developer.android.com/topic/performance/baselineprofiles/overview#what-to-include).

## Implementation

The Android Calendar team uses an internal wrapper for the
[Jetpack Macrobenchmark library](https://developer.android.com/topic/performance/baselineprofiles/measure-baselineprofile)
...
- <var translate="no">PACKAGE_NAME</var>: The package name of the app for which you want to generate Baseline Profiles.
