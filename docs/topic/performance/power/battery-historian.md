---
title: Analyze power use with Battery Historian  |  App quality  |  Android Developers
...
![Battery Historian’s display of system-wide events affecting power
  consumption.](/static/topic/performance/images/generic-timeline.png)


**Figure 1.** Battery Historian’s display of system-wide events
...
![A close-up of the Battery Historian timeline from roughly 6:50 AM to 7:20 AM.](/static/topic/performance/images/s-generic-closeup.png)


**Figure 2.** A close-up of the Battery Historian timeline from
roughly 6:50 AM to 7:20 AM.
...
![Investigating which apps consume the most power.](/static/topic/performance/images/app-rankings.png)
...
![Entering a specific app whose data to view.](/static/topic/performance/images/dropdown.png)
...
**Note:** From Android 6.0 (API level 23), the platform includes Doze functionality,
...
![Visualization of data for fictional app Pug Power.](/static/topic/performance/images/pug-visualization.png)
