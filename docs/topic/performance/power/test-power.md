...
Debug Bridge (`adb`)](https://developer.android.com/studio/command-line/adb) commands to turn some of the features on and off.
...
[Test with Doze
and App Standby](https://developer.android.com/training/monitoring-device-state/doze-standby#testing_doze_and_app_standby).
