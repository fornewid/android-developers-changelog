---
title: https://developer.android.com/topic/performance/issues/wakeup
url: https://developer.android.com/topic/performance/issues/wakeup
source: md.txt
---
...
[`AlarmManager`](https://developer.android.com/reference/android/app/AlarmManager) with
either the
...
and holds a [partial wake lock](https://developer.android.com/topic/performance/issues/stuck-wakelock) while executing the alarm's
...
> [!NOTE]
> **Note:** For information on how Android Play Vitals tracks and reports this issue, see [Excessive wakeups in Android vitals](https://developer.android.com/google/play/vitals/wakeup).

## Fix the problem

The [`AlarmManager`](https://developer.android.com/reference/android/app/AlarmManager) was
introduced in early versions of the Android platform, but over time, many use
cases that previously required
[`AlarmManager`](https://developer.android.com/reference/android/app/AlarmManager) are now
...
practices](https://developer.android.com/topic/performance/issues/wakeup#best_practices) section.
...
- Look for calls to the various
  [`set()`](https://developer.android.com/reference/android/app/AlarmManager#set(int,%20long,%20java.lang.String,%20android.app.AlarmManager.OnAlarmListener,%20android.os.Handler))
  methods in
  [`AlarmManager`](https://developer.android.com/reference/android/app/AlarmManager) that
  include either the
  [`RTC_WAKEUP`](https://developer.android.com/reference/android/app/AlarmManager#RTC_WAKEUP)
  or
  [`ELAPSED_REALTIME_WAKEUP`](https://developer.android.com/reference/android/app/AlarmManager#ELAPSED_REALTIME_WAKEUP)
...
expected by running the following [ADB](https://developer.android.com/studio/command-line/adb)
command:
...
Don't use
[`AlarmManager`](https://developer.android.com/reference/android/app/AlarmManager) to
...
Don't use [`AlarmManager`](https://developer.android.com/reference/android/app/AlarmManager)
...
[`Handler`](https://developer.android.com/reference/android/os/Handler) class because it is
