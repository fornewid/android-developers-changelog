---
title: https://developer.android.com/topic/performance/issues/lmk
...
services, perceptible apps, foreground app, persistent, system, and native.](https://developer.android.com/static/topic/performance/issues/images/oom-score.png) **Figure 1.** Android processes, with high scores at the top and low scores at the bottom.

<br />

> [!NOTE]
> **Note:** For information on how Android Play Vitals tracks and reports this issue, see [Low memory killers in Android vitals](https://developer.android.com/google/play/vitals/lmk).
...
memory allocation.
![](https://developer.android.com/static/studio/images/memory-profiler-jni-heap_2x.png) **Figure 2.** Viewing global JNI references in Android Studio Memory Profiler.
...
![Memory module shows memory allocations such as texture memory and mesh memory.](https://developer.android.com/static/topic/performance/issues/images/unity-profiler-memory-module.png) **Figure 3.** Unity Profiler window with the **Memory** module selected.
...
![](https://developer.android.com/static/topic/performance/issues/images/unity-memory-snapshot.png) **Figure 4.** Analyzing a memory snapshot using the Memory Profiler window.
...
Android projects.
![Memory Insights tracker showing main memory graph, live allocation count, and alloc/free event count.](https://developer.android.com/static/topic/performance/issues/images/unreal-memory-insights.png) **Figure 5.** Unreal's Memory Insights tracker.
