...
4.1. Any data collected or used pursuant to Your use of the ADC is in accordance with Google's[Privacy Policy](https://policies.google.com/privacy). Additionally, there are some special cases explained below applicable to data that Google collects in connection with the ADC.
