---
title: Frequently asked questions  |  Android developer verification  |  Android Developers
...
* **I'm a hobbyist/student. What is "limited distribution"?** We understand
  ...
  [Learn more about limited distribution accounts](/guides/limited-distribution). *Last updated: March
  25, 2026*
...
* **If I want to modify or hack some apk and install it on my own device, do I
  ...
  will verify developers can build and test apps that aren't intended or not
  yet ready to distribute to the wider consumer population. *Last updated:
  Sept 11, 2025*
* **How does this program impact developers in sanctioned countries?** Devices
  ...
  verification, though users there will not benefit from the enhanced security
...
* **What is a D-U-N-S number and how do I get one?** A D-U-N-S number is a
  ...
  organization does not have one, you can [get one for free](https://www.dnb.com/en-us/smb/duns/get-a-duns.html) from the Dun &
  Bradstreet website. The process can take up to 28 days so you should make
  preparations to obtain a D-U-N-S number. *Last updated: Sept 3,
  2025*
* **How is my personal information handled?** We use your personal information
  ...
  Privacy Policy](https://policies.google.com/privacy). We are committed to protecting your data.
  *Last updated: Sept 3, 2025*
...
* **I distribute my apps through Play and other channels** : To simplify the
  process, developers with a Play Console account can use it as the single
  place to manage all their verification requirements, including for their
  apps distributed outside of Play. *Last updated: Sept 3, 2025*
* **I use Play App Signing, are my apps claimed automatically?** Yes. If you
  use Play App Signing, we have the necessary information to securely identify
  your ownership. Your eligible apps will be part of the automatic
  registration process. *Last updated: Sept 3, 2025*
* **Can I recover a lost signing key?** We strongly recommend all developers
  use a secure key management solution. If you lose your signing key you won't
  be able to register your packages. *Last updated: March 23, 2026*
* **Can my app use multiple signing keys?** The Android Developer Console lets
  you add and verify multiple signing keys for a single package. *Last
  updated: March 23, 2026*
...
* **Can users still sideload apps from unverified developers?** Yes. Android
  is introducing an advanced flow for power users who want to take educated
  risks to install apps from unverified developers. It's a **one-time** setup
  for users to install apps from unverified developers after acknowledging the
  risks. It's designed to protect user choice while adding in safeguards to
  protect users from being tricked or coerced into disabling security
  protections. Preview it in our [video](https://youtube.com/shorts/WcPElxbOeXY) or [blog post](https://goo.gle/advance-flow). *Last updated:
  March 23, 2026*
