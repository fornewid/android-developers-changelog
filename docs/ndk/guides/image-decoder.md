---
title: Image decoder  |  Android NDK  |  Android Developers
...
# Image decoder Stay organized with collections Save and categorize content based on your preferences.
...
* [`NinePatch`](/reference/android/graphics/NinePatch): If present in an
  encoded image, NinePatch chunks are ignored.
* [Bitmap density](/reference/android/graphics/Bitmap#getDensity()):
  ...
  [`AImageDecoder_setTargetSize()`](/ndk/reference/group/image-decoder#aimagedecoder_settargetsize).
