...
Android Studio](https://developer.android.com/studio/debug) instead.
...
session. For more information, see [Options](https://developer.android.com/ndk/guides/ndk-gdb#opt).
