---
title: Advice for middleware vendors  |  Android NDK  |  Android Developers
...
# Advice for middleware vendors Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** This section describes how to distribute C/C++ *APIs* to users. If your
native libraries are implementation details of your *Java* API, see the [Java
...
**Warning:** [Bug 141758241](https://issuetracker.google.com/141758241): Older versions of the Android Gradle plugin do not
currently diagnose this error condition. One of the identically named libraries
will be arbitrarily chosen for packaging in the APK.
