...
2. In the module's [Android.mk](https://developer.android.com/ndk/guides/android_mk) file, assign to `LOCAL_SRC_FILES` the path to
...
in the same directory as the [Android.mk](https://developer.android.com/ndk/guides/android_mk) file that describes it.
...
the [Android.mk](https://developer.android.com/ndk/guides/android_mk) files associated with those other modules.
...
for your targeted ABI. The [`TARGET_ARCH_ABI`](https://developer.android.com/ndk/guides/android_mk#taa)
variable in the [Android.mk](https://developer.android.com/ndk/guides/android_mk) file can point the build system at the appropriate
