...
[`Application.mk`](https://developer.android.com/ndk/guides/application_mk), the build system, and your environment variables leave
...
`Android.mk` files that you can look at. In addition, [Sample: native-activity](https://developer.android.com/ndk/samples/sample_na)
provides a detailed explanation of that sample's `Android.mk` file. Finally,
[Variables and macros](https://developer.android.com/ndk/guides/android_mk#var) provides further information on the variables from this
section.
...
[Module-description variables](https://developer.android.com/ndk/guides/android_mk#mdv)).
...
more information about using prebuilts, see [Use prebuilt libraries](https://developer.android.com/ndk/guides/prebuilts).
...
corresponding Android system images, see [Native APIs](https://developer.android.com/ndk/guides/stable_apis). The
...
refer to [Android ABIs](https://developer.android.com/ndk/guides/abis).
...
modifications automatically. Throughout your `Android.mk` and [`Application.mk`](https://developer.android.com/ndk/guides/application_mk)
...
relevant information in the [`Application.mk`](https://developer.android.com/ndk/guides/application_mk) file. Doing it this way allows the
...
release, see [Native APIs](https://developer.android.com/ndk/guides/stable_apis).
...
this code at runtime. For more information, see [Neon support](https://developer.android.com/ndk/guides/cpu-arm-neon) and
...
can also define `APP_SHORT_COMMANDS` in your [`Application.mk`](https://developer.android.com/ndk/guides/application_mk) file to force
...
[`Application.mk`](https://developer.android.com/ndk/guides/application_mk) file through the `APP_THIN_ARCHIVE` variable.
