---
title: Sampling audio  |  Android NDK  |  Android Developers
...
# Sampling audio Stay organized with collections Save and categorize content based on your preferences.
...
* Floating-point operations employ unexpected properties, for example, addition is
  not associative.
* Floating-point calculations can sometimes lose arithmetic precision due to rounding or
  numerically unstable algorithms.
* Using floating-point effectively requires greater understanding to achieve accurate
...
* [What every
  computer scientist should know about floating-point arithmetic](http://docs.oracle.com/cd/E19957-01/806-3568/ncg_goldberg.html)
