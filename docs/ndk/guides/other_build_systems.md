...
The NDK contains official support for [ndk-build](https://developer.android.com/ndk/guides/ndk-build) and [CMake](https://developer.android.com/ndk/guides/cmake). Most users should
