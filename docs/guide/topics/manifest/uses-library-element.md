---
title: <uses-library>  |  App architecture  |  Android Developers
...
# <uses-library> Stay organized with collections Save and categorize content based on your preferences.
...
:   Specifies a shared library that the application must be linked against.
    ...
    All the `android` packages, such as `android.app`,
