...
description:
:   Declares a broadcast receiver, a `https://developer.android.com/reference/android/content/BroadcastReceiver`
    ...
    `https://developer.android.com/reference/android/content/BroadcastReceiver` class
    description.
...
:
    ...
    :   Whether the broadcast receiver is *Direct-Boot aware*, that
        ...
        **Note:** During
        [Direct Boot](https://developer.android.com/training/articles/direct-boot), a broadcast
    ...
    :   Whether the broadcast receiver can receive messages from non-system sources
        ...
        See the `https://developer.android.com/guide/topics/manifest/receiver-element#prmsn` attribute.
    ...
    :   An icon representing the broadcast receiver. This attribute is set
        ...
        instead. See the `https://developer.android.com/guide/topics/manifest/application-element`
    ...
    :   The name of the class that implements the broadcast receiver, a subclass of
        `https://developer.android.com/reference/android/content/BroadcastReceiver`. This is a fully qualified
        ...
        the `https://developer.android.com/guide/topics/manifest/manifest-element` element.

        Once you publish your application, [don't
        change this name](http://android-developers.blogspot.com/2011/06/things-that-cannot-change.html), unless you set `https://developer.android.com/guide/topics/manifest/receiver-element#exported="false"`.
    ...
    :   The name of a permission that broadcasters need in order to send a
        ...
        `https://developer.android.com/guide/topics/manifest/application-element#prmsn` attribute applies
    ...
    :   The name of the process in which the broadcast receiver runs.
        ...
        The
        `https://developer.android.com/guide/topics/manifest/application-element` element's
        `https://developer.android.com/guide/topics/manifest/application-element#proc` attribute can set a different
