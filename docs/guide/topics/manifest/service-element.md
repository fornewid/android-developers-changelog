---
title: <service>  |  App architecture  |  Android Developers
...
# <service> Stay organized with collections Save and categorize content based on your preferences.
...
:   Declares a service, a `Service` subclass, as one
    ...
    **Note:** On Android 8.0 (API level 26) and higher, the system limits
    ...
    [background execution limits](/about/versions/oreo/background) and
    [background location
...
:   `android:description`
    ...
    :   Whether the service is *Direct-Boot aware*, that is,
        ...
        **Note:** During
        [Direct Boot](/training/articles/direct-boot), a service in
    ...
    :   Specifies that the service is a
        [foreground service](/guide/components/services) that satisfies a
        ...
        location, usually to
        [continue
        a user-initiated action](/training/location/background#continue-user-initiated-action) related to device location.
    ...
    :   The name of a permission that an entity needs in order to
        ...
        [Security guidelines](/privacy-and-security/security-tips).
