...
`https://developer.android.com/reference/tools/gradle-api/7.1/com/android/build/api/variant/Variant#namespace`
...
an `https://developer.android.com/reference/android/content/Intent` object that describes an
...
`https://developer.android.com/reference/android/Manifest.permission`, or a permission
...
**Elements**
:   Only the
    `https://developer.android.com/guide/topics/manifest/manifest-element` and
    `https://developer.android.com/guide/topics/manifest/application-element`
    ...
    `https://developer.android.com/guide/topics/manifest/provider-element`, and
