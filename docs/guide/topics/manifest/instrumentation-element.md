---
title: <instrumentation>  |  App architecture  |  Android Developers
...
# <instrumentation> Stay organized with collections Save and categorize content based on your preferences.
...
description:
:   Declares an `Instrumentation` class that lets you
