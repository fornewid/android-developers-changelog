---
title: Adaptive optimized  |  Large screens  |  Android Developers
...
# Adaptive optimized Stay organized with collections Save and categorize content based on your preferences.
...
![Depiction of three tiers with the middle tier, tier 2, highlighted.](/static/images/docs/quality-guidelines/tier-2/tier_2_header.png)
...
![](/static/images/guide/topics/large-screens/quality-guidelines/tier-2/tier_2_do.png)
...
![](/static/images/guide/topics/large-screens/quality-guidelines/tier-2/tier_2_dont.png)
...
![](/static/images/guide/topics/large-screens/quality-guidelines/tier-2/user_interface_icon.svg)

### [User interface](/docs/quality-guidelines/adaptive-app-quality/tier-2#t2_user_interface)
...
See the [User interface](/guide/topics/large-screens/user-interface) overview.

![](/static/images/guide/topics/large-screens/quality-guidelines/tier-2/mouse_and_trackpad_icon.svg)

### [Keyboard, mouse, and trackpad](/docs/quality-guidelines/adaptive-app-quality/tier-2#t2_keyboard_mouse_trackpad)

Support external hardware input devices to increase app usability and user satisfaction.

Guidelines:

* [Keyboard\_Navigation](/docs/quality-guidelines/adaptive-app-quality/tier-2#Keyboard_Navigation)
* [Keyboard\_Shortcuts](/docs/quality-guidelines/adaptive-app-quality/tier-2#Keyboard_Shortcuts)
* [Keyboard\_Media\_Playback](/docs/quality-guidelines/adaptive-app-quality/tier-2#Keyboard_Media_Playback)
* [Keyboard\_Send](/docs/quality-guidelines/adaptive-app-quality/tier-2#Keyboard_Send)
* [Context\_Menus](/docs/quality-guidelines/adaptive-app-quality/tier-2#Context_Menus)
* [Content\_Zoom](/docs/quality-guidelines/adaptive-app-quality/tier-2#Content_Zoom)
* [Hover\_States](/docs/quality-guidelines/adaptive-app-quality/tier-2#Hover_States)
