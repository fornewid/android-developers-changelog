---
title: Device discovery API  |  Cross device SDK  |  Android Developers
...
# Device discovery API Stay organized with collections Save and categorize content based on your preferences.
...
![Dialog box with sharing options to nearby users](/static/images/develop/connectivity/cross-device-sdk/device-discovery.png)
...
**Note:** If a user receives a request from an uninstalled app, they’ll need to
install it and try the request again. In the future, we hope to take advantage
of Play Store APIs to continue the existing intent.
...
**Note:** This feature will be available in a later version of the developer
preview.
