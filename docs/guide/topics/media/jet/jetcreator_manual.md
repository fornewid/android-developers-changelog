---
title: https://developer.android.com/guide/topics/media/jet/jetcreator_manual
url: https://developer.android.com/guide/topics/media/jet/jetcreator_manual
source: md.txt
---

# SONiVOX JETCreator User Manual
...
JET works in conjunction with SONiVOX's Embedded Audio Synthesizer (EAS) which is the MIDI playback device for Android. Both the JET and EAS engines are integrated into the Android embedded platform through the[JetPlayer](https://developer.android.com/reference/android/media/JetPlayer)class, as well as inherent in the JET Creator application. As such, the JET content author can be sure that the playback will sound exactly the same in both the JET Creator and the final Android application playing back on Android mobile devices.
...
It is important to use a common set of terms to minimize confusion. Since JET uses MIDI in a unique way, normal industry terms may not always suffice. Here is the definition of terms as they are used on this page and in the JET Creator application:
...
![](https://developer.android.com/static/images/jet/linear_music.png)  
...
![](https://developer.android.com/static/images/jet/nonlinear_music.png)  
...
![](https://developer.android.com/static/images/jet/sync_muteunmute.png)  
...
![](https://developer.android.com/static/images/jet/music_game.png)  
Figure 4: Music Game
...
Please see the JET Content Authoring Guidelinesdocumentation for additional details on content authoring.
...
![](https://developer.android.com/static/images/jet/jc_open_dlg.png)
...
![](https://developer.android.com/static/images/jet/jc_main_wnd.png)  
...
![](https://developer.android.com/static/images/jet/jc_seg_wnd.png)
...
![](https://developer.android.com/static/images/jet/jc_event_wnd.png)
...
![](https://developer.android.com/static/images/jet/jc_rep_wnd.png)

Replicate Segment Window

![](https://developer.android.com/static/images/jet/jc_repseg_wnd.png)
...
![](https://developer.android.com/static/images/jet/jc_moveseg_wnd.png)
...
![](https://developer.android.com/static/images/jet/jc_audition_wnd.png)
...
2. User actions can be compared to trigger events which are pre-inserted into a music file at musically correct places. Based on the results, scoring or other game actions can take place.
3. Musical transitions between levels or action sequences can be synchronized to be musically seamless.
...
![](https://developer.android.com/static/images/jet/clip_marker.png)
...
![](https://developer.android.com/static/images/jet/event_marker.png)
