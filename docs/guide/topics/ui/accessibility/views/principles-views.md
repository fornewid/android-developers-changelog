---
title: Principles for improving app accessibility (Views)  |  Android Developers
url: https://developer.android.com/guide/topics/ui/accessibility/views/principles-views
source: html-scrape
---
...
* [Guides](https://developer.android.com/guide/topics/ui/accessibility/views/apps-views)

# Principles for improving app accessibility (Views) Stay organized with collections Save and categorize content based on your preferences.





[Concepts and Jetpack Compose implementationarrow\_forward](/guide/topics/ui/accessibility/principles)
...
In a list or a grid context, a screen reader may consolidate the text of a list
or grid element's child text nodes. It is best to avoid modifying this
announcement.
