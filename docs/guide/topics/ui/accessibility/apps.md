...
* If the text is smaller than 18pt, or if the text is bold and smaller than
  14pt, set the color contrast ratio to at least 4.5:1.
...
![Pictures displaying text](/static/images/guide/topics/ui/accessibility/color-contrast.svg)
...
* The sum of the values of
  [`android:paddingLeft`](/reference/android/view/View#attr_android:paddingLeft),
  [`android:minWidth`](/reference/android/view/View#attr_android:minWidth), and
  [`android:paddingRight`](/reference/android/view/View#attr_android:paddingRight)
  is greater than or equal to 48dp.
* The sum of the values of
  [`android:paddingTop`](/reference/android/view/View#attr_android:paddingTop),
  [`android:minHeight`](/reference/android/view/View#attr_android:minHeight), and
  [`android:paddingBottom`](/reference/android/view/View#attr_android:paddingBottom)
  is greater than or equal to 48dp.
...
**Note:** Don't provide descriptions for
[`TextView`](/reference/android/widget/TextView) elements. Android accessibility
services automatically announce the text itself as the description.
