...
for your application with the [`android:installLocation`](https://developer.android.com/guide/topics/manifest/manifest-element#install) manifest attribute. If you do
...
manifest file to include the [`android:installLocation`](https://developer.android.com/guide/topics/manifest/manifest-element#install) attribute in the `https://developer.android.com/guide/topics/manifest/manifest-element` element,
...
1. Include the `android:installLocation` attribute with a value of "`auto`" or "`preferExternal`" in the `https://developer.android.com/guide/topics/manifest/uses-sdk-element` element.
...
Services
:   Your running
    `https://developer.android.com/reference/android/app/Service` is
    killed and isn't restarted when external storage is remounted. Applications
    bound to this service can register for the
    `https://developer.android.com/reference/android/content/Intent#ACTION_EXTERNAL_APPLICATIONS_AVAILABLE`
...
Alarm Services
:   Your alarms registered with `https://developer.android.com/reference/android/app/AlarmManager` will be cancelled. You must
    manually re-register any alarms when external storage is remounted.

Input Method Editors
:   Your [IME](https://developer.android.com/guide/topics/text/creating-input-method) will be
...
App Widgets
:   Your [App Widget](https://developer.android.com/guide/topics/appwidgets) will be removed
...
Account Managers
:   Your accounts created with `https://developer.android.com/reference/android/accounts/AccountManager` will disappear until
    external storage is remounted.

Sync Adapters
:   Your `https://developer.android.com/reference/android/content/AbstractThreadedSyncAdapter` and all its sync functionality will
    not work until external storage is remounted.

Device Administrators
:   Your `https://developer.android.com/reference/android/app/admin/DeviceAdminReceiver` and all its admin capabilities will
...
:   The system delivers the `https://developer.android.com/reference/android/content/Intent#ACTION_BOOT_COMPLETED` broadcast
...
external storage, then you should make this clear by declaring [`android:installLocation`](https://developer.android.com/guide/topics/manifest/manifest-element#install) with a value of "`internalOnly`". Though this does not
