---
title: Android (Go edition)  |  Build for Billions  |  Android Developers
...
# Android (Go edition) Stay organized with collections Save and categorize content based on your preferences.
...
edition) was [first announced in 2017](https://www.blog.google/products/android/2bn-milestone),
...
[Optimize for devices running Android (Go edition)](/docs/quality-guidelines/build-for-billions/device-capacity#androidgo).
...
**Note:** This is not a comprehensive list and there may be other minor features
disabled on Android (Go edition).
...
see [Android 13 (Go edition): Easier to update and tailored just for you)](https://blog.google/products/android/android-13-go-edition/).