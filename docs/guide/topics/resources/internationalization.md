---
title: Unicode and internationalization support  |  App architecture  |  Android Developers
...
# Unicode and internationalization support Stay organized with collections Save and categorize content based on your preferences.
...
[multiple versions
of your APK](/google/play/publishing/multiple-apks), so users running versions of Android lower than
...
* The APIs in the Android framework don't replace Android’s support for
  [localizing with
  resources](/guide/topics/resources/localization).
...
[`VersionInfo.ICU_VERSION`](/reference/android/icu/util/VersionInfo#ICU_VERSION) API (available since Android 7.0) to obtain the ICU
...
[`DateFormat.is24HourFormat()`](/reference/android/text/format/DateFormat#is24HourFormat(android.content.Context)).
To observe this setting, either use
[`DateFormat`](/reference/android/text/format/DateFormat) or
[`DateUtils`](/reference/android/text/format/DateUtils)
...
[`Transliterator`](/reference/android/icu/text/Transliterator)
...
[`Transliterator.getAvailableIDs()`](/reference/android/icu/text/Transliterator#getAvailableIDs()),
...
Test your app with pseudolocales](/guide/topics/resources/pseudolocales)

[Next

Language and locale resolution

arrow\_forward](/guide/topics/resources/multilingual-support)