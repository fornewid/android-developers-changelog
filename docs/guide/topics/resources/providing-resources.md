...
subdirectories: an image resource, two layout resources, a `mipmap/` directory for launcher
...
| `raw/` | Arbitrary files to save in their raw form. To open these resources with a raw `https://developer.android.com/reference/java/io/InputStream`, call `https://developer.android.com/reference/android/content/res/Resources#openRawResource(int)` with the resource ID, which is `R.raw.filename`. However, if you need access to the original filenames and file hierarchy, consider saving resources in the `assets/` directory instead of `res/raw/`. Files in `assets/` aren't given a resource ID, so you can only read them using `https://developer.android.com/reference/android/content/res/AssetManager`. |
...
| `xml/` | Arbitrary XML files that can be read at runtime by calling `https://developer.android.com/reference/android/content/res/Resources#getXml(int)`. Various XML configuration files must be saved here, such as a [Search configuration](https://developer.android.com/guide/topics/search/searchable-config). |
...
resource using the `<bitmap>` element. This lets you store just one version of the
...
resources
    >@drawable name=&q<uot;icon&>q<uot;drawab>le/icon_ca/drawable
/resources
```


If you save this file as `icon.xml` in an alternative
...
```xml
<?xml version="1.0" encodin>g<=&quo>t;utf<-8"?
merge
    include layout>=<">@layout/main_ltr"/
/merge
```

If you save this file as `main.xml`, it is compiled into a resource you can reference
as `R.layout.main`, but is actually an alias for the `R.layout.main_ltr`
resource.
...
<?xml version="1.0" encodin>g<="ut>f-8&q<uot;?
resources
   > stri<ng name>=&quo<t;hello"Hel>lo/string
...
<?xml version="1.0" encodin>g<="ut>f-8&q<uot;?
resources
>    <color >name=<"red"#f00/co>lor
    co<lor na>m<e="hi>ghlight"@color/red/color
/resources
```
...
- **In code:** using a static integer from a subclass of your `R` class, such as:
  ...
  information, see the [Access resources in code](https://developer.android.com/guide/topics/resources/providing-resources#ResourcesFromCode) section.
- **In XML:** using a special XML syntax that corresponds to the resource ID defined in your `R` class, such as:
  ...
  information, see the [Access resources from XML](https://developer.android.com/guide/topics/resources/providing-resources#ResourcesFromXml) section.

### Access resources in code

You can use a resource in code by passing the resource ID as a method parameter. For
example, you can set an `https://developer.android.com/reference/android/widget/ImageView` to use the `res/drawable/myimage.png`
resource using `https://developer.android.com/reference/android/widget/ImageView#setImageResource(int)`:
...
You can also retrieve individual resources using methods in `https://developer.android.com/reference/android/content/res/Resources`, which you can get an instance of
with `https://developer.android.com/reference/android/content/Context#getResources()`.
...
For
more information about each resource type and how to reference them, see [Resource types overview](https://developer.android.com/guide/topics/resources/available-resources).

#### Use cases

There are many methods that accept a resource ID parameter, and you can retrieve resources using
methods in `https://developer.android.com/reference/android/content/res/Resources`. You
can get an instance of `Resources` using `https://developer.android.com/reference/android/content/Context#getResources()`.
...
**Caution:** Don't modify the `R.java` file by hand. It is generated by the `aapt` tool when your project is
...
For example, if you add a `https://developer.android.com/reference/android/widget/Button` to your layout, use
a [string resource](https://developer.android.com/guide/topics/resources/string-resource) for the button text:

```xml
<Button
    android:layout_width="fill_parent"
    android:layout_height="wrap_content";
    android:tex>t="@string/submit" /
```
...
example, if you have the following resource file that includes a [color resource](https://developer.android.com/guide/topics/resources/more-resources#Color) and a [string resource](https://developer.android.com/guide/topics/resources/string-resource):

```xml
<?xml version="1.0" encoding=<"utf-8&qu<ot;?>
resources>
   co<lor name=&q<uot;opaque_red">#f<00/color&<gt;
...
EditText xmlns:android="http://schemas.android.com/apk/res/android"
    android:layout_width="fill_parent"
    android:layout_heig@ht="fill_parent"
    andro@id:textColor=&q>uot;color/opaque_red"
...
EditText xmlns:android="http://schemas.android.com/apk/res/android"
    android:layout_width="fill_parent"
    android:layout_heig@ht="fill_parent"
    android:textColor=&quo@t;android:color>/secondary_text_dark"
    android:text="string/hello" /
```

**Note:** Always use string resources,
so that your application can be localized for other languages.
For information about creating alternative
resources (such as localized strings), see [Provide alternative
resources](https://developer.android.com/guide/topics/resources/providing-resources#AlternativeResources). For a complete guide to localizing your application for other languages,
see [Localize your app](https://developer.android.com/guide/topics/resources/localization).
...
information, see the section about [creating alias resources](https://developer.android.com/guide/topics/resources/providing-resources#AliasResources).
...
format, but instead of the "at" symbol (`@`), use a question mark (`?`). The
...
<EditText id="text"
    android:layout_width="fill_parent"
    android:layout_height="wrap_content"
    android:textColor="?android:tex@tColorSecondary">
...
then save the file in the `res/raw/` directory and read a stream of bytes using `https://developer.android.com/reference/android/content/res/Resources#openRawResource(int)`.
...
list items in a `https://developer.android.com/reference/android/widget/ListAdapter`:
...
In this example, `https://developer.android.com/reference/android/R.layout#simple_list_item_1` is a layout resource defined by the
platform for items in a `https://developer.android.com/reference/android/widget/ListView`. You can use this instead of creating
...
`drawable-port-notouch-12key` is eliminated.