---
title: Color state list resource  |  App architecture  |  Android Developers
...
# Color state list resource Stay organized with collections Save and categorize content based on your preferences.
...
applied to. For example, a `Button`
...
Animation](/guide/topics/resources/animation-resource)

[Next

Drawable

arrow\_forward](/guide/topics/resources/drawable-resource)