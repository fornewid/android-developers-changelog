---
title: Test your app with pseudolocales  |  App architecture  |  Android Developers
...
# Test your app with pseudolocales Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/images/develop/pseudo-locale-example-app_2x.png)
...
![](/static/images/develop/pseudo-locale-example-app-rtl_2x.png)
...
2. [Build and run your app](/studio/run).
   ...
   ![](/static/images/develop/pseudo-locale-select_2x.png)
...
3. Use the Settings app to select a pseudolocale. This step varies based on your
   ...
   **Android 5.0 (API level 21) or higher**
   ...
   2. In the **Language preferences** list, drag the tab to move a
      pseudolocale to the top of the list and make it the active language.
      See figure 3.
   ...
   **Android 4.4.4 (API level 19) or lower**
   ...
   3. In the **Language preferences** list, drag the tab to move a
      pseudolocale to the top of the list and make it the active language
      See figure 3.
...
* Hardcoded strings, which can't be sent to translation, display as unaccented
  text in the pseudolocale to make them noticeable.
* UI layout issues caused by text expansion, showing where the UI can break
  due to text length.
...
arrow\_forward](/guide/topics/resources/internationalization)