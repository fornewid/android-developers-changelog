...
[Storage Access Framework overview](https://developer.android.com/guide/topics/providers/document-provider#overview).
...
- The attribute `android:name` set to the name of your `https://developer.android.com/reference/android/provider/DocumentsProvider` subclass, which is its class name, including package name:
...
- The attribute `android:grantUriPermissions` set to `"true"`. This setting allows the system to grant other apps access to content in your provider. For a discussion about how these other apps can persist their access to content from your provider, see [Persist
  permissions](https://developer.android.com/training/data-storage/shared/documents-files#persist-permissions).
...
The
`https://developer.android.com/reference/android/content/Intent#ACTION_OPEN_DOCUMENT` intent is only available
on devices running Android 4.4 and higher.
If you want your application to support `https://developer.android.com/reference/android/content/Intent#ACTION_GET_CONTENT`
to accommodate devices that are running Android 4.3 and lower, you should
disable the `https://developer.android.com/reference/android/content/Intent#ACTION_GET_CONTENT` intent filter in
your manifest for devices running Android 4.4 or higher. A
document provider and `https://developer.android.com/reference/android/content/Intent#ACTION_GET_CONTENT` should be considered
...
`https://developer.android.com/reference/android/content/Intent#ACTION_GET_CONTENT` intent filter for devices
...
[Content providers](https://developer.android.com/guide/topics/providers/content-provider-creating#ContractClass) developers guide. A contract class is a `public final` class
...
- `https://developer.android.com/reference/android/provider/DocumentsContract.Root#COLUMN_ROOT_ID`
- `https://developer.android.com/reference/android/provider/DocumentsContract.Root#COLUMN_ICON`
- `https://developer.android.com/reference/android/provider/DocumentsContract.Root#COLUMN_TITLE`
- `https://developer.android.com/reference/android/provider/DocumentsContract.Root#COLUMN_FLAGS`
- `https://developer.android.com/reference/android/provider/DocumentsContract.Root#COLUMN_DOCUMENT_ID`
...
- `https://developer.android.com/reference/android/provider/DocumentsContract.Document#COLUMN_FLAGS`
...
abstract class `https://developer.android.com/reference/android/provider/DocumentsProvider`. At minimum, you must
implement the following methods:

- `https://developer.android.com/reference/android/provider/DocumentsProvider#queryRoots(java.lang.String[])`
- `https://developer.android.com/reference/android/provider/DocumentsProvider#queryChildDocuments(java.lang.String, java.lang.String[], android.os.Bundle)`
- `https://developer.android.com/reference/android/provider/DocumentsProvider#queryDocument(java.lang.String, java.lang.String[])`
- `https://developer.android.com/reference/android/provider/DocumentsProvider#openDocument(java.lang.String, java.lang.String, android.os.CancellationSignal)`

These are the only methods you are strictly required to implement, but there
are many more you might want to. See `https://developer.android.com/reference/android/provider/DocumentsProvider`
for details.

### Define a root

Your implementation of `https://developer.android.com/reference/android/provider/DocumentsProvider#queryRoots(java.lang.String[])` needs to return a `https://developer.android.com/reference/android/database/Cursor` pointing to all
...
`https://developer.android.com/reference/android/content/ContentResolver#notifyChange(android.net.Uri, android.database.ContentObserver)` method, as shown in the following code snippet.
...
`https://developer.android.com/reference/android/provider/DocumentsProvider#queryChildDocuments(java.lang.String, java.lang.String[], android.os.Bundle)`
must return a `https://developer.android.com/reference/android/database/Cursor` that points to all the files in
...
Your implementation of
`https://developer.android.com/reference/android/provider/DocumentsProvider#queryDocument(java.lang.String, java.lang.String[])`
must return a `https://developer.android.com/reference/android/database/Cursor` that points to the specified file,
using columns defined in `https://developer.android.com/reference/android/provider/DocumentsContract.Document`.

The `https://developer.android.com/reference/android/provider/DocumentsProvider#queryDocument(java.lang.String, java.lang.String[])`
...
overriding the
`https://developer.android.com/reference/android/provider/DocumentsProvider#openDocumentThumbnail(java.lang.String, android.graphics.Point, android.os.CancellationSignal)` method and adding the
`https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_SUPPORTS_THUMBNAIL`
flag to the supported files.
The following code snippet provides an example of how to implement the
`https://developer.android.com/reference/android/provider/DocumentsProvider#openDocumentThumbnail(java.lang.String, android.graphics.Point, android.os.CancellationSignal)`.
...
You must implement `https://developer.android.com/reference/android/provider/DocumentsProvider#openDocument(java.lang.String, java.lang.String, android.os.CancellationSignal)` to return a `https://developer.android.com/reference/android/os/ParcelFileDescriptor` representing
the specified file. Other apps can use the returned `https://developer.android.com/reference/android/os/ParcelFileDescriptor`
...
`https://developer.android.com/reference/android/os/ParcelFileDescriptor#createReliablePipe()`
or
`https://developer.android.com/reference/android/os/ParcelFileDescriptor#createReliableSocketPair()` methods.
Those methods allow you to create a pair of
`https://developer.android.com/reference/android/os/ParcelFileDescriptor` objects, where you can return one
and send the other via an
`https://developer.android.com/reference/android/os/ParcelFileDescriptor.AutoCloseOutputStream`
or
...
`https://developer.android.com/reference/android/provider/DocumentsProvider#queryRecentDocuments(java.lang.String, java.lang.String[])` method and returning
`https://developer.android.com/reference/android/provider/DocumentsContract.Root#FLAG_SUPPORTS_RECENTS`,
The following code snippet shows an example of how to implement the
`https://developer.android.com/reference/android/provider/DocumentsProvider#queryRecentDocuments(java.lang.String, java.lang.String[])` methods.
...
If a client app sends an `https://developer.android.com/reference/android/content/Intent#ACTION_CREATE_DOCUMENT`
...
`https://developer.android.com/reference/android/provider/DocumentsContract.Root#FLAG_SUPPORTS_CREATE` flag.
Directories that allow new files to be created within them need to have the
`https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_DIR_SUPPORTS_CREATE`
flag.


Your document provider also needs to implement the
`https://developer.android.com/reference/android/provider/DocumentsProvider#createDocument(java.lang.String, java.lang.String, java.lang.String)` method. When a user selects a directory within your
document provider to save a new file, the document provider receives a call to
`https://developer.android.com/reference/android/provider/DocumentsProvider#createDocument(java.lang.String, java.lang.String, java.lang.String)`. Inside the implementation of the
`https://developer.android.com/reference/android/provider/DocumentsProvider#createDocument(java.lang.String, java.lang.String, java.lang.String)` method, you return a new
`https://developer.android.com/reference/android/provider/DocumentsContract.Document#COLUMN_DOCUMENT_ID` for the
file. The client app can then use that ID to get a handle for the file
and, ultimately, call
`https://developer.android.com/reference/android/provider/DocumentsProvider#openDocument(java.lang.String, java.lang.String, android.os.CancellationSignal)` to write to the new file.
...
`https://developer.android.com/reference/android/provider/DocumentsContract.Document#COLUMN_FLAGS` column
to indicate the supported functionality. You also need to implement
the corresponding method of the `https://developer.android.com/reference/android/provider/DocumentsProvider`
class.


The following table provides the
`https://developer.android.com/reference/android/provider/DocumentsContract.Document#COLUMN_FLAGS` flag
and `https://developer.android.com/reference/android/provider/DocumentsProvider` method that a documents
provider needs to implement to expose specific features.

| Feature | Flag | Method |
|---|---|---|
| Delete a file | `https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_SUPPORTS_DELETE` | `https://developer.android.com/reference/android/provider/DocumentsProvider#deleteDocument(java.lang.String)` |
| Rename a file | `https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_SUPPORTS_RENAME` | `https://developer.android.com/reference/android/provider/DocumentsProvider#renameDocument(java.lang.String, java.lang.String)` |
| Copy a file to a new parent directory within the document provider | `https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_SUPPORTS_COPY` | `https://developer.android.com/reference/android/provider/DocumentsProvider#copyDocument(java.lang.String, java.lang.String)` |
| Move a file from one directory to another within the document provider | `https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_SUPPORTS_MOVE` | `https://developer.android.com/reference/android/provider/DocumentsProvider#moveDocument(java.lang.String, java.lang.String, java.lang.String)` |
| Remove a file from its parent directory | `https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_SUPPORTS_REMOVE` | `https://developer.android.com/reference/android/provider/DocumentsProvider#removeDocument(java.lang.String, java.lang.String)` |

### Support virtual files and alternate file formats


[Virtual files](https://developer.android.com/guide/topics/providers/document-provider#virtual),
...
When a client app sends an `https://developer.android.com/reference/android/content/Intent#ACTION_VIEW` intent
without the `https://developer.android.com/reference/android/content/Intent#CATEGORY_OPENABLE` category,
...
`https://developer.android.com/reference/android/provider/DocumentsContract.Document#FLAG_VIRTUAL_DOCUMENT`
...
`https://developer.android.com/reference/android/provider/DocumentsProvider#getDocumentStreamTypes(java.lang.String, java.lang.String)`
method. When client apps call the
`https://developer.android.com/reference/android/content/ContentResolver#getStreamTypes(android.net.Uri, java.lang.String)`
...
`https://developer.android.com/reference/android/content/ContentResolver#openTypedAssetFileDescriptor(android.net.Uri, java.lang.String, android.os.Bundle, android.os.CancellationSignal)`
method, which internally calls the document provider's
`https://developer.android.com/reference/android/provider/DocumentsProvider#openTypedDocument(java.lang.String, java.lang.String, android.os.Bundle, android.os.CancellationSignal)`
...
zero roots in your implementation of `https://developer.android.com/reference/android/provider/DocumentsProvider#queryRoots(java.lang.String[])`. That is, an empty root cursor:
...
Remember the `https://developer.android.com/reference/android/provider/DocumentsContract`? We're using it to make
...
logged in, a call to `https://developer.android.com/reference/android/provider/DocumentsProvider#queryRoots(java.lang.String[])` returns an
