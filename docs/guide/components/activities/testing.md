...
response to the events described in [The activity lifecycle](/guide/components/activities/activity-lifecycle).
...
[`createAndroidComposeRule`](/reference/kotlin/androidx/compose/ui/test/junit4/v2/package-summary#createAndroidComposeRule(kotlin.coroutines.CoroutineContext)) to launch your activity and interact with your
UI components.
...
underlying [`ActivityScenario`](/reference/kotlin/androidx/test/core/app/ActivityScenario) framework.
...
instances of [`ActivityScenario`](/reference/kotlin/androidx/test/core/app/ActivityScenario), part of the [AndroidX Test](/training/testing)
...
composables using [Compose testing APIs](/develop/ui/compose/testing).
...
Alternatively, you can use [`createAndroidComposeRule`](/reference/kotlin/androidx/compose/ui/test/junit4/package-summary#createAndroidComposeRule(kotlin.coroutines.CoroutineContext)) to automatically
...
**Note:** All the techniques in this document for manipulating and inspecting the
`ActivityScenario` apply equally to the scenario extracted from the
