...
instances of [`ActivityScenario`](https://developer.android.com/reference/androidx/test/core/app/ActivityScenario),
part of the
[AndroidX Test](https://developer.android.com/training/testing) library. Using this class, you can
...
`View` elements using [Espresso UI tests](https://developer.android.com/training/testing/espresso).
