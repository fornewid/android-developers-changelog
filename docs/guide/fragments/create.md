...
# Create a fragment Stay organized with collections Save and categorize content based on your preferences.
...
[AndroidX Fragment library](/jetpack/androidx/releases/fragment). You need to
add the [Google Maven repository](/studio/build/dependencies#google-maven)
...
[`Fragment`](/reference/androidx/fragment/app/Fragment) class, and override
its methods to insert your app logic, similar to the way you would create
an [`Activity`](/reference/android/app/Activity) class. To create a minimal
...
:   Displays a floating dialog. Using this class to create a dialog is a good
    ...
    [`Activity`](/reference/android/app/Activity) class, as fragments
    automatically handle the creation and cleanup of the `Dialog`.
    See [Displaying dialogs with `DialogFragment`](/guide/fragments/dialogs)
    for more details.

[`PreferenceFragmentCompat`](/reference/androidx/preference/PreferenceFragmentCompat)
:   Displays a hierarchy of
    [`Preference`](/reference/androidx/preference/Preference) objects as a
    list. You can use `PreferenceFragmentCompat` to
    [create a settings screen](/develop/ui/views/components/settings) for your app.

## Add a fragment to an activity

Generally, your fragment must be embedded within an AndroidX
[`FragmentActivity`](/reference/androidx/fragment/app/FragmentActivity) to
...
is instantiated,
[`onInflate()`](/reference/androidx/fragment/app/Fragment#onInflate(android.content.Context,%2520android.util.AttributeSet,%2520android.os.Bundle))
...
**Note:** You can use the `class` attribute instead of `android:name` as an
...
[`FragmentManager`](/reference/androidx/fragment/app/FragmentManager), which
...
[`FragmentTransaction.add()`](/reference/androidx/fragment/app/FragmentTransaction#add(int,%20java.lang.Class%3C?%20extends%20androidx.fragment.app.Fragment%3E,%20android.os.Bundle)),
...
**Note:** You should **always** use `setReorderingAllowed(true)` when
performing a `FragmentTransaction`. For more information on reordered
transactions, see
[Fragment transactions](/guide/fragments/transactions#reordering).
...
calling
[`requireArguments()`](/reference/androidx/fragment/app/Fragment#requireArguments()),
...
in the [Fragment manager guide](/guide/fragments/fragmentmanager).