...
A [fragment](https://developer.android.com/guide/fragments) represents a modular portion of the user
...
[AndroidX Fragment library](https://developer.android.com/jetpack/androidx/releases/fragment). You need to
add the [Google Maven repository](https://developer.android.com/studio/build/dependencies#google-maven)
...
[`Fragment`](https://developer.android.com/reference/androidx/fragment/app/Fragment) class, and override
its methods to insert your app logic, similar to the way you would create
an [`Activity`](https://developer.android.com/reference/android/app/Activity) class. To create a minimal
...
:   Displays a floating dialog. Using this class to create a dialog is a good
    ...
    [`Activity`](https://developer.android.com/reference/android/app/Activity) class, as fragments
    automatically handle the creation and cleanup of the `Dialog`.
    See [Displaying dialogs with `DialogFragment`](https://developer.android.com/guide/fragments/dialogs)
    for more details.
...
:   Displays a hierarchy of
    [`Preference`](https://developer.android.com/reference/androidx/preference/Preference) objects as a
    list. You can use `PreferenceFragmentCompat` to
    [create a settings screen](https://developer.android.com/develop/ui/views/components/settings) for your app.

## Add a fragment to an activity

Generally, your fragment must be embedded within an AndroidX
[`FragmentActivity`](https://developer.android.com/reference/androidx/fragment/app/FragmentActivity) to
...
is instantiated,
[`onInflate()`](https://developer.android.com/reference/androidx/fragment/app/Fragment#onInflate(android.content.Context,%2520android.util.AttributeSet,%2520android.os.Bundle))
...
[`FragmentManager`](https://developer.android.com/reference/androidx/fragment/app/FragmentManager), which
...
[`FragmentTransaction.add()`](https://developer.android.com/reference/androidx/fragment/app/FragmentTransaction#add(int,%20java.lang.Class%3C?%20extends%20androidx.fragment.app.Fragment%3E,%20android.os.Bundle)),
...
If your fragment requires some initial data, arguments can be passed to your fragment by providing a `https://developer.android.com/reference/android/os/Bundle` in the call to `FragmentTransaction.add()`, as shown below:
...
calling
[`requireArguments()`](https://developer.android.com/reference/androidx/fragment/app/Fragment#requireArguments()),
...
in the [Fragment manager guide](https://developer.android.com/guide/fragments/fragmentmanager).