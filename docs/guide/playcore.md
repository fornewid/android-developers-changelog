---
title: Overview of the Google Play Core libraries  |  Other Play guides  |  Android Developers
...
# Overview of the Google Play Core libraries Stay organized with collections Save and categorize content based on your preferences.
