---
title: Integrate in-app reviews (Unity)  |  Other Play guides  |  Android Developers
...
# Integrate in-app reviews (Unity) Stay organized with collections Save and categorize content based on your preferences.
