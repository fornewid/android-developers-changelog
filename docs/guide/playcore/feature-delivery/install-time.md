---
title: Configure install-time delivery  |  Other Play guides  |  Android Developers
...
# Configure install-time delivery Stay organized with collections Save and categorize content based on your preferences.
...
4. In the **Configure your new module** section, complete the
   ...
   2. Specify a **Module name**. The IDE uses this name to identify the
      ...
      [feature module’s manifest](/guide/app-bundle/dynamic-delivery#dynamic_feature_manifest).
...
6. In the **Module Download Options** section, complete the following:
   ...
   1. Specify the **Module title** using up to 50 characters. Your app’s base
      ...
      **Note:** If you enable resource shrinking, such as for your release builds,
      the shrinker might remove the module title string resource if code in your
...
**Note:** Configuring too many install-time modules as removable might increase the
download and install time for your app. To avoid this issue, keep the number of
removable install-time delivery modules under 10.