---
title: UX best practices for on demand delivery  |  Other Play guides  |  Android Developers
...
![](/static/studio/images/projects/dynamic-delivery/progress_bar.png)
...
![](/static/studio/images/projects/dynamic-delivery/failed_download.png)

**Figure 2.**  Let the user know why a feature cannot be installed at
this time

![](/static/studio/images/projects/dynamic-delivery/large_download.png)
...
![](/static/studio/images/projects/dynamic-delivery/success_notification.png)
...
**Note:** Requests for deferred installs are best-effort and you cannot track their
progress. Before trying to access a module you had marked for deferred
installation,
[check that the module has been installed](/guide/playcore/feature-delivery/on-demand#manage_installed_modules).
If it hasn't, you can always install it on-demand at that time.
