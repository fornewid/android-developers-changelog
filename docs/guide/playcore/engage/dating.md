---
title: Engage SDK Dating: Third-party technical integration instructions  |  Android Developers
...
# Engage SDK Dating: Third-party technical integration instructions Stay organized with collections Save and categorize content based on your preferences.
...
and enables a new immersive experience for personalized app content consumption
and discovery. This fullscreen experience provides developer partners with an
opportunity to showcase their best rich content in a dedicated channel outside
of their app.This guide contains instructions for developer partners to
integrate their dating content, using the Engage SDK to populate this new
surface area.
...
* **Recommendation** clusters show personalized dating suggestions
  from an individual developer partner. These recommendations can be
  personalized to the user.

  + A Recommendation cluster can be made of `ArticleEntity`, `PersonEntity`,
    or `EventEntity` but not a mix of different entity types.
  ...
  + **Entity:** An object representing a single item in a cluster. This
    ...
    - **ArticleEntity**: ArticleEntity represents a recommendation for
      text-based content that is related to dating. ArticleEntity item
      allows developers to provide a variety of text and image content
      with more metadata to articulate the information to the users.

      ![](/static/images/guide/playcore/engage/article-entity-dating.png)
    ...
    - **PersonEntity**: PersonEntity represents a person. The
      recommendations could be to highlight a person in the dating
      prospects.

      ![](/static/images/guide/playcore/engage/person-entity-dating.png)


      **Figure 2:** UI showing a single PersonEntity within
    ...
    - **EventEntity**: EventEntity represents an event happening in the
      ...
      ![](/static/images/guide/playcore/engage/event-entity-dating.png)


      **Figure 3:** UI showing a single EventEntity
...
* The **Continuation** cluster shows content recently engaged by users from
  ...
  + **ArticleEntity**: ArticleEntity represents a recommendation for
    text-based content that is related to dating. This entity can be used to
    represent unfinished news articles or other content that the user would
    like to continue consuming from where they left it.

    ![](/static/images/guide/playcore/engage/article-entity-continuation-dating.png)
  ...
  + **EventReservationEntity**: EventReservationEntity represents
    ...
    dating and meetup event reservations.

    ![](/static/images/guide/playcore/engage/event-reservation-entity-dating.png)
...
* The **Featured** cluster is a UI view that showcases the chosen hero
  ...
  + **GenericFeaturedEntity**: GenericFeaturedEntity differs from
    ...
    ![](/static/images/guide/playcore/engage/featured-cluster-dating.png)


    **Figure 12:** UI showing a FeaturedCluster with a
...
the following entities for the Dating category:
...
| Popularity - Visual | Optional | Indicate what the interaction is for. For example - Image showing Likes icon, emoji.  Can provide more than 1 image, though not all may not be shown on all form factors.  **Note:** Must be Square 1:1 image | See [Image Specifications](#image-specs) for guidance. |
...
1. Some entities like **ArticleEntity** and **GenericFeaturedEntity** are
   ...
   **EventEntity**, **EventReservationEntity**, **PersonEntity**, only a subset
   of these categories are eligible. Check the list of categories eligible for
   an entity type before populating the list.
