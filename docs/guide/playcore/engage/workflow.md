...
A [verification app](https://developer.android.com/guide/playcore/engage/workflow#lightbox-trigger) used
to verify content publishing in the UI.

### Content publishing guidelines

[Documentation](https://developer.android.com/guide/playcore/engage/publish) providing guidelines on how to effectively publish content
using the APIs.
