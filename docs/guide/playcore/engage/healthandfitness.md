---
title: Engage SDK Health and Fitness: Third-party technical integration instructions  |  Other Play guides  |  Android Developers
url: https://developer.android.com/guide/playcore/engage/healthandfitness
source: html-scrape
---
...
# Engage SDK Health and Fitness: Third-party technical integration instructions Stay organized with collections Save and categorize content based on your preferences.
...
* **Recommendation** clusters show personalized health and fitness suggestions
  ...
  + **Entity:** An object representing a single item in a cluster. This
    ...
    - **ArticleEntity**: ArticleEntity represents a recommendation for
      ...
      ![](/static/images/guide/playcore/engage/article-entity-health-and-fitness.png)
    ...
    - **PersonEntity**: PersonEntity represents a person. The
      ...
      ![](/static/images/guide/playcore/engage/person-entity-health-and-fitness.png)
    ...
    - **EventEntity**: EventEntity represents an event happening in the
      ...
      ![](/static/images/guide/playcore/engage/event-entity-health-and-fitness.png)
...
* The **Continuation** cluster shows content recently engaged by users from
  ...
  + **ArticleEntity**: ArticleEntity represents a recommendation for
    ...
    ![](/static/images/guide/playcore/engage/article-entity-continuation-health-and-fitness.png)
  ...
  + **EventReservationEntity**: EventReservationEntity represents
    ...
    ![](/static/images/guide/playcore/engage/event-reservation-entity-health-and-fitness.png)
...
| Poster images | **Required** | We will show only 1 image when multiple images are provided. Recommended aspect ratio is 16:9  **Note:** If a badge is provided, please ensure safe space of 24 dps at both the top and bottom of the image | See [Image Specifications](#image-specs) for guidance. |
...
| Poster images | Optional | We will show only 1 image when multiple images are provided. Recommended aspect ratio is 16:9  **Note:** Image is highly recommended. If a badge is provided, please ensure safe space of 24 dps at both the top and bottom of the image | See [Image Specifications](#image-specs) for guidance. |
...
| Header image | Optional | We will show only 1 image when multiple images are provided. Recommended aspect ratio is 16:9  **Note:** Image is highly recommended. If a badge is provided, please ensure safe space of 24 dps at both the top and bottom of the image | See [Image Specifications](#image-specs) for guidance. |
...
| Poster images | **Required** | We will show only 1 image when multiple images are provided. Recommended aspect ratio is 16:9  **Note:** Image is highly recommended. If a badge is provided, please ensure safe space of 24 dps at both the top and bottom of the image | See [Image Specifications](#image-specs) for guidance. |
