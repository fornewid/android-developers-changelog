---
title: Get started with Engage SDK for TV  |  Other Play guides  |  Android Developers
url: https://developer.android.com/guide/playcore/engage/tv/getting-started
source: html-scrape
---
...
# Get started with Engage SDK for TV Stay organized with collections Save and categorize content based on your preferences.
...
* [Publish Continue Watching data](/guide/playcore/engage/tv/continue-watching)
* [Publish device entitlements](/guide/playcore/engage/tv/entitlements)
* [Publish recommendations](/guide/playcore/engage/tv/recommendations)
...
7. In your production app, set the Engage service environment to production in
   ...
   **Important:** The Engage service environment declaration is only needed for
   your release build. For your local testing with the verification app, don't
...
2. If the value of `isServiceAvailable` is `false` in the verification app,
   click the **Toggle** button within the verification app to set it to `true`.
3. Enter the package name of your app. It automatically shows the published
   data.
4. Run your app and perform publishing actions, such as logging in or watching
   a video.
