---
title: Test asset delivery  |  Other Play guides  |  Android Developers
...
# Test asset delivery Stay organized with collections Save and categorize content based on your preferences.
...
2. Follow the Play Console instructions on how to
   [share your app internally](https://support.google.com/googleplay/android-developer/answer/9303479).
3. On the test device, click the internal app-sharing link for the version of
   your app you just uploaded.
4. Install the app from the Google Play Store page you see after clicking the
   link.