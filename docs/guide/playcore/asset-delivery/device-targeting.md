---
title: Device targeting for asset delivery (beta)  |  Other Play guides  |  Android Developers
...
# Device targeting for asset delivery (beta) Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** If a device matches multiple groups, it will be served the content for the
group that is defined first in the XML file. The order you define groups in the
XML file is your priority order.**Important:** It's not possible to prevent **any** variant of your asset pack from
being delivered to certain devices. Non-targeted devices will always receive the
default variant.