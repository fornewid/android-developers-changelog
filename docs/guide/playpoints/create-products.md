---
title: Create in-app products and promotions  |  Other Play guides  |  Android Developers
...
# Create in-app products and promotions Stay organized with collections Save and categorize content based on your preferences.
...
![A screenshot of TBD](/static/images/guide/playpoints/icon-model.png)
...
| A screenshot of TBD | A screenshot of TBD |
...
* Product ID: com.example.your\_title.1500gems.rew
  + We recommend that you append "rew" (reward) to your Product IDs. This can
    help both you and Google more easily identify your Play Points promotions.
* Name: 1500 Gems
