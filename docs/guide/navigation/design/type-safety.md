...
Compose](https://developer.android.com/jetpack/compose/navigation) or [Navigation Kotlin DSL](https://developer.android.com/guide/navigation/navigation-kotlin-dsl). They are available as of `Navigation
2.8.0`.

These APIs are equivalent to what [Safe Args](https://developer.android.com/guide/navigation/navigation-pass-data#Safe-args) provides to navigation graphs
built using XML.
...
dependencies](https://developer.android.com/guide/navigation#set-up).
...
your Navigation graph](https://developer.android.com/guide/navigation/design) page.

#### Access arguments in a ViewModel

To access arguments from a type-safe route in a `ViewModel`, you can retrieve
the route from the [`SavedStateHandle`](https://developer.android.com/topic/libraries/architecture/viewmodel/viewmodel-savedstate#savedstatehandle) by calling
[`SavedStateHandle.toRoute<T>()`](https://developer.android.com/reference/kotlin/androidx/navigation/package-summary#(androidx.lifecycle.SavedStateHandle).toRoute(kotlin.collections.Map)), where `T` is your route class:
