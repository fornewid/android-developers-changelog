...
[nested graphs](https://developer.android.com/guide/navigation/navigation-nested-graphs), they appear as child `<navigation>` elements.
...
destinations](https://developer.android.com/guide/navigation/navigation-create-destinations).
...
You can also use the [Layout Editor](https://developer.android.com/studio/write/layout-editor) to add a `NavHostFragment` to an
...
destination to another, though you can also create [global actions](https://developer.android.com/guide/navigation/navigation-global-action) that take
