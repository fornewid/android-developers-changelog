---
title: Use Navigation actions and Fragments  |  App architecture  |  Android Developers
...
# Use Navigation actions and Fragments Stay organized with collections Save and categorize content based on your preferences.
...
* **Animations:** You can also animate transitions between the destinations.
  For more information, see [Animate transitions between destinations](/reference/androidx/navigation/Navigation#createNavigateOnClickListener(int)).
...
**Important:** For more information about how to use `NavController.navigate()` and
its various overloads, see the [Navigate to a
