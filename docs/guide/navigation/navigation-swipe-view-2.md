...
[`ViewPager`](/reference/kotlin/androidx/viewpager/widget/ViewPager), see
...
![An image showing a TabLayout with four tabs, and the third one is selected.](/static/images/topic/libraries/architecture/navigation-tab-layout.png)
