...
@Serializable
class PersonDetailsForm : NavKeyhttps://github.com/android/nav3-recipes/blob/6dfa1da533ca261ad0f2d8c0ebf71c97a27ee026/app/src/main/java/com/example/nav3recipes/results/common/NavKeys.kt
```
...
@Parcelize
data class Person(val name: String, val favoriteColor: String) : Parcelablehttps://github.com/android/nav3-recipes/blob/6dfa1da533ca261ad0f2d8c0ebf71c97a27ee026/app/src/main/java/com/example/nav3recipes/results/common/Person.kt
```
