...
* Use [`rememberDecoratedNavEntries`](/reference/kotlin/androidx/navigation3/runtime/rememberDecoratedNavEntries.composable). This function is useful when you
  ...
  a decorated list of `NavEntry`s that you can use with [`NavDisplay`](/reference/kotlin/androidx/navigation3/ui/NavDisplay.composable).
