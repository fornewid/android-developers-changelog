---
title: Create swipe views with tabs using ViewPager  |  App architecture  |  Android Developers
...
For more information, see [Create swipe views with tabs using
...
`TabLayout` from fitting all tabs on the screen at once and lets users scroll
