---
title: Design for seamlessness  |  Android Developers
...
# Design for seamlessness Stay organized with collections Save and categorize content based on your preferences.
...
your computations to a thread. This [Design for Responsiveness](/guide/practices/app-design/responsiveness) document
...
the details, read [Styles and Themes](/guide/topics/ui/themes).
...
via a [command-line
option](/tools/help/emulator#netspeed) when starting the emulator.
...
code](/guide/practices/app-design/performance). To minimize the power drain from using the radio, be sure to handle
