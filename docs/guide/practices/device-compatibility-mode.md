...
[Large screen app quality](/docs/quality-guidelines/large-screen-app-quality) guidelines.
...
**Note:** The override applies only if the activity targets Android 14 (SDK level
34) or lower. See [Behavior changes: Apps targeting Android 15 or higher](/about/versions/15/behavior-changes-15#stable-configuration).
...
* [Large screen app quality](/docs/quality-guidelines/large-screen-app-quality) guidelines
* [Core app quality](/docs/quality-guidelines/core-app-quality) guidelines
