---
title: https://developer.android.com/develop/adaptive-apps/quality-guidelines/android-xr
url: https://developer.android.com/develop/adaptive-apps/quality-guidelines/android-xr
source: md.txt
---
...
[Android XR differentiated app](https://developer.android.com/develop/adaptive-apps/quality-guidelines/android-xr#android-xr-differentiated).
...
| **General Baseline Requirement** (Android \& OpenXR) | **Performance** | Crash Rate | Do not consume excessive system resources impacting the rest of the system and other apps, keeping a \~1% [crash rate](https://developer.android.com/topic/performance/issues/crash). |
