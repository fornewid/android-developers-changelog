---
title: https://developer.android.com/develop/adaptive-apps/quality-guidelines/adaptive-app-quality/experiences/stylus
url: https://developer.android.com/develop/adaptive-apps/quality-guidelines/adaptive-app-quality/experiences/stylus
source: md.txt
---
...
|---|---|---|
| Stylus_Draw_Write | [T-Stylus_Draw_Write](https://developer.android.com/develop/adaptive-apps/quality-guidelines/adaptive-app-quality/experiences/stylus#T-Stylus_Draw_Write) | App supports drawing and writing with a stylus. Drawings and writing can be erased with the stylus. |
| Stylus_Drag_Drop | [T-Stylus_Drag_Drop](https://developer.android.com/develop/adaptive-apps/quality-guidelines/adaptive-app-quality/experiences/stylus#T-Stylus_Drag_Drop) | App provides stylus support for dragging and dropping content between elements within the app and, in multi-window mode, to and from other apps. See [Enable drag and drop](https://developer.android.com/develop/ui/views/touch-and-input/drag-drop). |
| Stylus_Enhanced | [T-Stylus_Enhanced](https://developer.android.com/develop/adaptive-apps/quality-guidelines/adaptive-app-quality/experiences/stylus#T-Stylus_Enhanced) | App provides enhanced stylus support, including: - Low latency and motion prediction to improve responsiveness - Pressure sensitivity for drawing strokes of varying width - Tilt detection for creating shading strokes - Palm and finger rejection to prevent stray marks See [Advanced stylus features](https://developer.android.com/develop/ui/compose/touch-input/stylus-input/advanced-stylus-features#low-latency). |
