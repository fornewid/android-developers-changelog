...
> [!NOTE]
> **Note:** Through the [Car ready mobile apps program](https://developer.android.com/training/cars/car-ready-mobile-apps), mobile apps meeting the requirements in this tier can be made available for download from the Google Play Store on Android Automotive OS vehicles with Google built-in.
...
| Contrast | `VD-3` | Media | The app must provide colors that the system can optimize for in-vehicle readability. |
...
| Messaging Functionality | `MF-4` | Messaging | The app must use short-form messaging app design patterns. Long-form messaging apps, such as apps for email, are not permitted. |
...
- Voice Commands
  ...
  - Updated criterion: [`VC-1`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#VC-1)
  - Previous text:
...
- Theming
  ...
  - Categories affected: Media (templated), Messaging (templated), Navigation, POI, IOT, Weather
  - New criterion:
...
- Media Functionality (templated)
  ...
  - Updated criterion: [`MFT-1`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#MFT-1)
  - Previous text:
...
- Driver Distraction
  ...
  - New criterion:
    ...
    > [!IMPORTANT]
    > **Important:** The app must meet [`DD-2`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#DD-2) on devices that don't support audio while driving.

### December 2024

- [App Categories](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#app-categories): "Weather" has been added, including the introduction of the Weather Functionality criteria.
- Map Rendering
...
- Navigation Functionality
  ...
  - Categories affected: Navigation Replacement of criterion NF-8 by the [`MR-1`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#MR-1) criterion.
...
- Driver Distraction
  ...
  - New criterion:
    ...
    > [!NOTE]
    > **Note:** If your app plays audio, it must meet the [`DD-2`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#DD-2) requirement.
...
- Delayed Response
  ...
  - Categories affected: Video
  - Removal of criteria [`DR-1`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#DR-1) , [`DR-2`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#DR-2) , and [`DR-3`](https://developer.android.com/develop/adaptive-apps/quality-guidelines/car-app-quality#DR-3) for the video category
