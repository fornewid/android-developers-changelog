---
title: Query information for adaptive layouts with mediaQuery  |  Adaptive Apps  |  Android Developers
url: https://developer.android.com/develop/adaptive-apps/guides/mediaquery
source: html-scrape
---
...
**Note:** "media" refers to the presentation medium that the UI is rendered on.
The term "media" originates from [CSS media queries](https://www.w3.org/TR/mediaqueries-3/) which inspired the
`mediaQuery` API.
