---
title: https://developer.android.com/develop/adaptive-apps/guides/support-different-display-sizes
url: https://developer.android.com/develop/adaptive-apps/guides/support-different-display-sizes
source: md.txt
---
...
Because the composable isn't a content-level composable, don't use the current
...
- If you want to change *what* you show, use [`BoxWithConstraints`](https://developer.android.com/reference/kotlin/androidx/compose/foundation/layout/BoxWithConstraints.composable#BoxWithConstraints(androidx.compose.ui.Modifier,androidx.compose.ui.Alignment,kotlin.Boolean,kotlin.Function1)) as a
