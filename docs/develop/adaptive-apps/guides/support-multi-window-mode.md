...
[multi-window attributes](https://developer.android.com/develop/adaptive-apps/guides/support-multi-window-mode#launch) to request a specific location for the new
...
through 30](https://developer.android.com/develop/adaptive-apps/guides/support-multi-window-mode#test-mw).
