...
have display issues on Android 16, such as overlapping layouts. To provide an
optimal user experience on phones, foldables, tablets, ChromeOS devices, and
more, build your app to be responsive and adaptive.
...
- **Build responsive layouts:** Within window size classes, [responsive
  layouts](https://developer.android.com/develop/ui/compose/layouts/adaptive/support-different-display-sizes) adjust to changes in display dimensions to always create an optimal app presentation.
