---
title: Wi-Fi scanning overview  |  Connectivity  |  Android Developers
...
# Wi-Fi scanning overview Stay organized with collections Save and categorize content based on your preferences.
...
background, [access to location](/training/location/background) should be
...
* If your app is targeting SDK lower than Android 10 (API level 29), your app
  has the
  [`ACCESS_COARSE_LOCATION`](/reference/android/Manifest.permission#ACCESS_COARSE_LOCATION)
  or [`ACCESS_FINE_LOCATION`](/reference/android/Manifest.permission#ACCESS_FINE_LOCATION)
  permission.
* Your app has the [`CHANGE_WIFI_STATE`](/reference/android/Manifest.permission#CHANGE_WIFI_STATE)
  permission.
