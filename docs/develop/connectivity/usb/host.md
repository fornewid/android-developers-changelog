---
title: USB host overview  |  Connectivity  |  Android Developers
...
# USB host overview Stay organized with collections Save and categorize content based on your preferences.
...
intent filter](#using-intents) to discover USB devices as they're connected, it automatically receives
