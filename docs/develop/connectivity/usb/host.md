...
Before you begin, it is important to understand the classes that you need to work with. The following table describes the USB host APIs in the `https://developer.android.com/reference/android/hardware/usb/package-summary` package.
...
In most situations, you need to use all of these classes (`https://developer.android.com/reference/android/hardware/usb/UsbRequest` is only required if you are doing asynchronous communication) when communicating with a USB device. In general, you obtain a `https://developer.android.com/reference/android/hardware/usb/UsbManager` to retrieve the desired `https://developer.android.com/reference/android/hardware/usb/UsbDevice`. When you have the device, you need to find the appropriate `https://developer.android.com/reference/android/hardware/usb/UsbInterface` and the `https://developer.android.com/reference/android/hardware/usb/UsbEndpoint` of that interface to communicate on. Once you obtain the correct endpoint, open a `https://developer.android.com/reference/android/hardware/usb/UsbDeviceConnection` to communicate with the USB device.
...
In your activity, you can obtain the `https://developer.android.com/reference/android/hardware/usb/UsbDevice` that represents the attached device from the intent like this:
