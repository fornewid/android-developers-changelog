---
title: Use network slicing  |  Connectivity  |  Android Developers
...
# Use network slicing Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** The only premium capability supported in Android 14 is
[`NET_CAPABILITY_PRIORITIZE_LATENCY`](/reference/android/net/NetworkCapabilities#NET_CAPABILITY_PRIORITIZE_LATENCY).
...
**Note:** The network slicing upsell feature is only available in Android 14 and
higher for apps that have the
[`READ_BASIC_PHONE_STATE`](/reference/android/Manifest.permission#READ_BASIC_PHONE_STATE)
permission.
...
![The UX flow shows the user a notification that opens up a carrier
       websheet where they can complete the purchase.](/static/images/develop/connectivity/5g/upsell-ux-flow.png)