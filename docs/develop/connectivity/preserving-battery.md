...
Finally, you'll learn about three broad categories of updates: [User-initiated](https://developer.android.com/develop/connectivity/minimize-effect-regular-updates#user-initiated), [App-initiated](https://developer.android.com/develop/connectivity/minimize-effect-regular-updates#app-initiated), and [Server-initiated](https://developer.android.com/develop/connectivity/minimize-effect-regular-updates#server-initiated), with tools and techniques for maximizing the efficiency of each category.
