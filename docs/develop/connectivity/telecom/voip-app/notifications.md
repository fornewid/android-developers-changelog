---
title: Add notifications to a media app  |  Connectivity  |  Android Developers
...
# Add notifications to a media app Stay organized with collections Save and categorize content based on your preferences.
