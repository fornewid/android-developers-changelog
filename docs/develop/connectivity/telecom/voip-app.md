...
To learn more about how to build a calling app with the Telecom library, check out the[Telecom](https://developer.android.com/guide/topics/connectivity/telecom/voip-app/telecom)guide.
