---
title: Near field communication (NFC) overview  |  Connectivity  |  Android Developers
...
# Near field communication (NFC) overview Stay organized with collections Save and categorize content based on your preferences.
