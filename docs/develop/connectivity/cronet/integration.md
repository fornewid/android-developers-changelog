...
The Cronet team provides a library that enables[OkHttp](https://square.github.io/okhttp/)users to use Cronet as their transport layer, benefiting from features like QUIC/HTTP3 support or connection migration. The library can also be used with other OkHttp-based libraries such as[Retrofit](https://square.github.io/retrofit/),[Coil](https://coil-kt.github.io/coil/), and[others](https://square.github.io/okhttp/works_with_okhttp/).

For more details, visit the[Cronet Transport for OkHttp repository](https://github.com/google/cronet-transport-for-okhttp).
...
For more details, visit the[Cronet Dart bindings repository](https://github.com/google/cronet.dart)and[read a blogpost](https://unsuitable001.medium.com/package-cronet-an-http-dart-flutter-package-with-dart-ffi-84f9b69c8a24)about how it came to existence!