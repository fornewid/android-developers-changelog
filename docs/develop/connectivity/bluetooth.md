---
title: Bluetooth overview  |  Connectivity  |  Android Developers
...
# Bluetooth overview Stay organized with collections Save and categorize content based on your preferences.
...
using [Bluetooth Low Energy](/develop/connectivity/bluetooth/ble/ble-overview)
connections.
...
* [Find nearby Bluetooth
  devices](/develop/connectivity/bluetooth/find-bluetooth-devices), either devices
  that are already paired or new ones.
