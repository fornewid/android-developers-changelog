...
4. Toggle **Enable ADB debugging**. The Chromebook restarts.
   ...
   ![Enabling ADB debugging in Linux settings.](https://developer.android.com/static/images/topic/arc/debug_settings.gif) **Figure 2.** Enabling ADB debugging in Linux settings.
