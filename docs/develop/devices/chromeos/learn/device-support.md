---
title: ChromeOS device support for apps  |  Android Developers
...
# ChromeOS device support for apps Stay organized with collections Save and categorize content based on your preferences.
...
[ABIs (Application Binary Interfaces)](/ndk/guides/abis):
armeabi-v7a (arm32), arm64-v8a (arm64), x86 (x86\_32), and x86\_64. This provides the best performance
...
download size for your users. They also help you take advantage of [Dynamic Delivery](/guide/app-bundle/dynamic-delivery),
letting users download large game content only when requested. If App Bundles are not a possibility
for you, you can use the older [multi-APK](/google/play/publishing/multiple-apks) for
similar behaviour.

## 32-bit and 64-bit builds

All Android apps must provide a 64-bit build version. A 32-bit build is optional for both ARM and
x86 devices. See the [Android 64-bit⁠](/distribute/best-practices/develop/64-bit) for more information.
...
| arm32, arm64, x86\_32, and x86\_64 | Best |