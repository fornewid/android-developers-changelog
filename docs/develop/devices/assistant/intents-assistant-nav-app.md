...
![Intent data flow](/static/guide/app-actions/images/intent-data-flow-2.svg)
...
Google Assistant knows that your navigation app can receive navigation intents.
...
Declare the following intent format in your app's manifest file so that
Google Assistant knows that your navigation app can receive search intents:
...
Google Assistant know that your navigation app can receive custom action
intents.
...
![Custom action intent data flow](/static/guide/app-actions/images/intent-data-flow-custom-action.svg)
...
The table lists possible values that Google Assistant can pass as the action
