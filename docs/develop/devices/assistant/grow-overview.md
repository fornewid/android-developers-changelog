---
title: Grow your app with App Actions  |  Assistant  |  Android Developers
...
# Grow your app with App Actions Stay organized with collections Save and categorize content based on your preferences.
