...
- **In-app shortcut suggestions** . The[In-App Promo SDK](https://developer.android.com/guide/app-actions/in-app-promo-sdk)lets you easily suggest Assistant shortcuts to users in your app. Users can launch these shortcuts using their voice with Assistant and see them suggested on Google surfaces.

## Enable system shortcut suggestions

To add the Google Shortcuts Integration library to your Android project and push dynamic shortcuts to Assistant, follow the instructions at[Push dynamic shortcuts to Assistant](https://developer.android.com/guide/app-actions/dynamic-shortcuts).
...
For more information about building suggestions for your app, see[Implement suggestions](https://developer.android.com/guide/app-actions/in-app-promo-sdk#implement_suggestions).