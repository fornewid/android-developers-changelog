---
title: Follow wake lock best practices  |  Background work  |  Android Developers
...
# Follow wake lock best practices Stay organized with collections Save and categorize content based on your preferences.
...
alternatives. For other options, see the [Keep the device awake](/develop/background-work/background-tasks/awake)
