---
title: Declare foreground services and request permissions  |  Background work  |  Android Developers
...
in the [Google Play Device and Network Abuse policy](https://support.google.com/googleplay/android-developer/answer/9888379)
and the Google Play [Understanding foreground service requirements
...
* This code uses best practices for an app that targets API level 34 or
  higher.