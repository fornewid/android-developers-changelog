---
title: Handle user-initiated stopping of apps running foreground services  |  Background work  |  Android Developers
...
# Handle user-initiated stopping of apps running foreground services Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** The system doesn't send your app any callbacks when the user taps the
**Stop** button. When your app starts back up, it's helpful to check for the
[`REASON_USER_REQUESTED`](/reference/android/app/ApplicationExitInfo#REASON_USER_REQUESTED)
reason that's part of the `ApplicationExitInfo` API.
