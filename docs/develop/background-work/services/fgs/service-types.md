...
:   Data transfer operations, such as the following:
    ...
    > [!NOTE]
    > **Note:** Apps that target Android 15 or higher are not allowed to launch a data sync foreground service from a `BOOT_COMPLETED` broadcast receiver. For more information, see [Restrictions on `BOOT_COMPLETED` broadcast receivers launching foreground services](https://developer.android.com/about/versions/15/behavior-changes-15#fgs-boot-completed).
...
:   Continue audio or video playback from the background. Support Digital Video Recording (DVR) functionality on [Android TV](https://developer.android.com/training/tv/tif/content-recording).
    ...
    > [!NOTE]
    > **Note:** Apps that target Android 15 or higher are not allowed to launch a media playback foreground service from a `BOOT_COMPLETED` broadcast receiver. For more information, see [Restrictions on `BOOT_COMPLETED` broadcast receivers launching foreground services](https://developer.android.com/about/versions/15/behavior-changes-15#fgs-boot-completed).
...
:   Project content to non-primary display or external device using the [`MediaProjection`](https://developer.android.com/reference/android/media/projection/MediaProjection) APIs. This content doesn't have to be exclusively media content.
    ...
    > [!NOTE]
    > **Note:** Apps that target Android 15 or higher are not allowed to launch a media projection foreground service from a `BOOT_COMPLETED` broadcast receiver. For more information, see [Restrictions on `BOOT_COMPLETED` broadcast receivers launching foreground services](https://developer.android.com/about/versions/15/behavior-changes-15#fgs-boot-completed).
