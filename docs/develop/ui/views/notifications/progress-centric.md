---
title: Create a progress-centric notification  |  Views  |  Android Developers
...
* Set the right fields to meet [promoted visibility](/develop/ui/views/notifications#promoted-).
...
* Provide useful and relevant [actions](/reference/android/app/Notification.Builder#addAction(android.app.Notification.Action)) in the notification that streamline
...
* [Update](/develop/ui/views/notifications/build-notification#Updating) the progress experience to accurately reflect the actual
