...
like figure 3:
![An image showing the App Info screen after granted notification permission request](https://developer.android.com/static/images/ui/notifications/time-sensitive_notification_permission_granted.png) **Figure 3.** Notification permissions granted. **Experimental:** See the Accompanist [Jetpack Compose
