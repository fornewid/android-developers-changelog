---
title: Create and manage notification channels  |  Views  |  Android Developers
...
1. Construct a
   [`NotificationChannel`](/reference/android/app/NotificationChannel) object
...
2. Optionally, specify the description that the user sees in the system settings
   with
   [`setDescription()`](/reference/android/app/NotificationChannel#setDescription(java.lang.String)).
...
[`SDK_INT`](/reference/android/os/Build.VERSION#SDK_INT) version to run
...
[`NotificationManagerCompat`](/reference/androidx/core/app/NotificationManagerCompat)
class, such as
[`IMPORTANCE_DEFAULT`](/reference/androidx/core/app/NotificationManagerCompat#IMPORTANCE_DEFAULT())
or
[`IMPORTANCE_HIGH`](/reference/androidx/core/app/NotificationManagerCompat#IMPORTANCE_HIGH()).
...
[`enableLights()`](/reference/android/app/NotificationChannel#enableLights(boolean)),
[`setLightColor()`](/reference/android/app/NotificationChannel#setLightColor(int)),
and
[`setVibrationPattern()`](/reference/android/app/NotificationChannel#setVibrationPattern(long%5B%5D))
...
calling
[`createNotificationChannels()`](/reference/android/app/NotificationManager#createNotificationChannels(java.util.List%3Candroid.app.NotificationChannel%3E)).
...
such as
[`CATEGORY_ALARM`](/reference/androidx/core/app/NotificationCompat#CATEGORY_ALARM())
or
[`CATEGORY_REMINDER`](/reference/androidx/core/app/NotificationCompat#CATEGORY_REMINDER()).
...
[`IMPORTANCE_NONE(0)`](/reference/android/app/NotificationManager#IMPORTANCE_NONE)
to
...
call
[`setPriority()`](/reference/androidx/core/app/NotificationCompat.Builder#setPriority(int))
...
[a badge on the launcher icon](/develop/ui/views/notifications#icon-badge),
though you can
[modify the appearance of the notification badge](/training/notify-user/badges).

Once you submit the channel to the
[`NotificationManager`](/reference/android/app/NotificationManager), you
...
1. Get the `NotificationChannel` object by calling
   [`getNotificationChannel()`](/reference/android/app/NotificationManager#getNotificationChannel(java.lang.String))
   or
   [`getNotificationChannels()`](/reference/android/app/NotificationManager#getNotificationChannels()).
2. Query specific channel settings such as
   [`getVibrationPattern()`](/reference/android/app/NotificationChannel#getVibrationPattern()),
   [`getSound()`](/reference/android/app/NotificationChannel#getSound()), and
   [`getImportance()`](/reference/android/app/NotificationChannel#getImportance()).
...
[settings UI](/guide/topics/ui/settings) that opens these system settings.

You can open the system settings for notification channels with an
[`Intent`](/reference/android/content/Intent) that uses the
[`ACTION_CHANNEL_NOTIFICATION_SETTINGS`](/reference/android/provider/Settings#ACTION_CHANNEL_NOTIFICATION_SETTINGS)
action.
