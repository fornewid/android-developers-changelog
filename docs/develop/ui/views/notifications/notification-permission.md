...
- App is newly installed on a device that runs
  Android 13 or higher:
      ...
      adb shell pm revoke <var translate="no">PACKAGE_NAME</var> android.permission.POST_NOTIFICATIONS
      adb shell pm clear-permission-flags <var translate="no">PACKAGE_NAME</var> \
...
- The user keeps notifications enabled when the app is installed on a
  ...
  upgrades to Android 13 or higher:
      ...
      adb shell pm grant <var translate="no">PACKAGE_NAME</var> android.permission.POST_NOTIFICATIONS
      adb shell pm set-permission-flags <var translate="no">PACKAGE_NAME</var> \
        android.permission.POST_NOTIFICATIONS user-set
      adb shell pm clear-permission-flags <var translate="no">PACKAGE_NAME</var> \
        android.permission.POST_NOTIFICATIONS user-fixed
