---
title: Create a group of notifications  |  Views  |  Android Developers
...
# Create a group of notifications Stay organized with collections Save and categorize content based on your preferences.
...
[inbox-style notification](/training/notify-user/expanded#inbox-style).
...
**Note:** Notification groups are not the same as [notification channel groups](/training/notify-user/channels#CreateChannelGroup).
...
[updating an existing notification](/training/notify-user/managing) with
new information or creating a [message-style
notification](/training/notify-user/expanded#message-style) to show
multiple updates in the same conversation.

**Note:** If your app sends four or more notifications and doesn't specify a group,
the system [automatically groups](#automatic-grouping) them on Android 7.0 and
higher.
...
[`setGroup()`](/reference/androidx/core/app/NotificationCompat.Builder#setGroup(java.lang.String)),
...
[`setSortKey()`](/reference/androidx/core/app/NotificationCompat.Builder#setSortKey(java.lang.String)).

If alerts for a notification's group must be handled by a different
notification, call
[`setGroupAlertBehavior()`](/reference/androidx/core/app/NotificationCompat.Builder#setGroupAlertBehavior(int))
...
[`GROUP_ALERT_SUMMARY`](/reference/androidx/core/app/NotificationCompat#GROUP_ALERT_SUMMARY()).
The other options are
[`GROUP_ALERT_ALL`](/reference/androidx/core/app/NotificationCompat#GROUP_ALERT_ALL())
and
[`GROUP_ALERT_CHILDREN`](/reference/androidx/core/app/NotificationCompat#GROUP_ALERT_CHILDREN()).
...
1. Create a new notification with a description of the group—often best
   ...
   notification](/training/notify-user/expanded#inbox-style).
...
3. Specify that it must be used as the group summary by calling
   [`setGroupSummary(true)`](/reference/androidx/core/app/NotificationCompat.Builder#setGroupSummary(boolean)).
