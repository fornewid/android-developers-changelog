...
> [!NOTE]
> **Note:** The `Snackbar` class supersedes `https://developer.android.com/reference/android/widget/Toast`. While `Toast` is supported, `Snackbar` is the preferred way to display brief, transient messages to the user.
