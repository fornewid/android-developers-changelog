---
title: https://developer.android.com/develop/ui/views/search/training
url: https://developer.android.com/develop/ui/views/search/training
source: md.txt
---
...
to add search with
`https://developer.android.com/reference/android/widget/SearchView` while maintaining
backward compatibility with older versions of Android by
using the system's default search dialog.

## Lessons

**[Set up the search interface](https://developer.android.com/develop/ui/views/search/training/setup)**
:   Learn how to add a search interface to your app and how to configure an activity to handle
    search queries.

**[Store and search for data](https://developer.android.com/develop/ui/views/search/training/search)**
:   Learn a simple way to store and search for data in a SQLite virtual database table.

**[Remain backward compatible](https://developer.android.com/develop/ui/views/search/training/backward-compat)**
