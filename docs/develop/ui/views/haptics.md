...
Also, be sure to read the[best practices for accessibility](https://developer.android.com/guide/topics/ui/accessibility).

## Samples

The following samples are available in the[Haptic Sampler app](https://github.com/android/platform-samples/tree/main/samples/user-interface/haptics)on GitHub. You can also find documentation for each here.
