---
title: Emoji Picker  |  Views  |  Android Developers
...
# Emoji Picker Stay organized with collections Save and categorize content based on your preferences.
...
](/static/images/develop/ui/views/text-and-emoji/emoji-picker.mp4)
...
![emoji variants](/static/images/develop/ui/views/text-and-emoji/emoji-variants.png)
...
![recent emoji](/static/images/develop/ui/views/text-and-emoji/recent-emoji.png)
...
* The picker displays at most three rows of selected emoji, deduped, in reverse
  chronological order.
...
![bidirectional left emoji](/static/images/develop/ui/views/text-and-emoji/bidirectional-left.png "bidirectional emoji facig left")

**Figure 4.** Bidirectional emoji facing left.

![bidirectional right emoji](/static/images/develop/ui/views/text-and-emoji/bidirectional-right.png "bidrectional emoji facing right")
...
![touch and hold emoji couple](/static/images/develop/ui/views/text-and-emoji/long-press-couple.png "touch and hold emoji couple")

**Figure 6.** Touch and hold an emoji couple to reveal multi-person emoji
selections.

![tap left emoji person](/static/images/develop/ui/views/text-and-emoji/select-left.png "select the left-half emoji person")

**Figure 7.** Select a left-half emoji person.

![tap right emoji person](/static/images/develop/ui/views/text-and-emoji/select-right.png "select the right-half emoji person")
...
2. Inflate the Emoji Picker view, and optionally set `emojiGridRows` and
   ...
   * Row count is calculated based on the parent view height and the value of
     `emojiGridColumns`.
