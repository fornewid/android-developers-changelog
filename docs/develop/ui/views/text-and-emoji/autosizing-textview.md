...
`https://developer.android.com/reference/android/widget/TextView` to let the text size
...
- To use preset sizes to set up the autosizing of `TextView` programmatically, call the `https://developer.android.com/reference/android/widget/TextView#setAutoSizeTextTypeUniformWithPresetSizes(int[], int)` method. Provide an array of sizes and any `TypedValue` dimension unit for the size.
