---
title: Integrate Android search features into your app  |  Views  |  Android Developers
...
# Integrate Android search features into your app Stay organized with collections Save and categorize content based on your preferences.
...
screen or a search widget (`SearchView`) that you can embed in your activity
...
**[Add recent query suggestions](/develop/ui/views/search/adding-recent-query-suggestions)**
