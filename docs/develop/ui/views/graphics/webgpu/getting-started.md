---
title: Getting started with WebGPU  |  Views  |  Android Developers
...
# Getting started with WebGPU Stay organized with collections Save and categorize content based on your preferences.
...
* **Compatibility Mode and OpenGL ES Support**: Using WebGPU with [compatibility mode](https://github.com/gpuweb/gpuweb/blob/main/proposals/compatibility-mode.md#webgpu-spec-changes)
  ...
  [`GPUAdapter`](/reference/kotlin/androidx/webgpu/GPUAdapter).
...
official website](/studio) and follow the instructions given in the [Android
Studio Installation Guide](/studio/install).
...
2. **Select a template**: Choose the **Empty Activity** template in Android Studio and click **Next**.
   ...
   ![The Android Studio New Project dialog, showing the built-in list of
       activities that Studio will create on your behalf.](https://developer.android.com/develop/ui/views/graphics/webgpu/images/New Project.png)
...
3. **Configure your project**:
   ...
   * **Build Configuration Language**: It is recommended to use **Kotlin DSL (build.gradle.kts)** for modern dependency management.
   ![The Android Studio Empty Activity dialog that contains fields to
       ...
       Location, and Minimum SDK.](https://developer.android.com/develop/ui/views/graphics/webgpu/images/Empty Activity.png)
...
* Add the `google` repository to `settings.gradle` as described in
  [Use a Jetpack library in your app](/jetpack/getting-started#use_a_jetpack_library_in_your_app)
* Add the dependencies for the artifacts you need in the build.gradle file for your app or module:
  + **Note**: Check [webgpu | Jetpack | Android Developers](/jetpack/androidx/releases/webgpu) for the latest library version

The
[`androidx.webgpu`](/reference/kotlin/androidx/webgpu/package-summary) library
...
["Sync Project"](/build#sync-files) button in Android Studio.
...
* **UI Layer**: The UI is built with Jetpack Compose. A WebGPU drawing surface
  ...
  [`AndroidExternalSurface`](/reference/kotlin/androidx/compose/foundation/AndroidExternalSurface.composable#AndroidExternalSurface(androidx.compose.ui.Modifier,kotlin.Boolean,androidx.compose.ui.unit.IntSize,androidx.compose.foundation.AndroidExternalSurfaceZOrder,kotlin.Boolean,kotlin.Function1)).
...
![High-level architecture diagram showing the interaction between the
    ...
    Android application.](https://developer.android.com/develop/ui/views/graphics/webgpu/images/High Level Architecture Graphic.svg)
...
[`AndroidExternalSurface`](/reference/kotlin/androidx/compose/foundation/AndroidExternalSurface.composable#AndroidExternalSurface(androidx.compose.ui.Modifier,kotlin.Boolean,androidx.compose.ui.unit.IntSize,androidx.compose.foundation.AndroidExternalSurfaceZOrder,kotlin.Boolean,kotlin.Function1)) to provide a bridge between Compose and your renderer.
...
[`createWebGpu`](/reference/kotlin/androidx/webgpu/helper/package-summary?#createWebGpu(android.view.Surface,androidx.webgpu.GPUInstanceDescriptor,androidx.webgpu.GPURequestAdapterOptions,androidx.webgpu.GPUDeviceDescriptor)),
a helper method (part of
[`androidx.webgpu.helper`](/reference/kotlin/androidx/webgpu/helper/package-summary)) to streamline setup. This utility creates the WebGPU
...
![A screenshot of an Android phone screen displaying the output of a
    ...
    background.](https://developer.android.com/develop/ui/views/graphics/webgpu/images/Rendered Output.png)
...
* **Error Scopes:** You can capture specific errors by encapsulating GPU
  ...
  `[device.popErrorScope()](/reference/kotlin/androidx/webgpu/GPUDevice#popErrorScope(java.util.concurrent.Executor,androidx.webgpu.GPURequestCallback))
  blocks.
...
* **Avoid Per-Frame Object Creation**: Instantiate pipelines
  ([`GPURenderPipeline`](/reference/kotlin/androidx/webgpu/GPURenderPipeline)), bind group layouts, and shader modules once during application setup to maximize reuse.
