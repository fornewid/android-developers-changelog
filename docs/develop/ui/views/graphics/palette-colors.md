---
title: Select colors with the Palette API  |  Views  |  Android Developers
...
# Select colors with the Palette API Stay organized with collections Save and categorize content based on your preferences.



Good visual design is essential for a successful app, and color schemes are a
primary component of design. The
[Palette library](/jetpack/androidx/releases/palette) is a Jetpack
...
[themes](/guide/topics/ui/themes) and apply custom colors to
...
[customize](#customize-your-palette) its number of colors using the
...
![An image showing a sunset on the left and the extracted color palette on the right.](/static/training/material/images/palette-library-color-profiles_2-1_2x.png)
...
![An image showing a sunset and a toolbar with TitleTextColor inside](/static/training/material/images/palette-library-title-text-color_2-1_2x.png)
