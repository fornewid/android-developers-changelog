---
title: Create a two-pane layout  |  Views  |  Android Developers
...
# Create a two-pane layout Stay organized with collections Save and categorize content based on your preferences.
...
`ConstraintLayout`](/training/constraint-layout) that lets a single-pane
...
**Note:** For a step-by-step, hands-on experience creating a two-pane layout, see
the [Adaptive
Layouts](/codelabs/basic-android-kotlin-training-adaptive-layouts#0) codelab.
...
![An image showing an example of SlidingPaneLayout](/static/images/ui/slidingpanelayout-example.png)


**Figure 1.** An example of a layout created with
`SlidingPaneLayout`.
...
[`RecyclerView`](/reference/androidx/recyclerview/widget/RecyclerView) as its
left pane and a
...
[`open()`](/reference/androidx/slidingpanelayout/widget/SlidingPaneLayout#open())
...
[Navigation component](/guide/navigation) provides a prebuilt implementation of
...
Implement
[`onCreateListPaneView()`](/reference/androidx/navigation/fragment/AbstractListDetailFragment#onCreateListPaneView(android.view.LayoutInflater,android.view.ViewGroup,android.os.Bundle))
and
[`onListPaneViewCreated()`](/reference/androidx/navigation/fragment/AbstractListDetailFragment#onListPaneViewCreated(android.view.View,android.os.Bundle))
...
graph](/guide/navigation/navigation-design-graph) that only contains the
destinations to be shown in the detail pane. Then, you can use
[`NavController`](/reference/androidx/navigation/NavController) to swap your
...
navigation](/guide/navigation/navigation-custom-back) and connecting an
[`OnBackPressedCallback`](/reference/androidx/activity/OnBackPressedCallback) to
...
using
[`addCallback()`](/reference/androidx/activity/OnBackPressedDispatcher#addCallback(androidx.lifecycle.LifecycleOwner,%20androidx.activity.OnBackPressedCallback)):
...
[`close()`](/reference/androidx/slidingpanelayout/widget/SlidingPaneLayout#close())
...
navigation](/training/gestures/gesturenav). You can control the swipe direction
...
**Note:** The lock mode only controls what user gestures are possible. You can
always open or close the `SlidingPaneLayout` programmatically, regardless of
which lock mode is set.
...
* [Screen compatibility overview](/guide/practices/screens_support)
* [Design for different form factors](/guide/navigation/navigation-form-factors)

## Additional resources

* [Adaptive Layouts codelab](/codelabs/basic-android-kotlin-training-adaptive-layouts#0)
* [SlidingPaneLayout example](https://github.com/google-developer-training/basic-android-kotlin-training-sports/tree/starter)
  on GitHub.