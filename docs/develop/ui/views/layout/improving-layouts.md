...
Try the Compose way Jetpack Compose is the recommended UI toolkit for Android. Learn how to work with layouts in Compose. [Performance in Compose →](https://developer.android.com/jetpack/compose/performance) ![](https://developer.android.com/static/images/android-compose-ui-logo.png) [Video](https://www.youtube.com/watch?v=-FUw8HMbmBQ)
