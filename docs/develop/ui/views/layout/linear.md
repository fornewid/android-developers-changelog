...
# Create a linear layout Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** For better performance and tooling support,
[build your layout with
ConstraintLayout](/training/constraint-layout). Learn more about advantages of using
`ConstraintLayout` by reading
[Understanding
...
![An image showing a layout split in three vertical slices](/static/images/ui/linearlayout.png)
...
![An image showing three EditTexts and a Button in a vertically oriented LinearLayout](/static/images/ui/sample-linearlayout.png)
