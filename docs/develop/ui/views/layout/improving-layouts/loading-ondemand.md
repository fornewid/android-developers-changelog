---
title: Load views on demand  |  Views  |  Android Developers
...
# Load views on demand Stay organized with collections Save and categorize content based on your preferences.
...
![An image of a empty screen](/static/images/ui/viewstub_1.png)


**Figure 1.** Initial state of the screen: the `ViewStub` is
hiding the heavy layout.
...
![](/static/images/ui/viewstub_2.png)


**Figure 2.** The heavy layout is visible.


**Note:** The `inflate()` method returns the inflated
`View` after it's complete, so you don't need to call
`findViewById()`
