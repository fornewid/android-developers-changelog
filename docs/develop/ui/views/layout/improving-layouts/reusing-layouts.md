---
title: Reuse layouts with <include>  |  Views  |  Android Developers
...
# Reuse layouts with <include> Stay organized with collections Save and categorize content based on your preferences.
...
`View`, you can do it more easily by
...
**Note:** The
[`tools:showIn`](/studio/write/tool-attributes#toolsshowin) attribute
in the preceding XML file is a special attribute that is used only at design time in Android
Studio and is removed during compilation. It specifies a layout that *includes* this file,
so you can preview and edit this file as it appears while embedded in a parent layout.
