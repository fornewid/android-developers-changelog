---
title: Activity embedding  |  Views  |  Android Developers
...
# Activity embedding Stay organized with collections Save and categorize content based on your preferences.
...
configuration file or by making [Jetpack WindowManager](/reference/androidx/window/embedding/package-summary) API calls.
...
**Objective:** Activity embedding enables activity-based apps to meet the [LS-U1](/docs/quality-guidelines/large-screen-app-quality#LS-U1)
requirement of the [Large screen app quality](/docs/quality-guidelines/large-screen-app-quality) guidelines.
...
also [Split orientation](#split_orientation).
...
[`SlidingPaneLayout`](/reference/androidx/slidingpanelayout/widget/SlidingPaneLayout) can provide an improved large screen user experience
...
See the [XML configuration](#xml_configuration) section for examples.

For rules created using the WindowManager APIs, create a [`SplitAttributes`](/reference/kotlin/androidx/window/embedding/SplitAttributes)
object with [`SplitAttributes.Builder`](/reference/kotlin/androidx/window/embedding/SplitAttributes.Builder) and call the following builder
methods:

* `setSplitType()`: Sets the proportions of the split containers. See
  [`SplitAttributes.SplitType`](/reference/kotlin/androidx/window/embedding/SplitAttributes.SplitType) for valid arguments, including the
  [`SplitAttributes.SplitType.ratio()`](/reference/kotlin/androidx/window/embedding/SplitAttributes.SplitType#ratio(kotlin.Float)) method.
* `setLayoutDirection()`: Sets the layout of the containers. See
  [`SplitAttributes.LayoutDirection`](/reference/kotlin/androidx/window/embedding/SplitAttributes.LayoutDirection) for possible values.

  **Note:** The [`TOP_TO_BOTTOM`](/reference/kotlin/androidx/window/embedding/SplitAttributes.LayoutDirection#TOP_TO_BOTTOM()) and [`BOTTOM_TO_TOP`](/reference/kotlin/androidx/window/embedding/SplitAttributes.LayoutDirection#BOTTOM_TO_TOP()) specifications are
  available only through the WindowManager APIs. Equivalent XML attributes are
  not supported.

See the [WindowManager API](#windowmanager_api) section for examples.
...
You can specify the split orientation with the [`SplitController`](/reference/kotlin/androidx/window/embedding/SplitController)
[`SplitAttributes`](/reference/kotlin/androidx/window/embedding/SplitAttributes) calculator. The calculator computes `SplitAttributes` for
the active [`SplitRule`](/reference/kotlin/androidx/window/embedding/SplitRule).
...
However, the `stickyPlaceholder` attribute of a [`SplitPlaceholderRule`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule) or
[`setSticky()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setSticky(kotlin.Boolean)) method of [`SplitPlaceholder.Builder`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder) can override the
...
(see [Split configuration](#split_configuration) for an example).
...
Activity stacking is possible because [WindowManager](/reference/android/view/WindowManager) z-orders the activities
...
The [android:screenOrientation](/guide/topics/manifest/activity-element#screen) manifest setting enables apps to constrain
...
activity embedding (see the [Split configuration](#split_configuration)
...
configuration file or by making Jetpack [WindowManager](/jetpack/androidx/releases/window) API
calls.
...
1. Add the latest WindowManager library dependency to your app's module-level
   ...
   **Note:** See the [WindowManager release notes](/jetpack/androidx/releases/window) for release versions.
2. Inform the system that your app has implemented activity embedding.
   ...
   [Fixed-portrait orientation](#fixed_portrait)).
...
1. Create an XML resource file that does the following:
   ...
   * Creates a [placeholder](#placeholders) for the secondary container of
...
2. Create an initializer.
   ...
   The WindowManager [`RuleController`](/reference/kotlin/androidx/window/embedding/RuleController) component parses the XML
   configuration file and makes the rules available to the system. A Jetpack
   [Startup](/jetpack/androidx/releases/startup) library [`Initializer`](/reference/kotlin/androidx/startup/Initializer) makes the XML file available to
   ...
   1. Add the latest Jetpack Startup library dependency to your module-level
      ...
      **Note:** See the [Startup release notes](/jetpack/androidx/releases/startup) for release versions.
...
3. Create a content provider for the rule definitions.
   ...
   Add [`androidx.startup.InitializationProvider`](/reference/androidx/startup/InitializationProvider) to your app manifest file
   as a [`<provider>`](/guide/topics/manifest/provider-element). Include a reference to the implementation of your
...
[`Application`](/reference/kotlin/android/app/Application) to ensure the rules are in effect before any activities
launch.
...
1. Create a split rule:
   ...
   1. Create a [`SplitPairFilter`](/reference/kotlin/androidx/window/embedding/SplitPairFilter)
   ...
   3. Create layout attributes for the split:
      ...
      [`SplitAttributes.Builder`](/reference/kotlin/androidx/window/embedding/SplitAttributes.Builder) creates an object containing layout
      attributes:

      * [`setSplitType()`](/reference/kotlin/androidx/window/embedding/SplitAttributes.Builder#setSplitType(androidx.window.embedding.SplitAttributes.SplitType)): Defines how the available display area is
      ...
      * [`setLayoutDirection()`](/reference/kotlin/androidx/window/embedding/SplitAttributes.Builder#setLayoutDirection(androidx.window.embedding.SplitAttributes.LayoutDirection)): Specifies how the activity containers
        are laid out relative to one another, primary container first.
   4. Build a [`SplitPairRule`](/reference/kotlin/androidx/window/embedding/SplitPairRule):
      ...
      [`SplitPairRule.Builder`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder) creates and configures the rule:

      * `filterSet`: Contains split pair filters that determine when to
        apply the rule by identifying activities that share a split.
      * [`setDefaultSplitAttributes()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setDefaultSplitAttributes(androidx.window.embedding.SplitAttributes)): Applies layout attributes to the
        rule.
      * [`setMinWidthDp()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setMinWidthDp(kotlin.Int)): Sets the minimum display width (in
        density‑independent pixels, dp) that enables a split.
      * [`setMinSmallestWidthDp()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setMinSmallestWidthDp(kotlin.Int)): Sets the minimum value (in dp) that
        the smaller of the two display dimensions must have to enable a
        split regardless of the device orientation.
      * [`setMaxAspectRatioInPortrait()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setMaxAspectRatioInPortrait(androidx.window.embedding.EmbeddingAspectRatio)): Sets the maximum display aspect
        ...
        [`SPLIT_MAX_ASPECT_RATIO_PORTRAIT_DEFAULT`](/reference/kotlin/androidx/window/embedding/SplitRule#SPLIT_MAX_ASPECT_RATIO_PORTRAIT_DEFAULT()) and
        [`setMaxAspectRatioInLandscape()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setMaxAspectRatioInLandscape(androidx.window.embedding.EmbeddingAspectRatio)). The default value for
        landscape is [`ALWAYS_ALLOW`](/reference/kotlin/androidx/window/embedding/EmbeddingAspectRatio#ALWAYS_ALLOW()).
      * [`setFinishPrimaryWithSecondary()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setFinishPrimaryWithSecondary(androidx.window.embedding.SplitRule.FinishBehavior)): Sets how finishing all
        ...
        container finish (see [Finish activities](#finish_activities)).
      * [`setFinishSecondaryWithPrimary()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setFinishSecondaryWithPrimary(androidx.window.embedding.SplitRule.FinishBehavior)): Sets how finishing all
        ...
        [Finish activities](#finish_activities)).
      * [`setClearTop()`](/reference/kotlin/androidx/window/embedding/SplitPairRule.Builder#setClearTop(kotlin.Boolean)): Specifies whether all activities in the
   ...
   5. Get the singleton instance of the WindowManager [`RuleController`](/reference/kotlin/androidx/window/embedding/RuleController),
      and add the rule:
      ...
      ActivityEmbeddingJavaSnippets.java
      ```
   6. Create a [placeholder](#placeholders) for the secondary container when
      content is not available:
   7. Create an [`ActivityFilter`](/reference/kotlin/androidx/window/embedding/ActivityFilter) that identifies the activity with which
   ...
   8. Add the filter to a filter set:
      ...
      ```
   9. Create a
      [`SplitPlaceholderRule`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule):
      ...
      [`SplitPlaceholderRule.Builder`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder) creates and configures the rule:
      ...
      * [`Intent`](/reference/android/content/Intent): Specifies the launch of the placeholder activity.
      * [`setDefaultSplitAttributes()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setDefaultSplitAttributes(androidx.window.embedding.SplitAttributes)):
        Applies layout attributes to the rule.
      * [`setMinWidthDp()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setMinWidthDp(kotlin.Int)):
        Sets the minimum display width (in density-independent pixels, dp)
        that allows a split.
      * [`setMinSmallestWidthDp()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setMinSmallestWidthDp(kotlin.Int)):
        ...
        orientation.
      * [`setMaxAspectRatioInPortrait()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setMaxAspectRatioInPortrait(androidx.window.embedding.EmbeddingAspectRatio)):
        ...
        [`SPLIT_MAX_ASPECT_RATIO_PORTRAIT_DEFAULT`](/reference/kotlin/androidx/window/embedding/SplitRule#SPLIT_MAX_ASPECT_RATIO_PORTRAIT_DEFAULT()) and
        [`setMaxAspectRatioInLandscape()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setMaxAspectRatioInLandscape(androidx.window.embedding.EmbeddingAspectRatio)).
        The default value for landscape is [`ALWAYS_ALLOW`](/reference/kotlin/androidx/window/embedding/EmbeddingAspectRatio#ALWAYS_ALLOW()).
      * [`setFinishPrimaryWithPlaceholder()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setFinishPrimaryWithPlaceholder(androidx.window.embedding.SplitRule.FinishBehavior)):
        ...
        finishes (see [Finish activities](#finish_activities)).
      * [`setSticky()`](/reference/kotlin/androidx/window/embedding/SplitPlaceholderRule.Builder#setSticky(kotlin.Boolean)): Determines whether the placeholder activity
...
2. Specify activities that should never be part of a split:
   ...
   2. Add the filter to a filter set:
      ...
      ActivityEmbeddingJavaSnippets.java
      ```
   3. Create an [`ActivityRule`](/reference/kotlin/androidx/window/embedding/ActivityRule):
      ...
      [`ActivityRule.Builder`](/reference/kotlin/androidx/window/embedding/ActivityRule.Builder) creates and configures the rule:
      ...
      * [`setAlwaysExpand()`](/reference/kotlin/androidx/window/embedding/ActivityRule.Builder#setAlwaysExpand(kotlin.Boolean)): Specifies whether the activity should fill
...
apps. Cross‑application, or cross‑[UID](/guide/topics/permissions/defining#userid), activity embedding
...
application in the [`android:knownActivityEmbeddingCerts`](/reference/android/R.attr#knownActivityEmbeddingCerts) attribute of the
[`<activity>`](/guide/topics/manifest/activity-element) or [`<application>`](/guide/topics/manifest/application-element) elements of your app's manifest file.
...
the separating colons. For more information, see [Run a signing report](/studio/publish/app-signing#signing_report) and
...
specify the [`android:allowUntrustedActivityEmbedding`](/reference/android/R.attr#allowUntrustedActivityEmbedding) attribute in the
...
certificates, use the [`androidx.security.app.authenticator`](/reference/kotlin/androidx/security/app/authenticator/package-summary) library to
...
Use the [`ActivityEmbeddingController#isActivityEmbedded()`](/reference/kotlin/androidx/window/embedding/ActivityEmbeddingController#isActivityEmbedded(android.app.Activity)) method from the
...
manifest [`<layout>`](/guide/topics/manifest/layout-element) element to embedded activities. If an application does
...
[`<activity-alias>`](/guide/topics/manifest/activity-alias-element) element, `android:knownActivityEmbeddingCerts` or
...
implement single-app activity embedding. [`SplitPairRule`](/reference/kotlin/androidx/window/embedding/SplitPairRule) and
[`SplitPairFilter`](/reference/kotlin/androidx/window/embedding/SplitPairFilter) or [`ActivityRule`](/reference/kotlin/androidx/window/embedding/ActivityRule) and [`ActivityFilter`](/reference/kotlin/androidx/window/embedding/ActivityFilter) objects
specify embedded activities and task window splits. Split rules are defined
[statically in XML](#split_configuration) or at runtime using Jetpack
...
statically or at runtime and then call [`Context#startActivity()`](/reference/android/content/Context#startActivity(android.content.Intent)) without any
...
See the [Configuration attributes](#configuration_attributes) section.
...
[`SplitController.splitInfoList`](/reference/kotlin/androidx/window/embedding/SplitController#splitInfoList(android.app.Activity)) flow or register a listener with
[`SplitControllerCallbackAdapter`](/reference/androidx/window/java/embedding/SplitControllerCallbackAdapter) for changes in the split state. Then,
...
the [`STARTED`](/reference/kotlin/androidx/lifecycle/Lifecycle.State#STARTED) state to conserve resources (see [Use Kotlin coroutines with
lifecycle-aware components](/topic/libraries/architecture/coroutines) for more information).
...
Android 15 (API level 35) and higher supported by Jetpack [WindowManager 1.4](/jetpack/androidx/releases/window#version_14_2)
...
1. Create an instance of [`DividerAttributes`](/reference/kotlin/androidx/window/embedding/DividerAttributes)
2. Customize the divider attributes:

   * **[`color`](/reference/kotlin/androidx/window/embedding/DividerAttributes#color()):** The color of the draggable pane separator.
   * **[`widthDp`](/reference/kotlin/androidx/window/embedding/DividerAttributes#widthDp()):** The width of the draggable pane separator. Set to
     [`WIDTH_SYSTEM_DEFAULT`](/reference/kotlin/androidx/window/embedding/DividerAttributes#WIDTH_SYSTEM_DEFAULT()) to let the system determine the divider
     width.
   * **Drag range:** The minimum percentage of the screen either pane can
     occupy. Can range from 0.33 to 0.66. Set to
     [`DRAG_RANGE_SYSTEM_DEFAULT`](/reference/kotlin/androidx/window/embedding/DividerAttributes.DragRange#DRAG_RANGE_SYSTEM_DEFAULT()) to let the system determine the drag
     range.
...
* Only one activity can be pinned at a time. Unpin the pinned activity with [`unpinTopActivityStack()`](/reference/kotlin/androidx/window/embedding/SplitController#unpinTopActivityStack(kotlin.Int)) before pinning another.
* To enable pane expansion when pinning the activity, call
  [`SplitAttributes.Builder#setDividerAttributes()`](/reference/kotlin/androidx/window/embedding/SplitAttributes.Builder#setDividerAttributes(androidx.window.embedding.DividerAttributes)) for the
  newly created `SplitAttributes`. See the [Pane expansion](#pane_expansion) section.
...
dialog opens (see [`EmbeddingConfiguration.DimAreaBehavior.ON_TASK`](/reference/kotlin/androidx/window/embedding/EmbeddingConfiguration.DimAreaBehavior#ON_TASK())).

To dim only the container of the activity that opened the dialog, use
[`EmbeddingConfiguration.DimAreaBehavior.ON_ACTIVITY_STACK`](/reference/kotlin/androidx/window/embedding/EmbeddingConfiguration.DimAreaBehavior#ON_ACTIVITY_STACK()).
...
[`SplitController.splitSupportStatus`](/reference/kotlin/androidx/window/embedding/SplitController#splitSupportStatus()) property or
[`SplitController.getSplitSupportStatus()`](/reference/androidx/window/embedding/SplitController#getSplitSupportStatus()) method:
...
layouts, such as [list-detail](/develop/ui/compose/layouts/adaptive/canonical-layouts#list-detail), without any changes to the app. However, the
...
[`PROPERTY_ACTIVITY_EMBEDDING_ALLOW_SYSTEM_OVERRIDE`](/reference/kotlin/androidx/window/WindowProperties#PROPERTY_ACTIVITY_EMBEDDING_ALLOW_SYSTEM_OVERRIDE()) in the app manifest
file, for example:
...
The property name is defined in the Jetpack WindowManager [`WindowProperties`](/reference/kotlin/androidx/window/WindowProperties)
...
* Codelabs:
  + [Build a list-detail layout with activity embedding and Material Design](/codelabs/large-screens/activity-embedding)
  + [Advanced activity embedding](/codelabs/large-screens/advanced-activity-embedding)
* Learning pathway — [Activity embedding](/courses/pathways/activity-embedding)
