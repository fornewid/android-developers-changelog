...
`https://developer.android.com/reference/androidx/recyclerview/widget/DefaultItemAnimator`
...
4. Update item `https://developer.android.com/reference/android/view/View` objects in the `RecyclerView` to reflect whether the user selects or unselects them.
   ...
   `https://developer.android.com/reference/androidx/recyclerview/widget/RecyclerView.Adapter#onBindViewHolder(VH, int)`.
