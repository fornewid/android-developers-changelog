---
title: Support display cutouts  |  Views  |  Android Developers
...
# Support display cutouts Stay organized with collections Save and categorize content based on your preferences.
...
edge](/develop/ui/views/layout/edge-to-edge).
...
[`WindowInsetsCompat.getDisplayCutout()`](/reference/androidx/core/view/WindowInsetsCompat#getDisplayCutout())
to retrieve a [`DisplayCutout`](/reference/android/view/DisplayCutout) object
...
[style](/guide/topics/ui/look-and-feel/themes) in your activity. The following
...
[`LAYOUT_IN_DISPLAY_CUTOUT_MODE_ALWAYS`](/reference/android/view/WindowManager.LayoutParams#LAYOUT_IN_DISPLAY_CUTOUT_MODE_ALWAYS) is the default behavior, and
...
* Don't place or extend any interactive elements that require fine-touch
  ...
  cutout area.
* Where possible, use
  [`WindowInsetsCompat`](/reference/androidx/core/view/WindowInsetsCompat) to
...
* Use [`View.getLocationInWindow()`](/reference/android/view/View#getLocationInWindow(int%5B%5D))
  to determine how much window space your app is using. Don't assume the app is
  using the entire window, and don't use
  [`View.getLocationOnScreen()`](/reference/android/view/View#getLocationOnScreen(int%5B%5D)).
...
* When handling `MotionEvent`, use
  [`MotionEvent.getX()`](/reference/android/view/MotionEvent#getX()) and
  [`MotionEvent.getY()`](/reference/android/view/MotionEvent#getY()) to avoid
  similar coordinate issues. Don't use
  [`MotionEvent.getRawX()`](/reference/android/view/MotionEvent#getRawX()) or
  [`MotionEvent.getRawY()`](/reference/android/view/MotionEvent#getRawY()).
...
* [LAYOUT\_IN\_DISPLAY\_CUTOUT\_MODE\_ALWAYS](/reference/android/view/WindowManager.LayoutParams#LAYOUT_IN_DISPLAY_CUTOUT_MODE_ALWAYS)
* [LAYOUT\_IN\_DISPLAY\_CUTOUT\_MODE\_NEVER](/reference/android/view/WindowManager.LayoutParams#LAYOUT_IN_DISPLAY_CUTOUT_MODE_NEVER)
* [LAYOUT\_IN\_DISPLAY\_CUTOUT\_MODE\_SHORT\_EDGES](/reference/android/view/WindowManager.LayoutParams#LAYOUT_IN_DISPLAY_CUTOUT_MODE_SHORT_EDGES)
* [LAYOUT\_IN\_DISPLAY\_CUTOUT\_MODE\_DEFAULT](/reference/android/view/WindowManager.LayoutParams#LAYOUT_IN_DISPLAY_CUTOUT_MODE_DEFAULT)