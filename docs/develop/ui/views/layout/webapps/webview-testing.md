---
title: Beta program  |  Views  |  Android Developers
...
# Beta program Stay organized with collections Save and categorize content based on your preferences.
...
**Caution:** Beta releases may be less stable than the main release
track. Beta users are the first to try out new features, but may also experience
...
![Become a tester](/static/develop/ui/views/layout/webapps/beta-become-a-tester.png)
...
don't recommend doing this, because uninstalling WebView updates may
delete user data if apps on your device use WebView to store data.

## Other ways to test WebView

* Did you know WebView also has other testing tracks? For a more bleeding edge
  experience, try out the [Dev or Canary channels](https://chromium.googlesource.com/chromium/src/+/HEAD/android_webview/docs/prerelease.md#trichrome-dev).
* If you want to try out experimental features or report crashes back to Google,
  you can install the separate [WebView Beta package](https://play.google.com/store/apps/details?id=com.google.android.webview.beta) instead.
...
![You can debug your WebView apps with WebView DevTools.](/static/develop/ui/views/layout/webapps/devtools.png)
