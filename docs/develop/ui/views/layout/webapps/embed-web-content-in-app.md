...
The [`WebView`](https://developer.android.com/reference/android/webkit/WebView) API gives you access to the capabilities of a mini-browser for displaying web content within your app. This lets you provide web-powered experiences as a core or supporting part within your app, as seen in **Figure 1**.
...
For information on how to use `WebView` in your app, see the document [Build web apps in `WebView`](https://developer.android.com/guide/webapps/webview).
