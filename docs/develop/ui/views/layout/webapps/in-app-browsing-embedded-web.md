---
title: In-app browsing using Embedded Web  |  Views  |  Android Developers
...
# In-app browsing using Embedded Web Stay organized with collections Save and categorize content based on your preferences.
...
[Android Intent](/guide/components/intents-filters) to link out of your app to the user's default browser.
...
learn more about its capabilities, see [What WebView can do](/develop/ui/views/layout/webapps/embed-web-content-in-app#what-webview-can-do).
...
update periodically. To learn more, see [Build web apps in WebView](/develop/ui/views/layout/webapps/webview).
...
* **Security and maintenance:** You're responsible for hardening the security
  and managing the lifecycle. However, WebView updates roll out globally through
  Google Play, so you don't have to worry about the underlying engine getting
  outdated.
...
* **Custom Tabs:** Since Custom Tabs use an [`Intent`](/reference/android/content/Intent), you can launch them
  from any [`Context`](/reference/android/content/Context) in your Compose functions, making for a seamless
  integration.
* **WebView:** Compose doesn't have a native WebView composable yet, so you'll
  need to use [`AndroidView`](/reference/kotlin/androidx/compose/ui/viewinterop/AndroidView.composable#AndroidView(kotlin.Function1,androidx.compose.ui.Modifier,kotlin.Function1)) to embed a standard WebView into your layout.
...
* [API Reference: WebView](/reference/android/webkit/WebView)
