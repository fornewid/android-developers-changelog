---
title: Receive rich content  |  Views  |  Android Developers
...
# Receive rich content Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/images/develop/ui/views/copy-paste-drag-and-drop-in-split-screen.png)
](/images/develop/ui/views/copy-paste-drag-and-drop-in-split-screen.png)](/static/images/develop/ui/views/copy-paste-drag-and-drop-in-split-screen.mp4)


**Figure 1.** The unified API provides a single place to handle
incoming content regardless of the specific UI mechanism, such as pasting
from the touch & hold menu or using drag-and-drop.
...
![An image showing the different actions and the relative API to implement](/static/images/develop/ui/views/required-apis-before.svg)
...
![An image showing the simplified unified API](/static/images/develop/ui/views/required-apis-after.svg)


**Figure 3.** The unified API lets you implement a single
API that supports all UI mechanisms.
...
**Note:** See the
[Drag and Drop sample](https://github.com/android/platform-samples/tree/main/samples/user-interface/draganddrop) for a complete implementation of
[`DropHelper`](/reference/kotlin/androidx/draganddrop/DropHelper), which implements
`OnReceiveContentListener`. For more details, see the guide on
[Enabling drag and drop](/develop/ui/views/touch-and-input/drag-drop).
