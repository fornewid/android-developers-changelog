---
title: https://developer.android.com/develop/ui/views/animations/view-animation
url: https://developer.android.com/develop/ui/views/animations/view-animation
source: md.txt
---

Try the Compose way Jetpack Compose is the recommended UI toolkit for Android. Learn how to use Animations in Compose. [Animate properties →](https://developer.android.com/develop/ui/compose/animation/value-based) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)
...
and transparency) on the contents of a View object. So, if you have a `https://developer.android.com/reference/android/widget/TextView` object, you can move, rotate, grow, or shrink the text. If it has a
background image, the background image will be transformed along with the text. The `https://developer.android.com/reference/android/view/animation/package-summary` provides all the classes used in a tween animation.
...
`https://developer.android.com/reference/android/view/animation/AnimationSet` class and other `https://developer.android.com/reference/android/view/animation/Animation` subclasses.)
...
You can determine how a transformation is applied over time by assigning an `https://developer.android.com/reference/android/view/animation/Interpolator`. Android includes several Interpolator subclasses that
specify various speed curves: for instance, `https://developer.android.com/reference/android/view/animation/AccelerateInterpolator`
...
directory of the project, the following code will reference it and apply it to an `https://developer.android.com/reference/android/widget/ImageView` object from the layout.
...
animation with `` `https://developer.android.com/reference/android/view/animation/Animation#setStartTime(long)` ``, then assign the animation to the View with `` `https://developer.android.com/reference/android/view/View#setAnimation(android.view.animation.Animation)` ``.

For more information on the XML syntax, available tags and attributes, see [Animation Resources](https://developer.android.com/guide/topics/resources/animation-resource).
