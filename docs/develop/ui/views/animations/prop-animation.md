...
Try the Compose way Jetpack Compose is the recommended UI toolkit for Android. Learn how to use Animations in Compose. [animate\*AsState →](https://developer.android.com/jetpack/compose/animation/value-based#animate-as-state) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)
...
The `https://developer.android.com/reference/android/animation/ValueAnimator` object keeps track of your animation's timing,
such as how long the animation has been running, and the current value of the property that it is
animating.

The `https://developer.android.com/reference/android/animation/ValueAnimator` encapsulates a `https://developer.android.com/reference/android/animation/TimeInterpolator`, which defines animation interpolation, and a `https://developer.android.com/reference/android/animation/TypeEvaluator`, which defines how to calculate values for the property being
animated. For example, in Figure 2, the `https://developer.android.com/reference/android/animation/TimeInterpolator` used would be
`https://developer.android.com/reference/android/view/animation/AccelerateDecelerateInterpolator` and the `https://developer.android.com/reference/android/animation/TypeEvaluator` would be `https://developer.android.com/reference/android/animation/IntEvaluator`.

To start an animation, create a `https://developer.android.com/reference/android/animation/ValueAnimator` and give it the
starting and ending values for the property that you want to animate, along with the duration of
the animation. When you call `https://developer.android.com/reference/android/animation/ValueAnimator#start()` the animation
begins. During the whole animation, the `https://developer.android.com/reference/android/animation/ValueAnimator` calculates an *elapsed fraction*
...
When the `https://developer.android.com/reference/android/animation/ValueAnimator` is done calculating an elapsed fraction, it
calls the `https://developer.android.com/reference/android/animation/TimeInterpolator` that is currently set, to calculate an
...
When the interpolated fraction is calculated, `https://developer.android.com/reference/android/animation/ValueAnimator` calls
the appropriate `https://developer.android.com/reference/android/animation/TypeEvaluator`, to calculate the value of the
...
The view animation system provides the capability to only animate `https://developer.android.com/reference/android/view/View`
objects, so if you wanted to animate non-`https://developer.android.com/reference/android/view/View` objects, you have to implement
your own code to do so. The view animation system is also constrained in the fact that it only
exposes a few aspects of a `https://developer.android.com/reference/android/view/View` object to animate, such as the scaling and
...
You can find most of the property animation system's APIs in `https://developer.android.com/reference/android/animation/package-summary`. Because the view animation system already
defines many interpolators in `https://developer.android.com/reference/android/view/animation/package-summary`, you can use
...
The `https://developer.android.com/reference/android/animation/Animator` class provides the basic structure for creating
...
property. They take the timing data that is provided by an `https://developer.android.com/reference/android/animation/Animator`
...
|---|---|
| `https://developer.android.com/reference/android/animation/IntEvaluator` | The default evaluator to calculate values for `int` properties. |
| `https://developer.android.com/reference/android/animation/FloatEvaluator` | The default evaluator to calculate values for `float` properties. |
| `https://developer.android.com/reference/android/animation/ArgbEvaluator` | The default evaluator to calculate values for color properties that are represented as hexadecimal values. |
| `https://developer.android.com/reference/android/animation/TypeEvaluator` | An interface that allows you to create your own evaluator. If you are animating an object property that is *not* an `int`, `float`, or color, you must implement the `https://developer.android.com/reference/android/animation/TypeEvaluator` interface to specify how to compute the object property's animated values. You can also specify a custom `https://developer.android.com/reference/android/animation/TypeEvaluator` for `int`, `float`, and color values as well, if you want to process those types differently than the default behavior. See the section about [Using a TypeEvaluator](https://developer.android.com/develop/ui/views/animations/prop-animation#type-evaluator) for more information on how to write a custom evaluator. |
...
end of the animation. Table 3 describes the interpolators that are contained in `https://developer.android.com/reference/android/view/animation/package-summary`. If none of the provided interpolators suits
your needs, implement the `https://developer.android.com/reference/android/animation/TimeInterpolator` interface and create your own. See [Using interpolators](https://developer.android.com/develop/ui/views/animations/prop-animation#interpolators) for more information on how to write a custom
interpolator.
...
| Class/Interface | Description |
|---|---|
| `https://developer.android.com/reference/android/view/animation/AccelerateDecelerateInterpolator` | An interpolator whose rate of change starts and ends slowly but accelerates through the middle. |
| `https://developer.android.com/reference/android/view/animation/AccelerateInterpolator` | An interpolator whose rate of change starts out slowly and then accelerates. |
| `https://developer.android.com/reference/android/view/animation/AnticipateInterpolator` | An interpolator whose change starts backward then flings forward. |
| `https://developer.android.com/reference/android/view/animation/AnticipateOvershootInterpolator` | An interpolator whose change starts backward, flings forward and overshoots the target value, then finally goes back to the final value. |
| `https://developer.android.com/reference/android/view/animation/BounceInterpolator` | An interpolator whose change bounces at the end. |
| `https://developer.android.com/reference/android/view/animation/CycleInterpolator` | An interpolator whose animation repeats for a specified number of cycles. |
| `https://developer.android.com/reference/android/view/animation/DecelerateInterpolator` | An interpolator whose rate of change starts out quickly and then decelerates. |
| `https://developer.android.com/reference/android/view/animation/LinearInterpolator` | An interpolator whose rate of change is constant. |
| `https://developer.android.com/reference/android/view/animation/OvershootInterpolator` | An interpolator whose change flings forward and overshoots the last value then comes back. |
| `https://developer.android.com/reference/android/animation/TimeInterpolator` | An interface that allows you to implement your own interpolator. |

## Animate using ValueAnimator

The `https://developer.android.com/reference/android/animation/ValueAnimator` class lets you animate values of some type for the
duration of an animation by specifying a set of `int`, `float`, or color
values to animate through. You obtain a `https://developer.android.com/reference/android/animation/ValueAnimator` by calling one of
its factory methods: `https://developer.android.com/reference/android/animation/ValueAnimator#ofInt(int...)`, `https://developer.android.com/reference/android/animation/ValueAnimator#ofFloat(float...)`, or `https://developer.android.com/reference/android/animation/ValueAnimator#ofObject(android.animation.TypeEvaluator, java.lang.Object...)`. For example:
...
In this code, the `https://developer.android.com/reference/android/animation/ValueAnimator` starts calculating the values of the
animation, between 0 and 100, for a duration of 1000 ms, when the `https://developer.android.com/reference/android/animation/ValueAnimator#start()` method runs.
...
logic supplied by `MyTypeEvaluator` for a duration of 1000 ms, when the `https://developer.android.com/reference/android/animation/ValueAnimator#start()` method runs.

You can use the values of the animation by adding an
`https://developer.android.com/reference/android/animation/ValueAnimator.AnimatorUpdateListener`
to the `https://developer.android.com/reference/android/animation/ValueAnimator` object, as shown in the
following code:
...
In the `https://developer.android.com/reference/android/animation/ValueAnimator.AnimatorUpdateListener#onAnimationUpdate(android.animation.ValueAnimator)`
...
The `https://developer.android.com/reference/android/animation/ObjectAnimator` is a subclass of the `https://developer.android.com/reference/android/animation/ValueAnimator` (discussed in the previous section) and combines the timing
engine and value computation of `https://developer.android.com/reference/android/animation/ValueAnimator` with the ability to
animate a named property of a target object. This makes animating any object much easier, as you
no longer need to implement the `https://developer.android.com/reference/android/animation/ValueAnimator.AnimatorUpdateListener`,
because the animated property updates automatically.

Instantiating an `https://developer.android.com/reference/android/animation/ObjectAnimator` is similar to a `https://developer.android.com/reference/android/animation/ValueAnimator`, but you also specify the object and the name of that object's property (as
...
finishes. The Android system lets you bundle animations together into an `https://developer.android.com/reference/android/animation/AnimatorSet`, so that you can specify whether to start animations
simultaneously, sequentially, or after a specified delay. You can also nest `https://developer.android.com/reference/android/animation/AnimatorSet` objects within each other.

The following code snippet plays the following `https://developer.android.com/reference/android/animation/Animator`
...
- `https://developer.android.com/reference/android/animation/Animator.AnimatorListener`
  - `https://developer.android.com/reference/android/animation/Animator.AnimatorListener#onAnimationStart(android.animation.Animator)` - Called when the animation starts.
  - `https://developer.android.com/reference/android/animation/Animator.AnimatorListener#onAnimationEnd(android.animation.Animator)` - Called when the animation ends.
  - `https://developer.android.com/reference/android/animation/Animator.AnimatorListener#onAnimationRepeat(android.animation.Animator)` - Called when the animation repeats itself.
  - `https://developer.android.com/reference/android/animation/Animator.AnimatorListener#onAnimationCancel(android.animation.Animator)` - Called when the animation is canceled. A cancelled animation also calls `https://developer.android.com/reference/android/animation/Animator.AnimatorListener#onAnimationEnd(android.animation.Animator)`, regardless of how they were ended.
- `https://developer.android.com/reference/android/animation/ValueAnimator.AnimatorUpdateListener`
  - `https://developer.android.com/reference/android/animation/ValueAnimator.AnimatorUpdateListener#onAnimationUpdate(android.animation.ValueAnimator)` - called on every frame of the animation. Listen to this event to
    use the calculated values generated by `https://developer.android.com/reference/android/animation/ValueAnimator` during an
    animation. To use the value, query the `https://developer.android.com/reference/android/animation/ValueAnimator` object
    passed into the event to get the current animated value with the `https://developer.android.com/reference/android/animation/ValueAnimator#getAnimatedValue()` method. Implementing this
    listener is required if you use `https://developer.android.com/reference/android/animation/ValueAnimator`.


    Depending on what property or object you are animating, you might need to call
    `https://developer.android.com/reference/android/view/View#invalidate()` on a View to force that area of the
    ...
    such as `https://developer.android.com/reference/android/view/View#setAlpha(float)` and
    `https://developer.android.com/reference/android/view/View#setTranslationX(float)` invalidate the View
    properly, so you do not need to invalidate the View when calling these methods with new values.

You can extend the `https://developer.android.com/reference/android/animation/AnimatorListenerAdapter` class instead of
implementing the `https://developer.android.com/reference/android/animation/Animator.AnimatorListener` interface, if you do not
want to implement all of the methods of the `https://developer.android.com/reference/android/animation/Animator.AnimatorListener`
interface. The `https://developer.android.com/reference/android/animation/AnimatorListenerAdapter` class provides empty
implementations of the methods that you can choose to override.

For example, the following code snippet creates an `https://developer.android.com/reference/android/animation/AnimatorListenerAdapter`
for just the `https://developer.android.com/reference/android/animation/Animator.AnimatorListener#onAnimationEnd(android.animation.Animator)`
callback:
...
`https://developer.android.com/reference/android/animation/LayoutTransition` class. Views inside a ViewGroup can
...
`https://developer.android.com/reference/android/view/View#setVisibility(int)` method with
`https://developer.android.com/reference/android/view/View#VISIBLE`, `https://developer.android.com/reference/android/view/View#INVISIBLE`, or
`https://developer.android.com/reference/android/view/View#GONE`. The remaining Views in the ViewGroup can also
animate into their new positions when you add or remove Views. You can define
the following animations in a `https://developer.android.com/reference/android/animation/LayoutTransition` object
by calling `https://developer.android.com/reference/android/animation/LayoutTransition#setAnimator(int, android.animation.Animator)`
and passing in an `https://developer.android.com/reference/android/animation/Animator` object with one of the
following `https://developer.android.com/reference/android/animation/LayoutTransition` constants:
...
The `https://developer.android.com/reference/android/animation/StateListAnimator` class lets you define animators that run when
the state of a view changes. This object behaves as a wrapper for an
`https://developer.android.com/reference/android/animation/Animator` object, calling that animation whenever the specified
view state (such as "pressed" or "focused") changes.

The `https://developer.android.com/reference/android/animation/StateListAnimator` can be defined in an XML resource with a root
`<selector>` element and child `<item>` elements that each specify
a different view state defined by the `https://developer.android.com/reference/android/animation/StateListAnimator` class. Each
...
selector xmlns:android="http://schemas.and>roid.<com/apk/res/android"
    !-- the pressed state; in>creas<e x and y size to 150% --
    ite>m android<:st>ate_pressed=&<quot;true"
        set
            ...
            objectAnimator android:propertyName="scaleY"
                android:duration="@android:integer/config_shor>tAnimTime<&quo>t;
  <     >     <    android:valueTo="1.5"
                android:val>ueTyp<e="floatType"/
        />set
    /<ite>m
    ...
    item android:state_pressed="false"
        set
            objectAnimator android:propertyName="scaleX"
               > android:dura<tion="@android:integer/config_shortAnimTime"
                android:valueTo="1"
                android:valueType="floatType"/
            objectAnimator android:propert>yName=&qu<ot;s>caleY<">;<
        >        android:duration="@android:integer/config_shortAnimTime"
                android:valueTo="1"
                android:valueType="floatType"/
        /set
...
`https://developer.android.com/reference/android/animation/AnimatorInflater#loadStateListAnimator(android.content.Context, int)` method, and assign the animator to
your view with the `https://developer.android.com/reference/android/view/View#setStateListAnimator(android.animation.StateListAnimator)` method.

Or instead of animating properties of the view, you can play a drawable animation between
state changes, using `https://developer.android.com/reference/android/graphics/drawable/AnimatedStateListDrawable`.
Some of the system widgets in
Android 5.0 use these animations by default. The following example shows how
to define an `https://developer.android.com/reference/android/graphics/drawable/AnimatedStateListDrawable` as an XML resource:

```xml
<!-- res/drawable/myanimstatedrawable.xml --&g<t;
animated-selector
    xmlns:android="http://schemas.android.com/apk/res/android<">

    !-- provide a different drawable for ea<ch state-->
    item android:id="@+id/pressed" android:drawable="@drawable/drawableP"
    <    android:state_pressed="true"/>
    item android:id="@+id/focused" android:drawable=&qu<ot;@drawable/drawableF"
        android:state_focused="true"/>
   < item android:id="@id/defaul<t"
        android:drawable="@drawable/drawableD"/>

    !--< specify a transition --><
    transition android:fromId="@+id/default" android:toId="<;@+id/pressed">
        animation-list>
            item android:duration=&<quot;15" android<:drawable="@draw<able/dt1"/>
...
evaluator by implementing the `https://developer.android.com/reference/android/animation/TypeEvaluator` interface. The types that
are known by the Android system are `int`, `float`, or a color, which are
supported by the `https://developer.android.com/reference/android/animation/IntEvaluator`, `https://developer.android.com/reference/android/animation/FloatEvaluator`, and `https://developer.android.com/reference/android/animation/ArgbEvaluator` type
evaluators.

There is only one method to implement in the `https://developer.android.com/reference/android/animation/TypeEvaluator`
interface, the `https://developer.android.com/reference/android/animation/TypeEvaluator#evaluate(float, T, T)` method. This allows
the animator that you are using to return an appropriate value for your animated property at the
current point of the animation. The `https://developer.android.com/reference/android/animation/FloatEvaluator` class demonstrates
how to do this:
...
**Note:** When `https://developer.android.com/reference/android/animation/ValueAnimator` (or `https://developer.android.com/reference/android/animation/ObjectAnimator`) runs, it calculates a current elapsed fraction of the
animation (a value between 0 and 1) and then calculates an interpolated version of that depending
on what interpolator that you are using. The interpolated fraction is what your `https://developer.android.com/reference/android/animation/TypeEvaluator` receives through the `fraction` parameter, so you do
...
the `https://developer.android.com/reference/android/view/animation/package-summary`. If none of these suit your
needs, you can implement the `https://developer.android.com/reference/android/animation/TimeInterpolator` interface and create your
own.

As an example, how the default interpolator `https://developer.android.com/reference/android/view/animation/AccelerateDecelerateInterpolator` and the `https://developer.android.com/reference/android/view/animation/LinearInterpolator` calculate interpolated fractions are compared below.
The `https://developer.android.com/reference/android/view/animation/LinearInterpolator` has no effect on the elapsed fraction. The `https://developer.android.com/reference/android/view/animation/AccelerateDecelerateInterpolator` accelerates into the animation and
...
As the table shows, the `https://developer.android.com/reference/android/view/animation/LinearInterpolator` changes the values
at the same speed, .2 for every 200ms that passes. The `https://developer.android.com/reference/android/view/animation/AccelerateDecelerateInterpolator` changes the values faster than `https://developer.android.com/reference/android/view/animation/LinearInterpolator` between 200ms and 600ms and slower between 600ms and
1000ms.

## Specify keyframes

A `https://developer.android.com/reference/android/animation/Keyframe` object consists of a time/value pair that lets you define
...
To instantiate a `https://developer.android.com/reference/android/animation/Keyframe` object, you must use one of the factory
methods, `https://developer.android.com/reference/android/animation/Keyframe#ofInt(float)`, `https://developer.android.com/reference/android/animation/Keyframe#ofFloat(float)`, or `https://developer.android.com/reference/android/animation/Keyframe#ofObject(float)` to obtain the appropriate type of `https://developer.android.com/reference/android/animation/Keyframe`. You then call
the `https://developer.android.com/reference/android/animation/PropertyValuesHolder#ofKeyframe(android.util.Property, android.animation.Keyframe...)` factory method to
obtain a `https://developer.android.com/reference/android/animation/PropertyValuesHolder` object. Once you have the object, you can
obtain an animator by passing in the `https://developer.android.com/reference/android/animation/PropertyValuesHolder` object and
...
addition, Views also automatically call the `https://developer.android.com/reference/android/view/View#invalidate()`
method to refresh the screen whenever its properties are changed. The new properties in the `https://developer.android.com/reference/android/view/View` class that facilitate property animations are:
...
The `https://developer.android.com/reference/android/view/ViewPropertyAnimator` provides a simple way to animate several
properties of a `https://developer.android.com/reference/android/view/View` in parallel, using a single underlying `https://developer.android.com/reference/android/animation/Animator`
object. It behaves much like an `https://developer.android.com/reference/android/animation/ObjectAnimator`, because it modifies the
actual values of the view's properties, but is more efficient when animating many properties at
once. In addition, the code for using the `https://developer.android.com/reference/android/view/ViewPropertyAnimator` is much
more concise and easier to read. The following code snippets show the differences in using multiple
`https://developer.android.com/reference/android/animation/ObjectAnimator` objects, a single
`https://developer.android.com/reference/android/animation/ObjectAnimator`, and the `https://developer.android.com/reference/android/view/ViewPropertyAnimator` when
...
For more detailed information about `https://developer.android.com/reference/android/view/ViewPropertyAnimator`, see the corresponding Android Developers
[blog
...
- `https://developer.android.com/reference/android/animation/ValueAnimator` - `<animator>`
- `https://developer.android.com/reference/android/animation/ObjectAnimator` - `<objectAnimator>`
- `https://developer.android.com/reference/android/animation/AnimatorSet` - `<set>`
...
```xml
<set android:ordering="sequenti>ally&<quo>t;
    se<t
        objectAnimator
...
>         <   android:valueType="intType"/
        objectAnimator
            ...
            android:duration="500"
    >     <   <>/span>androi<d:valueTo="300"
            android:valueType="intType"/
    /set
    objectAnimator
       > &>lt;android:propertyName="alpha"
        android:duration="500"
        android:valueTo="1f"/
/set
```

In order to run this animation, you must inflate the XML resources in your code to an `https://developer.android.com/reference/android/animation/AnimatorSet` object, and then set the target objects for all of the animations
before starting the animation set. Calling `https://developer.android.com/reference/android/animation/AnimatorSet#setTarget(java.lang.Object)` sets a single target object for all children of the `https://developer.android.com/reference/android/animation/AnimatorSet` as a convenience. The following code shows how to do this:
...
You can also declare a `https://developer.android.com/reference/android/animation/ValueAnimator` in XML, as
...
<animator xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    android:valueType="floatType"
    android:valueFrom=&quo>t;0f"
    android:valueTo="-100f" /
```

To use the previous `https://developer.android.com/reference/android/animation/ValueAnimator` in your code, you
