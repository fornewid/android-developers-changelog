...
Try the Compose way Jetpack Compose is the recommended UI toolkit for Android. Learn how to use Animations in Compose. [Spring AnimationSpec →](https://developer.android.com/jetpack/compose/animation/customize#spring) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)


[Physics-based
motion](https://developer.android.com/training/animation/overview#physics-based) is driven by force. Spring force is one such force that guides
...
[fling animation](https://developer.android.com/guide/topics/graphics/fling-animation)
instead.

## Lifecycle of a spring animation


In a spring-based animation, the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce`
...
- [**Create a spring animation:**](https://developer.android.com/develop/ui/views/animations/spring-animation#creating-spring-animation) The primary step is to create an instance of the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation` class and set the motion behavior parameters.
...
2. Add the support library to the `dependencies` section.
   ...
   Dynamicanimation on the [versions](https://developer.android.com/jetpack/androidx/versions) page.

### Create a spring animation


The `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation` class lets you create
a spring animation for an object. To build a spring animation, you need to
create an instance of the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation`
...
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#ALPHA`: Represents the alpha transparency on the view. The value is 1 (opaque) by default, with a value of 0 representing full transparency (not visible).
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_X`, `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_Y`, and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_Z`: These properties control where the view is located as a delta from its left coordinate, top coordinate, and elevation, which are set by its layout container.
  - `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_X` describes the left coordinate.
  - `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_Y` describes the top coordinate.
  - `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_Z` describes the depth of the view relative to its elevation.
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#ROTATION`, `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#ROTATION_X`, and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#ROTATION_Y`: These properties control the rotation in 2D (`rotation` property) and 3D around the pivot point.
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#SCROLL_X` and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#SCROLL_Y`: These properties indicate the scroll offset of the source left and the top edge in pixels. It also indicates the position in terms how much the page is scrolled.
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#SCALE_X` and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#SCALE_Y`: These properties control the 2D scaling of a view around its pivot point.
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#X`, `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#Y`, and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#Z`: These are basic utility properties to describe the final location of the view in its container.
  - `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#X` is a sum of the left value and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_X`.
  - `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#Y` is a sum of the top value and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_Y`.
  - `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#Z` is a sum of the elevation value and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#TRANSLATION_Z`.

### Register listeners


The `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation` class provides two
listeners: `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation.OnAnimationUpdateListener`
and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation.OnAnimationEndListener`.
...
can set up `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation.OnAnimationUpdateListener`
...
1. Call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#addUpdateListener(android.support.animation.DynamicAnimation.OnAnimationUpdateListener)` method and attach the listener to the animation.
...
`https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation.OnAnimationEndListener`
...
1. Call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#addEndListener(android.support.animation.DynamicAnimation.OnAnimationEndListener)` method and attach the listener to the animation.
2. Override the `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation.OnAnimationEndListener#onAnimationEnd(android.support.animation.DynamicAnimation, boolean, float, float)` method to receive notification whenever an animation reaches equilibrium or is canceled.

### Remove listeners


To stop receiving animation update callbacks and animation end callbacks,
call `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#removeUpdateListener(android.support.animation.DynamicAnimation.OnAnimationUpdateListener)`
and `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#removeEndListener(android.support.animation.DynamicAnimation.OnAnimationEndListener)`
...
`https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#setStartValue(float)`
...
- To set the minimum value, call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#setMinValue(float)` method and pass the minimum value of the property.
- To set the maximum value, call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#setMaxValue(float)` method and pass the maximum value of the property.
...
[Converting dp per second to pixels per second](https://developer.android.com/develop/ui/views/animations/spring-animation#converting-value)
section.


To set the velocity, call the
`https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#setStartVelocity(float)`
method and pass the velocity in pixels per second. The method returns the
spring force object on which the velocity is set.

**Note:** Use the
`https://developer.android.com/reference/android/view/GestureDetector.OnGestureListener` or the
`https://developer.android.com/reference/android/view/VelocityTracker` class methods to retrieve and compute
...
`https://developer.android.com/reference/android/util/TypedValue#applyDimension(int, float, android.util.DisplayMetrics)`
method from the `https://developer.android.com/reference/android/util/TypedValue` class. Refer to the
...
The `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce` class defines the getter
...
[Creating a custom spring force](https://developer.android.com/develop/ui/views/animations/spring-animation#creating-custom-spring)
section.
...
1. Call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#getSpring()` method to retrieve the spring to add the damping ratio.
2. Call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#setDampingRatio(float)` method and pass the damping ratio that you want to add to the spring. The method returns the spring force object on which the damping ratio is set.
...
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#DAMPING_RATIO_HIGH_BOUNCY`
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#DAMPING_RATIO_MEDIUM_BOUNCY`
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#DAMPING_RATIO_LOW_BOUNCY`
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#DAMPING_RATIO_NO_BOUNCY`
...
The default damping ratio is set to `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#DAMPING_RATIO_MEDIUM_BOUNCY`.
...
1. Call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#getSpring()` method to retrieve the spring to add the stiffness.
2. Call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#setStiffness(float)` method and pass the stiffness value that you want to add to the spring. The method returns the spring force object on which the stiffness is set.
...
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#STIFFNESS_HIGH`
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#STIFFNESS_MEDIUM`
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#STIFFNESS_LOW`
- `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#STIFFNESS_VERY_LOW`
...
The default stiffness is set to `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#STIFFNESS_MEDIUM`.
...
1. Create a `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce` object.
...
3. Call the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#setSpring(android.support.animation.SpringForce)` method to set the spring to the animation.
...
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#start()` or by calling the
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#animateToFinalPosition(float)`
...
To use the `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#animateToFinalPosition(float)`
method, call the
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#animateToFinalPosition(float)`
method and pass the rest position of the spring. You can also set the rest
position of the spring by calling the
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringForce#setFinalPosition(float)`
method.


The `https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#start()` method does
...
The `https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#cancel()` method
terminates the animation at the value where it is. The
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#skipToEnd()` method
...
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#canSkipToEnd()` method. If
...
using either
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#skipToEnd()` method or the
`https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#cancel()` method. The
`https://developer.android.com/reference/androidx/dynamicanimation/animation/DynamicAnimation#cancel()` method
*must* be called only on the main thread.

**Note:** In general, the
`https://developer.android.com/reference/androidx/dynamicanimation/animation/SpringAnimation#skipToEnd()` method causes
a visual jump.