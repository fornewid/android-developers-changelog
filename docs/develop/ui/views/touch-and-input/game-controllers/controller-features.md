---
title: Overview  |  Views  |  Android Developers
...
[`VibratorManager`](/reference/android/os/VibratorManager) and
...
For more information about
[Motion sensors](/develop/sensors-and-location/sensors/sensors_motion) and
[`SensorEventListener`](/reference/android/hardware/SensorEventListener).
...
For more information about
[`LightsManager`](/reference/android/hardware/lights/LightsManager) and
[App manifest](/guide/topics/manifest/manifest-intro).
