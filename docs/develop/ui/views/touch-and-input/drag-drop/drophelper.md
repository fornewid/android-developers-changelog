---
title: DropHelper for simplified drag and drop  |  Views  |  Android Developers
...
# DropHelper for simplified drag and drop Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** See [Drag and Drop Demo](https://github.com/android/platform-samples/tree/main/samples/user-interface/draganddrop)
for a complete implementation sample.

To get started, create [`DragStartHelper`](/reference/androidx/core/view/DragStartHelper)
with drag source view and
[`OnDragStartListener`](/reference/androidx/core/view/DragStartHelper.OnDragStartListener).

In [`OnDragStartListener`](/reference/androidx/core/view/DragStartHelper.OnDragStartListener),
override method [`onDragStart()`](/reference/androidx/core/view/DragStartHelper.OnDragStartListener#onDragStart(android.view.View,androidx.core.view.DragStartHelper)). Create a `ClipData` object
...
[`DropHelper.configureView()`](/reference/androidx/draganddrop/DropHelper#configureView(android.app.Activity,%20android.view.View,%20java.lang.String%5B%5D,%20androidx.core.view.OnReceiveContentListener))
is a static, overloaded method that lets you specify drop targets. Its
parameters include the following:

* The current [`Activity`](/reference/android/app/Activity)—used for
  [URI
  permissions](/reference/android/app/Activity#requestDragAndDropPermissions(android.view.DragEvent)).
  + A [`View`](/reference/android/view/View) that serves as the drop target.
    - The [MIME types](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types)
      the drop target can accept from the dropped data.
* Configuration options for the drop target—in particular, a list of
  [embedded `EditText` fields](#EditTextComponentsInDropTargets).
* An [`OnReceiveContentListener`](/reference/androidx/core/view/OnReceiveContentListener)
...
The [`DropHelper.Options`](/reference/androidx/draganddrop/DropHelper.Options)
...
OnReceiveContentListener`)](/reference/androidx/draganddrop/DropHelper#configureView(android.app.Activity,%20android.view.View,%20java.lang.String%5B%5D,%20androidx.draganddrop.DropHelper.Options,%20androidx.core.view.OnReceiveContentListener))
...
Use the
[`DropHelper.Options.Builder`](/reference/androidx/draganddrop/DropHelper.Options.Builder)
...
hierarchy contains one or more [`EditText`](/reference/android/widget/EditText)
components, provide a list of the components to
[`DropHelper.Options.Builder.addInnerEditTexts(EditText...)`](/reference/androidx/draganddrop/DropHelper.Options.Builder#addInnerEditTexts(android.widget.EditText...))
...
Also, if the drag-and-drop [`ClipData`](/reference/android/content/ClipData)
...
3. The first `EditText` provided to the call to
...
[`ContentInfoCompat`](/reference/androidx/core/view/ContentInfoCompat) object.
Text data is present in the object. Media, such as images, is represented by
URIs.

**Warning:** `DropHelper` configures the drop target to listen for drag-and-drop
events and to handle the dropped data. Don't attach a
[`View.OnDragListener`](/reference/android/view/View.OnDragListener) or
...
* [`AppCompatEditText`](/reference/androidx/appcompat/widget/AppCompatEditText),
...
[`ClipDescription`](/reference/android/content/ClipDescription), which is
...
[`DragAndDropPermissions`](/reference/android/view/DragAndDropPermissions). The
