...
a `https://developer.android.com/reference/android/widget/ListView` or
`https://developer.android.com/reference/android/widget/GridView` and implementing the
...
`https://developer.android.com/reference/androidx/fragment/app/ListFragment`. If the
