---
title: Ensure compatibility with gesture navigation  |  Views  |  Android Developers
...
# Ensure compatibility with gesture navigation Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** The `DrawerLayout` and `SeekBar` components support automatic opt-out behavior
out of the box.
