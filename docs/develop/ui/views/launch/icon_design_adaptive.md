---
title: Adaptive icons  |  Views  |  Android Developers
...
![](/static/guide/practices/ui_guidelines/images/article_icons_header.png)
...
* **Different shapes:** an adaptive icon can display a variety of shapes
  ...
  two different kinds of squircles](/static/guide/practices/ui_guidelines/images/article_icon_adaptive.gif)
...
* **Visual effects:** an adaptive icon supports a variety of engaging visual
  ...
  icon expands and then contracts again.](/static/guide/practices/ui_guidelines/images/article_icon_effect.gif)
...
* **User theming:** starting with Android 13 (API level 33), users can theme
  ...
  icons have inherited the tinting of the wallpaper and blend in perfectly.](/static/guide/practices/ui_guidelines/images/adaptive-icon-themed-icons.png)
...
* You must provide two layers for the color version of the icon: one for the
  ...
  background and no logo.](/static/guide/practices/ui_guidelines/images/adaptive-icon-foreground-background.png)
  ...
  **Figure 4.** Adaptive icons defined using foreground
  ...
  circular mask.](/static/guide/practices/ui_guidelines/images/adaptive-icon-mask-applied.png)
...
* If you want to support user theming of app icons, provide a single layer for
  ...
  pink, yellow, and green).](/static/guide/practices/ui_guidelines/images/adaptive-icon-monochrome.png)
