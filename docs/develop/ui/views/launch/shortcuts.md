---
title: App shortcuts overview  |  Views  |  Android Developers
...
![app shortcuts](/static/images/guide/topics/ui/shortcuts_2023.png)
...
* *Static shortcuts* are defined in a resource file that is packaged into
  an APK or [app bundle](/guide/app-bundle/build).
* *Dynamic shortcuts* can be pushed, updated, and removed by your app
  only at runtime.
* *Pinned shortcuts* can be added to supported launchers at runtime if
...
[`getMaxShortcutCountPerActivity()`](//developer.android.com/reference/androidx/core/content/pm/ShortcutManagerCompat#getMaxShortcutCountPerActivity(android.content.Context))
