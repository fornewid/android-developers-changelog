---
title: About notifications  |  Views  |  Android Developers
...
notification](/training/notify-user/build-notification).
...
visibility](/training/notify-user/build-notification#lockscreenNotification).
...
badge](/training/notify-user/badges).
...
notification](/training/wearables/notifications#add-wearable-features).
...
layout](/training/notify-user/custom-notification).
...
read [Create an expandable notification](/training/notify-user/expanded).
...
notification](/training/notify-user/build-notification#Updating) rather
than issuing a new one or use the [inbox-style
notification](/training/notify-user/expanded#inbox-style) to show
...
notifications](/training/notify-user/group).
...
channels](/training/notify-user/channels).
...
the notification's
[`priority`](/reference/androidx/core/app/NotificationCompat.Builder#setPriority(int)).

On Android 8.0 (API level 26) and higher, the importance of a notification is
determined by the
[`importance`](/reference/android/app/NotificationChannel#setImportance(int))
...
importance](/training/notify-user/build-notification#Priority).
...
system-wide
category](/training/notify-user/build-notification#system-category).
