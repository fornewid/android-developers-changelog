...
Try the Compose way Jetpack Compose is the recommended UI toolkit for Android. Learn how to add components in Compose. [Radio buttons →](https://developer.android.com/develop/ui/compose/components/radio-button) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)
...
> [!NOTE]
> **Note:** `RadioGroup` is a subclass of `https://developer.android.com/reference/android/widget/LinearLayout` that has a vertical orientation by default.
...
> [!TIP]
> **Tip:** If you need to change the radio button state yourself, use the `https://developer.android.com/reference/android/widget/CompoundButton#setChecked(boolean)` or `https://developer.android.com/reference/android/widget/CompoundButton#toggle()` method.