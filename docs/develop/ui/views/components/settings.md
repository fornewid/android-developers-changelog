---
title: Settings  |  Views  |  Android Developers
...
library](/reference/androidx/preference/package-summary). Starting with Android
10, the platform `android.preference` library is deprecated.
...
Guidelines](https://source.android.com/devices/tech/settings/settings-guidelines)
...
![An image showing an example of Preference screen](/static/develop/ui/views/components/settings/images/settings-simple.png)


**Figure 1.** A settings screen created using two `Preference`
objects.
