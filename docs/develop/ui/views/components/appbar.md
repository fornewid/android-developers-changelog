...
`https://developer.android.com/reference/androidx/appcompat/widget/Toolbar` widget as an
app bar. There are other ways to implement an app bar---for example, some themes set up an
`https://developer.android.com/reference/android/app/ActionBar` as an app bar by
