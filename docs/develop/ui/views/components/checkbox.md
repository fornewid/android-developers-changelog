...
Try the Compose way Jetpack Compose is the recommended UI toolkit for Android. Learn how to add components in Compose. [Checkbox →](https://developer.android.com/develop/ui/compose/components/checkbox) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)
...
`https://developer.android.com/reference/android/widget/CheckBox` in your layout. Because
...
> [!TIP]
> **Tip:** If you need to change the checkbox state yourself, use the `https://developer.android.com/reference/android/widget/CompoundButton#setChecked(boolean)` or `https://developer.android.com/reference/android/widget/CompoundButton#toggle()` method.