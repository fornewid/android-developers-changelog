...
The [AndroidX](https://developer.android.com/jetpack/androidx) library's
`https://developer.android.com/reference/androidx/appcompat/widget/Toolbar` provides
different ways for users to interact with your app.
[Add and handle actions](https://developer.android.com/develop/ui/views/components/appbar/actions) describes how to
...
`https://developer.android.com/reference/androidx/appcompat/widget/SearchView` widget
...
[Add and handle actions](https://developer.android.com/develop/ui/views/components/appbar/actions). Add one of the following attributes to the
`<item>` element:
...
`https://developer.android.com/reference/android/view/MenuItem#getActionView()`
...
implements
`https://developer.android.com/reference/android/view/MenuItem.OnActionExpandListener`,
and pass a member of that class to
`https://developer.android.com/reference/android/view/MenuItem#setOnActionExpandListener(android.view.MenuItem.OnActionExpandListener)`.
...
resource, as described in [Add and handle actions](https://developer.android.com/develop/ui/views/components/appbar/actions). Add an
...
- See `https://developer.android.com/reference/androidx/appcompat/widget/ShareActionProvider` for an example of adding a share action to your top app bar.
- See `https://developer.android.com/reference/androidx/core/view/ActionProvider` for more information about creating a custom action provider.