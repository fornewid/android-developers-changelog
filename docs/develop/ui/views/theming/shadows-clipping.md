...
Try the Compose way Jetpack Compose is the recommended UI toolkit for Android. Learn how to work with theming in Compose. [Modifier.shadow() →](https://developer.android.com/reference/kotlin/androidx/compose/ui/Modifier#(androidx.compose.ui.Modifier).shadow(androidx.compose.ui.unit.Dp,androidx.compose.ui.graphics.Shape,kotlin.Boolean,androidx.compose.ui.graphics.Color,androidx.compose.ui.graphics.Color)) ![](https://developer.android.com/static/images/android-compose-ui-logo.png)
...
> Elevation](https://m3.material.io/styles/elevation/overview), and consider migrating your project to [Jetpack Compose](https://developer.android.com/jetpack/compose/interop).
...
`https://developer.android.com/reference/android/view/View#setElevation(float)`
method.

To set the translation of a view, use the
`https://developer.android.com/reference/android/view/View#setTranslationZ(float)`
method.

The
`https://developer.android.com/reference/android/view/ViewPropertyAnimator#z(float)`
and
`https://developer.android.com/reference/android/view/ViewPropertyAnimator#translationZ(float)`
...
and the [property
animation](https://developer.android.com/guide/topics/graphics/prop-animation) developer guide.
...
For more information, see
[Animate view
state changes using StateListAnimator](https://developer.android.com/develop/ui/views/animations/prop-animation#ViewState).
...
1. Extend the `https://developer.android.com/reference/android/view/ViewOutlineProvider` class.
2. Override the `https://developer.android.com/reference/android/view/ViewOutlineProvider#getOutline(android.view.View, android.graphics.Outline)` method.
3. Assign the new outline provider to your view with the `https://developer.android.com/reference/android/view/View#setOutlineProvider(android.view.ViewOutlineProvider)` method.

You can create oval and rectangular outlines with rounded corners using the
methods in the
`https://developer.android.com/reference/android/graphics/Outline`
...
`https://developer.android.com/reference/android/view/View#setClipToOutline(boolean)`
...
[reveal
animation](https://developer.android.com/develop/ui/views/animations/reveal-or-hide-view#Reveal).