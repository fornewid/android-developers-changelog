---
title: Implement dark theme  |  Views  |  Android Developers
...
# Implement dark theme Stay organized with collections Save and categorize content based on your preferences.
...
component, see [Darken web content in WebView](/guide/webapps/dark-theme).
...
* Light:
  [`MODE_NIGHT_NO`](/reference/androidx/appcompat/app/AppCompatDelegate#MODE_NIGHT_NO()).
* Dark:
  [`MODE_NIGHT_YES`](/reference/androidx/appcompat/app/AppCompatDelegate#MODE_NIGHT_YES()).
* System default:
  [`MODE_NIGHT_FOLLOW_SYSTEM`](/reference/androidx/appcompat/app/AppCompatDelegate#MODE_NIGHT_FOLLOW_SYSTEM()).
...
* On API level 30 and below, use
  [`AppCompatDelegate.setDefaultNightMode()`](/reference/androidx/appcompat/app/AppCompatDelegate#setDefaultNightMode(int))
  to switch the theme.
...
[`setForceDarkAllowed()`](/reference/android/view/View#setForceDarkAllowed(boolean)).

## Web content

For information on using dark themes in web-based content, see [Darken web
content in WebView](/guide/webapps/dark-theme). For an example of dark theme
...
triggers a [`uiMode`](/reference/android/content/res/Configuration#uiMode)
