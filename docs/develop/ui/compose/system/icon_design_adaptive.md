---
title: Adaptive icons  |  Jetpack Compose  |  Android Developers
...
# Adaptive icons Stay organized with collections Save and categorize content based on your preferences.





![](/static/develop/ui/compose/images/article_icons_header.png)

An adaptive icon, or [`AdaptiveIconDrawable`](/reference/android/graphics/drawable/AdaptiveIconDrawable), can display differently
...
In contrast to [bitmap images](/guide/topics/resources/drawable-resource#Bitmap), adaptive icons can adapt to different use
cases:
...
* **Different shapes:** an adaptive icon can display a variety of shapes
  ...
  two different kinds of squircles](/static/develop/ui/compose/images/article_icon_adaptive.gif)
...
* **Visual effects:** an adaptive icon supports a variety of engaging visual
  ...
  icon expands and then contracts again.](/static/develop/ui/compose/images/article_icon_effect.gif)


  **Figure 2.** Examples of visual effects displayed by
  an adaptive icon.

  **Note:** Animated visual effects are generated by supported launchers. Visual
  effects might vary from one launcher to another.
* **User theming:** starting with Android 13 (API level 33), users can theme
  ...
  icons have inherited the tinting of the wallpaper and blend in perfectly.](/static/develop/ui/compose/images/adaptive-icon-themed-icons.png)
  ...
  **Figure 3.** Adaptive icons inheriting from the
  ...
  + If your app doesn't provide a monochromatic app icon and the users
...
* You must provide two layers for the color version of the icon: one for the
  ...
  background and no logo.](/static/develop/ui/compose/images/adaptive-icon-foreground-background.png)
  ...
  **Figure 4.** Adaptive icons defined using foreground
  ...
  ![An example showing the icon from the preceding figure overlaid on a
  circular mask.](/static/develop/ui/compose/images/adaptive-icon-mask-applied.png)
...
* If you want to support user theming of app icons, provide a single layer for
  ...
  pink, yellow, and green).](/static/develop/ui/compose/images/adaptive-icon-monochrome.png)
...
**Caution:** If you don't update your launcher icon with the necessary layers, the
icon neither looks consistent with other icons displayed by the system nor
...
[Android Studio documentation for creating launcher icons](/studio/write/image-asset-studio#create-adaptive). Also, read the
...
* For dynamic shortcuts, call the
  [`createWithAdaptiveBitmap()`](/reference/android/graphics/drawable/Icon#createWithAdaptiveBitmap(android.graphics.Bitmap))
