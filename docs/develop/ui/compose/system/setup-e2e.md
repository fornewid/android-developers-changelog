...
[edge-to-edge is enforced](https://developer.android.com/about/verskotlin/ions/15/bactivityipackage-summaryienableedgetoedge(android.view.Window)) by default.
