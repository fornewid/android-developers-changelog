---
title: https://developer.android.com/develop/ui/compose/system/shortcuts/adding-capabilities
url: https://developer.android.com/develop/ui/compose/system/shortcuts/adding-capabilities
source: md.txt
---
...
1. Create a `shortcuts.xml` resource by following the instructions in [Create static shortcuts](https://developer.android.com/develop/ui/compose/system/shortcuts/creating-shortcuts#static).
...
The following example demonstrates a capability definition in `shortcuts.xml` for [`actions.intent.START_EXERCISE`](https://developers.google.com/assistant/app/reference/built-in-intents/health-and-fitness/start-exercise), a BII that lets users use spoken commands with Assistant to begin a workout in a fitness app:
