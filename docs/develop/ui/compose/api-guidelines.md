---
title: Style guidelines for Jetpack Compose APIs  |  Android Developers
...
* [API Guidelines for Jetpack Compose](https://android.googlesource.com/platform/frameworks/support/+/androidx-main/compose/docs/compose-api-guidelines.md): Outlines patterns, best
  ...
  + Guidance for `@Composable` functions and APIs that build on the Compose
...
* **Developers working on Jetpack Compose framework development**. You are in
  this group if you make contributions to the [`androidx.compose` libraries](/jetpack/androidx/releases/compose).
