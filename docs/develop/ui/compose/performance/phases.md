---
title: Compose phases and performance  |  Jetpack Compose  |  Android Developers
...
* **Defer state reads for as long as possible.** By moving state reading to a
  ...
  see an example of this technique in the [Defer reads as long as possible](/develop/ui/compose/performance/bestpractices#defer-reads)
  section of [Follow best practices](/develop/ui/compose/performance/bestpractices).
