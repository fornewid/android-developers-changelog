...
You can verify that the state stored with [`rememberSaveable`](https://developer.android.com/reference/kotlin/androidx/compose/runtime/saveable/rememberSaveable.composable#rememberSaveable(kotlin.Array,androidx.compose.runtime.saveable.Saver,kotlin.String,kotlin.Function0)) in your Compose elements is correctly restored when the activity or process is recreated. There are specific APIs to achieve this, such as [`StateRestorationTester`](https://developer.android.com/reference/kotlin/androidx/compose/ui/test/junit4/StateRestorationTester). Check out the [Testing](https://developer.android.com/develop/ui/compose/testing#verify_state_restoration) documentation to learn more.
...
In the following snippet, `message` stores the user input typed into a `TextField`:
