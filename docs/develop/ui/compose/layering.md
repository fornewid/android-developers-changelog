...
![](/static/develop/ui/compose/images/layering-major-layers.svg)
...
[Runtime](/reference/kotlin/androidx/compose/runtime/package-summary)
:   This module provides the fundamentals of the Compose runtime such as
    ...
    the
    [`@Composable`](/reference/kotlin/androidx/compose/runtime/Composable)
    annotation and
...
[UI](/reference/kotlin/androidx/compose/ui/package-summary)
:   The UI layer is made up of multiple modules (
    [`ui-text`](/reference/kotlin/androidx/compose/ui/text/package-summary),
    [`ui-graphics`](/reference/kotlin/androidx/compose/ui/graphics/package-summary),
    [`ui-tooling`](/reference/kotlin/androidx/compose/ui/tooling/package-summary),
    etc.). These modules implement the fundamentals of the UI toolkit, such as
    `LayoutNode`,
    [`Modifier`](/reference/kotlin/androidx/compose/ui/Modifier), input handlers,
...
[Foundation](/reference/kotlin/androidx/compose/foundation/package-summary)
:   This module provides design system agnostic building blocks for Compose UI,
    like
    [`Row`](/reference/kotlin/androidx/compose/foundation/layout/Row.composable#Row(androidx.compose.ui.Modifier,androidx.compose.foundation.layout.Arrangement.Horizontal,androidx.compose.ui.Alignment.Vertical,kotlin.Function1))
    and
...
[Material](/reference/kotlin/androidx/compose/material/package-summary)
...
[`animateColorAsState`](/reference/kotlin/androidx/compose/animation/package-summary#animateColorAsState(androidx.compose.ui.graphics.Color,androidx.compose.animation.core.AnimationSpec,kotlin.Function1))
API:
...
[`Animatable`](/reference/kotlin/androidx/compose/animation/core/Animatable)
API:
...
1. A material
   [`Surface`](/reference/kotlin/androidx/compose/material/Surface.composable)
   providing the background, shape, click handling, etc.
2. A
   [`CompositionLocalProvider`](/reference/kotlin/androidx/compose/runtime/CompositionLocalProvider.composable#CompositionLocalProvider(kotlin.Array,kotlin.Function0))
   which changes the content’s alpha when the button is enabled or disabled
3. A
   [`ProvideTextStyle`](/reference/kotlin/androidx/compose/material/ProvideTextStyle.composable#ProvideTextStyle(androidx.compose.ui.text.TextStyle,kotlin.Function0))
...
[current content alpha](/develop/ui/compose/designsystems/material3#emphasis)
...
[`androidx.compose.material.Text`](/reference/kotlin/androidx/compose/material/Text.composable)
is built upon
[`androidx.compose.foundation.text.BasicText`](/reference/kotlin/androidx/compose/foundation/text/BasicText.composable).
...
[`Modifier.pointerInput`](/reference/kotlin/androidx/compose/ui/input/pointer/package-summary#(androidx.compose.ui.Modifier).pointerInput(kotlin.Any,kotlin.coroutines.SuspendFunction1))
...
[`Modifier.scrollable`](/reference/kotlin/androidx/compose/foundation/gestures/scrollable.modifier#(androidx.compose.ui.Modifier).scrollable(androidx.compose.foundation.gestures.ScrollableState,androidx.compose.foundation.gestures.Orientation,kotlin.Boolean,kotlin.Boolean,androidx.compose.foundation.gestures.FlingBehavior,androidx.compose.foundation.interaction.MutableInteractionSource))
or [`Modifier.swipeable`](/reference/kotlin/androidx/compose/material/swipeable.modifier#(androidx.compose.ui.Modifier).swipeable(androidx.compose.material.SwipeableState,kotlin.collections.Map,androidx.compose.foundation.gestures.Orientation,kotlin.Boolean,kotlin.Boolean,androidx.compose.foundation.interaction.MutableInteractionSource,kotlin.Function2,androidx.compose.material.ResistanceConfig,androidx.compose.ui.unit.Dp)).
