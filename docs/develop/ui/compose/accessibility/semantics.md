...
[foundation library](/jetpack/androidx/releases/compose-foundation) already set the relevant properties for you by default.
...
[merging or clearing strategy](/develop/ui/compose/accessibility/merging-clearing).
...
[`SemanticsProperties`](/reference/kotlin/androidx/compose/ui/semantics/SemanticsProperties) object. For a full list of possible Accessibility
Actions, see the [`SemanticsActions`](/reference/kotlin/androidx/compose/ui/semantics/SemanticsActions) object.
...
indicate that your component is a [`heading`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).heading()) by defining its semantics
property:
...
Alert-like components can be marked with the [`liveRegion`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).liveRegion()) semantics
...
[`paneTitle`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).paneTitle()) semantics, so that any relevant window or pane changes may be
...
[`error`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).error(kotlin.String)) semantics, and provide expanded error messaging.
...
step size. You can do so with [`progressBarRangeInfo`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).progressBarRangeInfo()) semantics―this
...
By using [`collectionInfo`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).collectionInfo()) and [`collectionItemInfo`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).collectionItemInfo()) semantics on the
...
A composable can define a [`stateDescription`](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).stateDescription()) for semantics which the
...
[Custom actions](/reference/kotlin/androidx/compose/ui/semantics/package-summary#(androidx.compose.ui.semantics.SemanticsPropertyReceiver).customActions()) can be used for more complex touchscreen gestures, like
...
To make the [swipe to dismiss gesture](/reference/kotlin/androidx/compose/material3/SwipeToDismissBox.composable) more accessible, you can link it to a
...
with the [`clearAndSetSemantics`](/reference/kotlin/androidx/compose/ui/semantics/clearAndSetSemantics.modifier#(androidx.compose.ui.Modifier).clearAndSetSemantics(kotlin.Function1)) modifier, as you are moving them into
custom actions.
...
A composition [describes the UI](/develop/ui/compose/mental-model) of your app and is produced by running
...
understandable for [Accessibility](/develop/ui/compose/accessibility) services and for the [Testing](/develop/ui/compose/testing)
...
merging behavior](/develop/ui/compose/accessibility/merging-clearing) in your composable.
...
guide](/develop/ui/compose/testing).
