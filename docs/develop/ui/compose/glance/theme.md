...
For example, the following snippet shows how to create a drawable (a shape):
    ...
    </shape>https://github.com/android/snippets/blob/fbed24d5695413cfd86b4b2c6b6faf0a3a2eadb8/compose/snippets/src/main/res/drawable/button_outline.xml#L18-L21
