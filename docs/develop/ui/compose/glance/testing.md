...
development as you develop individual pieces of your widget and organize them
...
You can use any JVM-based Android unit testing framework, such as Robolectric,
