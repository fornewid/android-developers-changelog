...
widget. As mentioned previously, the user can still [reconfigure the widget](https://developer.android.com/develop/ui/compose/glance/configuration#reconfigure-widgets)
