---
title: Handle errors with Glance  |  Jetpack Compose  |  Android Developers
...
![An error message showing the type of error and a suggestion for where
  to look for it](/static/develop/ui/compose/images/default_error_layout.png)


**Figure 1.** Glance 1.0 default error layout


![A box with the text 'Can't show content'](/static/develop/ui/compose/images/new_error_layout.png)
...
![Contains a heading and a text field to display an error message](/static/develop/ui/compose/images/custom_error_layout.png)
...
Pin Glance widgets in-app](/develop/ui/compose/glance/pin-in-app)

[Next

Unit testing with Glance

arrow\_forward](/develop/ui/compose/glance/testing)