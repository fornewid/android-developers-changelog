...
[`pointerInput`](/reference/kotlin/androidx/compose/ui/input/pointer/package-summary#(androidx.compose.ui.Modifier).pointerInput(kotlin.Any,%20kotlin.coroutines.SuspendFunction1)) modifier. When we detect a new tap event, we
...
[`SwipeToDismiss`](/reference/kotlin/androidx/compose/material/SwipeToDismiss.composable) composable). The horizontal offset of the
