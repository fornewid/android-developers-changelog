---
title: Migrate from Swipeable to AnchoredDraggable  |  Jetpack Compose  |  Android Developers
...
# Migrate from Swipeable to AnchoredDraggable Stay organized with collections Save and categorize content based on your preferences.



**Warning:** This page and the snippets it contains are outdated.

[`Swipeable`](/reference/kotlin/androidx/compose/material/SwipeableState) is a Compose Material API that helps you build components that
...
Compose-Foundation 1.6.0-alpha01: [`AnchoredDraggable`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState). `AnchoredDraggable`
...
**Note:** `AnchoredDraggable` is an experimental API. Experimental APIs may change
in future.
...
[`AnchoredDraggableState`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState) is a final class, meaning it cannot be inherited
from. If your existing component inherits from [`SwipeableState`](/reference/kotlin/androidx/compose/material/SwipeableState), update
...
[`offset`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState#offset()), [`progress`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState#progress()), [`currentValue`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState#currentValue()) and [`targetValue`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState#targetValue()).
...
[`AnchoredDraggableState#updateAnchors`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState#updateAnchors(androidx.compose.foundation.gestures.DraggableAnchors,kotlin.Any)). Passing the anchors to
...
components, use [`AnchoredDraggableState#requireOffset`](/reference/kotlin/androidx/compose/foundation/gestures/AnchoredDraggableState#requireOffset()) to require that the
...
**Note:** Overflow support for `AnchoredDraggable` is currently being implemented.
See [b/288084801](https://issuetracker.google.com/288084801) for the latest status.

## Migrate `Modifier.swipeable` to `Modifier.anchoredDraggable`

[`Modifier.anchoredDraggable()`](/reference/kotlin/androidx/compose/foundation/gestures/package-summary#(androidx.compose.ui.Modifier).anchoredDraggable(androidx.compose.foundation.gestures.AnchoredDraggableState,androidx.compose.foundation.gestures.Orientation,kotlin.Boolean,kotlin.Boolean,androidx.compose.foundation.interaction.MutableInteractionSource)) replaces [`Modifier.swipeable`](/reference/kotlin/androidx/compose/material/swipeable.modifier#(androidx.compose.ui.Modifier).swipeable(androidx.compose.material.SwipeableState,kotlin.collections.Map,androidx.compose.foundation.gestures.Orientation,kotlin.Boolean,kotlin.Boolean,androidx.compose.foundation.interaction.MutableInteractionSource,kotlin.Function2,androidx.compose.material.ResistanceConfig,androidx.compose.ui.unit.Dp))(). Some
of `Modifier.swipeable()`'s parameters have moved to `AnchoredDraggableState`
directly, as described in the following sections.

### Define anchors

Define the anchors using the [`DraggableAnchors`](/reference/kotlin/androidx/compose/foundation/gestures/DraggableAnchors) builder method. Then, pass
...
separate [`ThresholdConfig`](/reference/kotlin/androidx/compose/material/ThresholdConfig) interface, `AnchoredDraggableState` has a
