...
and the [`SwipeToDismiss`](https://developer.android.com/reference/kotlin/androidx/compose/material3/SwipeToDismiss.composable) component contains swiping logic to dismiss an
