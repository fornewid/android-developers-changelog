---
title: Geometry APIs  |  Jetpack Compose  |  Android Developers
...
Draw a stroke](/develop/ui/compose/touch-input/stylus-input/ink-api-draw-stroke)

[Next

Manage state and storage

arrow\_forward](/develop/ui/compose/touch-input/stylus-input/ink-api-state-preservation)