---
title: Setup  |  Jetpack Compose  |  Android Developers
...
About the Ink API](/develop/ui/compose/touch-input/stylus-input/about-ink-api)

[Next

Pick your module

arrow\_forward](/develop/ui/compose/touch-input/stylus-input/ink-api-modules)