---
title: Modules  |  Jetpack Compose  |  Android Developers
...
The Compose [Authoring](/reference/kotlin/androidx/ink/authoring/compose/package-summary) module lets you capture user touch input and render it
as low-latency strokes on the screen in real time. This is achieved through
the [`InProgressStrokes`](/reference/kotlin/androidx/ink/authoring/compose/InProgressStrokes.composable#InProgressStrokes(androidx.ink.brush.Brush,kotlin.Function0,androidx.compose.ui.graphics.Matrix,androidx.compose.ui.graphics.Matrix,androidx.compose.ui.graphics.Path,androidx.ink.brush.TextureBitmapStore,kotlin.Function1)) composable, which processes motion events and displays
the strokes as they are drawn.

Once a stroke is completed, the composable notifies the client application using
an [`InProgressStrokesFinishedListener`](/reference/kotlin/androidx/ink/authoring/InProgressStrokesFinishedListener) callback. This allows the application
...
screen using the [rendering module](/reference/kotlin/androidx/ink/rendering/android/canvas/package-summary).
...
`CanvasStrokeRenderer` instance, and then call the [`draw()`](/reference/kotlin/androidx/ink/rendering/android/canvas/CanvasStrokeRenderer#draw(android.graphics.Canvas,androidx.ink.strokes.InProgressStroke,androidx.ink.geometry.AffineTransform)) method to
...
Add dependencies](/develop/ui/compose/touch-input/stylus-input/ink-api-setup)

[Next

Define your brushes

arrow\_forward](/develop/ui/compose/touch-input/stylus-input/ink-api-brush-apis)