---
title: State preservation and persistent storage  |  Jetpack Compose  |  Android Developers
...
apps, especially in Compose.
The core data objects, such as brush properties and the points that form a
stroke, are complex and don't automatically persist.
This requires a deliberate strategy for saving state during scenarios like
...
[`remember`](/reference/kotlin/androidx/compose/runtime/package-summary#remember)
and
[`rememberSaveable`](/reference/kotlin/androidx/compose/runtime/saveable/rememberSaveable.composable#rememberSaveable(kotlin.Array,androidx.compose.runtime.saveable.Saver,kotlin.String,kotlin.Function0)).
While
[`rememberSaveable`](/reference/kotlin/androidx/compose/runtime/saveable/rememberSaveable.composable#rememberSaveable(kotlin.Array,androidx.compose.runtime.saveable.Saver,kotlin.String,kotlin.Function0))
...
[`Brush`](/reference/kotlin/androidx/ink/brush/Brush), you must define explicit
serialization and deserialization mechanisms using a custom state saver. By
defining a custom [`Saver`](/reference/kotlin/androidx/compose/runtime/saveable/Saver)
...
You can then use the custom [`Saver`](/reference/kotlin/androidx/compose/runtime/saveable/Saver) to
...
Create interactive tools with the Geometry APIs](/develop/ui/compose/touch-input/stylus-input/ink-api-geometry-apis)

[Next

Choose your epsilon and coordinate system

arrow\_forward](/develop/ui/compose/touch-input/stylus-input/ink-api-coordinate-system)