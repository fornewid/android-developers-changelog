---
title: Epsilon and coordinate system  |  Jetpack Compose  |  Android Developers
...
you pass to [`InProgressStrokesView.startStroke()`](/reference/kotlin/androidx/ink/authoring/InProgressStrokesView#startStroke(androidx.ink.strokes.StrokeInput,androidx.ink.brush.Brush,android.graphics.Matrix)) and the similar transform
...
For portability across different screen sizes and [device densities](/training/multiscreen/screendensities), the world
...
Manage state and storage](/develop/ui/compose/touch-input/stylus-input/ink-api-state-preservation)