---
title: Advanced stylus features  |  Jetpack Compose  |  Android Developers
...
modifier to a drawing surface. Implement a [`ViewModel`](/reference/kotlin/androidx/lifecycle/ViewModel) class with a method
...
* [Create a note-taking app](/develop/ui/compose/touch-input/stylus-input/create-a-note-taking-app)
...
arrow\_forward](/develop/ui/compose/touch-input/stylus-input/create-a-note-taking-app)