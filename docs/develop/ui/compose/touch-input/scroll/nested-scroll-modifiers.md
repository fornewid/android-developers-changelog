---
title: Nested scrolling modifiers  |  Jetpack Compose  |  Android Developers
...
# Nested scrolling modifiers Stay organized with collections Save and categorize content based on your preferences.
...
![Two nested vertical scrolling UI elements, responding to gestures inside and outside the inner element](/static/develop/ui/compose/images/gestures-simple-nested-scroll.gif)


**Figure 1.** Two nested vertical scrolling UI elements, responding to gestures inside and outside the inner element.

## Using the `nestedScroll` modifier

If you need to create an advanced coordinated scroll between multiple elements,
the
[`nestedScroll`](/reference/kotlin/androidx/compose/ui/input/nestedscroll/nestedScroll.modifier#(androidx.compose.ui.Modifier).nestedScroll(androidx.compose.ui.input.nestedscroll.NestedScrollConnection,androidx.compose.ui.input.nestedscroll.NestedScrollDispatcher))
...
cycle](/static/develop/ui/compose/images/pointer-input/nested-scrolling-phases-example.jpeg)


**Figure 2.** Phases of the nested scrolling cycle.
...
up](/static/develop/ui/compose/images/pointer-input/prescroll-phase.jpeg)


**Figure 3.** Pre-scroll phase: dispatching up.
...
down](/static/develop/ui/compose/images/pointer-input/prescroll-phase-2.jpeg)


**Figure 4.** Pre-scroll phase - bubbling down.
...
![Node consumption
phase](/static/develop/ui/compose/images/pointer-input/node-consumption.jpeg)


**Figure 5.** Node consumption phase.
...
up](/static/develop/ui/compose/images/pointer-input/post-scroll.jpeg)


**Figure 6.** Post-scroll phase - dispatching up.
...
down](/static/develop/ui/compose/images/pointer-input/post-scroll-2.jpeg)


**Figure 7.** Post-scroll phase - bubbling down.
...
[`NestedScrollConnection`](/reference/kotlin/androidx/compose/ui/input/nestedscroll/NestedScrollConnection)
...
[`NestedScrollSource`](/reference/kotlin/androidx/compose/ui/input/nestedscroll/NestedScrollSource)
type.

[`NestedScrollDispatcher`](/reference/kotlin/androidx/compose/ui/input/nestedscroll/NestedScrollDispatcher)
...
This snippet demonstrates resizing an image within a [`LazyColumn`](/develop/ui/compose/lists) based on
...
AnimateImageSnippets.kt
```

### Key points about the code

* This code uses a [`NestedScrollConnection`](/reference/kotlin/androidx/compose/foundation/verticalScroll.modifier#(androidx.compose.ui.Modifier).verticalScroll(androidx.compose.foundation.ScrollState,kotlin.Boolean,androidx.compose.foundation.gestures.FlingBehavior,kotlin.Boolean)) to intercept scroll events.
* [`onPreScroll`](/reference/kotlin/androidx/compose/foundation/horizontalScroll.modifier#(androidx.compose.ui.Modifier).horizontalScroll(androidx.compose.foundation.ScrollState,kotlin.Boolean,androidx.compose.foundation.gestures.FlingBehavior,kotlin.Boolean)) calculates the change in image size based on the scroll
  delta.
* The `currentImageSize` state variable stores the current size of the image,
  constrained between `minImageSize` and `maxImageSize. imageScale` derives from
  the `currentImageSize`.
* The [`LazyColumn`](/develop/ui/compose/lists) offsets based on the `currentImageSize`.
* The [`Image`](/reference/kotlin/androidx/compose/foundation/ScrollState) uses a [`graphicsLayer`](/reference/kotlin/androidx/compose/foundation/rememberScrollState.composable#rememberScrollState(kotlin.Int)) modifier to apply the calculated
  scale.
* The `translationY` within the `graphicsLayer` ensures the image remains
  centered vertically as it scales.
...
](/static/develop/ui/compose/images/pointer-input/ImageResizeOnScrollExample.mp4)
...
[`NestedScrollingParent3`](/reference/kotlin/androidx/core/view/NestedScrollingParent3),
...
[`NestedScrollingChild3`](/reference/kotlin/androidx/core/view/NestedScrollingChild3).
...
[`rememberNestedScrollInteropConnection()`](/reference/kotlin/androidx/compose/ui/platform/package-summary#rememberNestedScrollInteropConnection()).
...
scrolling](/develop/ui/compose/touch-input/pointer-input/scroll#nestedscroll-modifier) for more detailed
information.
...
* [Create a button to enable snap scrolling](/develop/ui/compose/quick-guides/content/enable-snap-scrolling)
* [Create a parallax scrolling effect](/develop/ui/compose/quick-guides/content/parallax-scrolling)
...
Scroll modifiers](/develop/ui/compose/touch-input/scroll/scroll-modifiers)

[Next

Two-dimensional scrolling

arrow\_forward](/develop/ui/compose/touch-input/scroll/two-dimensional-scrolling)