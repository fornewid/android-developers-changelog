---
title: Build adaptive apps  |  Jetpack Compose  |  Android Developers
...
](/static/develop/ui/compose/images/layouts/adaptive/build-adaptive-apps/adaptive_app.mp4)


**Figure 1.** Adaptive app optimizes layout for different window sizes.
...
apps. Play bases the ranking on the [large screen app quality guidelines](/docs/quality-guidelines/large-screen-app-quality).
...
![Google Play store listing for an app with a warning that says 'May not be optimized for your device'.](/static/develop/ui/compose/images/layouts/adaptive/build-adaptive-apps/app_with_Play_warning_message.png)


**Figure 2.** Technical quality warning on app details page.
...
[Window size classes](/develop/ui/compose/layouts/adaptive/window-size-classes) categorize app windows as *compact*, *medium*, or
*expanded* based on window width or height.

![Depiction of the compact, medium, and expanded width window size classes.](/static/develop/ui/compose/images/layouts/adaptive/window-size-classes/window_size_classes_width.png)


**Figure 3.** Window size classes based on display width.

**Note:** Because vertical scrolling is commonplace, window width is typically the
main consideration in determining window size class.

Compute your app's [`WindowSizeClass`](/reference/androidx/window/core/layout/WindowSizeClass) using the
[`currentWindowAdaptiveInfo()`](/reference/kotlin/androidx/compose/material3/adaptive/package-summary#currentWindowAdaptiveInfo()) top‑level function of the [Compose
Material 3 Adaptive library](/reference/kotlin/androidx/compose/material3/adaptive/package-summary). The function returns an instance of
[`WindowAdaptiveInfo`](/reference/kotlin/androidx/compose/material3/adaptive/WindowAdaptiveInfo), which contains [`windowSizeClass`](/reference/kotlin/androidx/compose/material3/adaptive/WindowAdaptiveInfo#windowSizeClass()). Your app
...
![Device screens split into panes: one pane in compact and medium window size classes, two panes in expanded window size class.](/static/develop/ui/compose/images/layouts/adaptive/build-adaptive-apps/panes_for_window_size_classes.png)


**Figure 4.** Number of content panes per window size class.
...
The [Compose Material 3 Adaptive library](/reference/kotlin/androidx/compose/material3/adaptive/package-summary) contains composables that manage
window size classes, navigation components, multi‑pane layouts, and
foldable postures and hinge location, for example:

* [`NavigationSuiteScaffold`](/reference/kotlin/androidx/compose/material3/adaptive/navigationsuite/NavigationSuiteScaffold.composable): Automatically switches between navigation bar
  and navigation rail depending on app window size class and device posture.
* [`ListDetailPaneScaffold`](/reference/kotlin/androidx/compose/material3/adaptive/layout/ListDetailPaneScaffold.composable): Implements the [list-detail canonical
  layout](/guide/topics/large-screens/large-screen-canonical-layouts#list-detail).
  ...
  classes.
* [`SupportingPaneScaffold`](/reference/kotlin/androidx/compose/material3/adaptive/layout/SupportingPaneScaffold.composable): Implements the [supporting pane canonical
  layout](/guide/topics/large-screens/large-screen-canonical-layouts#supporting_pane).
...
activity's [`onSaveInstanceState()`](/reference/kotlin/android/app/Activity#onsaveinstancestate_1) method or in a [`ViewModel`](/reference/kotlin/androidx/lifecycle/ViewModel).
...
![A foldable phone in tabletop mode, with the bottom half of the screen resting on a surface and the top half upright.](/static/develop/ui/compose/images/layouts/adaptive/build-adaptive-apps/foldable_in_tabletop_posture.png)


**Figure 7.** Foldable device in tabletop posture.

The [`WindowInfoTracker`](/reference/kotlin/androidx/window/layout/WindowInfoTracker) interface in Jetpack WindowManager lets you to
obtain a list of [`DisplayFeature`](/reference/kotlin/androidx/window/layout/DisplayFeature) objects for the device. Among the display
features is [`FoldingFeature.State`](/reference/kotlin/androidx/window/layout/FoldingFeature.State), which indicates whether the device is
fully or half open.

The Compose Material 3 Adaptive library provides the
[`currentWindowAdaptiveInfo()`](/reference/kotlin/androidx/compose/material3/adaptive/package-summary#currentWindowAdaptiveInfo()) top‑level function, which returns an
instance of [`WindowAdaptiveInfo`](/reference/kotlin/androidx/compose/material3/adaptive/WindowAdaptiveInfo) containing [`windowPosture`](/reference/kotlin/androidx/compose/material3/adaptive/WindowAdaptiveInfo#windowPosture()).
...
* Jetpack [`androidx.compose.material3`](/reference/kotlin/androidx/compose/material3/package-summary) library: Enables users to write
  into any [`TextField`](/reference/kotlin/androidx/compose/material/TextField.composable#TextField(androidx.compose.ui.text.input.TextFieldValue,kotlin.Function1,androidx.compose.ui.Modifier,kotlin.Boolean,kotlin.Boolean,androidx.compose.ui.text.TextStyle,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Function0,kotlin.Boolean,androidx.compose.ui.text.input.VisualTransformation,androidx.compose.foundation.text.KeyboardOptions,androidx.compose.foundation.text.KeyboardActions,kotlin.Boolean,kotlin.Int,kotlin.Int,androidx.compose.foundation.interaction.MutableInteractionSource,androidx.compose.ui.graphics.Shape,androidx.compose.material.TextFieldColors)) component using a stylus.
* [Keyboard Shortcuts Helper](/develop/ui/compose/touch-input/keyboard-input/keyboard-shortcuts-helper): Makes Android platform and app keyboard
...
[Test different screen and window sizes](/training/testing/different-screens) and different device configurations.
...
The [large screen app quality guidelines](/docs/quality-guidelines/large-screen-app-quality) help you verify that your adaptive
...
The [`DeviceConfigurationOverride`](/reference/kotlin/androidx/compose/ui/test/DeviceConfigurationOverride) interface in Compose 1.7 and higher
...
With the [`DeviceConfigurationOverride.then()`](/reference/kotlin/androidx/compose/ui/test/DeviceConfigurationOverride#(androidx.compose.ui.test.DeviceConfigurationOverride).then(androidx.compose.ui.test.DeviceConfigurationOverride)) extension function, you can
...
Studio. Previews use annotations, such as [`@PreviewScreenSizes`](/reference/kotlin/androidx/compose/ui/tooling/preview/PreviewScreenSizes),
[`@PreviewFontScale`](/reference/kotlin/androidx/compose/ui/tooling/preview/PreviewFontScale), and [`@PreviewLightDark`](/reference/kotlin/androidx/compose/ui/tooling/preview/PreviewLightDark) to let you see composable
...
* Resizable emulator: Emulates a phone, tablet, or foldable device and lets
  you switch between them on the fly
...
* Desktop emulator: Lets you test free-form windowing, mouse hover, and
  keyboard shortcuts
...
see [Android Device Streaming, powered by Firebase](/studio/run/android-device-streaming).
