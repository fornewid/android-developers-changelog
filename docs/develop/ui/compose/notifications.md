...
3. Time stamp: provided by the system, but you can override it using `https://developer.android.com/reference/androidx/core/app/NotificationCompat.Builder#setWhen(long)` or hide it using `https://developer.android.com/reference/androidx/core/app/NotificationCompat.Builder#setShowWhen(boolean)`.
