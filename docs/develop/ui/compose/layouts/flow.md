---
title: Flow layouts in Compose  |  Android Developers
...
more space available.](/static/develop/ui/compose/images/layouts/flow/flow_row_simple.png)
...
| [`Arrangement.Start`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#Start()) (`Default`) | Items arranged with start |
| [`Arrangement.SpaceBetween`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#SpaceBetween()) | Items arrangement with space in between |
| [`Arrangement.Center`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#Center()) | Items arranged in the center |
| [`Arrangement.End`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#End()) | Items arranged at the end |
| [`Arrangement.SpaceAround`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#SpaceAround()) | Items arranged with space around them |
| [`Arrangement.spacedBy(8.dp)`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#spacedBy(androidx.compose.ui.unit.Dp)) | Items spaced by a certain dp |
...
| [`Arrangement.Top`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#Top()) (`Default`) | Container top arrangement |
| [`Arrangement.Bottom`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#Bottom()) | Container bottom arrangement |
| [`Arrangement.Center`](/reference/kotlin/androidx/compose/foundation/layout/Arrangement#Center()) | Container center arrangement |
...
| [`Alignment.Top`](/reference/kotlin/androidx/compose/ui/Alignment#Top()) (`Default`) | Items aligned to the top |
| [`Alignment.Bottom`](/reference/kotlin/androidx/compose/ui/Alignment#Bottom()) | Items aligned to the bottom |
| [`Alignment.CenterVertically`](/reference/kotlin/androidx/compose/ui/Alignment#CenterVertically()) | Items aligned to the center |
...
![Grid created with flow row](/static/develop/ui/compose/images/layouts/flow/flow_layout_grid_blue.png)


**Figure 2.** Using `FlowRow` to create a grid
...
![Last item full size on grid](/static/develop/ui/compose/images/layouts/flow/flow_layout_grid_last_item_large.png)


**Figure 3.** Using `FlowRow` to create a grid with the last item taking up full width
...
![Alternating grid with flow row](/static/develop/ui/compose/images/layouts/flow/flow_row_alternating_grid.png)


**Figure 4.** `FlowRow` with alternating sizes of rows
...
|  |  |
| --- | --- |
| `FlowRow`: Middle item with 0.7 fraction of whole container width. | Fractional width with flow row |
| `Row`: Middle item taking up 0.7 percent of remaining `Row` width. | Fractional width with row |

### `fillMaxColumnWidth()` and `fillMaxRowHeight()`

Applying either [`Modifier.fillMaxColumnWidth()`](/reference/kotlin/androidx/compose/foundation/layout/FlowColumnScope#(androidx.compose.ui.Modifier).fillMaxColumnWidth(kotlin.Float)) or
[`Modifier.fillMaxRowHeight()`](/reference/kotlin/androidx/compose/foundation/layout/FlowRowScope#(androidx.compose.ui.Modifier).fillMaxRowHeight(kotlin.Float)) to an item inside a `FlowColumn` or `FlowRow`
...
|  |  |
| --- | --- |
| `Modifier.fillMaxColumnWidth()` applied to each item | fillMaxColumnWidth |
| No width changes set (wrapping items) | No fill max column width set |

## Recommended for you

* Note: link text is displayed when JavaScript is off
* [Compose layout basics](/jetpack/compose/layouts/basics)
* [ConstraintLayout in Compose](/jetpack/compose/layouts/constraintlayout)
* [Editor actions {:#editor-actions}](/jetpack/compose/tooling/editor-actions)

[Previous

arrow\_back

Pager](/develop/ui/compose/layouts/pager)

[Next

Custom layouts

arrow\_forward](/develop/ui/compose/layouts/custom)