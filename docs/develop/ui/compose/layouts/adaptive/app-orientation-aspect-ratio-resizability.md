...
* **Build responsive layouts:** Within window size classes, [responsive
  layouts](/develop/ui/compose/layouts/adaptive/support-different-display-sizes) adjust to changes in display dimensions to always create an
  optimal app presentation.
