...
* **Media apps:** A [streaming video and a list of related videos](/large-screens/gallery/media#media-exploration)
...
Compose supports window size class logic, which lets you to determine whether to
show both the main content and the supporting content at the same time or place
the supporting content in an alternative location.
