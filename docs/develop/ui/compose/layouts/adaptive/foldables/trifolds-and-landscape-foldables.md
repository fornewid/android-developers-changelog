...
[`currentWindowAdaptiveInfo()`](/reference/kotlin/androidx/compose/material3/adaptive/currentWindowAdaptiveInfo.composable#currentWindowAdaptiveInfo(kotlin.Boolean)) function, then using the corresponding
