...
outlined in the [Large screen app quality](https://developer.android.com/docs/quality-guidelines/large-screen-app-quality) guidelines, the app should
...
differentiated)** of the [Large screen app quality](https://developer.android.com/docs/quality-guidelines/large-screen-app-quality) guidelines ensures your
...
For more information, see the [Camera preview](https://developer.android.com/media/camera/camera2/camera-preview) developer guide and
...
library; instead, use an [Intent](https://developer.android.com/reference/android/content/Intent).
...
[Restrict app orientation on phones](https://developer.android.com/develop/ui/compose/quick-guides/content/restrict-app-orientation-on-phones).
...
To fix this issue, check the current [Display.getRotation()](https://developer.android.com/reference/android/view/Display#getRotation()) and remap the axes
accordingly:
...
preview](https://developer.android.com/guide/practices/device-compatibility-mode#camera_preview), [overrides](https://developer.android.com/guide/practices/device-compatibility-mode#per-app_overrides), and [Android 16 API changes](https://developer.android.com/guide/practices/device-compatibility-mode#android_16) that could change
your app behavior.

To learn more about building adaptive apps, see [Large screen app quality](https://developer.android.com/docs/quality-guidelines/large-screen-app-quality).