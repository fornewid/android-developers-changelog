---
title: Support foldable display modes  |  Jetpack Compose  |  Android Developers
...
![](/static/develop/ui/compose/images/layouts/adaptive/foldables/rear-display-dialog.png)
...
Jetpack WindowManager](/codelabs/android-camera-foldables).
...
![](/static/develop/ui/compose/images/layouts/adaptive/foldables/dual-screen-interpreter.png)
...
WindowManager](/jetpack/androidx/releases/window) APIs, starting from library version 1.2.0-beta03.
...
The entry point is the [`WindowAreaController`](/reference/kotlin/androidx/window/area/WindowAreaController), which provides the
...
available [`WindowAreaInfo`](/reference/kotlin/androidx/window/area/WindowAreaInfo) objects.

Use `WindowAreaInfo` to access the [`WindowAreaSession`](/reference/kotlin/androidx/window/area/WindowAreaSession), an interface that
represents an active window area feature. Use `WindowAreaSession` to determine
the availability of a specific [`WindowAreaCapability`](/reference/kotlin/androidx/window/area/WindowAreaCapability).

Each capability is related to a particular [`WindowAreaCapability.Operation`](/reference/kotlin/androidx/window/area/WindowAreaCapability.Operation).
In version 1.2.0-beta03, Jetpack WindowManager supports two kinds of operations:

* [`WindowAreaCapability.Operation.OPERATION_PRESENT_ON_AREA`](/reference/kotlin/androidx/window/area/WindowAreaCapability.Operation#OPERATION_PRESENT_ON_AREA()), which is
  used to start dual‑screen mode
* [`WindowAreaCapability.Operation.OPERATION_TRANSFER_ACTIVITY_TO_AREA`](/reference/kotlin/androidx/window/area/WindowAreaCapability.Operation#OPERATION_TRANSFER_ACTIVITY_TO_AREA()),
...
**Note:** The Kotlin code uses the [`Flow`](https://kotlinlang.org/api/kotlinx.coroutines/kotlinx-coroutines-core/kotlinx.coroutines.flow/-flow/) approach of
[`WindowAreaController.windowAreaInfos`](/reference/kotlin/androidx/window/area/WindowAreaController#windowAreaInfos()), while the Java code is based on
[`WindowAreaControllerCallbackAdapter`](/reference/androidx/window/java/area/WindowAreaControllerCallbackAdapter).
...
otherwise calls the [`presentContentOnWindowArea()`](/reference/kotlin/androidx/window/area/WindowAreaController#presentContentOnWindowArea(android.os.Binder,android.app.Activity,java.util.concurrent.Executor,androidx.window.area.WindowAreaPresentationSessionCallback)) function:
...
[`WindowAreaPresentationSessionCallback`](/reference/kotlin/androidx/window/area/WindowAreaPresentationSessionCallback) argument.
...
through the listener's [`onSessionStarted()`](/reference/kotlin/androidx/window/area/WindowAreaPresentationSessionCallback#onSessionStarted(androidx.window.area.WindowAreaSessionPresenter)) method. When you close the
session, you get a confirmation in the [`onSessionEnded()`](/reference/kotlin/androidx/window/area/WindowAreaPresentationSessionCallback#onSessionEnded(kotlin.Throwable)) method.
...
**Note:** `WindowAreaPresentationSessionCallback` is a Java API located in the
`androidx.window:window` package (rather than `androidx.window:window-java`) to
enable Kotlin access.

The listener needs to implement the `onSessionStarted()`, `onSessionEnded(),`
and [`onContainerVisibilityChanged()`](/reference/kotlin/androidx/window/area/WindowAreaPresentationSessionCallback#onContainerVisibilityChanged(kotlin.Boolean)) methods. The callback methods notify
you of the session status and enable you to update the app accordingly.

The `onSessionStarted()` callback receives a [`WindowAreaSessionPresenter`](/reference/kotlin/androidx/window/area/WindowAreaSessionPresenter) as
...
closed by calling [`WindowAreaSessionPresenter#close()`](/reference/kotlin/androidx/window/area/WindowAreaSession#close()).
...
already active, or otherwise calls the [`transferActivityToWindowArea()`](/reference/kotlin/androidx/window/area/WindowAreaController#transferActivityToWindowArea(android.os.Binder,android.app.Activity,java.util.concurrent.Executor,androidx.window.area.WindowAreaSessionCallback))
function:
...
* [Optimize your camera app on foldable devices with Jetpack WindowManager](/codelabs/android-camera-foldables)
  codelab
* [`androidx.window.area`](/reference/androidx/window/area/package-summary) package summary
...
arrow\_forward](/develop/ui/compose/layouts/adaptive/foldables/trifolds-and-landscape-foldables)