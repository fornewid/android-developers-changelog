---
title: Learn about foldables  |  Jetpack Compose  |  Android Developers
...
![](/static/develop/ui/compose/images/layouts/adaptive/foldables/foldable_multiple_postures.png)
...
responsive design with the [`BoxWithConstraints`](/reference/kotlin/androidx/compose/foundation/layout/BoxWithConstraints.composable#BoxWithConstraints(androidx.compose.ui.Modifier,androidx.compose.ui.Alignment,kotlin.Boolean,kotlin.Function1)) composable.
...
](/develop/ui/compose/images/layouts/adaptive/foldables/fold_unfold_poster.png)](/static/develop/ui/compose/images/layouts/adaptive/foldables/fold_unfold.mp4)


**Figure 2.** Adaptive layouts optimized for both folded and unfolded screens.
...
![](/static/develop/ui/compose/images/layouts/adaptive/foldables/foldable_postures_flat_and_half_opened.png)
...
arrow\_forward](/develop/ui/compose/layouts/adaptive/foldables/make-your-app-fold-aware)