...
on a card, integrate it with the [`SwipeToDismissBox`](/reference/kotlin/androidx/compose/material3/SwipeToDismissBox.composable) composable. To integrate
...
documentation](/develop/ui/compose/touch-input/scroll/scroll-modifiers) for more information.
