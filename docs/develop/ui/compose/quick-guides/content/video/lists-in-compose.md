...
[Video](https://www.youtube.com/watch?v=BhqPpUYJYeQ)

## Key points

- The [`LazyColumn`](https://developer.android.com/reference/kotlin/androidx/compose/foundation/lazy/LazyColumn.composable) API is built as a DSL, differing from other layouts in Compose.
