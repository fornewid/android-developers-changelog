---
title: Create a floating action button (FAB)  |  Jetpack Compose  |  Android Developers
...
# Create a floating action button (FAB) Stay organized with collections Save and categorize content based on your preferences.
...
* [Extended FAB](#extended): A floating action button that contains more than
  just an icon.
