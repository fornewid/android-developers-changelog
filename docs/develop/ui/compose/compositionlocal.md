---
title: Locally scoped data with CompositionLocal  |  Jetpack Compose  |  Android Developers
...
Usually in Compose, [data flows down](/develop/ui/compose/architecture) through
...
most composables, **Compose offers [`CompositionLocal`](/reference/kotlin/androidx/compose/runtime/CompositionLocal), which allows you
...
[`MaterialTheme`](/reference/kotlin/androidx/compose/material3/MaterialTheme) is
...
can provide different values at different levels of the tree. The [`current`](/reference/kotlin/androidx/compose/runtime/CompositionLocal#current()) value
...
and its [`provides`](/reference/kotlin/androidx/compose/runtime/ProvidableCompositionLocal#provides(kotlin.Any))
...
As an example of this, the [`LocalContentColor`](/reference/kotlin/androidx/compose/material3/LocalContentColor) `CompositionLocal` contains
...
![Preview of the CompositionLocalExample composable.](/static/develop/ui/compose/images/compositionlocal-color.png)
...
use its [`current`](/reference/kotlin/androidx/compose/runtime/CompositionLocal#current())
property. In the following example, the current [`Context`](/reference/android/content/Context) value of the
[`LocalContext`](/reference/kotlin/androidx/compose/ui/platform/LocalContext) `CompositionLocal` that is commonly used in Android apps is
...
**Note:** `CompositionLocal` objects or constants are usually prefixed with `Local`
to allow better discoverability with auto-complete in the IDE.
...
usages* in the IDE or the [Compose layout inspector](/develop/ui/compose/tooling#layout-inspector) provide enough
...
[Alternatives to consider](#alternatives) section before creating a
`CompositionLocal`.
...
that they need following the pattern that [state flows down and events flow up](/develop/ui/compose/architecture). This approach will make your composables more
...
* [`compositionLocalOf`](/reference/kotlin/androidx/compose/runtime/package-summary#compositionLocalOf(androidx.compose.runtime.SnapshotMutationPolicy,kotlin.Function0)):
  Changing the value provided during recomposition invalidates *only*
  the content that reads its
  [`current`](/reference/kotlin/androidx/compose/runtime/CompositionLocal#current()) value.
* [`staticCompositionLocalOf`](/reference/kotlin/androidx/compose/runtime/package-summary#staticCompositionLocalOf(kotlin.Function0)):
...
**The [`CompositionLocalProvider`](/reference/kotlin/androidx/compose/runtime/CompositionLocalProvider.composable#CompositionLocalProvider(kotlin.Array,kotlin.Function0))
...
[`provides`](/reference/kotlin/androidx/compose/runtime/ProvidableCompositionLocal#provides(kotlin.Any))
...
[`CompositionLocal.current`](/reference/kotlin/androidx/compose/runtime/ProvidableCompositionLocal#current()) returns the value provided by the nearest
...
CompositionLocal](#deciding) section, another solution might likely be better
