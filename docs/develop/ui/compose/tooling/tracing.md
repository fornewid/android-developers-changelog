---
title: Composition tracing  |  Jetpack Compose  |  Android Developers
...
If you are using the [Compose BOM](/develop/ui/compose/bom), you don't have to specify the version:
...
4. Use your app to cause recomposition and stop recording. Once the trace has
   ...
   [Record traces](/studio/profile/record-traces#ui-shortcuts) documentation.

   ![System trace](/static/develop/ui/compose/images/performance/tracing-4.png)
...
5. You can also see composables in the Flame Chart along with the file and line
   ...
   ![Flame chart](/static/develop/ui/compose/images/performance/tracing-5.png)
...
the Compose [release notes](/jetpack/androidx/releases/compose-compiler).
...
app `profileable` and `non-debuggable` as per [Profileable applications](/studio/profile#profileable-apps).
...
You can measure performance with [Jetpack Macrobenchmark](/macrobenchmark),
...
2. Add `androidx.benchmark.fullTracing.enable=true` instrumentation argument
   ...
   arguments](/topic/performance/benchmarking/macrobenchmark-instrumentation-args#fulltracing) for more information about Macrobenchmark
...
Overview](/develop/ui/compose/tooling/debug)

[Next

Stack traces

arrow\_forward](/develop/ui/compose/tooling/stacktraces)