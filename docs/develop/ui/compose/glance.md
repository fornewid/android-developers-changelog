...
the home screen with less code. The pages in this documentation set describe
...
Before you start, make sure you have the [Glance dependencies](https://developer.android.com/jetpack/androidx/releases/glance) in your
project.

## Additional resources

For more information about canonical layouts, see
[Canonical widget layouts](https://developer.android.com/design/ui/mobile/guides/widgets/layouts). For more information about making your widget
high quality and discoverable, see [Widget quality](https://developer.android.com/docs/quality-guidelines/widget-quality).

> [!CAUTION]
> **Caution:** Glance requires Compose to be enabled and depends on Runtime, Graphics, and Unit [UI Compose layers](https://developer.android.com/develop/ui/compose/layering), but it's *not directly
> interoperable* with other existing Jetpack Compose UI elements. Avoid mixing the two.