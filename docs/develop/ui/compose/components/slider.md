---
title: Slider  |  Jetpack Compose  |  Android Developers
...
![A slider with thumb, track and tick marks.](/static/develop/ui/compose/images/components/slider.png)
...
![A discrete slider with a range from 0 to 50, showing five tick marks at equal intervals. The thumb is positioned near the second tick mark, indicating a selected value of 16.](/static/develop/ui/compose/images/components/slider-advanced.png)
...
are also intervals the user can select.**Note:** You can also pass `Slider` a `thumb` and `track` composable to more
