...
fun DialUseStateExample(
    ...
    Column {
        ...
        Button(onClick = { onConfirm(timePickerState) }) {
            Text("Confirm selection"https://github.com/android/snippets/blob/0e26519d6d4e3c3ff70cf0806b9a2df65d3929b6/compose/snippets/src/main/java/com/example/compose/snippets/components/TimePickers.kt#L236-L260   }
}TimePickers.kt
```
