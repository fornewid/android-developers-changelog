---
title: Card  |  Jetpack Compose  |  Android Developers
...
![An elevated card populated with text and icons.](/static/develop/ui/compose/images/components/card.svg)
...
each item inside the card below one another.
...
on a card, integrate it with the [`SwipeToDismiss`](/reference/kotlin/androidx/compose/material3/SwipeToDismissBox.composable) composable. To integrate
