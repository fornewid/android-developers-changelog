---
title: Autofill in Compose  |  Jetpack Compose  |  Android Developers
...
* The system displays Autofill suggestions for the user when they tap into a
  field where Autofill semantics are set.
* The system displays Autofill suggestions for the user and filters them
...
* The system triggers a save dialog, which prompts the user to save information
  when they input new or updated information into an Autofill-enabled field.
...
* Depending on your credential provider, the system may suggest a strong
  password to the user when a field has `ContentType.NewPassword` set.
...
![A settings page that shows how to specify a credential provider.](/static/develop/ui/compose/images/text/autofill_image_1.png)


**Figure 1.** A settings page showing how to specify a
credential provider.
...
[`ContentType`](/reference/kotlin/androidx/compose/ui/autofill/ContentType#summary) [reference](/reference/kotlin/androidx/compose/ui/autofill/ContentType#summary).
...
![Chips in the text toolbar showing saved credentials.](/static/develop/ui/compose/images/text/autofill_image_5.png)


**Figure 2.** Chips in the text toolbar showing saved
credentials.
...
- In your `TextField(s)`, add your chosen content type through
  `Modifier.semantics`:
...
![Bottom sheet prompting users to save password.](/static/develop/ui/compose/images/text/autofill_image_2.png)
...
![The suggest strong password chip in the keyboard toolbar.](/static/develop/ui/compose/images/text/autofill_image_3.png)


**Figure 4.** The suggest strong password chip in the keyboard
toolbar.


![Bottom sheet prompting users to use strong password.](/static/develop/ui/compose/images/text/autofill_image_4.png)


**Figure 5.** Bottom sheet prompting users to use strong
password.
...
![Bottom sheet prompting users to save password.](/static/develop/ui/compose/images/text/autofill_image_6.png)
...
To customize this highlight color, use [`CompositionLocal`](/develop/ui/compose/compositionlocal) and provide
