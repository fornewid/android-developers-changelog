...
- `edit`: Lets you edit the state contents and gives you `TextFieldBuffer`
  ...
  // textFieldState.text : I love Compose!!!!
  // textFieldState.selection: TextRange(0, 18)https://github.com/android/snippets/blob/2e71c4f00839800811b83aa43bf03a99b6f95b73/compose/snippets/src/main/java/com/example/compose/snippets/text/StateBasedText.kt#L181-L195
  ```
...
- `setTextAndPlaceCursorAtEnd`: Clears the current text, replaces it with the
  ...
  // textFieldState.selection : TextRange(21, 21)https://github.com/android/snippets/blob/2e71c4f00839800811b83aa43bf03a99b6f95b73/compose/snippets/src/main/java/com/example/compose/snippets/text/StateBasedText.kt#L199-L201
  ```
...
- `clearText`: Clears all text.
  ...
  // textFieldState.text :
  // textFieldState.selection : TextRange(0, 0)https://github.com/android/snippets/blob/2e71c4f00839800811b83aa43bf03a99b6f95b73/compose/snippets/src/main/java/com/example/compose/snippets/text/StateBasedText.kt#L205-L207
  ```
