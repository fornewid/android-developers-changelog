---
title: Android XR  |  Android Developers
...
[Develop with Unity, OpenXR, or WebXR](https://developer.android.com/develop/xr#build-with)
...
[Start building for AI glasses](https://developer.android.com/develop/xr/jetpack-xr-sdk/ai-glasses/build)
...
Develop with familiar Android Studio tools. Use the Android XR emulator to test your app directly on either your machine using virtual devices for [XR headsets and wired XR glasses](/develop/xr/jetpack-xr-sdk/run/create-avds/xr-headsets-glasses) or [AI glasses](/develop/xr/jetpack-xr-sdk/run/create-avds/ai-glasses). Debug your app's layout using the Layout Inspector.
