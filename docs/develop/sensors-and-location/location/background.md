---
title: Access location in the background  |  Sensors and location  |  Android Developers
...
* Look for use of location access APIs, such as the [Fused Location Provider
  ...
  + [`JobIntentService`](/reference/kotlin/androidx/core/app/JobIntentService)
    objects
  + [`WorkManager`](/reference/kotlin/androidx/work/WorkManager) or
    [`JobScheduler`](/reference/kotlin/android/app/job/JobScheduler) tasks
...
Request location updates](/develop/sensors-and-location/location/request-updates)

[Next

Create and monitor geofences

arrow\_forward](/develop/sensors-and-location/location/geofencing)