...
permissions](https://developer.android.com/training/location/permissions) and [privacy best
practices](https://developer.android.com/privacy/best-practices) pages, apps should only ask for the type of
...
- In your app's manifest, check for the
  [`ACCESS_COARSE_LOCATION` permission](https://developer.android.com/reference/android/Manifest.permission#ACCESS_COARSE_LOCATION)
  and the
  [`ACCESS_FINE_LOCATION` permission](https://developer.android.com/reference/android/Manifest.permission#ACCESS_FINE_LOCATION).
  ...
  - If your app targets Android 10 (API level 29) or higher, also check for the [`ACCESS_BACKGROUND_LOCATION`
    permission](https://developer.android.com/training/location/receive-location-updates#request-background-location). Verify that your app has a feature that requires it.
- Look for use of location access APIs, such as the [Fused Location Provider
  ...
  [LocationManager API](https://developer.android.com/reference/android/location/LocationManager), within your
...
- If you don't need location access in the background, remove it.
  ...
  permission](https://developer.android.com/training/location/receive-location-updates#request-background-location)
...
- If possible, [refactor your location access
  logic](https://developer.android.com/about/versions/oreo/background-location-limits#tuning-behavior) so that
