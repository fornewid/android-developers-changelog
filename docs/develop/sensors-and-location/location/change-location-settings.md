---
title: Change location settings  |  Sensors and location  |  Android Developers
...
# Change location settings Stay organized with collections Save and categorize content based on your preferences.
...
:   [`setPriority()`](https://developers.google.com/android/reference/com/google/android/gms/location/LocationRequest.Builder#setPriority(int))
    ...
    * [`PRIORITY_BALANCED_POWER_ACCURACY`](https://developers.google.com/android/reference/com/google/android/gms/location/Priority#PRIORITY_BALANCED_POWER_ACCURACY)
      ...
      available.
    * [`PRIORITY_HIGH_ACCURACY`](https://developers.google.com/android/reference/com/google/android/gms/location/Priority#PRIORITY_HIGH_ACCURACY)
    ...
    * [`PRIORITY_LOW_POWER`](https://developers.google.com/android/reference/com/google/android/gms/location/Priority#PRIORITY_LOW_POWER)
    ...
    * [`PRIORITY_PASSIVE`](https://developers.google.com/android/reference/com/google/android/gms/location/Priority#PRIORITY_PASSIVE)
      ...
      receives locations triggered by other apps.
...
The next lesson,
[Request Location Updates](/develop/sensors-and-location/location/request-updates), shows
...
Get the last known location](/develop/sensors-and-location/location/retrieve-current)

[Next

Request location updates

arrow\_forward](/develop/sensors-and-location/location/request-updates)