---
title: Request location permissions  |  Sensors and location  |  Android Developers
...
# Request location permissions Stay organized with collections Save and categorize content based on your preferences.
...
[`getLocationPowerSaverMode()`](/reference/android/os/PowerManager#getLocationPowerSaveMode()) to check how the device's location features
behave when Battery Saver is active. If this returns
[`LOCATION_MODE_FOREGROUND_ONLY`](/reference/android/os/PowerManager#LOCATION_MODE_FOREGROUND_ONLY), your app will continue to receive
