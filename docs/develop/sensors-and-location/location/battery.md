---
title: About background location and battery life  |  Sensors and location  |  Android Developers
...
# About background location and battery life Stay organized with collections Save and categorize content based on your preferences.
...
* [Google Location Services.](https://developers.google.com/android/reference/com/google/android/gms/location/package-summary.html) These APIs offer higher accuracy and
  impose a lighter battery burden than the [framework location APIs](/reference/android/location/package-summary).
...
* [`PRIORITY_HIGH_ACCURACY`](https://developers.google.com/android/reference/com/google/android/gms/location/Priority#public-static-final-int-priority_high_accuracy) provides the most accurate location possible,
  ...
  and cell, and uses a variety of [Sensors](/guide/topics/sensors/sensors_overview)), and may cause significant
  battery drain.
...
* [Recommendations](/develop/sensors-and-location/location/battery/optimize): This guide lays out some concrete recommended
  actions you can use to improve your app's impact on battery life.
* [Use cases](/develop/sensors-and-location/location/battery/scenarios): This guide provides several common use cases
