---
title: https://developer.android.com/develop/sensors-and-location/sensors/gnss-analyze-raw
...
Following are tables from the[RINEX 4.01 spec](https://www.igs.org/wg/rinex/)for convenience. See the full specification for details.
