...
Signal strength, or carrier-to-noise ratio (C/N0), of the signal as well as the [automatic gain control (AGC)](https://developer.android.com/reference/android/location/GnssAutomaticGainControl) of the GNSS radio in the phone can be a good indicator of interference.
...
You can use the **Spoof/Jam** tab in the [GnssLogger](https://play.google.com/store/apps/details?id=com.google.android.apps.location.gps.gnsslogger) app to explore the impact of their environment on C/N0 and AGC in real-time.
...
Below the real-time plot of AGC and [C/N0](http://c/N0), the app displays a series of automated data checks that identify conditions related to GNSS interference.
...
Provide feedback on the **Spoof/Jam** feature using our [public issue tracker](https://issuetracker.google.com/issues/new?component=313183&template=0).