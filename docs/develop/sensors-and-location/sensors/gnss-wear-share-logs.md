---
title: Access and share logs from GnssLogger for Wear OS  |  Sensors and location  |  Android Developers
...
# Access and share logs from GnssLogger for Wear OS Stay organized with collections Save and categorize content based on your preferences.
...
![GnssLogger for Wear OS](/static/images/sensors/gnss-share5.png)
...
![Message on watch when starting to log](/static/images/sensors/gnss-share1.png)
...
![Download & Delete Watch Log Files button](/static/images/sensors/gnss-share-9.png)

**Figure 3.** Download & Delete Watch Log Files button

GnssLogger displays the following message: "Preparing your file. Please wait…":

![Preparing your file message](/static/images/sensors/gnss-share-dandd.png)
...
![A dialog showing sharing options](/static/images/sensors/gnss-share-2b.png)
...
![Email with attached zip file](/static/images/sensors/gnss-share7.png)
...
![Android Studio Device Explorer showing log files](/static/images/sensors/gnss-share6.png)
...
![Dialog to save files to computer](/static/images/sensors/gnss-share4.png)
