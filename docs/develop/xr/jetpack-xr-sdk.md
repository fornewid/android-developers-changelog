...
Compose for XR introduces the [`SceneCoreEntity`](https://developer.android.com/reference/kotlin/androidx/xr/compose/subspace/package-summary#SceneCoreEntity(kotlin.Function0,androidx.xr.compose.subspace.layout.SubspaceModifier,kotlin.Function1,androidx.xr.compose.subspace.SceneCoreEntitySizeAdapter,kotlin.Function0)) subspace composable, which
lets you [place entities](https://developer.android.com/develop/xr/jetpack-xr-sdk/develop-ui#use-scenecoreentity), such as 3D models, relative to your UI.
