...
An EXR image resource can be created as an [`ExrImage`](/reference/kotlin/androidx/xr/scenecore/ExrImage), where the EXR is
...
assets](/develop/xr/jetpack-xr-sdk/optimize-environment-assets) for more details.
