---
title: https://developer.android.com/develop/xr/jetpack-xr-sdk/develop-ui
url: https://developer.android.com/develop/xr/jetpack-xr-sdk/develop-ui
source: md.txt
---
...
manages the [`Surface`](https://developer.android.com/reference/android/view/Surface) into which your app can draw content, such as an
...
For 180 or 360 degree video use
[`SpatialExternalSurface180Hemisphere`](https://developer.android.com/reference/kotlin/androidx/xr/compose/subspace/package-summary#SpatialExternalSurface180Hemisphere(androidx.xr.compose.subspace.StereoMode,androidx.xr.compose.subspace.layout.SubspaceModifier,androidx.compose.ui.unit.Dp,androidx.xr.compose.subspace.layout.SpatialFeatheringEffect,androidx.xr.compose.subspace.SurfaceProtection,androidx.xr.compose.subspace.layout.InteractionPolicy,kotlin.Function1)) and
[`SpatialExternalSurface360Sphere`](https://developer.android.com/reference/kotlin/androidx/xr/compose/subspace/package-summary#SpatialExternalSurface360Sphere(androidx.xr.compose.subspace.StereoMode,androidx.xr.compose.subspace.layout.SubspaceModifier,androidx.compose.ui.unit.Dp,androidx.xr.compose.subspace.layout.SpatialFeatheringEffect,androidx.xr.compose.subspace.SurfaceProtection,androidx.xr.compose.subspace.layout.InteractionPolicy,kotlin.Function1)).
...
- This [`Surface`](https://developer.android.com/reference/android/view/Surface) doesn't capture input events.
...
- In a 2D layout wrapped in a `SpatialPanel` (as shown in a [preceding code](https://developer.android.com/develop/xr/jetpack-xr-sdk/develop-ui#2dlayout-code-snippet) snippet), the orbiter anchors to that `SpatialPanel`.
