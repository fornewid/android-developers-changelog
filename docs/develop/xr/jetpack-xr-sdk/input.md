---
title: Handle input from AI glasses  |  Android XR for Jetpack XR SDK  |  Android Developers
...
# Handle input from AI glasses Stay organized with collections Save and categorize content based on your preferences.
