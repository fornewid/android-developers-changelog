...
**Note:** Monitor display state changes for the AI glasses directly within the
[projected activity](/develop/xr/jetpack-xr-sdk/ai-glasses/support-different-types#activity-lifecycle).
