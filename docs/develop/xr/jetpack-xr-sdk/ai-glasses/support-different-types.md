---
title: Plan to support different types of AI glasses  |  Android XR for Jetpack XR SDK  |  Android Developers
...
# Plan to support different types of AI glasses Stay organized with collections Save and categorize content based on your preferences.
...
your [`Activity`](/reference/kotlin/android/app/Activity) for glasses to check for different device capabilities.
...
activity lifecycle](/guide/components/activities/activity-lifecycle), but it also includes several key differences that
...
user's phone. A *projected context* is a device-aware [`Context`](/reference/kotlin/android/content/Context) that lets
...
hardware](/develop/xr/jetpack-xr-sdk/access-hardware-projected-context).
...
Create your first activity for glasses](/develop/xr/jetpack-xr-sdk/ai-glasses/first-activity)

[Next

Check device capabilities at runtime for AI glasses

arrow\_forward](/develop/xr/jetpack-xr-sdk/ai-glasses/check-capabilities)