---
title: https://developer.android.com/develop/xr/jetpack-xr-sdk/run/emulator/glasses
...
[virtual Android XR devices](https://developer.android.com/develop/xr/jetpack-xr-sdk/run/create-avds/glasses) in the emulator and the emulator controls you
can use.
...
1. In the Android Studio **Device Manager** , find the [phone AVD that you
   created](https://developer.android.com/develop/xr/jetpack-xr-sdk/run/create-avds/glasses#phone-avd-host-device) to act as a host device for the glasses AVD, and click
   **Start** .
...
2. In the Android Studio **Device Manager** , find the [glasses AVD that you
   created](https://developer.android.com/develop/xr/jetpack-xr-sdk/run/create-avds/glasses#create-avd) and click **Start**.
...
glasses](https://developer.android.com/develop/xr/jetpack-xr-sdk/glasses/support-different-types).
...
2. Tap **Device Settings** , and then toggle **Audio-only mode**.
   ...
   ![Toggle Audio-only mode through the Glasses .](https://developer.android.com/static/images/develop/xr/jetpack-xr-sdk/run/companion-app-audio-only-mode.png)
...
4. In the Android Studio **Device Manger** , find the phone AVD and click **Cold
   ...
   ![Click](https://developer.android.com/static/images/develop/xr/jetpack-xr-sdk/run/phone-avd-cold-boot.webp)
...
5. Follow the other steps to
   [relaunch the glasses emulator and run your app](https://developer.android.com/develop/xr/jetpack-xr-sdk/run/emulator/glasses#run-app-emulator).
...
2. Trigger Gemini Live from the glasses emulator, by touching \& holding the
   ...
   ![A visual indicator shows on the display when Gemini Live is active.](https://developer.android.com/static/images/develop/xr/jetpack-xr-sdk/run/ai-glasses-gemini-live-active.png)
3. Check that the host microphone input is active on the glasses emulator by
   ...
   input is active.](https://developer.android.com/static/images/develop/xr/jetpack-xr-sdk/run/ai-glasses-check-host-microphone.png)
...
![Use the emulator controls to capture a screenshot of the emulator display in Android Studio.](https://developer.android.com/static/images/develop/xr/jetpack-xr-sdk/run/capture-screenshot.png)
...
1. Click **Record Screen** in the emulator controls.
   ...
   display in Android Studio.](https://developer.android.com/static/images/develop/xr/jetpack-xr-sdk/run/capture-recording.png)
