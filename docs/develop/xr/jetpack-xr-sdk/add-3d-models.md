---
title: Add 3D models to your app  |  Android XR for Jetpack XR SDK  |  Android Developers
...
# Add 3D models to your app Stay organized with collections Save and categorize content based on your preferences.
...
![Example of adding assets to the /models directory](/static/images/develop/xr/jetpack-xr-sdk/add-3d-models/models-directory.png)
...
limits](https://support.google.com/googleplay/android-developer/answer/9859372#size_limits) due to 3D assets and high resolution textures, you
should consider using [Play Asset Delivery](/guide/playcore/asset-delivery) to optimize the delivery of your
assets. For more information, see how to [package and distribute apps for
...
![Example of the loaded 3d model](/static/images/develop/xr/jetpack-xr-sdk/add-3d-models/3d-model.jpg)

**Important:** Some 3D content, such as 3D models, will only be visible when the app
is in Full Space.

## Place a 3D model into a Compose SceneCoreEntity

While you will still need to load the glTF into memory using
[`GltfModel.create()`](/reference/kotlin/androidx/xr/scenecore/GltfModel#create(androidx.xr.runtime.Session,java.nio.file.Path)), you can place 3D models into a
...
Refer to [Use a SceneCoreEntity to place a 3D object in your layout](/develop/xr/jetpack-xr-sdk/ui-compose#use-scenecoreentity).
...
[`GltfModelEntity`](/reference/kotlin/androidx/xr/scenecore/GltfModelEntity) and Scene Viewer.
