...
A Jetpack Compose Glimmer Card is built from several specialized elements, allowing you to customize its content and layout.

- **Header**: The top section of the card, designed to hold an image.

- **Title and Subtitle**: These text fields provide the main and secondary labels for the card.

- **Leading Icon**: An optional icon that appears at the beginning of the card's content area.

- **Trailing Icon**: An optional icon that appears at the end of the card's content area.

- **Action**: A slot for a primary interactive element, such as a Button. This allows users to perform an action directly from the card. The slot is available on a separate overload of the Card composable.

- **Main Content**: The core body of the card, where you place the primary Text or other content.
