...
3. See the following topics for more information, depending on what types of experiences you're trying to build:
   ...
   - **Building augmented experiences** : If you're extending your mobile app to [audio glasses or display glasses](https://developer.android.com/develop/xr/devices#audio-display), see [Start building for audio
     glasses and display glasses](https://developer.android.com/develop/xr/jetpack-xr-sdk/ai-glasses/build) to get started.
...
Explore the code provided in the template, [set up the Jetpack XR SDK](https://developer.android.com/develop/xr/jetpack-xr-sdk/set-up-sdk), and
check out the documentation for [building immersive experiences](https://developer.android.com/develop/xr/jetpack-xr-sdk/add-xr-to-existing) for XR
headsets and XR glasses, and the documentation for [building augmented
experiences](https://developer.android.com/develop/xr/jetpack-xr-sdk/ai-glasses/build) for audio glasses and display glasses.