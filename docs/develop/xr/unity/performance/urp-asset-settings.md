---
title: Optimize rendering using URP Asset settings  |  Android Developers
url: https://developer.android.com/develop/xr/unity/performance/urp-asset-settings
source: html-scrape
---

# Optimize rendering using URP Asset settings Stay organized with collections Save and categorize content based on your preferences.
...
In the URP Asset properties that you [navigated to earlier](#access-urp-asset-settings), disable **HDR**.
...
1. In the URP Asset properties that you [navigated to earlier](#access-urp-asset-settings), find the
   **Renderer List**.
2. In the **Renderer List**, right-click the **Universal Renderer** and select
   **Properties**.
...
* Avoids increased performance impact from the depth pre-pass due to the two
  views on XR devices.
...
1. In the URP Asset properties that you [navigated to earlier](#access-urp-asset-settings), find the
   **Renderer List**.
2. Right-click the **(Universal Renderer Data)** file and select
   **Properties**.
...
In the URP Asset properties that you [navigated to earlier](#access-urp-asset-settings), change **Anti
Aliasing (MSAA)** to **2x**.
