...
[Unity project setup](https://developer.android.com/develop/xr/unity/setup).
...
4. In the **Android** tab, under **Plug-in Providers** , enable **OpenXR**.
   ...
   ![Example of the project settings screen](https://developer.android.com/static/images/develop/xr/unity/xr-extensions-quickstart/plugin-providers-settings.png)
