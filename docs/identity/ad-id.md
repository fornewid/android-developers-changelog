---
title: Identity  |  Android Developers
...
app, you can use the [Advertising ID library](/jetpack/androidx/releases/ads). This library, which is
...
1. Check whether an ad provider is available by calling
   [`AdvertisingIdClient.isAdvertisingIdProviderAvailable()`](/reference/androidx/ads/identifier/AdvertisingIdClient#isAdvertisingIdProviderAvailable(android.content.Context)). If this method
