---
title: Display the quick contact badge  |  Identity  |  Android Developers
...
# Display the quick contact badge Stay organized with collections Save and categorize content based on your preferences.
...
When users tap the `QuickContactBadge` icon, the contact's
...
:   Inflates a new `View` object to hold the item layout. In the override
...
[Set the contact URI and thumbnail](#SetURIThumbnail) section.
