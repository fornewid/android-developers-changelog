---
title: Manage contact storage locations  |  Identity  |  Android Developers
...
# Manage contact storage locations Stay organized with collections Save and categorize content based on your preferences.
...
[`ContactsContract.RawContacts.DefaultAccount`](/reference/android/provider/ContactsContract.RawContacts.DefaultAccount)

Call [`getDefaultAccountForNewContacts()`](/reference/android/provider/ContactsContract.RawContacts.DefaultAccount#getDefaultAccountForNewContacts(android.content.ContentResolver)) to get the
[`ContactsContrast.RawContacts.DefaultAccount.DefaultAccountAndState`](/reference/android/provider/ContactsContract.RawContacts.DefaultAccount.DefaultAccountAndState)
