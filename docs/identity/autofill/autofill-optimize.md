...
[Test your app with autofill](https://developer.android.com/identity/autofill/autofill-optimize#test).

### Use Activity Context for views

The autofill service requires Activity Context to function properly. When
instantiating a view, use [`Activity`](https://developer.android.com/reference/android/app/Activity) as the
...
[`android:autofillHints`](https://developer.android.com/reference/android/R.styleable#View_autofillHints)
...
[`setAutofillHints()`](https://developer.android.com/reference/android/view/View#setAutofillHints(java.lang.String...))
...
value, the
[`View`](https://developer.android.com/reference/android/view/View#setAutofillHints(java.lang.String...))
and AndroidX
[`HintConstants`](https://developer.android.com/reference/androidx/autofill/HintConstants) classes contain
...
[`AUTOFILL_HINT_USERNAME`](https://developer.android.com/reference/androidx/autofill/HintConstants#AUTOFILL_HINT_USERNAME())
and
[`AUTOFILL_HINT_PASSWORD`](https://developer.android.com/reference/androidx/autofill/HintConstants#AUTOFILL_HINT_PASSWORD()).

For creating a new account, or when users change their username and password,
you can use
[`AUTOFILL_HINT_NEW_USERNAME`](https://developer.android.com/reference/androidx/autofill/HintConstants#AUTOFILL_HINT_NEW_USERNAME())
and
[`AUTOFILL_HINT_NEW_PASSWORD`](https://developer.android.com/reference/androidx/autofill/HintConstants#AUTOFILL_HINT_NEW_PASSWORD()).

#### Credit card info

When requesting credit card info, you can use hints such as
[`AUTOFILL_HINT_CREDIT_CARD_NUMBER`](https://developer.android.com/reference/androidx/autofill/HintConstants#AUTOFILL_HINT_CREDIT_CARD_NUMBER())
and
[`AUTOFILL_HINT_CREDIT_CARD_SECURITY_CODE`](https://developer.android.com/reference/androidx/autofill/HintConstants#AUTOFILL_HINT_CREDIT_CARD_SECURITY_CODE()).
...
[`AUTOFILL_HINT_SMS_OTP`](https://developer.android.com/reference/androidx/autofill/HintConstants#AUTOFILL_HINT_SMS_OTP()).

For multiple views where each view maps to a single digit of the OTP,
you can use the
[`generateSmsOtpHintForCharacterPosition()`](https://developer.android.com/reference/androidx/autofill/HintConstants#generateSmsOtpHintForCharacterPosition(int))
...
For example,
[`TextView`](https://developer.android.com/reference/android/widget/TextView) shows an autofill entry in the
overflow menu if autofill is enabled for the user. To check whether autofill
is enabled for the user, call the [`isEnabled()`](https://developer.android.com/reference/android/view/autofill/AutofillManager#isEnabled())
method of the
[`AutofillManager`](https://developer.android.com/reference/android/view/autofill/AutofillManager) object.

To make sure your sign-up and login experience is optimized for users without
autofill, implement
[One Tap sign-in](https://developer.android.com/identity/legacy/one-tap).
...
You can also use the [`cancel()`](https://developer.android.com/reference/android/view/autofill/AutofillManager#cancel())
...
autofill](https://developer.android.com/guide/topics/ui/controls/pickers#PickerAutofill).
...
[`autofill()`](https://developer.android.com/reference/android/view/View#autofill(android.util.SparseArray%3Candroid.view.autofill.AutofillValue%3E))
...
[`getAutofillType()`](https://developer.android.com/reference/android/view/View#getAutofillType())
and
[`getAutofillValue()`](https://developer.android.com/reference/android/view/View#getAutofillValue())
...
[`AUTOFILL_TYPE_NONE`](https://developer.android.com/reference/android/view/View#AUTOFILL_TYPE_NONE),
...
by calling
[`notifyValueChanged()`](https://developer.android.com/reference/android/view/autofill/AutofillManager#notifyValueChanged(android.view.View))
...
[`onProvideAutofillStructure()`](https://developer.android.com/reference/android/view/View#onProvideAutofillStructure(android.view.ViewStructure,%20int))
and call
[`setDataIsSensitive()`](https://developer.android.com/reference/android/view/ViewStructure#setDataIsSensitive(boolean))
on the [`ViewStructure`](https://developer.android.com/reference/android/view/ViewStructure) object.
...
[`setAutofillOptions()`](https://developer.android.com/reference/android/view/ViewStructure#setAutofillOptions(java.lang.CharSequence%5B%5D))
method to set the options that can be used to autofill the view. In particular,
views whose autofill type is
[`AUTOFILL_TYPE_LIST`](https://developer.android.com/reference/android/view/View#AUTOFILL_TYPE_LIST) must use
...
[`Spinner`](https://developer.android.com/reference/android/widget/Spinner), are a similar case. For example,
a spinner that provides dynamically created years, based on the current year, to
use in credit card expiration fields can
implement the
[`getAutofillOptions()`](https://developer.android.com/reference/android/widget/Adapter#getAutofillOptions())
method of the
[`Adapter`](https://developer.android.com/reference/android/widget/Adapter) interface to provide a list of
years.

Views that use an [`ArrayAdapter`](https://developer.android.com/reference/android/widget/ArrayAdapter)
...
[`onProvideAutofillVirtualStructure()`](https://developer.android.com/reference/android/view/View#onProvideAutofillVirtualStructure(android.view.ViewStructure,%20int))
...
[`AutofillCallback`](https://developer.android.com/reference/android/view/autofill/AutofillManager.AutofillCallback).

This class provides the
[`onAutofillEvent(View, int)`](https://developer.android.com/reference/android/view/autofill/AutofillManager.AutofillCallback#onAutofillEvent(android.view.View,%20int))
...
defined as [constants](https://developer.android.com/reference/android/view/autofill/AutofillManager.AutofillCallback#constants)
in the callback.

You can register a callback using the
[`registerCallback()`](https://developer.android.com/reference/android/view/autofill/AutofillManager#registerCallback(android.view.autofill.AutofillManager.AutofillCallback))
...
[`unregisterCallback()`](https://developer.android.com/reference/android/view/autofill/AutofillManager#unregisterCallback(android.view.autofill.AutofillManager.AutofillCallback))
method.

### Customize the autofill highlighted drawable

When a view is autofilled, the platform renders a
[`Drawable`](https://developer.android.com/reference/android/graphics/drawable/Drawable) over the view to
...
the [theme](https://developer.android.com/guide/topics/ui/look-and-feel/themes) used by the application
...
not in [`onStart()`](https://developer.android.com/reference/android/app/Activity#onStart()) or
...
[`RecyclerView`](https://developer.android.com/reference/androidx/recyclerview/widget/RecyclerView) class, are
...
[dialog](https://developer.android.com/guide/topics/ui/dialogs) is resized after it's already displayed,
the view isn't considered for autofill. These views aren't included in the
[`AssistStructure`](https://developer.android.com/reference/android/app/assist/AssistStructure) object that
...
[`token`](https://developer.android.com/reference/android/view/WindowManager.LayoutParams#token)
...
[`onWindowAttributesChanged()`](https://developer.android.com/reference/android/app/Dialog#onWindowAttributesChanged(android.view.WindowManager.LayoutParams))
method of the class that inherits from
[`Dialog`](https://developer.android.com/reference/android/app/Dialog). Then, replace
the `token` property of the saved
parameters with the `token` property of the parent activity in the
[`onAttachedToWindow()`](https://developer.android.com/reference/android/app/Dialog#onAttachedToWindow())
method.
...
devices](https://developer.android.com/studio/run/managing-avds).
