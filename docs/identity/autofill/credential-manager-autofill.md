---
title: Integrate Credential Manager with autofill  |  Identity  |  Android Developers
...
# Integrate Credential Manager with autofill Stay organized with collections Save and categorize content based on your preferences.
...
![Illustration showing credentials in autofill results](/static/identity/sign-in/images/credman-autofill.svg)  
...
**Note:** The `setPendingGetCredentialRequest` is an *extension API* in the
androidx.credentials library, and is called differently between Kotlin and Java.
