---
title: Linked Account Sign-In  |  Identity  |  Android Developers
...
# Linked Account Sign-In Stay organized with collections Save and categorize content based on your preferences.
...
To support Linked Account Sign-In on your Android app, follow the instructions in the [Android implementation guide](/identity/legacy/one-tap/linked-account-signin-client).
...
| `id_token` | The ID token contains the user’s Google Account information. The [Validate Response section](#validate_id_token_response) contains details on how to decode and validate the ID token response |
