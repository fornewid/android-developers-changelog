---
title: Request Additional Scopes  |  Identity  |  Android Developers
...
# Request Additional Scopes Stay organized with collections Save and categorize content based on your preferences.
...
**Warning:** This page is out of date, refer to
[Authorize access to Google user data](/identity/authorization)
for the latest best practice.
