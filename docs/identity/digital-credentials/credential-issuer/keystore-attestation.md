---
title: Implement hardware-backed attestation for digital credentials  |  Identity  |  Android Developers
...
# Implement hardware-backed attestation for digital credentials Stay organized with collections Save and categorize content based on your preferences.
...
[Android Keystore](/privacy-and-security/keystore), ensuring the key is locked in a Trusted Execution
...
encoded value of the `c_nonce` string.
...
* **Issuer:** Various values are provided by the issuer, and the most common are
  put in the [issuer metadata format](#issuer-metadata-format) to allow for filtering at presentation.
...
* [Verify hardware-backed key pairs with key attestation](/privacy-and-security/security-key-attestation#verifying)
