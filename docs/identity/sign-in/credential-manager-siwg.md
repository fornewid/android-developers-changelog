...
- The [bottom sheet](https://developer.android.com/identity/sign-in/credential-manager-siwg#use-credential) implementation supports [Automatic Sign-In](https://support.google.com/accounts/answer/12849458#zippy=%2Cautomatic-sign-in), which removes manual steps for returning users who have already authorized the app.
...
> [!NOTE]
> **Note:** The appearance of the bottom sheet depends on the user's Google Account settings. The settings are enabled by default; however, if the user disables "Sign-in prompts" for any Google Account on the device under **Google Account Settings \> Sign in with Google \> Sign-in prompts**, the bottom sheet is suppressed for all accounts.
...
> [!NOTE]
> **Note:** For more information about the button branding, see [Implement Sign in with Google](https://developer.android.com/identity/sign-in/credential-manager-siwg-implementation#create-button-ui).
