---
title: Authenticate users with WebView  |  Identity  |  Android Developers
...
# Authenticate users with WebView Stay organized with collections Save and categorize content based on your preferences.
...
`android.webkit.WebView` library in [version 1.12.0](/jetpack/androidx/releases/webkit#1.12.0) and later.
...
[adding digital asset linking](/identity/credential-manager/prerequisites).
...
Verify the implementation corresponds to the [UX recommendations](/design/ui/mobile/guides/patterns/passkeys).