---
title: Migrate from Smart Lock for Passwords to Credential Manager  |  Identity  |  Android Developers
...
# Migrate from Smart Lock for Passwords to Credential Manager Stay organized with collections Save and categorize content based on your preferences.
...
* Credential Manager fully [supports password saving and authentication](/training/sign-in/passkeys).
...
* Credential Manager integrates support for multiple sign in methods,
  including [passkeys](https://developers.google.com/identity/passkeys) and federated sign in methods like [Sign
  in with Google](/training/sign-in/credential-manager), to increase security and enable conversion if you plan
...
* Credential Manager provides a consistent, unified [user experience](/design/ui/mobile/guides/patterns/passkeys)
...
* [Add support for Digital Asset Links](/training/sign-in/passkeys#add-support-dal) (this step should be already
  implemented if you are using Smart Lock for Passwords)
