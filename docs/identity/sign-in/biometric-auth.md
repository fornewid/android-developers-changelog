---
title: Show a biometric authentication dialog  |  Identity  |  Android Developers
...
# Show a biometric authentication dialog Stay organized with collections Save and categorize content based on your preferences.
...
As a general rule, you should use [Credential Manager](/identity/sign-in/credential-manager) for initial sign-in on
...
**Note:** The [Biometric library](/reference/androidx/biometric/package-summary)
...
[`BiometricManager.Authenticators`](/reference/androidx/biometric/BiometricManager.Authenticators)
interface. The system lets you declare the following types of
authentication:

[`BIOMETRIC_STRONG`](/reference/androidx/biometric/BiometricManager.Authenticators#BIOMETRIC_STRONG)
...
[`BIOMETRIC_WEAK`](/reference/androidx/biometric/BiometricManager.Authenticators#BIOMETRIC_WEAK)
:   Authentication using a **Class 2** biometric, as defined on the
    [Android compatibility
    definition](https://source.android.com/compatibility/android-cdd#7_3_10_biometric_sensors)
    page.

[`DEVICE_CREDENTIAL`](/reference/androidx/biometric/BiometricManager.Authenticators#DEVICE_CREDENTIAL)
...
[`setAllowedAuthenticators()`](/reference/androidx/biometric/BiometricPrompt.PromptInfo.Builder#setAllowedAuthenticators(int))
...
[`canAuthenticate()`](/reference/androidx/biometric/BiometricManager#canAuthenticate(int)) method.
If necessary, invoke the
[`ACTION_BIOMETRIC_ENROLL`](/reference/android/provider/Settings#ACTION_BIOMETRIC_ENROLL) intent
...
[`getAuthenticationType()`](/reference/androidx/biometric/BiometricPrompt.AuthenticationResult#getAuthenticationType()).

## Display the login prompt

To display a system prompt that requests the user to authenticate using
biometric credentials, use the
[Biometric library](/reference/androidx/biometric/package-summary). This
...
1. In your app module's `build.gradle` file, [add a dependency on the
   `androidx.biometric`
   library](/jetpack/androidx/releases/biometric#declaring_dependencies).
...
[`CryptoObject`](/reference/androidx/biometric/BiometricPrompt.CryptoObject).
...
[`Mac`](/reference/javax/crypto/Mac), and
[`KeyAgreement`](/reference/javax/crypto/KeyAgreement).
...
[`SecretKey`](/reference/javax/crypto/SecretKey) object.
...
1. Generate a key that uses the following
   [`KeyGenParameterSpec`](/reference/android/security/keystore/KeyGenParameterSpec)
   configuration:
...
credentials](#allow-fallback), which means that
...
[`BiometricPrompt`](/reference/androidx/biometric/BiometricPrompt). Such a key
...
[`setConfirmationRequired()`](/reference/androidx/biometric/BiometricPrompt.PromptInfo.Builder#setConfirmationRequired(boolean)) method.
...
credentials](#declare-supported-authentication-types) by including
...
or [`setDeviceCredentialAllowed()`](/reference/androidx/biometric/BiometricPrompt.PromptInfo.Builder#setDeviceCredentialAllowed(boolean))
