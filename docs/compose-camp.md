---
title: Compose Camp  |  Android Developers
url: https://developer.android.com/compose-camp
source: html-scrape
---
...
[Learn how to use Jetpack Compose](#learn-jetpack-compose)

## Why did developers participate in Compose Camp?

![](https://developer.android.com/static/compose-camp/images/ComposeCamp_LandingPage_Asset_Participate_Tools_001.png)
...
![](https://developer.android.com/static/compose-camp/images/ComposeCamp_LandingPage_Asset_Participate_Connect_001.png)
...
![](https://developer.android.com/static/compose-camp/images/ComposeCamp_LandingPage_Asset_Participate_Skills_001.png)

### Apply your skills

Tackle hands-on activities and learn development concepts that you can apply directly in your own projects.

![](https://developer.android.com/static/compose-camp/images/ComposeCamp_LandingPage_Asset_Img_Join_001.png)
...
[For beginners](https://developer.android.com/courses/android-basics-compose/course)
[For experienced Android developers](https://developer.android.com/courses/jetpack-compose/course)

![](https://developer.android.com/static/compose-camp/images/ComposeCamp_LandingPage_Asset_Img_Lead_001.png)
...
[View organizer guide](https://goo.gle/compose-camp-org-guide)
...
### [MAD Skills: Compose](https://www.youtube.com/playlist?list=PLWz5rJ2EKKc-CG9riunK996aI6cRhXFDC)
...
### [Jetpack Compose Videos](https://www.youtube.com/playlist?list=PLWz5rJ2EKKc9Ty3Zl1hvMVUsXfkn93NRk)
...
“Leverage [@Composable](https://www.youtube.com/watch?v=kyH01Lg4G1E&t=2582s) functions to make your app UI code more typesafe. E.g. avoid blindly passing a bunch of Strings in and pass in a domain object instead.”

### Odin from Norway says:

“Check out the [compose samples](http://goo.gle/compose-samples) and the [now in android](http://goo.gle/nia)(nia) app from Android on github. They are great assets for learning compose best practices! 😍😊”

### Mansi from GDG Ahmedabad says:

“Use  [Accompanist animation library](https://github.com/google/accompanist/tree/main/navigation-animation) to add cool animations in your Compose UI.”
