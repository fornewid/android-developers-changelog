---
title: Use Room for data persistence  |  Android Developers
...
7. ## Fill-in-the-blanks
   ...
   To handle conflicts when inserting into a database, you can pass an \_\_\_, such as `IGNORE`, to the `@Insert` annotation.
8. ## The `ViewModel` factory is a class that inherits from \_\_\_ and is responsible for creating instances of the `ViewModel` class.
