...
2. ## Which of the following statements are true about the DAO?
   ...
   All of the above
3. ## The Database class, inheriting from the RoomDatabase class, is responsible for \_\_\_.
...
7. ## Fill-in-the-blanks
   ...
   To handle conflicts when inserting into a database, you can pass a(n) \_\_\_ parameter, such as `IGNORE`, to the `@Insert` annotation.
