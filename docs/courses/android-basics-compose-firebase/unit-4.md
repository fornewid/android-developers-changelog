---
title: Android Basics with Compose and Firebase  |  Navigation and app architecture  |  Android Developers
url: https://developer.android.com/courses/android-basics-compose-firebase/unit-4
source: html-scrape
---
