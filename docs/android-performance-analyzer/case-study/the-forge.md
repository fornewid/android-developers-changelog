---
title: How The Forge Interactive used APA to reduce CPU overhead  |  Android Performance Analyzer  |  Android Developers
...
# How The Forge Interactive used APA to reduce CPU overhead Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/android-performance-analyzer/images/cs-forge-1a.png)
...
![](/static/android-performance-analyzer/images/cs-forge-1b.png)
...
![](/static/android-performance-analyzer/images/cs-forge-2a.png)
...
![](/static/android-performance-analyzer/images/cs-forge-2b.png)
...
![](/static/android-performance-analyzer/images/cs-forge-2c.png)
...
![](/static/android-performance-analyzer/images/cs-forge-2d.png)
...
![](/static/android-performance-analyzer/images/cs-forge-2e.png)
...
![](/static/android-performance-analyzer/images/cs-forge-3a.png)
...
![](/static/android-performance-analyzer/images/cs-forge-3b.png)
...
![](/static/android-performance-analyzer/images/cs-forge-3c.png)

And this is the result without the optimization:

![](/static/android-performance-analyzer/images/cs-forge-3d.png)
...
![](/static/android-performance-analyzer/images/cs-forge-4a.png)

In the above picture, each small block renders a widget. Let’s zoom in on a
single block:

![](/static/android-performance-analyzer/images/cs-forge-4b.png)
...
![](/static/android-performance-analyzer/images/cs-forge-4c.png)

After:

![](/static/android-performance-analyzer/images/cs-forge-4d.png)
...
* More than 1ms of CPU time saved by batching calls to
  `vkCmdBindDescriptorSets`, which now take (on average) 0.81ms instead of
  1.91ms: less than half the previous amount of time.
* Great improvements in thermals, doubling time to reach all thermal states and,
  in case of light thermal state, almost tripling it.
* Refactor font and UI rendering to a more GPU-driven system, removing several
  API calls and improving scalability of the system.

## About The Forge Interactive, Inc.

![](/static/android-performance-analyzer/images/forge-logo-light.png)
