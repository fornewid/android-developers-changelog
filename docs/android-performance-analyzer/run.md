...
**Note:** Make sure your computer, test device, and app under test meet the listed
[requirements](/android-performance-analyzer/quickstart#requirements) before attempting to record a trace.
